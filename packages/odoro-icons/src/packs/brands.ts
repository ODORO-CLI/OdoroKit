...
/** Brands — 609 icons. Logos of services and platforms. Unlike the other packs, these are registered trademarks: their licence says nothing about their use, the rules of each owner are what apply. */
export const INFO = {
  module: 'brands',
  title: 'Brands',
  summary:
