/* Valeurs de base du systeme visuel Odoro.

   Ce fichier est un artefact fige, versionne avec le depot. Il n'est pas
   regenere au build : les echelles ci-dessous sont la fondation numerique du
   design system et ne bougent qu'a la faveur d'une decision explicite.

   Les references ayant servi de base sont listees dans CREDITS.md. */

/** Pas d'espacement de base : toute l'echelle en est un multiple. */
export const baseSpacingUnit = "0.25rem"

/** Palette complete de base : 26 teintes de 11 nuances, plus noir et blanc. */
...
/** Hauteur de ligne associee par defaut a chaque taille de texte. */
export const baseFontSizeLeading = {
  "xs": "calc(1 / 0.75)",
  "sm": "calc(1.25 / 0.875)",
  "base": "calc(1.5 / 1)",
  "lg": "calc(1.75 / 1.125)",
...
/** Familles de police de base. */
export const baseFontFamily = {
  "sans": "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', 'Noto Sans', Arial,\n    sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
...
/** Interlettrages de base. */
export const baseTracking = {
  "tighter": "-0.05em",
  "tight": "-0.025em",
  "normal": "0em",
  "wide": "0.025em",
...
/** Hauteurs de ligne nommees de base. */
export const baseLeading = {
  "tight": "1.25",
  "snug": "1.375",
  "normal": "1.5",
  "relaxed": "1.625",
...
/** Ombres internes de base. */
export const baseInsetShadow = {
  "2xs": "inset 0 1px rgb(0 0 0 / 0.05)",
  "xs": "inset 0 1px 1px rgb(0 0 0 / 0.05)",
  "sm": "inset 0 2px 4px rgb(0 0 0 / 0.05)",
} as const

/** Ombres de filtre de base. */
export const baseDropShadow = {
...
/** Points de rupture de base. */
export const baseBreakpoint = {
  "sm": "40rem",
  "md": "48rem",
  "lg": "64rem",
  "xl": "80rem",
...
/** Courbes de Bezier de base. */
export const baseEase = {
  "in": "cubic-bezier(0.4, 0, 1, 1)",
  "out": "cubic-bezier(0, 0, 0.2, 1)",
  "in-out": "cubic-bezier(0.4, 0, 0.2, 1)",
} as const

/** Distances de perspective de base. */
export const basePerspective = {
  "dramatic": "100px",
  "near": "300px",
  "normal": "500px",
  "midrange": "800px",
...
/** Rapports de forme de base. */
export const baseAspect = {
  "video": "16 / 9",
} as const
