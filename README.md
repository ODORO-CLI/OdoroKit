...
| Paquet                                       | Rôle                                                                            |
| -------------------------------------------- | ------------------------------------------------------------------------------- |
| [`@odoro-cli/libs`](packages/odoro-libs)     | Routeur, moteur d'animation, système de style et composants d'interface.        |
...
| [`@odoro-cli/engine`](packages/odoro-engine) | Ce qui travaille à chaque image : boucle unique, politique de mouvement, WebGL. |
| [`@odoro-cli/bits`](packages/odoro-bits)     | Le registre de composants animés : source de vérité et artefacts servis.        |
...
import { Button, Dialog, Input, Tabs, ToastProvider } from '@odoro-cli/libs/ui'
