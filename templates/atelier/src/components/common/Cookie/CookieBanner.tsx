  ...
  return transitions((style, show) =>
    show ? (
      <animated.section
        ...
        className="o-fixed o-bottom-4 o-left-4 o-right-4 o-z-50 o-flex o-flex-col o-gap-3 o-rounded-xl o-border-w-1 at-border-foreground-10 at-bg-background-95 o-p-5 at-font-sans at-text-foreground o-shadow-2xl o-backdrop-blur-xl sm:o-bottom-12 sm:o-left-auto sm:o-right-12 at-sm-w-420px sm:o-p-6"
      >
        <h2 className="o-text-base o-font-medium o-leading-snug sm:o-text-lg">
          This website uses cookies
        </h2>
        <p className="o-text-sm o-leading-relaxed at-text-foreground-70">
          ...
          <a
            ...
            className="o-underline o-underline-offset-2 at-hover-text-foreground-70"
          >
            privacy policy
          </a>
          .
        ...
        <div className="o-mt-1 o-flex o-flex-wrap o-items-center o-gap-2">
          ...
          <button
            type="button"
            onClick={openModal}
            className="o-px-2 o-py-2 o-text-sm o-font-medium at-leading-none at-text-foreground o-underline o-underline-offset-2 at-hover-text-foreground-70 at-focus-visible-outline-2 at-focus-visible-outline-offset-2 at-focus-visible-outline-foreground"
          >
            Manage preferences
          </button>
        </div>
