 ...
 * details screen has no product at all — a viewport-tall flacon behind two
 ...
 * page instead. It was a **deliberate deviation** for the jacket, which the frame
...
export const ProductStage = ({ subject, children }: ProductStageProps) => {
   ...
   * pinned to the top would draw the flacon straight over them.
   *
