 ...
 *
 * **The square is drawn in the page's own ink, not the rule's olive.** It is
 ...
 * a speck of the render rather than as a mark on it. The line stays on the
 * rule's own olive at 50%: it is the connection, not the point.
 */
const Leader = ({
  layer,
  active,
