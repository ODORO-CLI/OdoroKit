  ...
  return transitions((style, show) =>
    show ? (
      <animated.section
        ...
        className="o-fixed o-bottom-4 o-left-4 o-right-4 o-z-50 o-flex o-flex-col o-gap-3 o-rounded-xl o-border-w-1 pf-border-foreground-10 pf-bg-background-95 o-p-5 pf-font-sans pf-text-foreground o-shadow-2xl o-backdrop-blur-xl sm:o-bottom-12 sm:o-left-auto sm:o-right-12 pf-sm-w-420px sm:o-p-6"
      >
        <h2 className="o-text-base o-font-medium o-leading-snug sm:o-text-lg">
          This website uses cookies
        </h2>
        <p className="o-text-sm o-leading-relaxed pf-text-foreground-70">
          ...
          <a
            ...
            className="o-underline o-underline-offset-2 pf-hover-text-foreground-70"
          >
            privacy policy
          </a>
          .
        ...
        <div className="o-mt-1 o-flex o-flex-wrap o-items-center o-gap-2">
          ...
          <button
            type="button"
            onClick={openModal}
            className="o-px-2 o-py-2 o-text-sm o-font-medium pf-leading-none pf-text-foreground o-underline o-underline-offset-2 pf-hover-text-foreground-70 pf-focus-visible-outline-2 pf-focus-visible-outline-offset-2 pf-focus-visible-outline-foreground"
          >
            Manage preferences
          </button>
        </div>
