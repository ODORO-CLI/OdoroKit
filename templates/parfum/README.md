# ODORO — maison de parfum

Site vitrine immersif pour ODORO, une maison de parfum : un flacon 3D rendu en
direct (three.js) qui traverse la page au scroll, une composition en six écrans,
et une direction artistique « officine » — papier crème, filets olive, terre
cuite, une seule monospace (IBM 3270). Copie en français.
...
- Les quatre prix sont inventés.
- Les assets (flacon 3D, packshots, pyramide) sont générés par IA : vérifier les
  conditions d'usage commercial du générateur.
- Les liens `#` n'ont pas de routes ; le formulaire newsletter n'a pas de point d'entrée.

---

_Ci-dessous : la documentation d'origine du starter._
