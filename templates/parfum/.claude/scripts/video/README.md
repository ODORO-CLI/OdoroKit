...
> **2026-09-08 — plus de vidéo source.** `technology-stack.mp4` (l'explosé des
> tissus de la veste) a été retiré avec la conversion parfum (ADR-0050). Le reel
> est désormais une image fixe (`stack-frames/{hi,lo}/000.webp`, `count: 1`),
> produite depuis `assets-source/packshots/pyramide-cutout.webp`. Ce script ne
> sert plus qu'à titre de référence pour un futur reel scrubbé.
