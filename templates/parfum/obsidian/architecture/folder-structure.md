...
├── assets-source/           ← generated renders the served assets are made FROM (blank-label
│                              packshots, pyramid cutout) + how to rebuild them — ADR-0050
├── obsidian/                ← this Obsidian vault — ALL project documentation
├── .claude/scripts/assets/  ← label-packshot.py: writes the real label onto a blank packshot
