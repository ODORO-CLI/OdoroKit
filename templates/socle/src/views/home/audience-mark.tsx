 ...
 */
const ScrollModel = lazy(() =>
  import("@/components/ui/scroll-model").then((m) => ({ default: m.ScrollModel })),
);
...
export const AudienceMark = ({ src, label }: AudienceMarkProps) => {
  ...
  return (
    ...
    >
      <div ref={setGateNode} className="o-size-full">
        {mounted ? (
          // Le module est charge a la demande : il lui faut sa frontiere de
          // suspension. Le repli est vide — la scene arrive ou n arrive pas.
