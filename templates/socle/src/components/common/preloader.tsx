  ...
  return (
    <>
      ...
      <div
        ref={curtainRef}
        aria-hidden="true"
        className="o-pointer-events-none o-fixed o-inset-0 sn-z-100 sn-bg-background"
      >
        ...
        <div className="o-absolute sn-inset-x-10 o-bottom-10 o-h-20 o-overflow-hidden">
          <animated.span
            className="o-absolute o-bottom-0 o-whitespace-nowrap sn-text-display o-font-light sn-leading-flat sn-text-foreground"
            style={{
