...
const base =
  "o-rounded-lg o-px-4 o-py-2 o-text-sm o-font-medium sn-leading-none sn-focus-visible-outline-2 sn-focus-visible-outline-offset-2 sn-focus-visible-outline-foreground";

const variants: Record<NonNullable<CookieButtonProps["variant"]>, string> = {
  primary: "sn-bg-foreground sn-text-background hover:o-opacity-90",
  secondary:
    "o-border-w-1 sn-border-foreground-15 o-bg-transparent sn-text-foreground sn-hover-bg-foreground-5",
};
