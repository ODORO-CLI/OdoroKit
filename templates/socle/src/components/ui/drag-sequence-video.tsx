...
export const DragSequenceVideo = ({
  ...
  return (
    <div
      ...
      className={`o-relative o-touch-pan-y o-select-none o-overflow-hidden sn-bg-surface-muted ${
        draggable ? "o-cursor-grab sn-active-cursor-grabbing" : ""
      } ${className ?? ""}`}
    >
      <video
        ref={videoRef}
        ...
        className="o-pointer-events-none o-absolute o-inset-0 o-size-full o-object-cover"
      />
      ...
      {scrubber ? (
        <div
          ...
          className={`o-absolute sn-inset-x-6-75 sn-bottom-7-5 o-flex sn-h-8-75 o-items-center o-rounded-full sn-bg-surface-glass sn-px-6-25 sn-backdrop-blur-glass sn-focus-visible-outline-2 sn-focus-visible-outline-offset-2 sn-focus-visible-outline-on-media ${
            draggable ? "o-cursor-ew-resize" : "o-cursor-default"
          }`}
        >
          {/* The track is the measured element; the handle rides it. */}
          <div ref={trackRef} className="o-relative o-h-px o-w-full sn-bg-on-media">
            <span
              ref={handleRef}
              aria-hidden="true"
              className="o-absolute o-left-0 o-top-1/2 o-block sn-h-2-75 sn-w-9-5 sn-translate-x-1-2 sn-translate-y-1-2 o-rounded-full o-border-w-1 sn-border-on-media sn-bg-action-primary"
            />
          </div>
        </div>
      ) : null}
