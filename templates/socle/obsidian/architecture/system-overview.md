...
`next16-claude-starter` is a **frontend-only the framework starter** for building animation-heavy
...
app/layout.tsx ──────────────► RootLayout
   │   loads Google Sans Flex (the framework's local font loader), globals.css, metadata
   │
