...
- **Tier 1 — colour:** pure black/white plus their alpha steps
  ...
  S'y ajoute **`--raw-color-orange-500` (`#f97316`)**, l'orange du logo ODORO —
  la seule teinte de la palette. Elle remonte en tier 2 sous `--brand-mark` et
  n'est exposee qu'au sigle : le reste de la page garde son noir et blanc
  photographique. Ne pas l'etendre aux boutons ou aux liens sans une decision
  explicite, ce serait un second Style.
