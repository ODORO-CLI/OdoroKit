...
│   ├── home.tsx            # HomeView (Server Component) — composes the sections
│   └── home/sections/      # Feature components for the home view
│       └── hero.tsx · sitemap.tsx · brief.tsx · impact.tsx
│
├── data/mocks/home.ts      # Placeholder content, passed into sections as props
│
├── layouts/                # Reusable layout wrappers
│   └── scroll-layout.tsx   # Lenis smooth-scroll wrapper
│
├── components/
│   ├── ui/                 # Design-system primitives — SitemapButton
│   ├── common/             # Shared infrastructure (Cookie, grid, ReducedMotion, Skeletons)
│   │   ├── scene/          # WebGL backdrop — one point cloud in three forms (ADR-0028)
│   │   ├── sections/       # SectionController, Slide, SectionDeepLink
...
│   ├── sections/           # useSections, useSceneFade, useCursorParallax
│   └── use-window-size.ts
│
