 ...
 * page. Pure SVG in `currentColor`: give it `hl-text-accent-500` for the brand
...
export const LogoMark = ({ className = "o-size-7" }: LogoMarkProps) => (
  <svg
    aria-hidden="true"
    focusable="false"
    viewBox={MARK_SVG_VIEWBOX}
    className={`o-inline-block o-shrink-0 ${className}`}
  >
