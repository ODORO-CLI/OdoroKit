...
> In this project it is **built**: it is the Keld Studio page, composed from the
> sections in `src/views/home/` ([[changelog]] 2026-09-14). Extend it there, or
> add a new route with [[new-page]].
