...
const base =
  "o-rounded-lg o-px-4 o-py-2 o-text-sm o-font-medium cb-leading-none cb-focus-visible-outline-2 cb-focus-visible-outline-offset-2 cb-focus-visible-outline-foreground";

const variants: Record<NonNullable<CookieButtonProps["variant"]>, string> = {
  primary: "cb-bg-foreground cb-text-background hover:o-opacity-90",
  secondary:
    "o-border-w-1 cb-border-foreground-15 o-bg-transparent cb-text-foreground cb-hover-bg-foreground-5",
};
