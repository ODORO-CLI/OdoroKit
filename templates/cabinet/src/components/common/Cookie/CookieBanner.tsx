  ...
  return transitions((style, show) =>
    show ? (
      <animated.section
        ...
        className="o-fixed o-bottom-4 o-left-4 o-right-4 o-z-50 o-flex o-flex-col o-gap-3 o-rounded-xl o-border-w-1 cb-border-foreground-10 cb-bg-background-95 o-p-5 cb-font-sans cb-text-foreground o-shadow-2xl o-backdrop-blur-xl sm:o-bottom-12 sm:o-left-auto sm:o-right-12 cb-sm-w-420px sm:o-p-6"
      >
        <h2 className="o-text-base o-font-medium o-leading-snug sm:o-text-lg">
          Ce site utilise des cookies
        </h2>
        <p className="o-text-sm o-leading-relaxed cb-text-foreground-70">
          Ils font fonctionner le site, nous aident à comprendre son usage et à
          l&apos;améliorer. Acceptez tout, refusez le non-essentiel ou choisissez
          catégorie par catégorie. Voir notre{" "}
          <a
            href="/privacy-policy"
            target="_blank"
            rel="noopener noreferrer"
            className="o-underline o-underline-offset-2 cb-hover-text-foreground-70"
          >
        ...
        <div className="o-mt-1 o-flex o-flex-wrap o-items-center o-gap-2">
          ...
          <button
            type="button"
            onClick={openModal}
            className="o-px-2 o-py-2 o-text-sm o-font-medium cb-leading-none cb-text-foreground o-underline o-underline-offset-2 cb-hover-text-foreground-70 cb-focus-visible-outline-2 cb-focus-visible-outline-offset-2 cb-focus-visible-outline-foreground"
          >
