...
/**
 * Breakpoints, largest first. The Keld Studio design is authored at 1440, so
 * the starter's 1920 band is dropped: above 1440 the grid scales up instead of
 * re-basing (the same shape as the other 1440-authored projects).
 */
