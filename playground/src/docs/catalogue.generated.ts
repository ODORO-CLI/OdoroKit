...
export const CATALOGUE: readonly CatalogueEntry[] = [
  {
    ...
    title: 'Aurore',
    description:
      'Un fond de bruit fractal a deplacement de domaine, colore par la palette du projet.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    tokens: ['--o-palette-brand-600', '--o-palette-fuchsia-600', '--o-palette-zinc-50'],
    props: [
      {
        name: 'speed',
        type: 'number',
      ...
      },
      {
        ...
        required: false,
        description:
          'Classes du repli, affiche pendant le chargement et si WebGL manque.',
      },
    ],
    perf: {
      tier: 'medium',
      backend: 'ogl',
      notes:
        'Un triangle plein ecran et un shader de fragment. Treize kilo-octets compresses ; le rendu se suspend hors du champ.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-brand-500', '--o-palette-fuchsia-500'],
    props: [
      {
        name: 'speed',
        type: 'number',
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-fuchsia-600'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Un champ evalue par bulle, borne a seize. En qualite basse, le nombre est ramene a six.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-sky-950', '--o-palette-sky-200'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Cinq iterations de deux fonctions trigonometriques. Aucun bruit, donc aucun echantillonnage de texture.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    title: 'Cellules',
    description:
      'Un pavage cellulaire anime, dont les aretes viennent de la seconde distance.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Neuf germes evalues par fragment, quelle que soit la densite. En qualite basse, la densite est bornee a cinq.',
      fallback: 'gradient',
    },
    id: 'background/cells',
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-zinc-800', '--o-palette-emerald-300'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Trois evaluations d un bruit fractal a quatre octaves : la pente est mesuree par difference finie plutot que par fwidth, qui demande une extension en WebGL 1.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'L espace est replie sur lui-meme : le cout ne depend pas du nombre de points.',
      fallback: 'gradient',
    },
    id: 'background/dots',
  },
  {
    ...
    title: 'Grille',
    description:
      'Un quadrillage qui derive, en degrades repetes. Aucun contexte graphique.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Deux degrades repetes et un masque. Aucun contexte graphique, aucun plafond a partager.',
    },
  ...
  },
  {
    ...
    title: 'Trame',
    description:
      'Un demi-ton dont les points grossissent avec la lumiere, comme en impression.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-amber-300'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Un bruit fractal a trois octaves et une rotation. La finesse ne coute rien.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-brand-500'],
    props: [
      {
        name: 'speed',
        type: 'number',
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-900', '--o-palette-brand-600', '--o-palette-fuchsia-500'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Un bruit fractal a trois octaves, evalue une fois par carreau et non par pixel.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    title: 'Plasma',
    description:
      'L interference de quatre ondes, dont une radiale qui brise la periodicite.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-fuchsia-500', '--o-palette-sky-400'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Quatre sinus par fragment, sans bruit ni boucle : le cout ne varie pas avec les reglages.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-sky-300'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Un sinus et deux repliements par fragment. Le nombre de colonnes est gratuit.',
      fallback: 'gradient',
    },
    id: 'background/rain',
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-sky-400'],
    props: [
      {
        name: 'speed',
        type: 'number',
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-brand-500', '--o-palette-sky-300'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Neuf evaluations de bruit fractal par fragment. En qualite basse, les octaves tombent a deux.',
      fallback: 'gradient',
    },
    id: 'background/silk',
  },
  {
    ...
    title: 'Spectre',
    description:
      'Un balayage angulaire de teintes, qui module la palette sans la remplacer.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-brand-400'],
    props: [
      {
        name: 'speed',
        type: 'number',
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-zinc-100'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Trois couches, une cellule evaluee par couche. La densite ne change pas le cout.',
      fallback: 'gradient',
    },
    id: 'background/stars',
  },
  {
    ...
    title: 'Fils',
    description:
      'Un faisceau de courbes fines, d epaisseur constante sur toute leur longueur.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-emerald-300'],
    props: [
      {
        name: 'speed',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Un passage par fil, borne a douze. En qualite basse, le faisceau est ramene a quatre.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Une division, un arc tangente, deux repliements. Rien ne depend des reglages.',
      fallback: 'gradient',
    },
  ...
  },
  {
    ...
    title: 'Vortex',
    description:
      'Une spirale obtenue en ajoutant a l angle une quantite qui decroit avec le rayon.',
    engine: {
      gsap: [],
      gl: 'ogl',
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-zinc-950', '--o-palette-brand-600', '--o-palette-amber-300'],
    props: [
      {
        name: 'speed',
        type: 'number',
  ...
  },
  {
    ...
    perf: {
      ...
      backend: 'ogl',
      notes:
        'Un triangle plein ecran. Le cout ne depend que du nombre de bandes, borne a huit.',
      fallback: 'gradient',
    },
    id: 'background/waves',
  },
  ...
  },
  {
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Le defilement natif fait le travail : pas de boucle, pas de transform pilote a la main.',
    },
    id: 'effect/carousel',
  },
  {
    ...
    title: 'Deformation',
    description:
      'Un filtre de deplacement pose sur n importe quel contenu : fond, texte ou image.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    props: [
      ...
      },
      {
        ...
        default: 'clean',
        description:
          'clean redecoupe le resultat sur la forme d origine ; organic laisse la silhouette se deformer.',
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Un filtre natif, calcule une fois. Le mouvement translate le champ plutot que de le regenerer : animer la frequence effondrerait la cadence.',
    },
    id: 'effect/deform',
  },
  {
    ...
    title: 'Attraction',
    description:
      'Un element attire par le pointeur, qui revient a sa place des qu il s eloigne.',
    engine: {
      gsap: [],
      gl: false,
    },
  ...
  },
  {
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Une translation animee par le compositeur, et un masque. Aucun JavaScript par image.',
    },
    id: 'effect/marquee',
  },
  {
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Une lecture de defilement dans la boucle unique, une ecriture de transform. Aucun rendu React.',
    },
    id: 'effect/parallax',
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-palette-brand-600', '--o-duration-fast'],
    props: [
      {
        name: 'target',
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Un abonnement au defilement, une ecriture de transform par image. Aucun rendu React en cours de defilement.',
    },
  ...
  },
  {
    ...
    title: 'Molten',
    description:
      'Une masse en fusion qui respire, deformee par un bruit fractal et coloree par la palette.',
    engine: {
      gsap: [],
      gl: 'three',
    },
    ...
    dependencies: [],
    registryDependencies: ['hooks/use-poster', 'hooks/use-pointer-damped'],
    tokens: ['--o-palette-brand-600', '--o-palette-fuchsia-600'],
    props: [
      {
        name: 'amplitude',
        type: 'number',
    ...
    perf: {
      ...
      backend: 'three',
      notes:
        'Scene 3D : environ 130 Ko compresses au premier affichage, contre 13 pour le backend leger. Le nombre d octaves et la subdivision suivent la qualite retenue.',
      fallback: 'poster',
    },
    id: 'hero/molten',
  },
  {
    ...
    description:
      'Position du pointeur, normalisee et lissee, mise a jour dans la boucle du moteur.',
    engine: {
      gsap: ['core'],
      gl: false,
    },
  ...
  },
  {
    ...
    title: 'Repli visuel',
    description:
      'Maintient un repli affiche jusqu a ce que la scene soit prete, puis le fond en douceur.',
    engine: {
      gsap: [],
      gl: false,
    },
  ...
  },
  {
    ...
    title: 'Avant / apres',
    description:
      'Deux images superposees, revelees par une poignee au pointeur comme au clavier.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Une variable CSS ecrite au deplacement. Aucun rendu React pendant le glissement.',
    },
    id: 'image/compare',
  },
  {
    ...
    title: 'Cadre',
    description:
      'Une image avec rapport fige, silhouette de chargement et revelation en douceur.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-duration-slow', '--o-ease-entrance'],
    props: [
      {
        name: 'src',
        type: 'string',
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Le rapport est fige avant le chargement : la page ne se decale pas quand l image arrive.',
    },
    id: 'image/frame',
  },
  {
    ...
    title: 'Lecteur video',
    description:
      'Un lecteur complet : lecture, barre de progression, volume, plein ecran, au clavier.',
    engine: {
      gsap: [],
      gl: false,
    },
  ...
  },
  {
    ...
    title: 'Video de fond',
    description:
      'Une video au rapport fige, avec affiche de chargement et respect du mouvement reduit.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'La lecture ne demarre qu une fois la video dans le champ, et jamais sous mouvement reduit.',
      fallback: 'poster',
    },
    id: 'image/video',
  },
  {
    ...
    description:
      'Une liste de questions repliables, une seule ouverte a la fois ou plusieurs.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    dependencies: [],
    registryDependencies: [],
    tokens: ['--o-duration-fast', '--o-ease-standard'],
    props: [
      {
        name: 'items',
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Le repliage passe par les elements natifs : le clavier et la recherche dans la page fonctionnent sans code.',
    },
    id: 'section/faq',
  },
  {
    ...
    dependencies: [],
    registryDependencies: ['effect/marquee'],
    tokens: [],
    props: [
      {
        name: 'children',
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Le defilement vient du bandeau ; cette section n ajoute qu une mise en page et un intitule.',
    },
  ...
  },
  {
    ...
    description:
      'Une grille dont les elements arrivent en cascade quand la section entre dans le champ.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Un observateur d intersection, puis des transitions CSS decalees. Aucun JavaScript par image.',
    },
  ...
  },
  {
    ...
    description:
      'Un media colle a gauche, des etapes qui defilent a droite, et le media qui suit l etape active.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Une lecture de defilement dans la boucle unique, et un index qui ne change qu au passage d une etape.',
    },
  ...
  },
  {
    ...
    description:
      'Des cartes qui se figent et s empilent a mesure que le defilement avance.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Le collage est natif. Seule l echelle est ecrite par la boucle, une fois par carte et par image.',
    },
  ...
  },
  {
    ...
    title: 'Decodage',
    description:
      'Le texte se stabilise depuis un brouillage de caracteres, lettre par lettre.',
    engine: {
      gsap: [],
      gl: false,
    },
  ...
  },
  {
    ...
    title: 'Reflet',
    description:
      'Un reflet traverse le texte en boucle, sans aucun JavaScript a l execution.',
    engine: {
      gsap: [],
      gl: false,
    },
  ...
  },
  {
    ...
    description:
      'Un titre qui se compose caractere par caractere quand il entre dans le champ.',
    engine: {
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Le decoupage a lieu une fois. L animation est jouee par l orchestrateur, sans rendu React.',
    },
  ...
  },
  {
    ...
    description:
      'Une suite de phrases frappees puis effacees, avec un curseur clignotant.',
    engine: {
      gsap: [],
      gl: false,
    },
    ...
    perf: {
      ...
      backend: false,
      notes:
        'Un minuteur, pas d abonnement a la boucle : la frappe n a pas besoin de la cadence de l ecran.',
    },
    id: 'text/typewriter',
  },
]
