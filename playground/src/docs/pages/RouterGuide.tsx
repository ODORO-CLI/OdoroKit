  ...
  return (
    <article>
      <PageHeader
        ...
        title="Le routeur"
        lead="Un routeur client complet : routes imbriquees, paramètres, routes paresseuses, défilement restaure et transitions de page natives. Ce site entier est rendu avec."
      />

      <Section
        title="Declarer des routes"
        lead="Les routes se déclarent en JSX et s'imbriquent ; Outlet rend la route enfant active dans son parent."
      >
        <CodeBlock
          lang="tsx"
...
<Router>
  <Routes fallback={<p>Chargement...</p>}>
    <Route path="/" element={<Layout />}>
      ...
      <Section
        title="Lire l'état de navigation"
        lead="Quatre hooks couvrent les besoins courants : l'emplacement, les paramètres de route, la navigation programmatique et les paramètres de requête."
      >
        <CodeBlock
          lang="tsx"
  ...
  return (
    <button onClick={() => navigate('/projets')}>
      ...
      <Section
        ...
        lead="Chaque navigation est enveloppee dans une View Transition native quand le navigateur la supporte. La feuille odoro fournit le fondu par défaut ; nommez une zone pour lui donner du mouvement."
      >
        <CodeBlock
          lang="tsx"
...
<main className="o-view-transition-page">
  <Outlet />
        ...
        <Callout>
          ...
          transitions sont neutralisees par la feuille de style — rien a faire côté
          application.
        </Callout>
      </Section>
    </article>
