    ...
    <div className="o-flex o-flex-col o-gap-16">
      ...
      <section>
        ...
        >
          ...
          <Feature title="Composants" to="/docs/composants/button" icon={LayoutGrid}>
          ...
          <Feature title="Icones" to="/docs/icones" icon={Shapes}>
            Cinq jeux normalises sur un meme contrat, dix mille six cent trente-neuf
