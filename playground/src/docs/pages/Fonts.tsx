...
import { GOOGLE_FONTS, fontStack, loadGoogleFonts } from '@odoro-cli/libs/styles'
  ...
  return (
    <article>
      ...
      >
        <CodeBlock
          lang="ts"
          code={`import { loadGoogleFonts, applyFontFamily } from '@odoro-cli/libs/styles'
...
<p style={{ fontFamily: fontStack('${family}') }}>...</p>`}
      ...
      >
        <CodeBlock
          lang="ts"
          code={`import { googleFontsUrl } from '@odoro-cli/libs/styles'
