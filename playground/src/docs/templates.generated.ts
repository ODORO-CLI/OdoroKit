...
export const TEMPLATES: readonly TemplateEntry[] = [
  ...
  },
  {
    ...
    stack: ['Vite', 'React', 'WebGL', 'Motion', 'Tailwind v4'],
  ...
  },
  {
    ...
    kind: 'starter',
    description:
      'Le socle dont les autres derivent : ressorts partout, texte anime, defilement lisse, grille adaptative en rem.',
    stack: ['Next 16', 'react-spring', 'Lenis', 'Tailwind v4'],
