...
const CLIENTS = ['Meridian', 'Ardoise', 'Calque', 'Nordsud', 'Houle', 'Brevet', 'Semaphore', 'Litt'] as const
 ...
 * slogan.
 */
const ACTES: readonly { readonly mot: string; readonly phrase: string; readonly note: string }[] = [
  {
    mot: 'Sentir',
...
const CAS = [
  {
    ...
    chiffre: 82,
    unite: '%',
    texte: 'Lecture des bons de commande par modele de vision, controle humain sur les seuls cas douteux. Quatre-vingt-deux pour cent des lignes ne sont plus tapees.',
  ...
  },
  {
    ...
    chiffre: 1400,
    unite: ' h',
    texte: 'Mille quatre cents heures rendues par an, avec un taux de reprise manuelle sous trois pour cent. Le cabinet a repris deux clients de plus sans embaucher.',
  ...
  },
  {
    ...
    chiffre: 11,
    unite: ' j',
    texte: 'Le support repondait en onze jours ouvres. Huit semaines plus tard, la premiere reponse tombe en une heure, redigee par le systeme et relue par un humain.',
 ...
 */
const OMBRE_SUR_RELIEF: CSSProperties = { textShadow: '0 1px 2px rgba(0,0,0,0.85), 0 2px 22px rgba(0,0,0,0.8)' }
...
function Rendement(): ReactElement {
  ...
  return (
    <BorderBeam duration={5200} width={2} trail={22} color={encreSurSombre()} className="o-rounded-2xl">
      <div className={`${verre(true)} o-grid o-gap-8 o-p-6 md:o-p-8 lg:o-grid-cols-12`}>
        <div className="o-flex o-flex-col o-gap-6 lg:o-col-span-5">
          <label className="o-block">
            ...
            <input type="range" min={1} max={20} value={heures} onChange={(e) => { setHeures(Number(e.target.value)) }} className={`o-mt-3 ${curseur}`} />
          </label>
          <label className="o-block">
            <span className="o-flex o-justify-between o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
            ...
            <input type="range" min={3} max={400} step={1} value={effectif} onChange={(e) => { setEffectif(Number(e.target.value)) }} className={`o-mt-3 ${curseur}`} />
          </label>
          <div role="group" aria-label="Poste concerne" className="o-flex o-flex-wrap o-gap-2">
            {POSTES.map((p) => {
        ...
        <dl className="o-m-0 o-grid o-grid-cols-2 o-gap-6 o-border-white-10 lg:o-col-span-7 lg:o-border-l lg:o-pl-8">
          <div className="o-col-span-2">
            <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Heures rendues par an</dt>
            <dd className="o-m-0 o-mt-2 o-tabular-nums o-text-white" style={{ ...affiche('l', 300), fontSize: 'clamp(3rem, 8vw, 7rem)' }}>
              <CountUp value={calcul.parAn} locale="fr-FR" duration={700} declenchement="montage" />
            </dd>
          </div>
          <div>
            <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Ce que cela vaut</dt>
            <dd className="o-m-0 o-mt-2 o-text-3xl o-tabular-nums o-tracking-tight" style={{ color: encreSurSombre() }}>
              {calcul.valeur.toLocaleString('fr-FR')} EUR
            </dd>
          </div>
          <div>
            <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Retour sur le projet</dt>
          ...
          <p className="o-col-span-2 o-m-0 o-text-sm o-leading-relaxed o-text-zinc-400">
            Part automatisable prise a 62 %, la mediane de nos flux livres. Le projet est chiffre a 48 000 EUR plus 600 EUR par personne formee. Ce sont des ordres de grandeur ; le cadrage donne les vrais.
          </p>
        </dl>
      </div>
    </BorderBeam>
  ...
  return (
    <div className="o-flex o-size-full o-flex-col o-px-6 o-py-10 md:o-px-10 lg:o-px-16">
      ...
      <div className="o-my-auto o-grid o-items-baseline o-gap-8 o-py-8 md:o-grid-cols-12 md:o-gap-12">
        <p key={acte.mot} className="o-m-0 o-text-white md:o-col-span-5" style={{ ...CORPS_ACTE, ...OMBRE_SUR_RELIEF }}>
          {acte.mot}
        </p>
        <div className="md:o-col-span-7">
          <p className="o-m-0 o-max-w-xl o-text-balance o-text-white" style={{ ...affiche('m', 300), fontSize: 'clamp(1.5rem, 2.6vw, 2.5rem)', lineHeight: 1.12, ...OMBRE_SUR_RELIEF }}>
            {acte.phrase}
          </p>
          <p className="o-m-0 o-mt-6 o-max-w-lg o-text-base o-leading-relaxed o-text-zinc-300" style={OMBRE_SUR_RELIEF}>{acte.note}</p>
        </div>
      </div>
      <div className="o-flex o-items-center o-gap-3" aria-hidden="true">
        {ACTES.map((a, index) => (
          <span
            ...
            style={{ backgroundColor: index <= rang ? encreSurSombre() : 'var(--o-palette-zinc-800)' }}
          />
        ))}
      </div>
    </div>
    ...
    <Porte forme="compteur" marque="Tangente">
      <div className="o-relative o-isolate" style={{ ...nuit('zinc'), ...polices }}>
        ...
        <div className="o-relative o-isolate">
          ...
          */}
          <div aria-hidden="true" className="o-pointer-events-none o-absolute o-inset-0 o-z-0">
            <div className="o-sticky o-relative o-overflow-hidden" style={{ top: CHROME, height: ECRAN }}>
              <TerrainWireframe
          ...
          <header className="o-relative o-z-10 o-min-h-screen">
            <BarreFilet marque="Tangente" liens={LIENS} action={['#appel', 'Prendre rendez-vous']} />
            ...
            <div className="o-mx-auto o-flex o-max-w-6xl o-flex-col o-items-center o-px-6 o-pb-24 o-pt-20 o-text-center md:o-pt-28">
              ...
              <TitreVague delai={120} className="o-m-0 o-mt-8 o-text-white" style={affiche('xxl', 300)}>
                Tangente
              </TitreVague>
              <Surgit delai={420} as="p" className="o-m-0 o-mt-8 o-max-w-2xl o-text-lg o-leading-relaxed o-text-zinc-300 md:o-text-xl">
                Nous cherchons ou l IA rentre dans votre metier, ce que les taches repetees vous coutent en heures, et nous construisons ce qui tient — sans deviner.
              </Surgit>
              <Surgit delai={560} className="o-mt-10">
                <Actions pleine={['#rendement', <>Calculer les heures rendues <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]} fantome={['#manifeste', 'Comment on travaille']} />
              </Surgit>
            </div>
            ...
            <div className="o-mx-auto o-flex o-max-w-6xl o-justify-between o-gap-6 o-px-6 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400">
              <Surgit delai={700} as="p" className="o-m-0">Lyon — Nantes<br />Depuis 2021</Surgit>
              <Surgit delai={760} as="p" className="o-m-0 o-text-right">Vingt-deux flux en production<br />Onze clients</Surgit>
            </div>
          ...
          <section id="manifeste" className="o-relative o-z-10 o-scroll-mt-24">
            <div className="o-mx-auto o-max-w-5xl o-px-6 o-py-28 md:o-py-40">
              ...
              >
                La plupart des projets d IA echouent parce qu on a commence par le modele. Nous commencons par le chronometre.
              </ScrollReveal>
            </div>
        ...
        <main>
          ...
          <section id="cas" className="o-mx-auto o-max-w-7xl o-scroll-mt-24 o-px-6 o-py-24 md:o-py-32">
            <Reveal>
              <Indice rang="01">Les cas</Indice>
            </Reveal>
            <Reveal delay={80}>
              <h2 className="o-m-0 o-mt-6 o-max-w-3xl o-text-white" style={affiche('m', 300)}>
            ...
            <ol className="o-m-0 o-mt-16 o-list-none o-border-t o-border-white-10 o-p-0">
              {CAS.map((cas, rang) => (
                <li key={cas.nom} className="o-grid o-items-center o-gap-8 o-border-b o-border-white-10 o-py-12 md:o-grid-cols-12 md:o-gap-10 md:o-py-16">
                  <span aria-hidden="true" className="o-tabular-nums o-text-zinc-500 md:o-col-span-2" style={affiche('l', 300)}>
                  ...
                  <div className="md:o-col-span-5">
                    ...
                    <p className="o-m-0 o-mt-4 o-tabular-nums o-text-white" style={{ ...affiche('l', 300), fontSize: 'clamp(3rem, 6.5vw, 6rem)' }}>
                      <CountUp value={cas.chiffre} suffix={cas.unite} locale="fr-FR" duration={1400} />
                    </p>
                    <SplitLines
                      as="h3"
                      stagger={90}
                      ...
                      style={{ ...affiche('m', 300), fontSize: 'clamp(1.375rem, 2.4vw, 2rem)', lineHeight: 1.15 }}
                    >
                      {cas.titre}
                    </SplitLines>
                    <p className="o-m-0 o-mt-4 o-max-w-md o-text-sm o-leading-relaxed o-text-zinc-400">{cas.texte}</p>
                  </div>
          ...
          <section id="rendement" className="o-relative o-isolate o-scroll-mt-24 o-overflow-hidden o-border-t o-border-white-10 o-py-24 md:o-py-32">
            <div aria-hidden="true" className="o-absolute o-inset-0 o-z-0" style={{ background: `radial-gradient(ellipse at 50% 0%, ${accentDoux(500, 22)} 0%, transparent 60%)` }} />
          ...
          >
            <div className="o-mx-auto o-w-full o-max-w-5xl">
              <Reveal>
                <blockquote className="o-m-0 o-text-balance o-text-white" style={{ ...affiche('l', 300), fontSize: 'clamp(1.875rem, 4.6vw, 4.25rem)', lineHeight: 1.1 }}>
                  « Ils n ont pas cherche a nous vendre des outils en plus. Ils ont compris notre flux, et ils ont construit exactement ce qu il fallait — pas une ligne de plus. »
                </blockquote>
              </Reveal>
              <Reveal delay={140}>
                <div className="o-mt-14 o-flex o-flex-wrap o-items-center o-justify-between o-gap-6 o-border-t o-border-white-10 o-pt-8">
                  <div className="o-flex o-items-center o-gap-4">
                    <img src={temoin.src} alt={temoin.alt} className="o-size-14 o-rounded-full o-object-cover" />
                    <div>
                      <p className="o-m-0 o-font-medium o-text-white">Helene Marchal</p>
                      <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Directrice des operations, Meridian</p>
                    </div>
                  </div>
                  <a href="#cas" className="o-inline-flex o-items-center o-gap-2 o-font-mono o-text-xs o-uppercase o-tracking-widest o-no-underline focus:o-ring" style={{ color: encreSurSombre() }}>
                    Lire le cas Meridian <Icon icon={ArrowUpRight} size={14} aria-hidden="true" />
                  </a>
                </div>
              </Reveal>
            </div>
          ...
          <section id="appel" className="o-scroll-mt-24 o-border-t o-border-white-10 o-px-6 o-py-24 md:o-py-32">
            <div className="o-mx-auto o-max-w-4xl">
              <Indice rang="03">Prendre rendez-vous</Indice>
              <h2 className="o-m-0 o-mt-6 o-max-w-3xl o-text-white" style={{ ...affiche('m', 300), fontSize: 'clamp(2rem, 4.4vw, 4rem)' }}>
              ...
              >
                <label className="o-block o-min-w-0 md:o-flex-1">
                  <span className="o-block o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Votre nom</span>
                  <input
                    type="text"
                    name="nom"
                    autoComplete="name"
                    ...
                    style={{ border: 0, borderRadius: 0, borderBottom: '1px solid var(--o-palette-zinc-700)' }}
                  />
                </label>
                <label className="o-block o-min-w-0 md:o-flex-1">
                  <span className="o-block o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Votre courriel</span>
                  <input
                    type="email"
                    name="courriel"
                    autoComplete="email"
              ...
              <p aria-live="polite" className="o-m-0 o-mt-8 o-max-w-xl o-text-sm o-leading-relaxed o-text-zinc-400">
                {envoye
        ...
        <Pied
          marque="Tangente"
          colonnes={[
            { titre: 'Agence', liens: [['#manifeste', 'La methode'], ['#cas', 'Les cas'], ['#appel', 'Contact']] },
            { titre: 'Bureaux', liens: [['#appel', 'Lyon — 14 rue Bellecordiere'], ['#appel', 'Nantes — 9 quai Moncousu']] },
            { titre: 'Ecrire', liens: [['#appel', 'bonjour@tangente.fr'], ['#appel', 'presse@tangente.fr']] },
            { titre: 'Legal', liens: [['#appel', 'Mentions'], ['#appel', 'Donnees'], ['#appel', 'Conditions']] },
          ]}
