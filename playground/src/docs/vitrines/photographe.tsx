...
const NOTES: Readonly<Record<Rubrique, string>> = {
  Portrait:
    'En lumiere naturelle, sur une demi-journee. Les sujets ont le temps de cesser de poser.',
  Architecture:
    'A l heure ou le batiment est le mieux servi par le ciel : reperage la veille, prise de vue a l aube.',
  Paysage:
    'Des series longues, souvent au retour de la meme cote a deux saisons d ecart.',
  'Nature morte':
    'Au studio, sur fond papier, une seule source. Objets, matieres, produits.',
}
...
const TIRAGES: readonly Tirage[] = [
  {
    graine: 'lisiere-couverture',
    alt: 'Silhouette de profil, contre-jour',
    rubrique: 'Portrait',
    lieu: 'Paris',
    focale: '85 mm',
    portrait: true,
  },
  {
    ...
    alt: 'Facade en zinc et balcons filants',
    rubrique: 'Architecture',
    lieu: 'Rennes',
    focale: '24 mm',
  },
  {
    graine: 'tamaris-crique-9',
    alt: 'Calanque, eau turquoise, bateau',
    rubrique: 'Paysage',
    lieu: 'Cassis',
    focale: '35 mm',
  },
  {
    graine: 'cafe-guji',
    alt: 'Grains de cafe torrefies, gros plan',
    rubrique: 'Nature morte',
    lieu: 'Studio',
    focale: '100 mm',
    portrait: true,
  },
  {
    graine: 'cadre-bandeau-six',
    alt: 'Facade moderniste, noir et blanc',
    rubrique: 'Architecture',
    lieu: 'Newport',
    focale: '50 mm',
  },
  {
    ...
    alt: 'Village de pecheurs sous les sommets',
    rubrique: 'Paysage',
    lieu: 'Reine',
    focale: '28 mm',
  },
  {
    graine: 'tige-rose',
    alt: 'Roses serrees, vue de dessus',
    rubrique: 'Nature morte',
    lieu: 'Studio',
    focale: '90 mm',
  },
  {
    ...
    alt: 'Interieur de boutique, sol en damier',
    rubrique: 'Architecture',
    lieu: 'Nantes',
    focale: '35 mm',
  },
  {
    graine: 'cadre-archive-escalier',
    alt: 'Escalier en beton, vide central',
    rubrique: 'Architecture',
    lieu: 'Nantes',
    focale: '20 mm',
    portrait: true,
  ...
  {
    graine: 'tamaris-crique-1',
    alt: 'Falaises dans la brume, mer plate',
    rubrique: 'Paysage',
    lieu: 'Cotentin',
    focale: '70 mm',
  },
  {
    graine: 'tige-tulipes',
    alt: 'Tulipe striee, fond de bleuets',
    rubrique: 'Nature morte',
    lieu: 'Jardin',
    focale: '105 mm',
    portrait: true,
  },
  {
    ...
    alt: 'Silhouette en mouvement, defile en plein air',
    rubrique: 'Portrait',
    lieu: 'Arles',
    focale: '135 mm',
  },
  {
    ...
    alt: 'Vallee ocre, villages en terrasses',
    rubrique: 'Paysage',
    lieu: 'Haut Atlas',
    focale: '35 mm',
  },
  {
    graine: 'rasoir-outils',
    alt: 'Bol, blaireau et rasoir sur bois',
    rubrique: 'Nature morte',
    lieu: 'Studio',
    focale: '60 mm',
  },
  {
    graine: 'cadre-archive-bois',
    alt: 'Charpente en bois vue en contre-plongee',
    rubrique: 'Architecture',
    lieu: 'Vosges',
    focale: '16 mm',
  },
...
const RAIL = [0, 8, 2, 4, 10, 5, 1, 13, 12, 7]
  .map((rang) => TIRAGES[rang])
  .filter((t): t is Tirage => t !== undefined)
...
const CORPS_NOM: CSSProperties = {
  ...affiche('xxl', 800),
  fontSize: 'clamp(3.5rem, 15.5vw, 17rem)',
  lineHeight: 0.86,
}

/** Le corps de l heure, a droite du paragraphe. */
const CORPS_HEURE: CSSProperties = {
  ...affiche('m', 800),
    ...
    <p className="o-m-0 o-tabular-nums o-uppercase" style={CORPS_HEURE}>
      ...
      <span aria-hidden="true">
        {heure === '' ? (
          ...
          <Shuffle key={heure} declenchement="montage" duration={700} step={45} tilt={24}>
            {heure}
          </Shuffle>
        )}
        <span className="o-ml-4 o-font-mono o-text-xs o-align-middle o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
          Paris
        </span>
      </span>
    </p>
    ...
    <figure className="o-m-0 o-mr-4 o-shrink-0 md:o-mr-6">
      <div
        ...
        style={{
          ...
          aspectRatio: tirage.portrait === true ? '3 / 4' : '4 / 3',
        }}
      >
        <ParallaxImage
...
export default function Page(): ReactElement {
  ...
  const retenus = useMemo(
    () => TIRAGES.filter((t) => rubrique === 'Tout' || t.rubrique === rubrique),
    [rubrique],
  )
    ...
    <Porte forme="trou" marque="Maud Ferrand" sombre={false}>
      ...
      >
        ...
        <header className="o-relative o-isolate o-overflow-hidden">
          ...
          <div className="o-px-6 o-pb-16 o-pt-6 md:o-px-8">
            <div className="o-flex o-flex-wrap o-items-start o-justify-between o-gap-6">
              <Surgit>
                <span
                  className="o-inline-flex o-items-center o-gap-2 o-rounded-full o-border-w-1 o-border-black-20 o-px-3 o-py-1 o-font-mono o-text-xs o-uppercase o-tracking-widest dark:o-border-zinc-700"
              ...
              <Surgit delai={200} className="o-flex o-flex-wrap o-gap-2">
                {(
                  ...
                  <a
                    key={href}
                    href={href}
                    className="o-rounded-full o-border-w-1 o-border-black-20 o-px-4 o-py-1.5 o-text-sm o-no-underline o-text-zinc-950 o-transition-colors hover:o-bg-black-10 dark:o-border-zinc-700 dark:o-text-zinc-50 dark:hover:o-bg-zinc-800 focus:o-ring"
                  >
                    {mot}
                  </a>
                ))}
            ...
            <div className="o-mt-10 o-grid o-items-end o-gap-8 md:o-grid-cols-12">
              <Surgit
                delai={360}
                as="p"
                className="o-m-0 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400 md:o-col-span-7"
              >
                Photographe et directrice de l image depuis onze ans. Portrait,
                architecture, nature morte et paysage, pour des maisons qui veulent qu on
                regarde deux fois.
              </Surgit>
        ...
        <main>
          ...
          <section
            id="table"
            className="o-scroll-mt-24 o-border-t o-border-black-10 o-px-6 o-py-20 dark:o-border-zinc-800 md:o-px-8 md:o-py-28"
          >
            <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-6">
              ...
              <div className="o-min-w-0 o-max-w-full o-overflow-x-auto">
                <SegmentedControl
                  ...
                  options={(['Tout', ...RUBRIQUES] as const).map((r) => ({
                    value: r,
                    label: r,
                  }))}
                />
            ...
            <ul className="o-m-0 o-mt-10 o-grid o-list-none o-grid-cols-2 o-gap-3 o-p-0 md:o-grid-cols-4">
              {retenus.map((t, rang) => (
                <li
                  key={t.graine}
                  className={`o-min-w-0 ${t.portrait === true ? 'md:o-row-span-2' : ''}`}
                >
                  <figure className="o-m-0">
                    ...
                    <figcaption className="o-mt-2 o-flex o-items-baseline o-justify-between o-gap-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                      <span>
                        PL. {String(rang + 1).padStart(2, '0')} — {t.lieu}
                      </span>
                      <span>{t.focale}</span>
                    </figcaption>
                  </figure>
          ...
          <section
            id="series"
            className="o-scroll-mt-24 o-border-t o-border-black-10 o-px-6 o-pb-10 o-pt-20 dark:o-border-zinc-800 md:o-px-8 md:o-pt-28"
          >
            <Reveal>
            ...
            {RUBRIQUES.map((r, rang) => {
              ...
              return (
                <article
                  key={r}
                  className="o-grid o-gap-8 o-border-t o-border-black-10 o-py-16 dark:o-border-zinc-800 md:o-grid-cols-12 md:o-gap-10 md:o-py-24"
                >
                  ...
                  <div className="md:o-col-span-3">
                    <div className="md:o-sticky" style={{ top: COLLE }}>
                      ...
                      >
                        <Shuffle as="span" duration={780} step={30} tilt={22}>
                          {r}
                        </Shuffle>
                      </h3>
                      <p className="o-m-0 o-mt-4 o-max-w-xs o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                        {NOTES[r]}
                      </p>
                      <a
                        href="#table"
                        className="o-mt-5 o-inline-flex o-items-center o-gap-2 o-font-mono o-text-xs o-uppercase o-tracking-widest o-no-underline focus:o-ring"
                        style={{ color: encre() }}
                      >
                        Voir sur la table{' '}
                  ...
                  <ul className="o-m-0 o-grid o-list-none o-grid-cols-1 o-gap-6 o-p-0 md:o-col-span-9 md:o-grid-cols-12">
                    {serie.map((t, k) => {
                      ...
                      return (
                        <li
                          key={t.graine}
                          className={`o-min-w-0 ${place.colonnes} ${place.decale}`}
                        >
                          <ParallaxImage
          ...
          >
            <div className="o-grid o-gap-10 md:o-grid-cols-12 md:o-gap-12">
              ...
              <div className="md:o-col-span-8">
                ...
                <Reveal delay={80}>
                  <p
                    className="o-m-0 o-mt-8 o-max-w-2xl o-text-balance"
                    style={{
                      ...affiche('m', 300),
                  ...
                  >
                    Je travaille en lumiere naturelle des que c est possible, et je livre
                    des planches, pas des fichiers en vrac.
                  </p>
                </Reveal>
                <Reveal delay={160}>
                  <p className="o-m-0 o-mt-8 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                    Chaque serie arrive editee, legendee, numerotee : ce que vous voyez
                    sur la table lumineuse est exactement ce que vous recevez. Je repere
                    la veille, je photographie a l heure ou le sujet est le mieux servi,
                    et je ne rends jamais une planche que je n aurais pas accrochee.
                  </p>
                </Reveal>

                <div className="o-mt-14 o-border-t o-border-black-10 o-pt-8 dark:o-border-zinc-800">
                  <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                    Ils m ont confie une serie
                  </p>
                  <ul className="o-m-0 o-mt-5 o-flex o-list-none o-flex-wrap o-gap-x-8 o-gap-y-3 o-p-0">
                    {CLIENTS.map((c) => (
                      <li
                        key={c}
                        className="o-text-xl o-font-medium o-tracking-tight o-text-zinc-500 dark:o-text-zinc-500"
                      >
                        {c}
                      </li>
                    ))}
          ...
          <section
            id="ecrire"
            className="o-scroll-mt-24 o-border-t o-border-black-10 o-px-6 o-py-24 dark:o-border-zinc-800 md:o-px-8 md:o-py-32"
          >
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
            ...
            >
              {(
                [
                  ...
                  ['#table', 'Table lumineuse'],
                  ['#series', 'Series'],
                  [`mailto:${COURRIEL}`, COURRIEL],
                ] as const
              ).map(([href, mot]) => (
                <a
                  key={href}
                  href={href}
                  className="o-no-underline o-text-zinc-600 o-transition-colors hover:o-text-zinc-950 dark:o-text-zinc-400 dark:hover:o-text-zinc-50 focus:o-ring"
                >
                  {mot}
                </a>
              ))}
