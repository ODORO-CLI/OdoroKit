...
const NOMS = ['Camille Roux', 'Nadia Belkacem', 'Jonas Vidal', 'Elsa Marchand'] as const
...
const COMPLETS = SEMAINE.flatMap((jour) =>
  jour.cours.filter((c) => c.places === 0).map((c) => ({ jour: jour.jour, cours: c })),
)

/** Le premier cours de la semaine ou il reste de la place. */
const PROCHAIN = SEMAINE.flatMap((jour) =>
  jour.cours.map((c) => ({ jour: jour.jour, cours: c })),
).find((e) => e.cours.places > 0)
    ...
    <Porte forme="compteur" marque="Souffle" sombre={false}>
      ...
      >
        ...
        <header className="o-relative o-isolate o-overflow-hidden">
          ...
          <BarreGelule
            ...
            liens={[
              ...
              ['#profs', 'Les professeurs'],
            ]}
            action={['#attente', 'Liste d attente']}
          />

          <div
            className="o-relative o-z-10 o-mx-auto o-flex o-max-w-5xl o-flex-col o-items-center o-justify-center o-px-6 o-pb-24 o-pt-40 o-text-center"
            style={{ minHeight: 'calc(100vh - 101px)' }}
          >
            <Surgit>
              <Etiquette sombre={false}>
                Toujours quatorze tapis. Jamais un de plus.
              </Etiquette>
            </Surgit>
            <Surgit
              delai={120}
              ...
              style={affiche('l', 300)}
            >
              Un cours ou l&nbsp;on vous <Accent couleur={encre()}>voit</Accent>, parce
              qu&nbsp;on est quatorze.
            </Surgit>
            <Surgit
              delai={360}
              as="p"
              className="o-m-0 o-mt-7 o-max-w-xl o-text-lg o-leading-relaxed o-text-stone-600 dark:o-text-stone-300"
            >
              Le professeur corrige chaque posture, une par une. C est impossible a
              trente, et c est la seule raison pour laquelle nous refusons du monde.
            </Surgit>
            <Surgit delai={480} className="o-mt-9">
              <Actions
                ...
                fantome={['#respirer', 'Respirer d abord']}
              />
            </Surgit>
            ...
            {PROCHAIN !== undefined && (
              <Surgit delai={700} className="o-mt-16 o-w-full o-max-w-md">
                <Flotte amplitude={7} duree={7} angle={-2}>
                  <a
                    href="#planning"
                    className={`${verre(false)} o-flex o-items-center o-gap-4 o-p-3 o-pr-5 o-text-left o-no-underline o-text-stone-900 dark:o-text-stone-100 focus:o-ring`}
                  >
                    <img
                      src={photo('souffle-tapis', 300, 300)}
                      alt=""
                      aria-hidden="true"
                      className="o-size-16 o-shrink-0 o-rounded-xl o-object-cover"
                    />
                    <span className="o-min-w-0">
                      <span className="o-block o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
                        Prochain cours — {PROCHAIN.jour} {PROCHAIN.cours.heure}
                      </span>
                      <span className="o-mt-1 o-block o-truncate o-text-base o-font-medium">
                        {PROCHAIN.cours.titre}, avec {PROCHAIN.cours.prof.split(' ')[0]}
                      </span>
                      <span className="o-block o-text-sm" style={{ color: encre() }}>
                        {placesLibelle(PROCHAIN.cours.places)} sur{' '}
                        {PROCHAIN.cours.capacite}
                      </span>
                    </span>
                    <Icon
                      icon={ArrowRight}
                      size={16}
                      className="o-ml-auto o-shrink-0"
                      aria-hidden="true"
                    />
                  </a>
                </Flotte>
          ...
          <div
            className="o-pointer-events-none o-absolute o-z-20 max-lg:o-hidden"
            style={{ top: '38%', right: 'clamp(1rem, 6vw, 6rem)' }}
          >
          ...
          <p className="o-pointer-events-none o-absolute o-bottom-6 o-right-6 o-z-10 o-m-0 o-hidden o-text-right o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-600 dark:o-text-stone-400 md:o-block">
            Salle claire, salle basse
            <br />
            Lumiere du nord, aucun miroir
          </p>
        </header>
        ...
        <main>
          ...
          <section
            id="respirer"
            aria-labelledby="respirer-titre"
            className="o-relative o-mx-auto o-flex o-max-w-6xl o-scroll-mt-24 o-flex-col o-items-center o-justify-center o-px-6 o-py-24 o-text-center md:o-py-32"
            style={{ minHeight: 'calc(100vh - 101px)' }}
          >
            <Indice rang="01" sombre={false}>
              Avant de choisir un cours
            </Indice>

            <div
              className="o-relative o-mt-12 o-flex o-items-center o-justify-center"
              style={{ width: 'min(52vw, 22rem)', height: 'min(52vw, 22rem)' }}
            >
              {/* Trois anneaux : le cercle qui respire, son halo, et le filet fixe qui donne la mesure. */}
              <span
                aria-hidden="true"
                className="o-absolute o-inset-0 o-rounded-full o-border-w-1"
              ...
              <Respire
                ...
                style={{
                  inset: '14%',
                  background: `radial-gradient(circle at 40% 35%, ${accent(200)}, ${accent(400)} 70%, ${accent(500)})`,
                  boxShadow: `0 30px 80px -30px ${accent(500)}`,
                }}
              />
              <Respire
                duree={8}
                className="o-absolute o-rounded-full o-border-w-1"
                style={{ inset: '4%', borderColor: encre(), opacity: 0.5 }}
              />
            </div>
            ...
            <h2
              id="respirer-titre"
              className="o-m-0 o-mt-12 o-text-stone-950 dark:o-text-stone-50"
              style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 4.5vw, 4rem)' }}
            >
            ...
            <p className="o-m-0 o-mt-6 o-max-w-md o-text-base o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
              Le cercle s ouvre pendant quatre secondes et se ferme pendant quatre. C est
              le rythme par lequel Jonas commence chaque cours. Faites-le trois fois, puis
              descendez.
            </p>
          ...
          <section
            ...
            className="o-scroll-mt-24 o-border-t o-border-b o-border-stone-300 dark:o-border-stone-700 o-bg-white dark:o-bg-stone-900"
          >
            <div className="o-mx-auto o-max-w-6xl o-px-5 o-pt-14 md:o-px-8 md:o-pt-20">
              <div className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-x-8 o-gap-y-2 o-border-b o-border-stone-900 dark:o-border-stone-100 o-pb-3">
                <h2
                  id="planning-titre"
                  className="o-m-0 o-font-mono o-text-sm o-font-normal o-uppercase o-tracking-widest o-text-stone-950 dark:o-text-stone-50"
                >
              ...
              <p className="o-m-0 o-mt-4 o-max-w-md o-text-sm o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
                Les cours qui ne conviennent pas restent affiches, grises : on voit ce qu
                on manque.
              </p>
              ...
              <div className="o-mt-8 o-flex o-flex-col o-gap-2.5 o-border-t o-border-b o-border-stone-300 dark:o-border-stone-700 o-py-3">
                {(
                  [
                    [
                      'Niveau',
                      ['Tous', ...NIVEAUX] as readonly string[],
                      niveau,
                      setNiveau,
                    ],
                    ['Professeur', ['Tous', ...NOMS] as readonly string[], prof, setProf],
                  ] as const
                ).map(([titre, options, courant, poser]) => (
                  <div
                    key={titre}
                    role="group"
                    aria-label={`Filtrer par ${titre.toLowerCase()}`}
                    className="o-flex o-flex-wrap o-items-baseline o-gap-x-4 o-gap-y-1"
                  >
              ...
              <p
                aria-live="polite"
                className="o-mt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-600 dark:o-text-stone-400"
              >
            ...
            <div className="o-mx-auto o-max-w-6xl o-px-5 o-pb-20 o-pt-6 md:o-px-8 md:o-pb-28">
              <div className="o-overflow-x-auto o-scrollbar dark:o-scrollbar-dark">
                <ol
                  ...
                  style={{
                    minWidth: '58rem',
                    gridTemplateColumns: `repeat(${String(SEMAINE.length)}, minmax(0, 1fr))`,
                            ...
                            >
                              ...
                              <p className="o-m-0 o-mt-1.5 o-flex o-items-center o-gap-1.5 o-text-xs">
                                ...
                                {plein ? (
                                  <a
                                    href="#attente"
                                    className="o-text-stone-600 dark:o-text-stone-400 o-underline focus:o-ring"
            ...
            <div className="o-mx-auto o-grid o-max-w-6xl o-gap-12 o-px-5 o-py-20 md:o-px-8 md:o-py-28 lg:o-grid-cols-12">
              <figure className="o-m-0 o-min-w-0 lg:o-col-span-5">
                <div className="o-relative lg:o-sticky" style={{ top: 133 }}>
                  <ParallaxImage
                    src={photo('souffle-salle', 900, 1100)}
                    alt="La salle claire, vide, un matin"
                    ratio={0.8}
                    strength={0.45}
                    className="o-w-full o-rounded-3xl"
                  />
                  {/* Une seconde etiquette penchee, qui flotte sur la photo. */}
                  <div
                    className="o-pointer-events-none o-absolute o-z-10"
                    style={{ bottom: '-1.25rem', right: '-0.75rem' }}
                  >
              ...
              <div className="o-min-w-0 lg:o-col-span-7">
                ...
                <h2
                  id="profs-titre"
                  className="o-m-0 o-mt-4 o-max-w-xl o-text-stone-950 dark:o-text-stone-50"
                  style={{
                    ...affiche('m', 300),
                ...
                <dl className="o-m-0 o-mt-12 o-border-t o-border-stone-300 dark:o-border-stone-700">
                  {PROFESSEURS.map((personne, rang) => (
                    <Reveal key={personne.nom} delay={rang * 70}>
                      <div
                        className={`o-grid o-gap-x-6 o-gap-y-2 o-border-b o-border-stone-200 dark:o-border-stone-800 o-py-7 sm:o-grid-cols-12 ${rang % 2 === 1 ? 'sm:o-pl-12' : ''}`}
                      >
                        <dt className="o-flex o-items-center o-gap-4 sm:o-col-span-12">
                          <img
                            src={personne.image.src}
                            alt={personne.image.alt}
                            width={64}
                            height={64}
                            loading="lazy"
                            className="o-size-14 o-shrink-0 o-rounded-full o-object-cover"
                          />
                          <span className="o-min-w-0">
                            <span className="o-block o-text-2xl o-font-medium o-tracking-tight md:o-text-3xl">
                              {personne.nom}
                            </span>
                            <span
                              className="o-block o-font-serif o-italic o-text-lg"
                              style={{ color: encre() }}
                            >
                              {personne.role}
                            </span>
          ...
          <section
            ...
            className="o-relative o-isolate o-scroll-mt-24 o-overflow-hidden o-px-6 o-py-24 md:o-py-36"
            style={nuit('stone')}
          >
            <Nappe
              couleurs={[accent(500), accent(300), 'var(--o-palette-stone-700)']}
              opacite={0.5}
            />
            <Grain opacite={0.05} />
            <div className="o-relative o-z-20 o-mx-auto o-grid o-max-w-6xl o-gap-12 lg:o-grid-cols-12 lg:o-items-center">
              <div className="lg:o-col-span-5">
                ...
                <h2
                  id="attente-titre"
                  className="o-m-0 o-mt-4 o-text-stone-50"
                  style={{
                    ...affiche('m', 300),
                    fontSize: 'clamp(1.75rem, 4.5vw, 4rem)',
                  }}
                ...
                <p className="o-m-0 o-mt-6 o-max-w-md o-text-base o-leading-relaxed o-text-stone-300">
                  Quand un tapis se libere, la premiere personne de la liste recoit un
                  message et a deux heures pour repondre. Puis la suivante.
                </p>
              </div>

              <GlassSurface
                colors={['--o-vitrine-300', '--o-palette-white']}
                blur={22}
                tint={0.1}
                thickness={1.2}
                className="o-rounded-3xl o-p-6 o-text-stone-50 md:o-p-8 lg:o-col-span-7"
              >
                ...
                <div
                  role="group"
                  aria-label="Choisir le cours complet"
                  className="o-mt-4 o-flex o-flex-col o-gap-2"
                >
                  {COMPLETS.map((e) => {
                    ...
                    return (
                      ...
                      >
                        <span className="o-text-base o-font-medium">
                          {e.cours.titre}{' '}
                          <span className="o-text-stone-300">
                            — {e.jour} {e.cours.heure}
                          </span>
                        </span>
                        <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-100">
                          {e.cours.attente} devant vous
                        </span>
                      </button>
                    )
                  })}
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="o-inline-flex o-shrink-0 o-items-center o-justify-center o-gap-2 o-rounded-full o-px-6 o-py-3 o-text-sm o-font-semibold o-transition-transform hover:o-scale-105 focus:o-ring"
                    style={{
                ...
                <p
                  aria-live="polite"
                  className="o-m-0 o-mt-4 o-text-sm o-leading-relaxed o-text-stone-300"
                >
        ...
        <footer className="o-mx-auto o-max-w-6xl o-px-6 o-pb-10 o-pt-20 md:o-pt-28">
          <p
            className="o-m-0 o-font-serif o-italic o-text-stone-950 dark:o-text-stone-50"
            style={{
          ...
          <div className="o-mt-14 o-flex o-flex-wrap o-items-center o-justify-between o-gap-x-8 o-gap-y-3 o-border-t o-border-stone-200 dark:o-border-stone-800 o-pt-5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
            ...
            <a
              href="mailto:bonjour@souffle.paris"
              className="o-no-underline o-text-stone-600 dark:o-text-stone-400 hover:o-text-stone-950 dark:hover:o-text-stone-50 focus:o-ring"
            >
              bonjour@souffle.paris ↗
            </a>
