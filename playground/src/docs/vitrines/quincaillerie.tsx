...
const MEUBLE: readonly Filet[] = [
  { d: 3, pas: [0.5], clef: 5.5, couple: 1.3, prix: 6, stock: [2400, 1800, 620, 940], casier: 'A-04' },
  { d: 4, pas: [0.7], clef: 7, couple: 3, prix: 7, stock: [2180, 1610, 540, 820], casier: 'A-07' },
  { d: 5, pas: [0.8], clef: 8, couple: 6, prix: 9, stock: [1940, 1380, 470, 690], casier: 'A-11' },
  { d: 6, pas: [1, 0.75], clef: 10, couple: 10.1, prix: 12, stock: [1750, 1220, 410, 580], casier: 'A-14' },
  { d: 8, pas: [1.25, 1], clef: 13, couple: 24.6, prix: 18, stock: [1410, 960, 330, 415], casier: 'A-18' },
  { d: 10, pas: [1.5, 1.25], clef: 17, couple: 48, prix: 29, stock: [1120, 710, 245, 260], casier: 'A-22' },
  { d: 12, pas: [1.75, 1.25], clef: 19, couple: 84, prix: 46, stock: [830, 485, 160, 145], casier: 'A-26' },
  { d: 16, pas: [2, 1.5], clef: 24, couple: 208, prix: 98, stock: [435, 240, 95, 0], casier: 'A-31' },
  { d: 20, pas: [2.5, 1.5], clef: 30, couple: 407, prix: 185, stock: [215, 115, 40, 0], casier: 'A-35' },
]
...
const MATIERES: readonly Matiere[] = [
  { code: 'ZN', nom: 'Acier zingue 8.8', prix: 1, couple: 1, note: 'Le tout-venant. Zingage blanc de huit micrometres : l interieur, l abri, jamais la pluie battante.' },
  { code: 'A2', nom: 'Inox A2-70', prix: 2.4, couple: 0.72, note: 'Inox 304. Dehors, hors bord de mer. Il se grippe a sec : une pointe de pate au montage.' },
  { code: 'A4', nom: 'Inox A4-80', prix: 3.6, couple: 0.82, note: 'Inox 316 au molybdene. Bord de mer, piscine, toiture. Trois fois le prix, trente ans de plus.' },
  { code: 'MS', nom: 'Laiton', prix: 3, couple: 0.45, note: 'Decoratif, amagnetique, tendre. On ne serre pas un laiton au couple d un acier : on le casse.' },
]
...
const CASES: readonly Case[] = [
  { rang: '01', symbole: '4.6', nom: 'Acier doux', valeur: '400', unite: 'MPa a la rupture' },
  { rang: '02', symbole: '8.8', nom: 'Acier zingue', valeur: '800', unite: 'MPa a la rupture' },
  { rang: '03', symbole: '10.9', nom: 'Acier trempe', valeur: '1000', unite: 'MPa a la rupture' },
  { rang: '04', symbole: '12.9', nom: 'Acier a haute charge', valeur: '1200', unite: 'MPa a la rupture' },
  ...
  { rang: '08', symbole: 'ZnNi', nom: 'Zinc-nickel', valeur: '720', unite: 'h au brouillard salin' },
  { rang: '09', symbole: 'Ms', nom: 'Laiton CuZn37', valeur: '110', unite: 'HV de durete' },
  ...
  { rang: '12', symbole: 'Al', nom: 'Aluminium 5754', valeur: '215', unite: 'MPa a la rupture' },
  { rang: '13', symbole: 'Nyl', nom: 'Bague nylstop', valeur: '120', unite: 'degres admis' },
  { rang: '14', symbole: 'Fr', nom: 'Frein filet moyen', valeur: '150', unite: 'degres admis' },
  { rang: '15', symbole: 'Gr', nom: 'Rondelle Grower', valeur: '2', unite: 'tours de reserve' },
  { rang: '16', symbole: 'Ep', nom: 'Rondelle epaisse', valeur: '4', unite: 'mm d epaisseur' },
  { rang: '17', symbole: 'Cu', nom: 'Rivet cuivre', valeur: '210', unite: 'MPa au cisaillement' },
  { rang: '18', symbole: 'Ti', nom: 'Titane grade 5', valeur: '900', unite: 'MPa a la rupture' },
]
...
const COMPTOIR: readonly (readonly [string, string, string, string])[] = [
  ...
  ['Coupe de tige filetee', 'Au metre ou a la cote, ebavuree', '1,20 EUR la coupe', 'immediat'],
  ['Taraudage M3 a M20', 'Dans votre piece, a l etabli', '4,00 EUR le trou', '20 minutes'],
  ['Affutage de lame', 'Ciseaux, secateurs, couteaux', '5,00 EUR', 'le lendemain'],
  ['Decoupe de verre et de plexiglas', 'Jusqu a 120 par 80 centimetres', '14,00 EUR le metre', '30 minutes'],
...
const RAYONS: readonly Rayon[] = [
  { lettre: 'A', nom: 'Visserie au detail', x: 24, y: 24, w: 168, h: 80, quoi: 'Le meuble a 620 tiroirs, de M2 a M24. Vente a la piece, au cent, au kilo.' },
  { lettre: 'B', nom: 'Outillage a main', x: 24, y: 116, w: 168, h: 80, quoi: 'Marteaux, scies, limes, serre-joints. Les manches en frene se remplacent.' },
  { lettre: 'C', nom: 'Electricite', x: 24, y: 208, w: 168, h: 72, quoi: 'Fil au metre, domino, disjoncteur, va-et-vient. Conseil de section gratuit.' },
  { lettre: 'D', nom: 'Plomberie', x: 216, y: 24, w: 152, h: 104, quoi: 'Joints, raccords laiton, siphons. On depanne un mitigeur en piece detachee.' },
  { lettre: 'E', nom: 'Peinture et colle', x: 216, y: 140, w: 152, h: 72, quoi: 'Mise a la teinte au comptoir, en 900 nuances, pendant que vous attendez.' },
  { lettre: 'F', nom: 'Jardin et balcon', x: 216, y: 224, w: 152, h: 56, quoi: 'Secateurs, terreau, tuteurs. Affutage rendu le lendemain.' },
  { lettre: 'G', nom: 'Aimants et abrasifs', x: 392, y: 24, w: 136, h: 120, quoi: 'Neodyme de 3 a 40 millimetres, papier de verre au grain, laine d acier.' },
  { lettre: 'H', nom: 'Cles et decoupe', x: 392, y: 156, w: 136, h: 76, quoi: 'Le duplicateur, la scie a verre, l etabli. C est ici qu on vous taraude un trou.' },
]
...
function Grille({ hauteur = 220 }: { readonly hauteur?: number }): ReactElement {
  ...
  useEffect(() => {
    ...
    const bouger = (evenement: PointerEvent): void => {
      el.style.setProperty('--o-qc-x', `${String(Math.round(evenement.clientX - boite.left))}px`)
      el.style.setProperty('--o-qc-y', `${String(Math.round(evenement.clientY - boite.top))}px`)
    }
  ...
  return (
    <div ref={cadre} aria-hidden="true" className="o-pointer-events-none o-absolute o-inset-0 o-overflow-hidden">
      {/* La trame de fond, a peine lisible : le meuble derriere la vitre. */}
      <div className="o-absolute o-inset-0" style={{ backgroundImage: trame, backgroundSize: '10px 10px', opacity: 0.35 }} />
...
function Cellule({
  ...
  return (
    <div className={`o-relative o-bg-zinc-50 dark:o-bg-zinc-950 ${className ?? ''}`} style={style}>
      {children}
    </div>
  )
}
...
function Bouton({
  ...
  return (
    <a
      ...
      style={pleine ? aplat() : { boxShadow: `inset 0 0 0 1px ${accentDoux(700, 46)}`, color: 'inherit' }}
    >
      {children}
    </a>
  )
 ...
 */
function Vis({ filet, pas }: { readonly filet: Filet; readonly pas: number }): ReactElement {
  const d = filet.d
  const rayon = d / 2
  ...
  for (let x = finTete; x < finTige - pas; x += pas) {
    dents.push(`M${x.toFixed(2)} ${String(axe - rayon)} l${(pas / 2).toFixed(2)} ${(rayon * 0.34).toFixed(2)} l${(pas / 2).toFixed(2)} ${(-rayon * 0.34).toFixed(2)}`)
    dents.push(`M${x.toFixed(2)} ${String(axe + rayon)} l${(pas / 2).toFixed(2)} ${(-rayon * 0.34).toFixed(2)} l${(pas / 2).toFixed(2)} ${(rayon * 0.34).toFixed(2)}`)
  }
  ...
  return (
    ...
    >
      ...
      */}
      {d < 20 && (
        <g stroke={accentDoux(700, 20)} strokeWidth="0.3" fill="none" strokeDasharray="1.2 1.2">
      ...
      <g stroke={accentDoux(700, 40)} strokeWidth="0.25">
        <path d={`M${String(finTige)} ${String(axe - rayon)}H86M${String(finTige)} ${String(axe + rayon)}H86`} strokeDasharray="1 1" />
      ...
      {d < 20 && (
        <text x="4" y="5" fontSize="3" fill="var(--o-theme-muted)" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.1em' }}>
          GABARIT M20 — MEME ECHELLE
        </text>
      )}

      {/* La tete : la clef sur plats en vraie grandeur. */}
      <rect x={depart} y={axe - demi} width={teteLongueur} height={filet.clef} fill={accentDoux(600, 62)} />
      <path d={`M${String(depart)} ${String(axe - demi + 1.4)}h${String(teteLongueur)}M${String(depart)} ${String(axe + demi - 1.4)}h${String(teteLongueur)}`} stroke={accentDoux(900, 70)} strokeWidth="0.3" fill="none" />

      {/* La tige, et ses filets. */}
      <rect x={finTete} y={axe - rayon} width={tige} height={d} fill={accentDoux(500, 46)} />
 ...
 */
function Ecrou({ filet, pas }: { readonly filet: Filet; readonly pas: number }): ReactElement {
  ...
  return (
    <svg viewBox="0 0 48 48" className="o-h-auto o-w-full" role="img" aria-label={`Ecrou vu de face, clef de ${String(filet.clef)} millimetres, percage a ${foret.toFixed(2).replace('.', ',')}`}>
      <polygon points={sommets} fill={accentDoux(600, 54)} stroke={accentDoux(900, 60)} strokeWidth="0.3" />
      <circle cx={centre} cy={centre} r={filet.d / 2} fill="var(--o-theme-bg)" />
      <circle cx={centre} cy={centre} r={foret / 2} fill="none" stroke={accent(500)} strokeWidth="0.5" strokeDasharray="1.6 1.2" />
      <path d={`M${String(centre)} ${String(centre)}h${String(rayonCercle + 3)}`} stroke={accentDoux(700, 40)} strokeWidth="0.2" />
      <text x={centre + rayonCercle + 4} y={centre + 1} fontSize="3" fill="var(--o-theme-muted)" style={{ fontFamily: 'var(--o-font-mono)' }}>
        {`c ${String(filet.clef)}`}
      </text>
    </svg>
  )
    ...
    <div className="o-grid o-gap-10 lg:o-grid-cols-12">
      ...
      <div className="lg:o-col-span-5">
        <fieldset className="o-m-0 o-border-none o-p-0">
          ...
          <div className="o-grid o-grid-cols-3 o-gap-px sm:o-grid-cols-5" style={{ backgroundColor: filetDeGrille }}>
              ...
              return (
                <button
                  ...
                  className={`o-cursor-pointer o-appearance-none o-border-none o-px-3 o-py-4 o-text-center o-font-mono o-text-sm o-tabular-nums o-transition-colors focus:o-ring ${
                    choisi ? '' : `${cellule} o-text-zinc-700 dark:o-text-zinc-300 hover:o-text-zinc-950 dark:hover:o-text-zinc-50`
                  }`}
            ...
            <p className={`o-m-0 o-px-3 o-py-4 o-text-center o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400 ${cellule}`}>
              M24
              <br />
              sur commande
            </p>
        ...
        <fieldset className="o-m-0 o-mt-10 o-border-none o-p-0">
          ...
          <div className="o-flex o-flex-wrap o-gap-px" style={{ backgroundColor: filetDeGrille }}>
            ...
            {filet.pas.length === 1 && (
              <span className={`o-grow o-px-4 o-py-4 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400 dark:o-text-zinc-500 ${cellule}`}>
                Pas fin — non tenu
              </span>
            )}
          </div>
            ...
            {MATIERES.map((ligne, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="o-font-mono o-text-xs o-tabular-nums o-opacity-70">{vide ? 'vide' : `${String(filet.stock[index] ?? 0)} p.`}</span>
                </button>
              )
            })}
          </div>
          <p className="o-m-0 o-mt-4 o-max-w-sm o-text-xs o-leading-relaxed o-text-zinc-500 dark:o-text-zinc-400">{matiere.note}</p>
        </fieldset>
      </div>
      ...
      <div className="o-min-w-0 lg:o-col-span-7">
        <div
          ...
          style={{ boxShadow: `inset 0 0 0 1px ${accentDoux(700, 34)}`, backgroundColor: accentDoux(300, 8) }}
        >
          {/* La plaque du tiroir. */}
          ...
          <dl className="o-m-0 o-mt-8 o-grid o-gap-px sm:o-grid-cols-2" style={{ backgroundColor: accentDoux(700, 22) }}>
            {([
              ['Foret avant taraudage', `${releve.foret.toFixed(2).replace('.', ',')} mm`, 'diametre nominal moins le pas'],
              ['Clef sur plats', `${String(filet.clef)} mm`, 'tete hexagonale, norme metrique'],
              ['Couple de serrage', `${releve.couple < 10 ? releve.couple.toFixed(1).replace('.', ',') : String(Math.round(releve.couple))} Nm`, `a sec, ${matiere.nom.toLowerCase()}`],
              ['Prix', `${euros(releve.prix)} la piece`, `${euros(Math.round(releve.prix * 90))} le cent`],
              ...
              <div key={quoi} className="o-bg-zinc-50 dark:o-bg-zinc-950 o-px-5 o-py-4">
                ...
                <dd className="o-m-0 o-mt-2 o-font-mono o-text-lg o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50">{valeur}</dd>
                <dd className="o-m-0 o-mt-1 o-text-xs o-leading-relaxed o-text-zinc-500 dark:o-text-zinc-400">{note}</dd>
              </div>
            ))}
          </dl>
          ...
          >
            <span data-o-qc-temoin="" aria-hidden="true" className="o-block o-size-1.5" style={{ backgroundColor: releve.stock === 0 ? 'var(--o-theme-muted)' : accent(500) }} />
            {releve.stock === 0
    ...
    <div className="o-grid o-gap-10 lg:o-grid-cols-12">
      <div className="o-min-w-0 lg:o-col-span-7">
        <svg viewBox="0 0 544 344" className="o-h-auto o-w-full" aria-hidden="true">
          ...
          <rect x="8" y="8" width="528" height="300" fill="none" stroke={accentDoux(700, 46)} strokeWidth="1.5" />
          <path d="M20 308h116" stroke="var(--o-theme-bg)" strokeWidth="5" fill="none" />
          <path data-o-qc-file="" d="M20 308h116" stroke={accent(500)} strokeWidth="3" strokeDasharray="12 12" fill="none" />
          <text x="20" y="332" fontSize="11" fill="var(--o-theme-muted)" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.14em' }}>
            ENTREE — RUE DES BATIGNOLLES
          </text>

          {/* Le comptoir, au fond a droite. */}
          <rect x="392" y="244" width="136" height="36" fill={accentDoux(700, 18)} />
          <text x="404" y="267" fontSize="10" fill="var(--o-theme-muted)" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.14em' }}>
            COMPTOIR
          </text>
        ...
        <div className="o-mt-6 o-grid o-grid-cols-2 o-gap-px sm:o-grid-cols-4" style={{ backgroundColor: accentDoux(700, 22) }}>
          {RAYONS.map((r) => {
            const actif = r.lettre === choisi
            return (
              <button
                ...
                className={`o-cursor-pointer o-appearance-none o-border-none o-px-3 o-py-3 o-text-left o-font-mono o-text-xs o-uppercase o-tracking-widest o-transition-colors focus:o-ring ${
                  actif ? '' : 'o-bg-zinc-50 dark:o-bg-zinc-950 o-text-zinc-700 dark:o-text-zinc-300'
                }`}
      ...
      <div className="lg:o-col-span-5">
        <div className="o-p-8" style={{ boxShadow: `inset 0 0 0 1px ${accentDoux(700, 34)}` }}>
          <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest" style={{ color: encre() }}>
            Rayon {rayon.lettre}
          </p>
          <h3
            className="o-m-0 o-mt-4 o-uppercase o-text-zinc-950 dark:o-text-zinc-50"
            style={{ ...affiche('m', 700), fontSize: 'clamp(1.5rem, 3vw, 2.5rem)', lineHeight: 0.95 }}
          >
            {rayon.nom}
          </h3>
  ...
  return (
    <Porte forme="trou" marque="Ecrou" sombre={false}>
      <div className="o-bg-zinc-50 dark:o-bg-zinc-950 o-text-zinc-900 dark:o-text-zinc-50" style={polices}>
          ...
          <div className="o-relative o-flex o-grow o-flex-col o-justify-between o-gap-12 o-px-6 o-pb-10 o-pt-12 md:o-px-10">
            <div className="o-grid o-items-end o-gap-10 lg:o-grid-cols-12">
              <div className="lg:o-col-span-8">
                <Surgit>
                  <Etiquette sombre={false}>Quincaillerie de detail — depuis 1961</Etiquette>
                </Surgit>
                <TitreVague
                  delai={140}
                  className="o-m-0 o-mt-6 o-uppercase o-text-zinc-950 dark:o-text-zinc-50"
                  style={{ ...affiche('xl', 800), fontSize: 'clamp(3.25rem, 14vw, 13rem)', lineHeight: 0.8, letterSpacing: '-0.05em' }}
                >
                  Ecrou
                </TitreVague>
                <Surgit delai={520} as="p" className="o-m-0 o-mt-8 o-max-w-lg o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                  Onze mille quatre cents references, vendues a la piece. Vous
                  apportez la votre, on ouvre le tiroir ; vous ne l avez pas, on
                  la mesure au pied a coulisse.
                </Surgit>
                <Surgit delai={640} className="o-mt-10 o-flex o-flex-wrap o-gap-3">
                  <Aimant force={0.4}>
                    <Bouton href="#tiroir">
                      Ouvrir le tiroir <Icon icon={ArrowRight} size={14} aria-hidden="true" />
                    </Bouton>
                  </Aimant>
              ...
              <Surgit delai={340} className="lg:o-col-span-4">
                <div className="o-relative" style={{ boxShadow: `inset 0 0 0 1px ${accentDoux(700, 40)}` }}>
                  <MagnetLines
                    rows={10}
                    columns={10}
                    length={16}
            ...
            <Surgit delai={760} className="o-grid o-gap-px sm:o-grid-cols-2 lg:o-grid-cols-4" style={{ backgroundColor: accentDoux(700, 22) }}>
              {([
                ...
                <Cellule key={quoi} className="o-px-5 o-py-5">
                  ...
                  <p className="o-m-0 o-mt-3 o-font-mono o-text-base o-text-zinc-950 dark:o-text-zinc-50">{valeur}</p>
        ...
        <section aria-labelledby="manifeste-titre" className="o-px-6 o-py-24 md:o-px-10 md:o-py-32" style={nuit('zinc')}>
          <div className="o-mx-auto o-max-w-6xl">
            ...
            <Reveal delay={120}>
              <p className="o-m-0 o-mt-10 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-400">
                Le meuble a tiroirs est la depuis 1961. Il a ete repeint deux
                fois, jamais deplace. Ce qui a change, c est le nombre de
                tiroirs : soixante-dix a l ouverture, six cent vingt aujourd hui.
              </p>
            </Reveal>
          </div>
        </section>
        ...
        {/* ================= Le mecanisme : le tiroir ===================== */}
        <section id="tiroir" className="o-relative o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
          <Grille hauteur={200} />
          <div className="o-relative o-mx-auto o-max-w-6xl">
            ...
            <Reveal delay={140}>
              <p className="o-m-0 o-mt-6 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                La vis se redessine a chaque cran : la tete fait la clef, la tige
                le diametre, et les filets sont espaces du pas. Le foret a
                percer avant taraudage vaut le diametre moins le pas — c est la
                seule regle a retenir.
              </p>
            </Reveal>
        ...
        <section id="matieres" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32" style={nuit('zinc')}>
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
            ...
            <ul className="o-m-0 o-mt-14 o-grid o-list-none o-grid-cols-2 o-gap-px o-p-0 sm:o-grid-cols-3 lg:o-grid-cols-6" style={{ backgroundColor: 'var(--o-palette-zinc-800)' }}>
              {CASES.map((c) => (
                <li key={c.rang} className="o-relative o-bg-zinc-950 o-px-4 o-py-5 o-transition-colors hover:o-bg-zinc-900">
                  <p className="o-m-0 o-font-mono o-text-xs o-tabular-nums o-text-zinc-500">{c.rang}</p>
                  <p
                    className="o-m-0 o-mt-2 o-text-zinc-50"
                    style={{ ...affiche('m', 500), fontSize: 'clamp(1.25rem, 2.4vw, 1.9rem)', lineHeight: 1 }}
                  >
                    {c.symbole}
                  </p>
                  <p className="o-m-0 o-mt-3 o-font-mono o-text-lg o-tabular-nums" style={{ color: encreSurSombre() }}>
                    {c.valeur}
                  </p>
                  <p className="o-m-0 o-mt-1 o-text-xs o-leading-relaxed o-text-zinc-400">{c.unite}</p>
            ...
            <p className="o-m-0 o-mt-8 o-max-w-2xl o-text-sm o-leading-relaxed o-text-zinc-400">
              Les valeurs sont celles des normes, pas des arguments de vente. Une
              8.8 casse a huit cents megapascals ; une A2 ne rouille pas mais
              tient moins ; un laiton ne tient presque rien et ne se voit pas.
            </p>
          </div>
        </section>

        {/* ================= Le comptoir : ce qui se fait a l etabli ====== */}
        <section id="comptoir" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
          <div className="o-mx-auto o-grid o-max-w-6xl o-gap-12 lg:o-grid-cols-12">
            <div className="lg:o-col-span-4">
              <div className="lg:o-sticky" style={{ top: CHROME + 32 }}>
                ...
                <Reveal delay={80}>
                  <h2
                    className="o-m-0 o-mt-6 o-uppercase o-text-zinc-950 dark:o-text-zinc-50"
                    style={{ ...affiche('m', 700), fontSize: 'clamp(1.75rem, 3.4vw, 3rem)', lineHeight: 0.92, letterSpacing: '-0.04em' }}
                  >
                    Ce qui se fait a l etabli.
                  </h2>
                </Reveal>
                {/* Un profil de cle, dessine : la page ne montre pas une photo de cle. */}
                <svg viewBox="0 0 240 92" className="o-mt-10 o-w-full" role="img" aria-label="Profil d une cle plate, dessine au trait">
                  <path
                    ...
                    strokeWidth="1.5"
                  />
                  <circle cx="34" cy="46" r="7" fill="none" stroke={accentDoux(700, 40)} strokeWidth="1.5" />
                  <path d="M92 76 l6 -12 l8 12 l7 -14 l8 14 l9 -10 l7 10 l9 -13 l8 13" fill="none" stroke={accent(500)} strokeWidth="1.5" />
                  <text x="92" y="34" fontSize="9" fill="var(--o-theme-muted)" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.14em' }}>
                    PROFIL — 4 MINUTES
                  </text>
                </svg>
              </div>
            ...
            <div className="o-min-w-0 lg:o-col-span-8">
              <table className="o-w-full o-text-left" style={{ borderCollapse: 'collapse' }}>
                <caption className="o-sr-only">Les travaux du comptoir, leur tarif et leur delai</caption>
                <thead>
                  <tr className="o-border-b o-border-black-20 dark:o-border-zinc-700">
                    <th scope="col" className="o-py-3 o-pr-4 o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                      Travail
                    </th>
                    <th scope="col" className="o-py-3 o-pr-4 o-text-right o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                      Tarif
                    </th>
                    <th scope="col" className="o-py-3 o-text-right o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                      Delai
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {COMPTOIR.map(([quoi, note, tarif, delai]) => (
                    <tr key={quoi} className="o-border-b o-border-black-10 dark:o-border-zinc-800">
                      <th scope="row" className="o-py-5 o-pr-4 o-font-normal">
                        <span className="o-block o-text-base o-text-zinc-950 dark:o-text-zinc-50">{quoi}</span>
                        <span className="o-mt-1 o-block o-text-xs o-leading-relaxed o-text-zinc-500 dark:o-text-zinc-400">{note}</span>
                      </th>
                      <td className="o-py-5 o-pr-4 o-text-right o-font-mono o-text-sm o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50">{tarif}</td>
                      <td className="o-py-5 o-text-right o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">{delai}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section id="rayon" className="o-scroll-mt-24 o-border-t o-border-black-10 dark:o-border-zinc-800 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
            ...
            <div className="o-mt-14">
              {reduced ? (
                ...
                <TargetCursor targets="button" padding={6} spin={0.08} corner={10} color={accent(500)}>
                  {plan}
                </TargetCursor>
              )}
            </div>
        ...
        <footer className="o-px-6 o-py-16 md:o-px-10" style={nuit('zinc')}>
          <div className="o-mx-auto o-max-w-6xl">
            ...
            <div className="o-mt-8 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
              <table className="o-w-full o-text-left" style={{ minWidth: 640, borderCollapse: 'collapse' }}>
                <caption className="o-sr-only">Extrait du catalogue : references, codes et tailles du rayon A</caption>
                <thead>
                  <tr className="o-border-b o-border-white-20">
                    {['Reference', 'Tiroir', 'Diametre', 'Pas', 'Clef', 'Le cent'].map((entete) => (
                      <th key={entete} scope="col" className="o-py-3 o-pr-5 o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500">
                        {entete}
                      </th>
                    ))}
                  </tr>
                  ...
                  {MEUBLE.map((ligne) => {
                    ...
                    return (
                      <tr key={ligne.d} className="o-border-b o-border-white-10">
                        <th scope="row" className="o-py-3 o-pr-5 o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest" style={{ color: encreSurSombre() }}>
                          {`H-M${String(ligne.d).padStart(2, '0')}-${String(Math.round(premier * 100)).padStart(3, '0')}-ZN`}
                        </th>
                        <td className="o-py-3 o-pr-5 o-font-mono o-text-xs o-tabular-nums o-text-zinc-400">{ligne.casier}</td>
                        <td className="o-py-3 o-pr-5 o-font-mono o-text-xs o-tabular-nums o-text-zinc-50">M{ligne.d}</td>
                        <td className="o-py-3 o-pr-5 o-font-mono o-text-xs o-tabular-nums o-text-zinc-400">{direPas(ligne, premier)}</td>
                        <td className="o-py-3 o-pr-5 o-font-mono o-text-xs o-tabular-nums o-text-zinc-400">{ligne.clef} mm</td>
                        <td className="o-py-3 o-font-mono o-text-xs o-tabular-nums o-text-zinc-50">{euros(ligne.prix * 90)}</td>
                      </tr>
                    )
                  })}
                </tbody>
            ...
            <div className="o-mt-12 o-grid o-gap-10 sm:o-grid-cols-2 lg:o-grid-cols-4">
              ...
              <div>
                ...
                <p className="o-m-0 o-mt-4">
                  ...
                  >
                    tiroir@ecrou.fr <Icon icon={ArrowUpRight} size={14} aria-hidden="true" />
                  </a>
                </p>
            ...
            <p className="o-m-0 o-mt-12 o-border-t o-border-white-10 o-pt-5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500">
              Ecrou — SARL au capital de 12 000 EUR — RCS Paris — © 2026. Couples
              de serrage indicatifs, mesures a sec, sans frein filet.
            </p>
          </div>
        </footer>
      </div>
