...
const METIERS = [
  {
    ...
    minutes: 480,
    fait:
      'Implante cent trente-quatre projecteurs, en accroche quarante et un au gril et vingt-deux a la face de salle, puis encode cinquante-deux memoires avec le createur. La poursuite se tient en cabine, au fond.',
    releve: [
      ['Projecteurs', '134'],
  ...
  },
  {
    ...
    minutes: 360,
    fait:
      'Monte le decor, le cale, le trappe et le deplace a vue. Trois changements a vue dans ce spectacle, le plus long tient en trente-huit secondes, compte depuis le dernier mot.',
    releve: [
      ['Changements a vue', '3'],
      ['Le plus long', '38 s'],
  ...
  },
  {
    ...
    minutes: 120,
    fait:
      'Charge les perches au contrepoids, releve les hauteurs au centimetre et les reporte sur la conduite. Neuf perches en service sur les vingt-quatre du gril, dont deux en vitesse lente.',
    releve: [
  ...
  },
  {
    ...
    minutes: 90,
    fait:
      'Cale le systeme sur la salle vide, puis le recale a la vingtieme minute sur la salle pleine : quatre cents corps mangent les aigus et rien d autre. Douze entrees, deux retours de plateau.',
    releve: [
      ['Entrees', '12'],
  ...
  },
  {
    ...
    minutes: 120,
    fait:
      'Onze costumes, quatre changements rapides dont un de vingt-deux secondes dans le noir, cote jardin, en aveugle. Le passage sous le plateau est le seul chemin d un cote a l autre pendant le jeu.',
    releve: [
      ['Costumes', '11'],
...
function Rideau(): ReactElement {
  ...
  return (
    <div aria-hidden="true" className="o-pointer-events-none o-absolute o-inset-0 o-overflow-hidden">
      ...
      <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="o-absolute o-inset-x-0 o-top-0 o-h-24 o-w-full">
        <path
...
function Coupe({ acte }: { readonly acte: number }): ReactElement {
  ...
  const mono: CSSProperties = { fontFamily: 'var(--o-font-mono)', letterSpacing: '0.12em' }
  ...
  return (
    ...
    >
      <defs>
        <pattern id="o-th-hachure" width="10" height="10" patternUnits="userSpaceOnUse" patternTransform="rotate(38)">
      ...
      <rect x="52" y="292" width="124" height="70" fill="none" stroke={filet} strokeWidth="1.2" />
      ...
      {[170, 230, 290, 350, 410].map((x) => (
        <path key={x} d={`M${String(x)} 210l-9 22h18z`} fill={accentDoux(400, 40)} stroke={filet} strokeWidth="1" />
      ))}
      ...
      <rect x="452" y="500" width="68" height="66" fill="url(#o-th-hachure)" stroke={filet} strokeWidth="1.2" />

      {/* Le mur de cadre, puis le lointain. */}
      <rect x="516" y="40" width="24" height="130" fill={accentDoux(900, 40)} stroke={filet} strokeWidth="1.2" />
      <rect x="1120" y="40" width="16" height="470" fill={accentDoux(900, 40)} stroke={filet} strokeWidth="1.2" />

      {/* Le gril, et les perches qui y pendent. */}
      <rect x="540" y="48" width="580" height="30" fill="url(#o-th-hachure)" stroke={filet} strokeWidth="1.2" />
      ...
      {perches.map((y, rang) => (
        <g key={y}>
          {[620, 830, 1040].map((x) => (
            <path key={x} d={`M${String(x)} 78V${String(y)}`} stroke={filet} strokeWidth="1" />
          ))}
          <path d={`M580 ${String(y)}h520`} stroke={accentDoux(300, 40)} strokeWidth="4" />
          {rang % 2 === 0 &&
            [640, 760, 880, 1000].map((x) => (
              <path key={x} d={`M${String(x)} ${String(y)}l-9 20h18z`} fill={accentDoux(400, 40)} stroke={filet} strokeWidth="1" />
            ))}
        </g>
      ))}

      {/* Le rideau, replie contre le cadre. */}
      <path d="M544 170c14 40 0 80 8 120 8 40-6 80 2 120 8 40 0 60 0 90" stroke={accent(500)} strokeWidth="3" fill="none" />

      {/* Le plateau, son plancher, son dessous, les loges. */}
      <path d="M536 500h584" stroke={accentDoux(300, 70)} strokeWidth="5" />
      <rect x="536" y="500" width="584" height="16" fill={accentDoux(900, 40)} stroke={filet} strokeWidth="1" />
      <rect x="536" y="516" width="584" height="72" fill="url(#o-th-hachure)" stroke={filet} strokeWidth="1.2" />
      <rect x="556" y="524" width="240" height="56" fill={accentDoux(900, 34)} stroke={filet} strokeWidth="1.2" />
      ...
      <Cote sens="v" de={78} a={500} pose={1172} valeur="18,00 m" ancre="end" part={0.14} />
      ...
      {METIERS.map((metier, rang) => (
        <g key={metier.nom} style={{ opacity: rang === acte ? 1 : 0, transition: 'opacity 520ms ease' }}>
...
const SAISON: readonly {
  ...
  { rang: '01', titre: 'Le Mur porteur', forme: 'Creation maison', duree: '1 h 50', dates: '9 — 18 octobre' },
  { rang: '02', titre: 'Nous autres', forme: 'Theatre gestuel', duree: '1 h 05', dates: '7 — 9 novembre' },
  { rang: '03', titre: 'La Repetition generale', forme: 'Accueil, deux salles', duree: '2 h 20', dates: '4 — 13 decembre' },
  { rang: '04', titre: 'Fond de scene', forme: 'Carte blanche a la troupe', duree: '55 min', dates: '22 janvier' },
  { rang: '05', titre: 'Onze', forme: 'Creation maison', duree: '1 h 35', dates: '5 — 21 mars' },
  { rang: '06', titre: 'Le Dernier Rang', forme: 'Sortie de residence', duree: '1 h 10', dates: '16 — 24 mai' },
]
...
function Porte3({
  ...
  return (
    <a
      ...
      style={{ color: 'inherit' }}
    >
      <div className="o-relative o-overflow-hidden" style={{ boxShadow: `inset 0 0 0 1px ${accentDoux(300, 26)}` }}>
        {/* Ce qu il y a derriere la porte, visible quand le battant s ecarte. */}
        <div className="o-flex o-h-full o-flex-col o-justify-end o-gap-3 o-p-6" style={{ minHeight: '19rem', backgroundColor: accentDoux(900, 34) }}>
          <p className="o-m-0 o-text-sm o-leading-relaxed o-text-zinc-300">{texte}</p>
          <p className="o-m-0 o-inline-flex o-items-center o-gap-2 o-font-mono o-text-xs o-uppercase o-tracking-widest" style={{ color: encreSurSombre() }}>
        ...
        >
          <span className="o-tabular-nums" style={{ ...affiche('m', 800), fontSize: 'clamp(3.5rem, 8vw, 6rem)', lineHeight: 0.8, color: accent(500) }}>
            {numero}
          </span>
          <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">{intention}</span>
          {/* La poignee, a hauteur d homme. */}
          <span className="o-absolute o-right-4 o-top-1/2 o-block o-h-6 o-w-1.5" style={{ backgroundColor: accentDoux(300, 60) }} />
        </div>
      </div>
...
const PICTOS: readonly { readonly nom: string; readonly d: string }[] = [
  ...
  { nom: 'Regie', d: 'M12 30v-6a16 16 0 0 1 32 0v6M12 30h8v14h-8zM36 30h8v14h-8zM28 44h10' },
  // Une aiguille et son fil.
  { nom: 'Costumes', d: 'M10 44L40 14M40 14l6-6M36 10a6 6 0 1 0 8 8M14 40c-6 4-6 8-2 8s4-6 2-8' },
  // Une cle a molette.
  ...
  return (
    <Porte forme="trou" marque="Coulisse">
      <div className="o-relative" style={{ ...nuit('zinc'), ...polices }}>
        ...
        {!reduced && <CursorHalo host={plateau} haloSize={110} dotSize={4} speed={6} hoverScale={1.3} style={{ color: accent(400) }} />}
        ...
        <header className="o-relative o-isolate o-flex o-flex-col o-overflow-hidden" style={{ minHeight: `calc(100vh - ${String(CHROME)}px)` }}>
          ...
          <BarreCoins marque="Coulisse" liens={NAVIGATION} droite="Scene conventionnee — Villeneuve-sur-Lot" />
          ...
          <div className="o-relative o-z-20 o-flex o-grow o-flex-col o-justify-between o-gap-10 o-px-6 o-pb-12 md:o-px-10">
            <div className="o-max-w-4xl">
              ...
              <TitreVague
                ...
                style={{ ...affiche('xl', 800), fontSize: 'clamp(3.25rem, 15vw, 13rem)', lineHeight: 0.78, letterSpacing: '-0.055em' }}
              >
                Coulisse
              </TitreVague>
              <Surgit delai={520} as="p" className="o-m-0 o-mt-8 o-max-w-xl o-text-lg o-leading-relaxed o-text-zinc-300">
                Le theatre de la ville, et le seul plateau du departement ou l on peut encore monter un decor a l italienne.
              </Surgit>
              <Surgit delai={600} className="o-mt-8">
                <Actions pleine={['#portes', 'Prendre une place']} fantome={['#saison', 'Les six creations']} />
              </Surgit>
            </div>
            ...
            <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-8">
              <Surgit delai={640}>
                ...
                <div className="o-relative o-inline-block o-px-7 o-py-5" style={{ backgroundColor: accentDoux(950, 82) }}>
                  <NeonBorder color="--o-vitrine-500" radius={0} thickness={1} glow={80} duration={5200} />
              ...
              <Surgit delai={720} as="p" className="o-m-0 o-max-w-xs o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400 md:o-text-right">
                Cette page ne montre pas la salle.
                <br />
                Elle montre ce qu il y a derriere.
                <br />
                <a href="#plateau" className="o-inline-flex o-items-center o-gap-2 o-no-underline focus:o-ring" style={{ color: encreSurSombre() }}>
        ...
        <main>
              ...
              <div className="o-min-w-0 md:o-col-span-9">
                <Reveal>
                  <Manifeste eteint="Ce que le public voit dure une heure cinquante.">
                    Ce qui le rend possible commence a huit heures du matin, et se demonte a une heure.
                  </Manifeste>
                </Reveal>
              </div>
            </div>
                  ...
                  <div className="o-flex o-h-full o-flex-col o-px-4 o-pb-4 o-pt-6 md:o-px-10 md:o-pb-8">
                    <div className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-4">
                      ...
                      <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500">
                        {String(acte + 1).padStart(2, '0')} / {String(METIERS.length).padStart(2, '0')} — appel {metier.appel}
                      </p>
                    </div>
                    ...
                    <div className="o-mt-4 o-grid o-min-h-0 o-grow o-items-center o-gap-6 md:o-grid-cols-12 md:o-gap-10">
                      ...
                      <div className="o-min-w-0 md:o-col-span-4">
                        <h2 className="o-m-0 o-uppercase o-text-zinc-50" style={{ ...affiche('m', 800), fontSize: 'clamp(1.6rem, 3.4vw, 3rem)', lineHeight: 0.88, letterSpacing: '-0.04em' }}>
                          {metier.nom}
                        </h2>
                        <p className="o-m-0 o-mt-2 o-font-mono o-text-xs o-uppercase o-tracking-widest" style={{ color: encreSurSombre() }}>
                          {metier.poste}
                        </p>
                        <p className="o-m-0 o-mt-5 o-max-w-md o-text-sm o-leading-relaxed o-text-zinc-300">{metier.fait}</p>
                        <dl className="o-m-0 o-mt-6 o-grid o-grid-cols-2 o-gap-x-6">
                          {metier.releve.map(([quoi, valeur]) => (
                            <div key={quoi} className="o-min-w-0 o-border-t o-border-white-10 o-py-2">
                              <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500">{quoi}</dt>
                              <dd className="o-m-0 o-mt-1 o-font-mono o-text-sm o-tabular-nums o-text-zinc-50">{valeur}</dd>
                            </div>
                          ))}
                        </dl>
                      </div>
                        ...
                        {METIERS.map((autre, rang) => (
                          <li key={autre.nom}>
                            <span
                              ...
                              style={{ backgroundColor: rang === acte ? accent(500) : 'var(--o-theme-line)' }}
                            />
          ...
          <section className="o-px-6 o-py-24 md:o-px-10 md:o-py-32" style={{ backgroundColor: accentDoux(950, 70) }}>
            <div className="o-mx-auto o-max-w-6xl">
              <Reveal>
                <p className="o-m-0 o-max-w-4xl o-text-balance o-uppercase o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 4.4vw, 4rem)', lineHeight: 0.95 }}>
                  <ShineText
              ...
              <Reveal delay={90}>
                <p className="o-m-0 o-mt-8 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-400">
                  Soit {rapport} fois la duree du spectacle, chaque jour de premiere, pour cinq personnes appelees a des heures differentes. C est la somme des cinq presences ci-dessus, et rien d autre.
                </p>
              </Reveal>
            </div>
          </section>
          ...
          {/* ================= La conduite du soir ======================== */}
          <section id="conduite" className="o-scroll-mt-24 o-border-t o-border-white-10 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
            <div className="o-mx-auto o-max-w-6xl">
              <Reveal>
                <Indice rang="03">La conduite du soir</Indice>
              </Reveal>
              <Reveal delay={80}>
                <h2 className="o-m-0 o-mt-6 o-max-w-3xl o-uppercase o-text-zinc-50" style={{ ...affiche('m', 800), fontSize: 'clamp(1.85rem, 4.4vw, 3.75rem)', lineHeight: 0.9, letterSpacing: '-0.04em' }}>
              ...
              <ol className="o-m-0 o-mt-14 o-list-none o-border-t o-border-white-10 o-p-0">
                {CONDUITE.map(([heure, quoi, qui], rang) => (
                  <li key={heure} className="o-grid o-items-baseline o-gap-3 o-border-b o-border-white-10 o-py-5 md:o-grid-cols-12 md:o-gap-8">
                    <span className="o-font-mono o-text-sm o-tabular-nums md:o-col-span-2" style={{ color: encreSurSombre() }}>
                      {heure}
                    </span>
                    <span className="o-min-w-0 o-text-lg o-text-zinc-50 md:o-col-span-6" style={{ fontWeight: 500 }}>
                      {quoi}
                    </span>
                    <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 md:o-col-span-3">{qui}</span>
                    <span aria-hidden="true" className="o-font-mono o-text-xs o-tabular-nums o-text-zinc-500 md:o-col-span-1 md:o-text-right">
          ...
          {/* ================= La saison ================================== */}
          <section id="saison" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32" style={{ backgroundColor: accentDoux(950, 70) }}>
            <div className="o-mx-auto o-max-w-6xl">
              <Reveal>
              ...
              <ol className="o-m-0 o-mt-12 o-list-none o-border-t o-border-white-10 o-p-0">
                {SAISON.map((piece) => (
                  <li key={piece.rang} className="o-grid o-items-end o-gap-4 o-border-b o-border-white-10 o-py-8 md:o-grid-cols-12 md:o-gap-8">
                    <span aria-hidden="true" className="o-tabular-nums o-text-zinc-500 md:o-col-span-2" style={{ ...affiche('m', 800), fontSize: 'clamp(2rem, 4vw, 3.25rem)', lineHeight: 0.8 }}>
                      {piece.rang}
                    </span>
                    <h3 className="o-m-0 o-min-w-0 o-uppercase o-text-zinc-50 md:o-col-span-6" style={{ ...affiche('m', 800), fontSize: 'clamp(1.35rem, 3vw, 2.5rem)', lineHeight: 0.92, letterSpacing: '-0.03em' }}>
                      {piece.titre}
                    </h3>
                    <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400 md:o-col-span-4 md:o-text-right">
                      {piece.forme}
                      <br />
                      <span style={{ color: encreSurSombre() }}>{piece.dates}</span> · {piece.duree}
                    </p>
                  </li>
                ))}
              </ol>
          ...
          <section id="portes" className="o-scroll-mt-24 o-border-t o-border-white-10 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
            <div className="o-mx-auto o-max-w-6xl">
              <Reveal>
                <Indice rang="05">Venir</Indice>
              </Reveal>
              <Reveal delay={80}>
                <h2 className="o-m-0 o-mt-6 o-max-w-2xl o-uppercase o-text-zinc-50" style={{ ...affiche('m', 800), fontSize: 'clamp(1.85rem, 4.4vw, 3.75rem)', lineHeight: 0.9, letterSpacing: '-0.04em' }}>
        ...
        <footer className="o-border-t o-border-white-10 o-px-6 o-py-16 md:o-px-10">
          <div className="o-mx-auto o-max-w-6xl">
            ...
            <ul className="o-m-0 o-mt-8 o-grid o-list-none o-gap-px o-p-0 o-grid-cols-2 sm:o-grid-cols-3 lg:o-grid-cols-6" style={{ backgroundColor: 'var(--o-theme-line)' }}>
              {PICTOS.map((picto) => (
                <li key={picto.nom} className="o-min-w-0 o-px-4 o-py-6" style={{ backgroundColor: 'var(--o-theme-bg)' }}>
                  <svg viewBox="0 0 56 56" className="o-h-12 o-w-12" aria-hidden="true">
                    <path d={picto.d} fill="none" stroke={accent(400)} strokeWidth="2.2" strokeLinecap="square" />
                  </svg>
                  <p className="o-m-0 o-mt-4 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-50">{picto.nom}</p>
                </li>
              ))}
            </ul>
            ...
            <div className="o-mt-12 o-flex o-flex-wrap o-items-end o-justify-between o-gap-6 o-border-t o-border-white-10 o-pt-8">
              ...
              <p className="o-m-0">
                ...
                >
                  billetterie@coulisse-theatre.fr <Icon icon={ArrowUpRight} size={15} aria-hidden="true" />
                </a>
              </p>
            </div>
          </div>
