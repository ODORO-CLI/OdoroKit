...
import { ArrowRight, ArrowUpRight, Sun, Waves, Wind } from '@odoro-cli/icons/filaire'
...
import { Actions, affiche, BarreFilet, CHROME, Coin, Etiquette, Grain, Porte, Surgit, usePolices } from './marche.jsx'
...
const PARCS: readonly Parc[] = [
  { nom: 'Plateau de Vensac', departement: 'Gironde', filiere: 'Eolien', puissance: 68, charge: 27.4, production: 163, service: 2019, note: 1 },
  { nom: 'Coteaux de Meze', departement: 'Herault', filiere: 'Solaire', puissance: 54, charge: 16.8, production: 79, service: 2022, note: 2 },
  { nom: 'Barrage de Tresque', departement: 'Ardeche', filiere: 'Hydraulique', puissance: 18, charge: 44.2, production: 70, service: 2016 },
  { nom: 'Bois de Cerisy', departement: 'Manche', filiere: 'Eolien', puissance: 42, charge: 29.1, production: 107, service: 2021, note: 3 },
  { nom: 'Plaine de Lauris', departement: 'Vaucluse', filiere: 'Solaire', puissance: 61, charge: 17.9, production: 96, service: 2024 },
  { nom: 'Mont Chauve', departement: 'Aveyron', filiere: 'Eolien', puissance: 51, charge: 26.2, production: 117, service: 2018, note: 4 },
  { nom: 'Ecluse de Rive', departement: 'Saone-et-Loire', filiere: 'Hydraulique', puissance: 9, charge: 41.8, production: 33, service: 2015 },
  { nom: 'Landes de Kervin', departement: 'Morbihan', filiere: 'Eolien', puissance: 36, charge: 28.7, production: 91, service: 2023, note: 5 },
  { nom: 'Toitures de Saint-Priest', departement: 'Rhone', filiere: 'Solaire', puissance: 22, charge: 15.1, production: 29, service: 2023 },
  { nom: 'Val de Vire', departement: 'Calvados', filiere: 'Eolien', puissance: 33, charge: 27.9, production: 81, service: 2020 },
  { nom: 'Canal de Mielan', departement: 'Gers', filiere: 'Hydraulique', puissance: 6, charge: 39.4, production: 21, service: 2017 },
]
...
function Chapitre({ rang, children }: { readonly rang: string; readonly children: string }): ReactElement {
  return (
    ...
    >
      <div className="o-mx-auto o-max-w-6xl">
        <p className="o-m-0 o-flex o-items-center o-gap-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
          <span aria-hidden="true" className="o-size-1.5 o-rounded-full" style={{ backgroundColor: encreSurSombre() }} />
        ...
        <div className="o-mt-10 o-grid o-items-end o-gap-x-10 o-gap-y-8 md:o-grid-cols-12">
          ...
          <p className="o-m-0 o-flex o-items-baseline o-justify-start o-gap-4 o-tabular-nums o-text-zinc-50 md:o-col-span-7 md:o-justify-end">
            <span aria-hidden="true" style={{ ...affiche('xxl', 300), fontSize: 'clamp(4rem, 15vw, 13rem)', lineHeight: 0.82 }}>
              <CountUp
                key={total}
                value={total}
                from={totalPrecedent}
            ...
            <span aria-hidden="true" className="o-font-mono o-text-sm o-uppercase o-tracking-widest o-text-zinc-400">
              MW
            </span>
          </p>
        </div>
        ...
        <dl className="o-m-0 o-mt-14 o-border-t o-border-white-10">
          {FILIERES.map((nom) => {
            ...
            return (
              <div key={nom} className="o-grid o-items-center o-gap-x-6 o-gap-y-2 o-border-b o-border-white-10 o-py-5 md:o-grid-cols-12">
                <dt className="o-flex o-items-center o-gap-2.5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-300 md:o-col-span-3">
                  <Icon icon={iconeFiliere(nom)} size={14} style={{ color: encreSurSombre() }} aria-hidden="true" />
                  {nom}
                </dt>
                <dd className="o-m-0 o-flex o-items-center o-gap-5 md:o-col-span-9">
                  <span aria-hidden="true" className="o-h-1.5 o-min-w-0 o-grow o-overflow-hidden o-rounded-full o-bg-white-10">
                    <span
                      className="o-block o-h-full o-rounded-full"
                      style={{ width: `${String(part)}%`, backgroundColor: encreSurSombre(), transition: 'width 1100ms cubic-bezier(0.16, 1, 0.3, 1)' }}
                    />
                  </span>
                  <span className="o-w-24 o-shrink-0 o-text-right o-font-mono o-text-lg o-tabular-nums o-text-zinc-50">
                    <CountUp key={`${nom}-${String(valeur)}`} value={valeur} from={precedent[nom]} duration={1100} locale="fr-FR" declenchement="montage" />
        ...
        <p className="o-m-0 o-mt-6 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400">
          Quatre cent douze megawatts installes — le compteur se rafraichit toutes les dix minutes, et ce qui suit est le rapport de l exercice clos.
        </p>
      </div>
      <Grain opacite={0.05} />
    </section>
...
export default function Page(): ReactElement {
  ...
  return (
    ...
    <div className="o-bg-white dark:o-bg-zinc-950 o-text-zinc-900 dark:o-text-zinc-100" style={polices}>
      ...
      <header className="o-relative o-isolate o-overflow-hidden" style={{ ...nuit('zinc'), minHeight: '100vh' }}>
        <img src={photo('courant-vensac', 1800, 1100)} alt="" aria-hidden="true" className="o-absolute o-inset-0 o-z-0 o-size-full o-object-cover" />
        ...
        <div
          ...
          style={{ backgroundColor: 'color-mix(in oklab, var(--o-palette-zinc-950) 46%, transparent)' }}
        />
        <Voile sens="haut-bas" />
        <Grain />

        <BarreFilet marque="Courant" liens={[['#direct', 'En direct'], ['#parc', 'Le parc'], ['#offres', 'Vendre'], ['#engagements', 'Engagements']]} action={['#terrain', 'J ai du terrain']} />
        ...
        >
          ...
          <Surgit delai={120} className="o-mt-7">
            <MaskedHeading
              ...
              style={{ ...affiche('xl', 700), fontSize: 'clamp(2.5rem, 7.5vw, 7.5rem)' }}
            >
              887 gigawattheures, releves au compteur.
            </MaskedHeading>
          </Surgit>
          <Surgit delai={420} as="p" className="o-m-0 o-mt-7 o-max-w-md o-text-lg o-leading-relaxed o-text-zinc-300">
            Pas au dimensionnement, pas en puissance installee : au compteur, et transmis au gestionnaire de reseau.
          </Surgit>
          <Surgit delai={540} className="o-mt-9">
            <Actions pleine={['#direct', <>Voir le compteur <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]} fantome={['#parc', 'Les onze parcs']} />
          </Surgit>
        </div>

        <Coin position="bg">Rapport d activite<br />Arrete le 12 mars 2026</Coin>
        <Coin position="bd">Bordeaux — quai de Paludate<br />Producteur declare, CRE</Coin>
      </header>
      ...
      <main>
        ...
        {/* ----- Le sommaire pagine ------------------------------------------- */}
        <nav aria-label="Sommaire" className="o-mx-auto o-max-w-4xl o-px-6 o-pb-6 o-pt-20 md:o-px-14 md:o-pt-28">
          ...
          <ol className="o-m-0 o-mt-6 o-flex o-list-none o-flex-col o-p-0">
            {SOMMAIRE.map(([rang, ancre, titre, quoi]) => (
              <li key={ancre} className="o-border-b o-border-zinc-200 dark:o-border-zinc-800">
                <a
                  href={`#${ancre}`}
                ...
                >
                  <span className="o-w-6 o-font-mono o-text-sm o-tabular-nums" style={{ color: encre() }}>
                    {rang}
                  </span>
                  <span className="o-text-base o-font-medium o-tracking-tight">{titre}</span>
        ...
        <section id="exercice" aria-labelledby="exercice-titre" className="o-mx-auto o-max-w-4xl o-scroll-mt-24 o-px-6 o-py-12 md:o-px-14">
          ...
          <p className="o-mt-4 o-max-w-2xl o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
            Huit cent quatre-vingt-sept gigawattheures produits sur quatre cent
            douze megawatts installes, soit un facteur de charge d ensemble de
            31,0 %. L effacement demande par le gestionnaire de reseau a represente
            1,8 % de la production, indemnise au tarif du contrat.
          </p>
            ...
            <figure className="o-m-0 o-mt-10">
              ...
              >
                {MENSUEL.map(([mois, valeur], rang) => (
                  <span key={`${mois}-${String(rang)}`} className="o-flex o-h-full o-flex-1 o-flex-col o-justify-end o-gap-2">
                    <span className="o-font-mono o-text-xs o-tabular-nums o-text-zinc-500 dark:o-text-zinc-400">{valeur}</span>
                    <span
              ...
              <div aria-hidden="true" className="o-mt-2 o-flex o-gap-1.5">
                {MENSUEL.map(([mois], rang) => (
                  <span key={`${mois}-${String(rang)}`} className="o-flex-1 o-text-center o-font-mono o-text-xs o-uppercase o-text-zinc-500 dark:o-text-zinc-400">
                    {mois}
                  </span>
                ))}
              </div>
              <figcaption className="o-mt-5 o-flex o-flex-wrap o-items-baseline o-gap-x-4 o-gap-y-1 o-font-mono o-text-xs">
                <span className="o-font-bold" style={{ color: encre() }}>Figure 1.1</span>
                <span className="o-text-zinc-600 dark:o-text-zinc-400">
                  Production mensuelle, en gigawattheures. L hiver porte l eolien, l ete le solaire ; l ecart entre janvier et juin vaut quarante gigawattheures.
                </span>
              </figcaption>
            </figure>
          </Reveal>
        ...
        <section id="parc" aria-labelledby="parc-titre" className="o-mx-auto o-max-w-4xl o-scroll-mt-24 o-px-6 o-py-12 md:o-px-14">
          <div id="parc-titre">
            <Chapitre rang="2">Le parc d exploitation</Chapitre>
          </div>
          <p className="o-mt-4 o-max-w-2xl o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
            Onze sites, trois filieres, aucun projet en portefeuille qui ne soit
            pas deja autorise. Le facteur de charge de chaque ligne est celui de
            l exercice, pertes et bridages deduits.
          </p>
          ...
          <div className="o-mt-12 o-grid o-grid-cols-12 o-gap-4 md:o-gap-6">
            ...
            <Parallaxe vitesse={0.2} className="o-col-span-10 o-col-start-3" style={{ marginBottom: '-3rem' }}>
              <Devoile
          ...
          <div className="o-mt-6 o-overflow-x-auto o-scrollbar dark:o-scrollbar-dark">
            <table className="o-w-full o-text-sm" style={{ minWidth: '40rem', borderCollapse: 'collapse' }}>
              <caption className="o-sr-only">Parc d exploitation au 31 decembre 2025</caption>
              <thead>
                <tr className="o-border-b o-border-zinc-400 dark:o-border-zinc-600">
                  {['Site', 'Departement', 'Filiere', 'MW', 'Charge', 'GWh', 'Service'].map((entete) => (
                    <th
                      key={entete}
                      scope="col"
              ...
              <tbody>
                {lignes.map((p) => (
                  <tr key={p.nom} className="o-border-b o-border-zinc-200 dark:o-border-zinc-800">
                    <th scope="row" className="o-py-2.5 o-pr-5 o-text-left o-font-medium">
                      {p.nom}
                      {p.note !== undefined && (
                        <a
                          href="#notes"
                    ...
                    <td className="o-py-2.5 o-pr-5 o-text-zinc-600 dark:o-text-zinc-400">{p.departement}</td>
                    <td className="o-py-2.5 o-pr-5">
                      <span className="o-inline-flex o-items-center o-gap-1.5 o-text-zinc-600 dark:o-text-zinc-400">
                        <Icon icon={iconeFiliere(p.filiere)} size={13} aria-hidden="true" />
                        {p.filiere}
                      </span>
                    </td>
                    <td className="o-py-2.5 o-pr-5 o-font-mono o-tabular-nums">{p.puissance}</td>
                    <td className="o-py-2.5 o-pr-5 o-font-mono o-tabular-nums">
                      {p.charge.toLocaleString('fr-FR')} %
                    </td>
                    <td className="o-py-2.5 o-pr-5 o-font-mono o-tabular-nums">{p.production}</td>
              ...
              <tfoot>
                <tr style={{ backgroundColor: accentDoux(500, 10) }}>
                  <th scope="row" className="o-py-3 o-pr-5 o-text-left o-font-mono o-text-xs o-uppercase o-tracking-wider">
                    Total
                  </th>
                  ...
                  <td className="o-py-3 o-pr-5 o-font-mono o-font-bold o-tabular-nums" style={{ color: encre() }}>
                    {totaux.puissance}
                  </td>
                  <td className="o-py-3 o-pr-5 o-font-mono o-font-bold o-tabular-nums" style={{ color: encre() }}>
          ...
          <p aria-live="polite" className="o-mt-3 o-font-mono o-text-xs o-text-zinc-500 dark:o-text-zinc-400">
            {lignes.length} site{lignes.length > 1 ? 's' : ''} sur {PARCS.length}. Les exposants renvoient aux notes du chapitre 6.
          </p>
        </section>

        {/* ----- 3. Le reseau, ouvert par le maillage ------------------------- */}
        <section id="reseau" aria-labelledby="reseau-titre" className="o-scroll-mt-24 o-pt-12">
          <figure className="o-relative o-isolate o-m-0 o-overflow-hidden" style={nuit('zinc')}>
            <ElasticMesh
            ...
            <figcaption className="o-flex o-flex-wrap o-items-baseline o-gap-x-4 o-gap-y-1 o-border-t o-border-zinc-800 o-px-6 o-py-3 o-font-mono o-text-xs md:o-px-14">
              ...
              <span className="o-text-zinc-400 dark:o-text-zinc-400">
                Souplesse du reseau — representation schematique de la contrainte
                d equilibre. Sans valeur de mesure.
              </span>
            </figcaption>
          </figure>
          ...
          <div className="o-mx-auto o-max-w-4xl o-px-6 o-py-12 md:o-px-14">
            ...
            <p className="o-mt-4 o-max-w-2xl o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
              Lorsque le reseau ne peut pas absorber, le gestionnaire nous demande
              de reduire, et nous reduisons. Cela a represente 1,8 % de la
              production de l exercice, indemnise au tarif du contrat. Le detail
              par parc est tenu a disposition des souscripteurs.
            </p>
          </div>
        </section>

        {/* ----- 4. Vendre le courant ----------------------------------------- */}
        <section id="offres" aria-labelledby="offres-titre" className="o-mx-auto o-max-w-4xl o-scroll-mt-24 o-px-6 o-py-12 md:o-px-14">
          <div id="offres-titre">
            <Chapitre rang="4">Vendre le courant</Chapitre>
          </div>
          <p className="o-mt-4 o-max-w-2xl o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
            Un producteur ne choisit pas son prix, il choisit sa duree. Voici les
            trois contrats sous lesquels les huit cent quatre-vingt-sept
            gigawattheures ont ete vendus, et ce que chacun rapporte au megawattheure.
          </p>
          <ol className="o-m-0 o-mt-10 o-list-none o-border-t o-border-zinc-300 dark:o-border-zinc-700 o-p-0">
            {CONTRATS.map(([rang, titre, prix, texte]) => (
              <li key={rang} className="o-grid o-gap-x-6 o-gap-y-3 o-border-b o-border-zinc-200 dark:o-border-zinc-800 o-py-7 md:o-grid-cols-12">
                <p className="o-m-0 o-font-mono o-text-xs o-tabular-nums md:o-col-span-1" style={{ color: encre() }}>
                  {rang}
                </p>
                <div className="md:o-col-span-7">
                  <h3 className="o-m-0 o-text-lg o-font-semibold o-tracking-tight">{titre}</h3>
                ...
                <p
                  ...
                  style={{ ...affiche('m', 300), fontSize: 'clamp(1.5rem, 2.6vw, 2.25rem)', color: encre() }}
                >
                  {prix}
                </p>
              </li>
        ...
        {/* ----- 5. Les engagements ------------------------------------------- */}
        <section id="engagements" aria-labelledby="engagements-titre" className="o-mx-auto o-max-w-4xl o-scroll-mt-24 o-px-6 o-py-12 md:o-px-14">
          ...
          <dl className="o-m-0 o-mt-6 o-flex o-flex-col o-gap-6">
            {ENGAGEMENTS.map(([rang, titre, texte]) => (
              <div key={rang} className="o-grid o-gap-x-5 o-gap-y-1 sm:o-grid-cols-12">
                <dt className="o-font-mono o-text-xs o-tabular-nums sm:o-col-span-1" style={{ color: encre() }}>
                  {rang}
                </dt>
                <div className="sm:o-col-span-11">
                  <p className="o-m-0 o-text-base o-font-semibold o-tracking-tight">{titre}</p>
        ...
        {/* ----- 6. Les notes -------------------------------------------------- */}
        <section id="notes" aria-labelledby="notes-titre" className="o-mx-auto o-max-w-4xl o-scroll-mt-24 o-px-6 o-py-12 md:o-px-14">
          <div id="notes-titre">
          ...
          <ol className="o-m-0 o-mt-6 o-flex o-list-none o-flex-col o-gap-3.5 o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-p-0 o-pt-6">
            {NOTES.map((texte, rang) => (
              <li key={texte.slice(0, 24)} className="o-grid o-gap-x-4 sm:o-grid-cols-12">
        ...
        >
          <h2 id="terrain-titre" className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
          ...
          <p className="o-m-0 o-mt-12 o-max-w-sm o-text-sm o-leading-relaxed o-text-zinc-500 dark:o-text-zinc-400">
            Reponse sous trois semaines, avec le rendement estime, le loyer propose
            et la part de fiscalite qui revient a la commune.
          </p>
        </section>
      </main>
      ...
      <PiedColle hauteur={520}>
        <footer className="o-flex o-h-full o-flex-col o-justify-end o-px-6 o-pb-10 o-pt-14 md:o-px-14" style={nuit('zinc')}>
          <div className="o-mx-auto o-w-full o-max-w-4xl">
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Colophon</p>
            <p className="o-m-0 o-mt-6 o-max-w-2xl o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 3.2vw, 3rem)' }}>
              Courant Energie
            </p>
            <dl className="o-m-0 o-mt-10 o-grid o-gap-x-10 o-gap-y-5 o-border-t o-border-white-10 o-pt-8 o-font-mono o-text-xs sm:o-grid-cols-3">
              {([
                ...
                ['Immatriculation', 'RCS Bordeaux 792 441 018 — capital de 9 200 000 EUR'],
                ['Ecrire', 'territoires@courant-energie.fr'],
              ] as const).map(([quoi, valeur]) => (
                <div key={quoi}>
                  <dt className="o-uppercase o-tracking-wider o-text-zinc-400">{quoi}</dt>
                  <dd className="o-m-0 o-mt-1.5 o-leading-relaxed o-text-zinc-100">{valeur}</dd>
                </div>
              ))}
            </dl>
            <p className="o-m-0 o-mt-10 o-border-t o-border-white-10 o-pt-5 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400">
              © 2026 — document arrete le 12 mars 2026 par la direction de l exploitation ; il ne constitue ni un document d information reglemente ni une invitation a souscrire.
            </p>
          </div>
        </footer>
      </PiedColle>
