...
import { Actions, affiche, BarreFilet, Coin, Etiquette, Grain, Indice, Porte, Surgit, TitreVague, usePolices, verre } from './marche.jsx'
...
const PRESTATIONS: readonly Prestation[] = [
  ...
  },
  {
    ...
    duree: 20,
    prix: 24,
    detail: 'Gommage, vapeur, masque a l argile verte. Se prend a la suite d autre chose.',
...
const ANNULATION = [
  ['Jusqu a quatre heures avant', 'annulation ou report sans rien payer, depuis le lien du message.'],
  ['Moins de quatre heures avant', '15 EUR retenus sur le rendez-vous suivant.'],
  ['Retard de plus de dix minutes', 'la prestation est raccourcie, le prix ne change pas.'],
] as const
...
export default function Page(): ReactElement {
  ...
  const [retenu, setRetenu] = useState<{ readonly qui: string; readonly jour: string; readonly heure: string } | null>(
    null,
  )
  ...
  const fauteuilsPossibles = useMemo(
    () => FAUTEUILS.filter((f) => choisies.every((p) => p.parQui.includes(f.cle))).map((f) => f.cle),
    [choisies],
  )

  const basculer = (cle: string): void => {
    setRetenu(null)
    setPanier((avant) => (avant.includes(cle) ? avant.filter((c) => c !== cle) : [...avant, cle]))
  }
  ...
  return (
    ...
    <div className="o-bg-zinc-50 dark:o-bg-zinc-950 o-text-zinc-900 dark:o-text-zinc-100" style={polices}>
      ...
      <header className="o-relative o-isolate o-overflow-hidden" style={nuit('zinc')}>
        ...
        <BarreFilet marque="Atelier Rasoir" liens={[['#soins', 'Les soins'], ['#fauteuils', 'Les fauteuils'], ['#agenda', 'L agenda']]} action={['#agenda', 'Prendre rendez-vous']} />

        <div className="o-relative o-z-10 o-mx-auto o-grid o-max-w-6xl o-items-end o-gap-10 o-px-6 o-pb-28 o-pt-16 lg:o-grid-cols-12 lg:o-gap-14 lg:o-pb-32" style={{ minHeight: 'calc(100vh - 101px)' }}>
          <div className="o-min-w-0 lg:o-col-span-7">
            <Surgit>
              <Etiquette>#01 — Barbier, Paris 9e</Etiquette>
            </Surgit>
            <TitreVague delai={100} className="o-m-0 o-mt-6 o-uppercase o-text-zinc-50" style={affiche('l', 800)}>
              Atelier Rasoir
            </TitreVague>
            <Surgit delai={360} as="p" className="o-m-0 o-mt-7 o-max-w-md o-text-lg o-leading-relaxed o-text-zinc-300">
              Trois fauteuils, un agenda qui se prend en trois clics, et quarante minutes pour un rasage au rasoir droit.
            </Surgit>
            <Surgit delai={480} className="o-mt-9">
              <Actions pleine={['#agenda', <>Voir les creneaux libres <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]} fantome={['#soins', 'Les six soins']} />
            </Surgit>
          </div>
          ...
          <Surgit delai={240} className="o-relative o-min-w-0 lg:o-col-span-5">
            <KenBurns
              ...
              interval={5200}
              images={[
                { src: photo('rasoir-salle', 1000, 900), alt: 'La salle, fauteuils et miroirs' },
                { src: photo('rasoir-fauteuil', 1000, 900), alt: 'Un fauteuil et son poste de travail' },
                { src: photo('rasoir-outils', 1000, 900), alt: 'Bol, blaireau et rasoir droit sur leur support' },
              ]}
            />
            {/* Le soin le plus demande, en carte flottante — Salonix. */}
            <div className={`${verre(true)} o-absolute o-bottom-4 o-left-4 o-right-4 o-flex o-items-center o-gap-4 o-p-4`}>
              <div className="o-min-w-0">
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Le plus demande</p>
                <p className="o-m-0 o-mt-1 o-text-base o-font-medium o-text-zinc-50">Rasage a l ancienne</p>
                <p className="o-m-0 o-mt-0.5 o-text-sm o-text-zinc-300">40 min — 38 EUR</p>
              </div>
              <a href="#agenda" aria-label="Reserver un rasage a l ancienne" className="o-ml-auto o-inline-flex o-size-10 o-shrink-0 o-items-center o-justify-center o-rounded-full o-no-underline focus:o-ring" style={aplat()}>
        ...
        <Coin position="bg">27 rue Bergere<br />Paris 9e — Grands Boulevards</Coin>
        <Coin position="bd">Du mardi au samedi<br />Jeudi jusqu a 21 h</Coin>
      </header>
      ...
      <main>
        ...
        <section id="soins" aria-labelledby="soins-titre" className="o-scroll-mt-24">
          <Rail
            ...
            entete={
              <div className="o-mx-auto o-flex o-w-full o-max-w-6xl o-flex-wrap o-items-end o-justify-between o-gap-x-10 o-gap-y-4 o-px-6 o-pb-6 o-pt-10">
                <div className="o-min-w-0">
                  <Indice rang="01" sombre={false}>Les soins</Indice>
                  <h2 id="soins-titre" className="o-m-0 o-mt-4 o-max-w-2xl" style={{ ...affiche('m', 800), fontSize: 'clamp(1.75rem, 4vw, 3.5rem)' }}>
                    Six soins. Cochez au passage.
                  </h2>
                </div>
                <p aria-live="polite" className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400 md:o-text-right">
                  {choisies.length === 0 ? 'Rien de coche' : `${String(choisies.length)} coche${choisies.length > 1 ? 's' : ''} — ${dureeLisible(duree)} — ${String(prix)} EUR`}
                  <br />
          ...
          >
            ...
            <div aria-hidden="true" className="o-w-6 o-shrink-0 md:o-w-12" style={{ width: 'max(1.5rem, calc((100vw - 72rem) / 2 + 1.5rem))' }} />
              ...
              return (
                ...
                >
                  <span className="o-flex o-items-baseline o-justify-between o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                    ...
                    <span className="o-tabular-nums">{dureeLisible(prestation.duree)}</span>
                  </span>

                  <span className="o-block">
                    <LetterSwap as="span" step={40} duration={420} className="o-block o-uppercase o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 800), fontSize: 'clamp(2.5rem, 6vw, 4.5rem)' }}>
                      {prestation.court}
                    </LetterSwap>
                    <span className="o-mt-2 o-block o-text-base o-font-medium">{prestation.nom}</span>
                    <span className="o-mt-3 o-block o-max-w-xs o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">{prestation.detail}</span>
                  </span>

                  <span className="o-flex o-items-end o-justify-between o-gap-4">
                    <span className="o-block">
                      <span className="o-block o-text-3xl o-font-bold o-tabular-nums o-tracking-tighter" style={{ color: encre() }}>
                        {prestation.prix} EUR
                      </span>
                    ...
                    <span
                      ...
                      style={coche ? { ...aplat(), borderColor: 'transparent' } : { borderColor: 'var(--o-theme-line)' }}
                    >
            ...
            >
              <span className="o-block" style={{ ...affiche('m', 800), fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                Puis l heure <span aria-hidden="true">→</span>
              </span>
              <span className="o-mt-3 o-block o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">L agenda de la semaine</span>
            </a>
        ...
        <section
          ...
          style={nuit('zinc')}
        >
          <div aria-hidden="true" className="o-border-b o-border-white-10 o-pb-6 o-text-zinc-500 dark:o-text-zinc-500">
            <Bandeau mots={PRESTATIONS.map((p) => p.court.toUpperCase())} separateur="·" vitesse={38} taille="clamp(1.75rem, 4.5vw, 4rem)" />
          </div>
          ...
          <div className="o-mx-auto o-mt-12 o-grid o-max-w-6xl o-gap-x-10 o-gap-y-8 md:o-grid-cols-12 md:o-mt-16">
            <div className="o-relative o-z-10 o-min-w-0 md:o-col-span-8">
              <p aria-hidden="true" className="o-m-0 o-flex o-items-baseline o-gap-4 o-tabular-nums o-text-zinc-50" style={{ ...affiche('xxl', 800), fontSize: 'clamp(6.5rem, 26vw, 19rem)', lineHeight: 0.78 }}>
                11
                <span className="o-uppercase o-text-zinc-500" style={{ ...affiche('m', 800), fontSize: 'clamp(1.25rem, 4vw, 3rem)' }}>ans</span>
              </p>
              <h2 id="onze-titre" className="o-m-0 o-mt-10 o-max-w-xl o-text-2xl o-font-medium o-leading-snug o-tracking-tight o-text-zinc-100 md:o-text-3xl">
                <span className="o-sr-only">Onze ans. </span>
                Onze ans rue Bergere, trois fauteuils, jamais un quatrieme : personne n est double, et vous non plus.
              </h2>
            </div>
            ...
            <dl className="o-m-0 o-self-end o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400 md:o-col-span-4">
              <div className="o-mb-3 o-border-b o-border-white-10 o-pb-2 o-text-zinc-500">Les heures, peintes sur la vitre</div>
              {HORAIRES.map(([jour, heures]) => (
                <div key={jour} className="o-flex o-justify-between o-gap-4 o-py-1">
                  <dt>{jour}</dt>
                  <dd className="o-m-0 o-tabular-nums" style={heures === 'Ferme' ? { color: 'var(--o-palette-zinc-500)' } : { color: encreSurSombre() }}>{heures}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <div id="fauteuils" className="o-scroll-mt-24" style={{ backgroundColor: 'var(--o-theme-surface)' }}>
          <div className="o-mx-auto o-max-w-6xl o-px-6 o-pb-20 md:o-pb-28" style={{ paddingTop: 'clamp(9rem, 15vw, 13rem)' }}>
            <Chapitre
              indice="(02) — Les fauteuils"
              largeur={4}
              titre={
                <h2 className="o-m-0" style={{ ...affiche('m', 800), fontSize: 'clamp(1.75rem, 4vw, 3.5rem)' }}>
            ...
            >
              <ol className="o-m-0 o-list-none o-border-t o-border-zinc-300 dark:o-border-zinc-700 o-p-0">
                {FAUTEUILS.map((fauteuil, rang) => {
                  ...
                  return (
                    <li key={fauteuil.cle} className="o-border-b o-border-zinc-300 dark:o-border-zinc-700 o-py-8">
                      <Reveal delay={rang * 80}>
                        <div className="o-grid o-gap-x-6 o-gap-y-4 sm:o-grid-cols-12">
                          <div className="o-flex o-items-center o-gap-4 sm:o-col-span-3 sm:o-flex-col sm:o-items-start">
                            <span aria-hidden="true" className="o-tabular-nums o-text-zinc-500 dark:o-text-zinc-500" style={{ ...affiche('l', 300), fontSize: 'clamp(2.75rem, 7vw, 5.5rem)' }}>
                              {String(rang + 1).padStart(2, '0')}
                            </span>
                            <img src={image.src} alt={image.alt} width={96} height={96} loading="lazy" className="o-size-16 o-rounded-full o-object-cover md:o-size-20" />
                          </div>
                          <div className="o-min-w-0 sm:o-col-span-9">
                            <p className="o-m-0 o-flex o-flex-wrap o-items-baseline o-gap-x-4 o-gap-y-1">
                              <span className="o-text-3xl o-font-bold o-tracking-tight md:o-text-4xl">{fauteuil.complet}</span>
                              <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest" style={{ color: encre() }}>{METIERS[fauteuil.cle]?.[0]}</span>
                            </p>
                            <p className="o-m-0 o-mt-3 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">{METIERS[fauteuil.cle]?.[1]}</p>
                            <p className="o-m-0 o-mt-4 o-flex o-flex-wrap o-gap-2">
                              {PRESTATIONS.filter((p) => p.parQui.includes(fauteuil.cle)).map((p) => (
                                <span key={p.cle} className="o-rounded-full o-border-w-1 o-px-3 o-py-1 o-font-mono o-text-xs o-uppercase o-tracking-widest" style={panier.includes(p.cle) ? { ...aplat(), borderColor: 'transparent' } : { borderColor: 'var(--o-theme-line)' }}>
                                  {p.court}
                                </span>
                              ))}
                              {!possible && (
                                <span className="o-self-center o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">— ne fait pas tout le panier</span>
                              )}
                            </p>
                          </div>
                        </div>
        ...
        <section id="agenda" aria-labelledby="agenda-titre" className="o-scroll-mt-24 o-mx-auto o-max-w-6xl o-px-6 o-py-20 md:o-py-28">
          <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
            <div className="md:o-col-span-8">
              <Indice rang="03" sombre={false}>L agenda</Indice>
              <h2 id="agenda-titre" className="o-m-0 o-mt-4 o-max-w-2xl" style={{ ...affiche('m', 800), fontSize: 'clamp(1.75rem, 4vw, 3.5rem)' }}>
            ...
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400 md:o-col-span-4 md:o-text-right">
              Semaine du 10 au 14 septembre<br />La fenetre libre est ecrite sous chaque heure
            </p>
          </div>
          ...
          <div className="o-mt-10 o-grid o-gap-8 lg:o-grid-cols-12 lg:o-gap-10">
            ...
            <div className="o-min-w-0 lg:o-col-span-8">
              <div className="o-overflow-x-auto o-scrollbar dark:o-scrollbar-dark">
                <table className="o-w-full o-text-sm" style={{ minWidth: '38rem', borderCollapse: 'collapse' }}>
                  <caption className="o-sr-only">
                    Creneaux libres par fauteuil et par jour, pour la semaine du 10 au 14 septembre
                  </caption>
                  <thead>
                    <tr className="o-border-b o-border-zinc-900 dark:o-border-zinc-100">
                      <th scope="col" className="o-py-2 o-pr-4 o-text-left o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                        Fauteuil
                      </th>
                      {JOURS.map((jour) => (
                        <th
                  ...
                  <tbody>
                    {FAUTEUILS.map((fauteuil) => {
                      const possible = fauteuilsPossibles.includes(fauteuil.cle)
                      return (
                        <tr key={fauteuil.cle} className="o-border-b o-border-zinc-200 dark:o-border-zinc-800 o-align-top">
                          <th scope="row" className="o-py-3 o-pr-4 o-text-left">
                            <span className="o-block o-font-medium">{fauteuil.nom}</span>
                            <span className="o-block o-text-xs o-text-zinc-500 dark:o-text-zinc-400">
                              {fauteuil.complet}
                            </span>
                            {!possible && (
                              <span className="o-mt-1 o-block o-text-xs" style={{ color: 'var(--o-theme-muted)' }}>
                          ...
                          {JOURS.map((jour) => {
                            ...
                            return (
                              <td key={jour.value} className="o-py-3 o-pr-4">
                                {creneaux.length === 0 ? (
                                  <span className="o-text-xs o-text-zinc-500 dark:o-text-zinc-400">—</span>
                                ) : (
                                  <ul className="o-list-none o-m-0 o-flex o-flex-col o-gap-1.5 o-p-0">
                                    {creneaux.map((creneau) => {
                                      ...
                                      const tient = possible && creneau.fenetre >= duree && duree > 0
                                      const choisi =
                                      ...
                                      return (
                                        <li key={creneau.heure}>
                                          <button
                                            ...
                                            aria-pressed={choisi}
                                            onClick={() => {
                                              setRetenu({ qui: fauteuil.cle, jour: jour.value, heure: creneau.heure })
                                            }}
                                            title={
                                              tient
                                          ...
                                          >
                                            {creneau.heure}
                                            <span className="o-ml-1 o-opacity-70">{creneau.fenetre} min</span>
                                          </button>
                                        </li>
                                      )
                                    })}
              ...
              <p className="o-mt-4 o-max-w-xl o-text-xs o-leading-relaxed o-text-zinc-500 dark:o-text-zinc-400">
                Un creneau trop court reste affiche, grise : c est plus honnete que de le faire disparaitre.
              </p>
            </div>

            {/* ----- Le panier, colle -------------------------------------------- */}
            <aside aria-label="Votre rendez-vous" className="lg:o-col-span-4">
              <div className="o-rounded-2xl o-border-w-1 o-border-zinc-900 dark:o-border-zinc-100 o-p-5 lg:o-sticky" style={{ top: 133 }}>
                ...
                {choisies.length === 0 ? (
                  <p className="o-mt-3 o-text-sm o-text-zinc-600 dark:o-text-zinc-400">
                    Cochez au moins un soin : l agenda s ouvrira sur les creneaux assez longs pour le prendre.
                  </p>
                ) : (
                  <ul className="o-list-none o-m-0 o-mt-3 o-flex o-flex-col o-gap-1.5 o-p-0 o-text-sm">
                    {choisies.map((prestation) => (
                      <li key={prestation.cle} className="o-flex o-items-baseline o-justify-between o-gap-3">
                ...
                {restantes.length > 0 && (
                  <p className="o-m-0 o-mt-4 o-flex o-flex-wrap o-items-center o-gap-1.5">
                    <span className="o-mr-1 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Ajouter</span>
                    {restantes.map((p) => (
                      <button
                        key={p.cle}
                        type="button"
                ...
                {choisies.length > 0 && (
                  <>
                    ...
                    >
                      {retenu === null ? (
                        <span className="o-text-zinc-700 dark:o-text-zinc-300">
                          Choisissez un creneau dans l agenda. Les creneaux grises sont trop courts pour {dureeLisible(duree)}.
                        </span>
                      ) : (
                    ...
                    {retenu !== null && (
                      <button type="button" className="o-mt-3 o-inline-flex o-w-full o-items-center o-justify-center o-gap-2 o-rounded-full o-px-6 o-py-3 o-text-sm o-font-semibold o-transition-transform hover:o-scale-105 focus:o-ring" style={aplat()}>
                        Confirmer ce rendez-vous <Icon icon={ArrowRight} size={16} aria-hidden="true" />
                      </button>
                    )}
                  </>
                )}
                ...
                <dl className="o-m-0 o-mt-5 o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-pt-3">
                  {ANNULATION.map(([quand, regle]) => (
                    <div key={quand} className="o-mt-1.5 o-text-xs o-leading-relaxed">
                      ...
                      <dd className="o-m-0 o-inline o-text-zinc-600 dark:o-text-zinc-400">{regle}</dd>
                    </div>
                  ))}
                </dl>
              </div>
      ...
      <CinematicFooter
        ...
        banner={
          <span className="o-px-8">
            27 rue Bergere, Paris 9e — Metro Grands Boulevards — Mardi au samedi — Jeudi jusqu a 21 h — Carte, especes, cartes cadeaux — Entree de plain-pied
          </span>
        }
        actions={
        ...
        links={
          <nav aria-label="Pied de page" className="o-flex o-flex-wrap o-justify-center o-gap-6 o-text-sm">
            {([
              ['#soins', 'Les soins'],
