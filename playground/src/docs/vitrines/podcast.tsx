...
import { ArrowRight, CalendarDays, Clock, Pause, Play, Quote, Rss, SkipBack, SkipForward } from '@odoro-cli/icons/filaire'
...
import { affiche, BarreCoins, CHROME, Coin, Etiquette, Grain, Indice, Porte, Surgit, usePolices } from './marche.jsx'
...
const PHRASES = ['une conversation par semaine', 'quarante minutes, jamais plus', 'enregistre a Lyon, sans montage', 'cent quatre-vingt-douze episodes']
...
const EPISODES: readonly Episode[] = [
    ...
    chapitres: [
      {
        ...
        extrait: [
          ['Salome Ferrand', 'Le chiffre qu on publie est une moyenne sur vingt-quatre heures. Une rue a soixante decibels de moyenne, ca ne dit rien : elle peut etre a quarante-cinq toute la journee et a quatre-vingt-dix a chaque passage de bus.'],
          ['Onde Courte', 'Et c est le pic qui reveille.'],
          ['Salome Ferrand', 'C est le pic qui reveille, oui. On dort avec un bruit de fond continu, on ne dort pas avec seize evenements par nuit. La moyenne les efface exactement.'],
        ],
      },
      {
        seconde: 875,
        ...
        extrait: [
          ['Salome Ferrand', 'Trois passages : un a six heures, un a quatorze, un a vingt-deux. Vingt minutes chacun, au meme endroit, a un metre cinquante du sol.'],
          ['Onde Courte', 'Pourquoi un metre cinquante ?'],
          ['Salome Ferrand', 'Parce que c est la hauteur d une oreille debout. On mesure ce que les gens entendent, pas ce que la facade recoit. Ce sont deux metiers differents, et on les confond tout le temps.'],
        ],
      },
      {
        seconde: 1780,
        ...
        extrait: [
          ['Salome Ferrand', 'Cent douze logements, livres en 2019, avec une facade certifiee. On a mesure a l interieur : trente-huit decibels la nuit, fenetres fermees. La norme dit trente.'],
          ['Onde Courte', 'Et ensuite ?'],
          ['Salome Ferrand', 'Ensuite rien pendant deux ans, puis un remplacement des vitrages sur la face nord. Ce qui a bouge, ce n est pas notre rapport, c est le fait qu une locataire l a lu et l a apporte a une audience.'],
        ],
      },
      {
        seconde: 2462,
        ...
        extrait: [
          ['Salome Ferrand', 'On sait poser un enrobe qui retire trois decibels. On sait dessiner une cour qui ne renvoie pas. On sait ou mettre les chambres. Rien de tout cela ne coute cher si on le decide avant le permis.'],
          ['Onde Courte', 'Et apres le permis ?'],
          ['Salome Ferrand', 'Apres, ca coute dix fois plus, et on ne le fait pas. C est toute l histoire du metier en une phrase.'],
        ],
      },
    ],
  },
  {
    ...
    dateIso: '2026-08-28',
    duree: 2580,
    resume: 'Il reste trois cents cabines a relais electromecaniques en France, et une poignee de gens qui savent les remettre en marche. Yanis Doucet est l un d eux.',
    chapitres: [
      { seconde: 105, titre: 'Une cabine, un carnet, quarante ans', extrait: [] },
      { seconde: 740, titre: 'Les pieces qu on refait soi-meme', extrait: [] },
      { seconde: 1615, titre: 'Ce que la norme impose, et ce qu elle interdit', extrait: [] },
  ...
  },
  {
    ...
    dateIso: '2026-08-21',
    duree: 3060,
    resume: 'Une cloche se coule une fois : si la note est fausse, on recommence tout. Anne-Claire Bassot raconte le moule en argile, l attente de trois semaines, et la minute ou l on frappe pour savoir.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2026-08-14',
    duree: 2340,
    resume: 'Trois cents micros poses dans les Cevennes, huit mille heures d enregistrement, et un modele qui trie. Mathias Ohl explique ce que la machine entend mieux que lui, et les deux choses qu elle rate toujours.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2026-08-07',
    duree: 2760,
    resume: 'Entre une heure et cinq heures du matin, une ligne automatique appartient a quinze personnes dans une salle sans fenetre. Fatou Berthelot decrit une nuit ordinaire, et les six minutes ou tout se decide.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2026-07-31',
    duree: 2640,
    resume: 'Neuf mois sur un livre qu on trouve mauvais : Pierre Vasseur raconte le metier par son cote le moins glorieux, et pourquoi la fidelite au texte est parfois une forme de politesse.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2025-12-12',
    duree: 2700,
    resume: 'Le dernier phare habite de France tient par deux personnes qui se relaient quinze jours durant. Ozan Kirmizi raconte l eau douce comptee, la lanterne a remonter a la main, et les visiteurs de juillet.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2025-10-24',
    duree: 2460,
    resume: 'Quatre cents moules au catalogue, tous graves a la main entre 1890 et 1960. Solange Petit explique pourquoi on ne redessine pas un lapin, et ce qu il faut savoir pour demouler sans casser.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2025-09-05',
    duree: 2820,
    resume: 'Un poste d aiguillage mecanique de 1937, quarante-deux leviers, et deux cents circulations par jour. Renaud Sisco raconte la memoire qu il faut, et ce qui arrive quand elle flanche.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2024-11-15',
    duree: 2640,
    resume: 'De vingt-trois heures a sept heures, seule, avec un levain qui n attend pas. Nour Belkacem decrit une nuit entiere, minute par minute, et le calcul qu elle refait chaque soir.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2024-09-06',
    duree: 3360,
    resume: 'Deux mille cinq cents tuyaux, dix-huit mois de chantier, et une soufflerie qui date de 1783. Emile Ruff raconte un demontage complet, piece par piece, et l accord final devant une nef vide.',
    chapitres: [
  ...
  },
  {
    ...
    dateIso: '2024-07-12',
    duree: 2280,
    resume: 'Une liaison en morse a tenu jusqu en 1997 sur une ligne de montagne, parce que rien d autre ne passait. Colette Vanier l a entretenue quinze ans, et garde le carnet des derniers messages.',
    chapitres: [
...
const SAISONS: readonly number[] = [...new Set(EPISODES.map((e) => e.saison))].sort((a, b) => b - a)

/** Les invites, par ordre alphabetique. */
const INVITES_TOUS: readonly string[] = [...new Set(EPISODES.map((e) => e.invite))].sort((a, b) => a.localeCompare(b, 'fr'))
...
const INVITES = [
  { nom: 'Salome Ferrand', metier: 'Acousticienne, bureau d etudes Sillage', episode: 'Episode 192', graine: 'onde-salome' },
  { nom: 'Yanis Doucet', metier: 'Ascensoriste, atelier Doucet et fils', episode: 'Episode 191', graine: 'onde-yanis' },
  { nom: 'Anne-Claire Bassot', metier: 'Fondeuse de cloches, Villedieu', episode: 'Episode 190', graine: 'onde-anne' },
  { nom: 'Mathias Ohl', metier: 'Ornithologue, parc des Cevennes', episode: 'Episode 189', graine: 'onde-mathias' },
] as const
...
const ONDE = [22, 48, 34, 72, 56, 88, 41, 63, 96, 52, 30, 74, 45, 68, 28, 82, 59, 37, 91, 44, 66, 25, 78, 50, 35, 70, 42, 86, 31, 60, 47, 75, 26, 64, 39, 83, 54, 29, 71, 46]
...
const COLONNES = [
  { titre: 'L emission', liens: [['#dernier', 'Le dernier episode'], ['#episodes', 'Tous les episodes'], ['#invites', 'Les invites'], ['#dernier', 'Les transcriptions']] },
  { titre: 'Ecouter', liens: [['#plateformes', 'Apple Podcasts'], ['#plateformes', 'Spotify'], ['#plateformes', 'Pocket Casts'], ['#plateformes', 'Flux RSS']] },
  { titre: 'Nous ecrire', liens: [['mailto:bonjour@ondecourte.fr', 'Proposer un invite'], ['#haut', 'Presse'], ['#haut', 'Rediffusion et licence'], ['#haut', 'Mentions legales']] },
] as const
...
function Titre({
  ...
  return (
    <div>
      ...
      <h2 id={id} className="o-m-0 o-mt-5 o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: taille }}>
        {children}
      </h2>
    </div>
  )
...
function Heros(): ReactElement {
  return (
    <header id="haut" className="o-relative o-isolate o-flex o-flex-col o-overflow-hidden o-text-zinc-50" style={{ ...nuit('zinc'), minHeight: `calc(100vh - ${String(CHROME)}px)` }}>
      <AudioBars
        aria-hidden="true"
      ...
      />
      <div aria-hidden="true" className="o-absolute o-inset-0 o-z-0" style={{ background: VOILE_HEROS }} />
      <Grain opacite={0.06} />

      <BarreCoins marque="Onde Courte" liens={NAVIGATION} droite="Chaque vendredi, 7 h — Lyon" />
      ...
      <div className="o-relative o-z-10 o-flex o-grow o-flex-col o-justify-between o-px-6 o-pb-24 o-pt-6 md:o-px-8 md:o-pb-28">
        ...
        <Surgit delai={160} distance={36} className="o-my-10">
          <EchoText as="h1" copies={3} lag={180} spread={1.2} className="o-m-0 o-block o-uppercase o-text-zinc-50" style={{ ...affiche('xxl', 800), fontSize: 'clamp(3.5rem, 16vw, 15rem)', lineHeight: 0.84, letterSpacing: '-0.06em', textWrap: 'balance' }}>
            Onde Courte
          </EchoText>
        </Surgit>

        <div className="o-grid o-items-end o-gap-8 lg:o-grid-cols-12">
          <Surgit delai={420} as="p" className="o-m-0 o-text-xl o-leading-tight md:o-text-2xl lg:o-col-span-6" style={{ color: CLAIR }}>
          ...
          <Surgit delai={520} className="lg:o-col-span-6 lg:o-justify-self-end">
            ...
            >
              <label className="o-block o-grow">
                ...
                <input type="email" name="courriel" autoComplete="email" placeholder="votre@courriel.fr" className="o-w-full o-border-b o-border-white-20 o-bg-transparent o-py-3 o-text-base o-text-zinc-50 focus:o-ring" style={{ borderRadius: 0 }} />
              </label>
              <button type="submit" className="o-inline-flex o-shrink-0 o-cursor-pointer o-items-center o-gap-2 o-rounded-full o-px-6 o-py-3 o-text-sm o-font-semibold o-transition-transform hover:o-scale-105 focus:o-ring" style={{ backgroundColor: CLAIR, color: 'var(--o-palette-zinc-950)' }}>
                Recevoir la lettre <Icon icon={ArrowRight} size={15} aria-hidden="true" />
              </button>
            </form>
            <p className="o-m-0 o-mt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Le vendredi a 7 h : l episode, trois liens, une phrase. Rien d autre.</p>
          </Surgit>
        </div>
      </div>
      <Coin position="bg">Enregistre a Lyon<br />14 rue Duviard</Coin>
      <Coin position="bd">Sans montage, sans publicite<br />Licence CC BY-NC 4.0</Coin>
    </header>
  )
}

/** Un bouton rond du lecteur, secondaire. */
function Rond({ libelle, icone, onClick }: { readonly libelle: string; readonly icone: typeof Play; readonly onClick?: () => void }): ReactElement {
  return (
    <button
      type="button"
      aria-label={libelle}
...
function Dernier(): ReactElement {
  ...
  const courant = [...episode.chapitres].reverse().find((c) => c.seconde <= position) ?? episode.chapitres[0]
  ...
  return (
    <section id="dernier" aria-labelledby="dernier-titre" className="o-scroll-mt-24 o-px-6 o-py-20 md:o-px-8 md:o-py-28">
      <div className="o-mx-auto o-grid o-max-w-7xl o-gap-12 lg:o-grid-cols-12">
        ...
        <div className="lg:o-col-span-5">
          <div className="lg:o-sticky" style={{ top: CHROME + 32 }}>
            <Titre rang="01" surtitre={`Le dernier episode — ${episode.date}`} id="dernier-titre">
              {episode.titre}
            </Titre>
            ...
            <p className="o-m-0 o-mt-6 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300">{episode.resume}</p>

            <div className="o-mt-10 o-border-t o-border-zinc-300 o-pt-6 dark:o-border-zinc-700">
              <div aria-hidden="true" className="o-flex o-h-20 o-items-end o-gap-1 o-overflow-hidden">
                {ONDE.map((hauteur, index) => (
                  <span key={`${String(index)}-${String(hauteur)}`} className="o-w-full o-rounded-full" style={{ height: `${String(hauteur)}%`, backgroundColor: index < remplies ? ENCRE : 'var(--o-theme-line)' }} />
                ))}
              </div>
              ...
              <div className="o-mt-5 o-flex o-flex-wrap o-items-center o-gap-3">
                <button
                  ...
                  aria-label={enLecture ? `Mettre en pause l episode ${String(episode.numero)}` : `Lire l episode ${String(episode.numero)}`}
                  onClick={() => {
        ...
        <div className="lg:o-col-span-7">
          <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400">Les chapitres — choisissez, la lecture s y place</p>
            ...
            {episode.chapitres.map((chapitre, rang) => {
              ...
              return (
                <li key={chapitre.seconde}>
                  ...
                  >
                    <span aria-hidden="true" className="o-col-span-2 o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.5rem, 2.6vw, 2.5rem)' }}>
                      {String(rang + 1).padStart(2, '0')}
                    </span>
                    <span className="o-col-span-10 o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-x-6 o-gap-y-1">
                      <span className={`o-text-lg o-tracking-tight md:o-text-xl ${actif ? 'o-font-medium o-text-zinc-950 dark:o-text-zinc-50' : 'o-text-zinc-800 dark:o-text-zinc-200'}`}>{chapitre.titre}</span>
                      <span className="o-font-mono o-text-xs o-tabular-nums" style={{ color: ENCRE }}>{horloge(chapitre.seconde)}</span>
                    </span>
                  </button>
                </li>
              )
          ...
          {courant !== undefined && courant.extrait.length > 0 && (
            <div className="o-mt-10 o-rounded-2xl o-p-6 md:o-p-8" style={{ backgroundColor: accentDoux(500, 8) }}>
              ...
              <dl className="o-m-0 o-mt-5 o-flex o-flex-col o-gap-5">
                {courant.extrait.map(([qui, quoi]) => (
                  <div key={quoi.slice(0, 40)} className="o-grid o-gap-1 md:o-grid-cols-12 md:o-gap-6">
                    <dt className="o-font-mono o-text-xs o-uppercase o-tracking-wider md:o-col-span-3" style={{ color: ENCRE }}>{qui}</dt>
                    <dd className="o-m-0 o-text-base o-leading-relaxed o-text-zinc-800 dark:o-text-zinc-200 md:o-col-span-9">{quoi}</dd>
                  </div>
                ))}
              </dl>
              <p className="o-m-0 o-mt-6 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400">Transcription integrale en texte brut et en sous-titres, pour chaque episode depuis le numero 120.</p>
            </div>
          )}
        </div>
      </div>
...
function Choix({ id, intitule, valeur, onChange, children }: { readonly id: string; readonly intitule: string; readonly valeur: string; readonly onChange: (valeur: string) => void; readonly children: ReactNode }): ReactElement {
  return (
    <div className="o-flex o-min-w-0 o-flex-col o-gap-1.5">
      <label htmlFor={id} className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400">
        {intitule}
      </label>
      <select
        id={id}
...
function Archives(): ReactElement {
  ...
  const liste = EPISODES.filter((candidat) => (saison === 'toutes' || String(candidat.saison) === saison) && (invite === 'tous' || candidat.invite === invite))
  const episode = liste.find((candidat) => candidat.id === choisi) ?? liste[0]

  return (
    <section id="episodes" aria-labelledby="episodes-titre" className="o-scroll-mt-24 o-border-t o-border-zinc-200 o-bg-zinc-100 o-px-6 o-py-20 dark:o-border-zinc-800 dark:o-bg-zinc-900 md:o-px-8 md:o-py-28">
      <div className="o-mx-auto o-grid o-max-w-7xl o-gap-10 lg:o-grid-cols-12 lg:o-gap-8">
        <div className="lg:o-col-span-4">
          ...
          <p className="o-m-0 o-mt-5 o-max-w-xs o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">Douze episodes sont ici, choisis dans trois saisons ; les autres se trouvent dans le flux. Sans abonnement, sans coupure.</p>
          <div className="o-mt-8 o-flex o-max-w-xs o-flex-col o-gap-4">
            <Choix id="onde-saison" intitule="Saison" valeur={saison} onChange={setSaison}>
            ...
            <Choix id="onde-invite" intitule="Invite" valeur={invite} onChange={setInvite}>
          ...
          <p aria-live="polite" className="o-m-0 o-mt-4 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400">
            {liste.length === 0 ? 'Aucun episode ne repond a ces deux filtres.' : `${String(liste.length)} episode${liste.length > 1 ? 's' : ''} — du plus recent au plus ancien`}
          </p>
        </div>
        ...
        <div className="lg:o-col-span-4">
          {episode !== undefined && (
            ...
            <article className="lg:o-border-l lg:o-pl-8" style={{ borderColor: 'var(--o-theme-line)' }}>
              <span aria-hidden="true" className="o-mb-6 o-block o-h-px o-bg-zinc-300 dark:o-bg-zinc-700 lg:o-hidden" />
              <p className="o-m-0 o-flex o-flex-wrap o-items-center o-gap-x-4 o-gap-y-1 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400">
                <span style={{ color: ENCRE }}>Saison {episode.saison} · episode {episode.numero}</span>
              ...
              <h3 className="o-m-0 o-mt-4 o-text-2xl o-font-medium o-tracking-tight o-text-zinc-950 dark:o-text-zinc-50 md:o-text-3xl">{episode.titre}</h3>
              <p className="o-m-0 o-mt-2 o-text-sm" style={{ color: ENCRE }}>
                {episode.invite} — {episode.metier}
              </p>
              <p className="o-m-0 o-mt-4 o-text-base o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300">{episode.resume}</p>
              <ul className="o-m-0 o-mt-6 o-flex o-list-none o-flex-col o-gap-1.5 o-p-0 o-text-sm">
                {episode.chapitres.map((chapitre) => (
                  <li key={chapitre.seconde} className="o-flex o-gap-4">
                    <span className="o-w-14 o-shrink-0 o-font-mono o-text-xs o-tabular-nums" style={{ color: ENCRE }}>{horloge(chapitre.seconde)}</span>
                    <span className="o-text-zinc-700 dark:o-text-zinc-300">{chapitre.titre}</span>
                  </li>
                ))}
              </ul>
              <a href="#dernier" className="o-mt-6 o-inline-flex o-items-center o-gap-2 o-rounded-full o-px-5 o-py-2.5 o-text-sm o-font-medium o-no-underline o-transition-transform hover:o-scale-105 focus:o-ring" style={PLEIN}>
...
function Invites(): ReactElement {
  return (
    <section id="invites" aria-labelledby="invites-titre" className="o-scroll-mt-24 o-px-6 o-py-20 md:o-px-8 md:o-py-28">
      <div className="o-mx-auto o-max-w-7xl">
        <div className="o-grid o-gap-6 md:o-grid-cols-12 md:o-items-end">
          <div className="md:o-col-span-8">
            <Titre rang="03" surtitre="Qui parle, ce mois-ci" id="invites-titre" taille="clamp(2.25rem, 5.5vw, 5.5rem)">
        ...
        <ol className="o-m-0 o-mt-14 o-list-none o-border-t o-border-zinc-300 o-p-0 dark:o-border-zinc-700 md:o-mt-20">
          {INVITES.map((invite) => {
            ...
            return (
              ...
              >
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest md:o-col-span-2" style={{ color: ENCRE }}>
                  {invite.episode}
                </p>
                <h3 className="o-m-0 o-min-w-0 o-text-zinc-950 dark:o-text-zinc-50 md:o-col-span-6" style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 4vw, 3.75rem)' }}>
                  {invite.nom}
                </h3>
                ...
                />
                <p className="o-m-0 o-text-base o-leading-snug o-text-zinc-600 dark:o-text-zinc-400 md:o-col-span-3 md:o-text-right">{invite.metier}</p>
              </li>
            )
          })}
        </ol>
...
function Plateformes(): ReactElement {
  return (
    <section id="plateformes" aria-labelledby="plateformes-titre" className="o-border-t o-border-zinc-200 o-bg-white o-text-zinc-700 dark:o-border-zinc-800 dark:o-bg-zinc-900 dark:o-text-zinc-300">
      <LogoBand title="Onde Courte s ecoute la ou vous ecoutez deja" speed={34}>
        {PLATEFORMES.map((plateforme) => (
          <span key={plateforme.nom} className="o-inline-flex o-items-center o-whitespace-nowrap o-text-2xl o-font-medium o-tracking-tight">
            {plateforme.nom}
          </span>
        ))}
      </LogoBand>
      <div className="o-mx-auto o-max-w-7xl o-px-6 o-pb-16 md:o-px-8">
        <h2 id="plateformes-titre" className="o-sr-only">Ce que chaque plateforme rend</h2>
        <dl className="o-m-0 o-grid o-gap-x-10 md:o-grid-cols-2 lg:o-grid-cols-3">
          {PLATEFORMES.map((plateforme) => (
            <div key={plateforme.nom} className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-x-4 o-gap-y-1 o-border-t o-border-zinc-200 o-py-3 dark:o-border-zinc-800">
              <dt className="o-text-sm o-font-medium o-text-zinc-900 dark:o-text-zinc-100">{plateforme.nom}</dt>
              <dd className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-wider o-text-zinc-600 dark:o-text-zinc-400">{plateforme.note}</dd>
            </div>
          ))}
        </dl>
        <p className="o-m-0 o-mt-6 o-flex o-max-w-2xl o-items-start o-gap-2 o-text-xs o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
          ...
          Le flux est la source : tout le reste en decoule. Il ne porte aucune balise de mesure — on ne sait pas qui ecoute, et c est voulu.
        </p>
      </div>
    </section>
  )
...
export default function Page(): ReactElement {
  ...
  return (
    <Porte forme="zoom" marque="Onde Courte">
      <div className="o-bg-zinc-50 o-text-zinc-900 dark:o-bg-zinc-950 dark:o-text-zinc-100" style={polices}>
        <Heros />
        ...
        <PiedColle hauteur={470}>
          <footer className="o-flex o-h-full o-flex-col o-justify-between o-px-6 o-pb-6 o-pt-12 o-text-zinc-300 md:o-px-8 md:o-pt-16" style={nuit('zinc')}>
            <div className="o-mx-auto o-grid o-w-full o-max-w-7xl o-gap-10 md:o-grid-cols-12">
              <div className="md:o-col-span-5">
                <p className="o-m-0 o-uppercase o-text-zinc-50" style={{ ...affiche('l', 800), fontSize: 'clamp(2.5rem, 6vw, 5.5rem)', letterSpacing: '-0.06em' }}>
                  Onde Courte
                </p>
                <p className="o-m-0 o-mt-4 o-max-w-xs o-text-sm o-leading-relaxed o-text-zinc-400">Independant depuis 2021, finance par les abonnes et par deux bourses publiques.</p>
              </div>
                  ...
                  <nav key={colonne.titre} aria-label={colonne.titre}>
                    ...
                    <ul className="o-m-0 o-mt-4 o-flex o-list-none o-flex-col o-gap-2 o-p-0">
                      {colonne.liens.map(([href, libelle]) => (
                        <li key={libelle}>
                          <a href={href} className="o-text-sm o-text-zinc-300 o-no-underline o-transition-colors hover:o-text-zinc-50 focus:o-ring">
                            {libelle}
                          </a>
                        </li>
                      ))}
            ...
            <div className="o-mx-auto o-flex o-w-full o-max-w-7xl o-flex-wrap o-items-center o-justify-between o-gap-3 o-border-t o-pt-5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400" style={{ borderColor: FILET }}>
              <p className="o-m-0">© 2026 Onde Courte — 14 rue Duviard, 69004 Lyon — 04 78 29 41 06</p>
