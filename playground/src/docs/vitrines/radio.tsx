...
const NUIT: readonly Case[] = [
  {
    ...
    nom: 'La nuit longue',
    genre: 'musique',
    qui: 'Antenne automatique',
    quoi: 'Six heures sans voix, tirees de la discotheque de l association. Deux mille huit cents titres, aucune repetition dans la meme nuit.',
  },
  {
    debut: 360,
    duree: 60,
    ...
    genre: 'antenne',
    qui: 'Yanis Kerdal',
    quoi: 'Une heure pour se reveiller : la revue des affichages de la ville, la meteo du jour, et un disque toutes les trois minutes.',
  },
]
...
const SOIR: readonly Case[] = [
  {
    ...
    genre: 'musique',
    qui: 'Selim Abkhar',
    quoi: 'Deux heures sans parler par-dessus les morceaux. C est la seule regle de l emission, et elle tient depuis onze ans.',
  },
]

/** Les jours, chacun avec son milieu de journee. */
const JOURS: readonly {
  readonly id: string
    ...
    cases: [
      {
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal local de quinze minutes, puis l invite du matin : un conseil de quartier, une association, un chantier qui traine.',
      },
      {
        debut: 510,
        duree: 150,
        ...
        genre: 'parole',
        qui: 'Noor Hamdi',
        quoi: 'Deux heures et demie de standard ouvert. Le sujet est annonce le vendredi ; les auditeurs arrivent avec le leur.',
      },
      {
        debut: 660,
        duree: 180,
        ...
        genre: 'musique',
        qui: 'Rotation',
        quoi: 'Trois heures de disques choisis par les benevoles, un bac par semaine. Personne ne sait ce qui va sortir.',
      },
      {
        debut: 840,
        duree: 120,
        nom: 'Les heures creuses',
        genre: 'antenne',
        qui: 'Antenne automatique',
        quoi: 'La playlist de la semaine, sans presentation, avec les rendez-vous de l association toutes les demi-heures.',
      },
      {
        debut: 960,
        duree: 120,
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal de dix-huit heures, le point circulation, et la chronique du conseil municipal quand il siege.',
      },
      {
        debut: 1080,
        duree: 180,
        ...
        genre: 'parole',
        qui: 'Les ateliers',
        quoi: 'L emission des ateliers de la radio : lyceens le lundi, groupe d alphabetisation le mercredi, detenus le jeudi.',
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal local de quinze minutes, puis l invite du matin.',
      },
      {
        debut: 510,
        duree: 120,
        ...
        genre: 'parole',
        qui: 'Perrine Vaux',
        quoi: 'Deux heures d entretiens longs, un seul invite, sans montage. On coupe quand la conversation s arrete, pas quand l horloge le dit.',
      },
      {
        debut: 630,
        duree: 210,
        ...
        genre: 'musique',
        qui: 'Rotation',
        quoi: 'Trois heures et demie de disques choisis par les benevoles.',
      },
      {
        debut: 840,
        duree: 120,
        ...
        genre: 'antenne',
        qui: 'Antenne automatique',
        quoi: 'La playlist de la semaine, sans presentation.',
      },
      {
        debut: 960,
        duree: 120,
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal de dix-huit heures et le point circulation.',
      },
      {
        debut: 1080,
        duree: 180,
        ...
        genre: 'musique',
        qui: 'Selim Abkhar',
        quoi: 'Trois heures de scene locale : huit groupes du departement par mois, enregistres au studio de la rue Basse.',
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal local et l invite du matin.',
      },
      {
        debut: 510,
        duree: 120,
        nom: 'Le bocal',
        genre: 'parole',
        qui: 'Atelier des enfants',
        quoi: 'Deux heures tenues par les huit-douze ans du centre social : ils ecrivent, ils enregistrent, ils passent a l antenne le jour meme.',
      },
      {
        debut: 630,
        duree: 210,
      ...
      },
      {
        ...
        genre: 'antenne',
        qui: 'Antenne automatique',
        quoi: 'La playlist de la semaine.',
      },
      {
        debut: 960,
        duree: 120,
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal de dix-huit heures.',
      },
      {
        debut: 1080,
        duree: 180,
        ...
        genre: 'parole',
        qui: 'Les ateliers',
        quoi: 'L emission du groupe d alphabetisation, en trois langues, avec les traductions en direct.',
      },
    ],
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        genre: 'parole',
        qui: 'Noor Hamdi',
        quoi: 'Deux heures et demie de standard ouvert.',
      },
      {
        debut: 660,
        duree: 180,
        ...
        genre: 'musique',
        qui: 'Rotation',
        quoi: 'Trois heures de disques choisis par les benevoles.',
      },
      {
        debut: 840,
        duree: 120,
      ...
      },
      {
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal de dix-huit heures, et le compte rendu du conseil quand il siege.',
      },
      {
        debut: 1080,
        duree: 180,
        nom: 'Parloir',
        genre: 'parole',
        qui: 'Atelier de la maison d arret',
        quoi: 'Enregistre le mardi, diffuse le jeudi : une heure de textes lus, deux heures de disques demandes.',
      },
    ],
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        genre: 'parole',
        qui: 'Perrine Vaux',
        quoi: 'Deux heures d entretiens longs, un seul invite.',
      },
      {
        debut: 630,
        duree: 210,
      ...
      },
      {
        ...
        genre: 'info',
        qui: 'La redaction',
        quoi: 'Le journal de dix-huit heures, et l agenda du week-end en entier.',
      },
      {
        debut: 1080,
        duree: 180,
        nom: 'Plateau du vendredi',
        genre: 'musique',
        qui: 'En public',
        quoi: 'Trois heures en direct du studio, portes ouvertes, trente places assises. On entre par la cour, il faut arriver avant vingt heures.',
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        genre: 'antenne',
        qui: 'En exterieur',
        quoi: 'Trois heures depuis la halle, avec un emetteur portatif : commercants, acheteurs, et le bruit du marche sous la voix.',
      },
      {
        debut: 600,
        duree: 240,
        ...
        genre: 'musique',
        qui: 'Rotation',
        quoi: 'Quatre heures, la plus longue de la semaine, avec deux benevoles a la console.',
      },
      {
        debut: 840,
        duree: 180,
        ...
        genre: 'parole',
        qui: 'Perrine Vaux',
        quoi: 'Ce qui se joue ce soir dans le departement : salles, chapiteaux, bars a concert, et le theatre de ville.',
      },
      {
        debut: 1020,
        duree: 240,
        ...
        genre: 'musique',
        qui: 'Selim Abkhar',
        quoi: 'Quatre heures de scene locale et d enregistrements du studio.',
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        genre: 'antenne',
        qui: 'Antenne automatique',
        quoi: 'Quatre heures de playlist, sans presentation : le dimanche matin, personne n est au studio.',
      },
      {
        debut: 660,
        duree: 120,
        nom: 'Rediffusions',
        genre: 'parole',
        qui: 'La semaine passee',
        quoi: 'Les deux entretiens de la semaine, a la suite, pour qui les a manques.',
      },
      {
        debut: 780,
        duree: 180,
      ...
      },
      {
        ...
        genre: 'musique',
        qui: 'Antenne automatique',
        quoi: 'Cinq heures d une seule selection, annoncee le samedi. La plus ecoutee de la semaine, et celle ou personne ne parle.',
      },
    ],
  },
]
...
const GENRES: Readonly<
  Record<Case['genre'], { readonly nom: string; readonly part: number }>
> = {
...
const EMETTEURS: readonly (readonly [
  frequence: number,
  lieu: string,
  puissance: string,
])[] = [
        ...
        <div className="o-relative o-pb-24 o-pt-16">
          ...
          {EMETTEURS.map(([frequence, lieu, puissance]) => (
            <div
              ...
              style={{
                left: `${String(place(frequence))}%`,
                transform: 'translateX(-50%)',
              }}
            >
              <p
                className="o-m-0 o-whitespace-nowrap o-text-center o-tabular-nums"
                style={{
                  ...affiche('m', 700),
              ...
              <span
                aria-hidden="true"
                className="o-mx-auto o-mt-2 o-block o-w-px"
                style={{ height: 22, backgroundColor: accent(400) }}
              />
            </div>
          ))}
            ...
            {graduations.map((trait) => (
              <span
                ...
                style={{
                  ...
                  backgroundColor: trait.haute
                    ? 'var(--o-palette-zinc-300)'
          ...
          {Array.from({ length: 13 }, (_, rang) => rang * 2).map((h) => (
            <span
              ...
              style={{
                ...
                transform: h === 24 ? 'translateX(-100%)' : 'translateX(0)',
              }}
            >
        ...
        <div className="o-relative o-flex o-h-20 o-gap-px">
          {cases.map((creneau) => {
            ...
            return (
              ...
              >
                <span className="o-block o-truncate o-font-mono o-text-xs o-uppercase o-tracking-widest">
                  {creneau.nom}
                </span>
                <span className="o-mt-1 o-block o-truncate o-font-mono o-text-xs o-tabular-nums o-opacity-70">
                  {heure(creneau.debut)}
                </span>
              </button>
            )
          ...
          {minute >= 0 && (
            <span
              ...
              style={{
                left: `${String((minute / 1440) * 100)}%`,
                backgroundColor: 'var(--o-palette-zinc-50)',
              }}
            >
              <span
                className="o-absolute o-left-0 o-top-0 o-block o-size-2 o-rounded-full"
                style={{
                  backgroundColor: 'var(--o-palette-zinc-50)',
...
export default function Page(): ReactElement {
  ...
  const enCours = useMemo(() => {
    ...
    return (
      dujour.find(
        (creneau) =>
          minuteCourante >= creneau.debut &&
          minuteCourante < creneau.debut + creneau.duree,
      ) ?? dujour[0]
    )
  ...
  const avance =
    enCours === undefined ? 0 : ((minuteCourante - enCours.debut) / enCours.duree) * 100
      ...
      <div className="o-relative" style={{ ...nuit('zinc'), ...polices }}>
        ...
        >
          ...
          <div
            ...
            className="o-absolute o-inset-0 o-z-0"
            style={{
              background: `linear-gradient(180deg, var(--o-palette-zinc-950) 4%, transparent 42%, var(--o-palette-zinc-950) 92%)`,
            }}
          />
          <Grain opacite={0.08} />
          ...
          <div className="o-relative o-z-20 o-flex o-grow o-flex-col o-justify-between o-gap-8 o-px-6 o-pb-10 md:o-px-10">
            ...
            <h1
              ...
              style={{
                ...affiche('xxl', 400),
                fontSize: 'clamp(3rem, 17vw, 17rem)',
                lineHeight: 0.8,
            ...
            <div className="o-grid o-items-end o-gap-8 md:o-grid-cols-12">
              <Surgit delai={420} className="md:o-col-span-5">
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `inset 0 0 0 1px ${accentDoux(300, 26)}`,
                  }}
                >
                  <p
                  ...
                  <span
                    aria-hidden="true"
                    className="o-mt-5 o-block o-h-1 o-w-full"
                    style={{ backgroundColor: accentDoux(300, 20) }}
                  >
                    <span
              ...
              <Surgit
                delai={520}
                as="p"
                className="o-m-0 o-text-base o-leading-relaxed o-text-zinc-300 md:o-col-span-4"
              >
                Vingt-quatre heures sur vingt-quatre depuis 1987, sans publicite, avec
                quarante benevoles et deux salaries.
              </Surgit>
        ...
        <div
          className="o-overflow-hidden o-border-t o-border-b o-border-white-10 o-py-5"
          style={{ backgroundColor: accentDoux(950, 60) }}
        >
          <Bandeau
            mots={[
              'Table ouverte',
        ...
        <main>
            ...
            <div className="o-mx-auto o-max-w-6xl">
              ...
              <div className="o-mt-10 o-flex o-flex-wrap o-items-center o-justify-between o-gap-4">
                ...
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
                  {jour === aujourdhui
                    ? `Aujourd hui — ${heure(minuteCourante)}`
                    : 'Le curseur ne marque que le jour en cours'}
                </p>
              </div>
              ...
              <div className="o-mt-8">
                <Bande
                  ...
                  choisie={choisie}
                  choisir={setChoisie}
                  minute={jour === aujourdhui ? minuteCourante : -1}
                />
              </div>
              ...
              <ul className="o-m-0 o-mt-5 o-flex o-list-none o-flex-wrap o-gap-x-6 o-gap-y-2 o-p-0">
                {(Object.keys(GENRES) as Case['genre'][]).map((genre) => (
                  ...
                  >
                    <span
                      aria-hidden="true"
                      className="o-block o-size-3"
                      style={{ backgroundColor: habit(genre).backgroundColor }}
                    />
                    {GENRES[genre].nom}
                  </li>
                ))}
                ...
                <div className="o-mt-10 o-grid o-gap-8 o-border-t o-border-white-10 o-pt-10 md:o-grid-cols-12">
                  <div className="o-min-w-0 md:o-col-span-7">
                    <p
                      ...
                      style={{ color: encreSurSombre() }}
                    >
                      {heure(fiche.debut)} — {heure(fiche.debut + fiche.duree)} ·{' '}
                      {GENRES[fiche.genre].nom}
                    </p>
                    <h3
                      className="o-m-0 o-mt-4 o-text-zinc-50"
                      style={{
                    ...
                    >
                      {reduced ? (
                        ...
                        <GlitchHover intensity={5}>{fiche.nom}</GlitchHover>
                      )}
                    </h3>
                    <p className="o-m-0 o-mt-5 o-max-w-2xl o-text-base o-leading-relaxed o-text-zinc-300">
                      {fiche.quoi}
                    </p>
                  </div>
                  <dl className="o-m-0 o-min-w-0 md:o-col-span-5">
                    {[
                      ...
                      [
                        'Duree',
                        `${String(Math.floor(fiche.duree / 60))} h ${String(fiche.duree % 60).padStart(2, '0')}`,
                      ],
                      ['Genre', GENRES[fiche.genre].nom],
                      [
                        'Rediffusion',
                        fiche.genre === 'parole' ? 'Dimanche, 11 h' : 'Aucune',
                      ],
                    ].map(([quoi, valeur]) => (
                      <div
                        key={quoi}
                      ...
                      >
                        ...
                        <dd className="o-m-0 o-text-right o-font-mono o-text-xs o-text-zinc-100">
                          {valeur}
                        </dd>
                      </div>
                    ))}
          ...
          <section
            id="bande"
            className="o-scroll-mt-24 o-px-6 o-py-20 md:o-px-10 md:o-py-28"
            style={{ backgroundColor: accentDoux(950, 74) }}
          >
            <div className="o-mx-auto o-max-w-6xl">
              <Reveal>
              ...
              <p className="o-m-0 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-300">
                Le relais du Haut-du-Lievre porte jusqu a vingt-deux kilometres par temps
                clair. Au-dela, il reste le flux : il part du meme studio, avec une
                seconde de retard.
              </p>
            </div>
          </section>
            ...
            <div className="o-mx-auto o-grid o-max-w-6xl o-gap-10 md:o-grid-cols-12">
              ...
              <ol className="o-m-0 o-min-w-0 o-list-none o-border-t o-border-white-10 o-p-0 md:o-col-span-7">
                {[
                  [
                    'Le studio A',
                    'Direct, six micros, une baie vitree sur la cour. C est de la que part tout ce qui est en direct.',
                  ],
                  [
                    'Le studio B',
                    'Montage et enregistrement. Deux personnes en meme temps, pas trois : la piece fait neuf metres carres.',
                  ],
                  [
                    'La discotheque',
                    'Quatre mille disques, classes par annee d entree dans la maison. Rien n est jete, meme ce qu on ne passe plus.',
                  ],
                  [
                    'L atelier',
                    'Le mercredi et le jeudi, pour ceux qui n ont jamais tenu un micro. On sort avec une emission montee.',
                  ],
                ].map(([nom, texte], rang) => (
                  <li
                    key={nom}
                    className="o-grid o-gap-3 o-border-b o-border-white-10 o-py-6 md:o-grid-cols-12 md:o-gap-6"
                  >
                    <span
                      aria-hidden="true"
          ...
          >
            <div className="o-mx-auto o-max-w-4xl">
              ...
              <p className="o-m-0 o-mt-6 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-300">
                Choisissez pourquoi vous ecrivez. Nous avons redige le reste : il n y a
                plus qu a l envoyer, et a signer.
              </p>
                    ...
                    style={
                      candidat.id === intention
                        ...
                        : {
                            ...
                            border: `1px solid ${accentDoux(300, 30)}`,
                          }
                    }
                  >
                    {candidat.label}
              ...
              {message !== undefined && (
                ...
                >
                  ...
                  <p
                    className="o-m-0 o-whitespace-pre-line o-px-6 o-py-7 o-text-base o-leading-relaxed o-text-zinc-100"
                    aria-live="polite"
                  >
                    {message.corps}
                  </p>
        ...
        <footer className="o-border-t o-border-white-10 o-px-6 o-py-14 md:o-px-10">
            ...
            <p className="o-m-0 o-text-zinc-400">
              {[
                ...
                <a
                  key={mot}
                  href={cible}
                  className="o-block o-text-zinc-300 o-no-underline hover:o-text-zinc-50 focus:o-ring"
                >
                  {mot}
                </a>
              ))}
          ...
          <p className="o-mx-auto o-mt-12 o-max-w-6xl o-border-t o-border-white-10 o-pt-5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500">
            © 2026 BANDE FM — AUTORISATION ARCOM 2024-118 — SANS PUBLICITE — 212 ADHERENTS
            — DERNIERE MISE A JOUR DE LA GRILLE : 1ER SEPTEMBRE 2026
          </p>
        </footer>
      </div>
    </Porte>
