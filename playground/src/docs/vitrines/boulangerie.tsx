...
import { ArrowDown, ArrowUpRight, Wheat } from '@odoro-cli/icons/outline'
import {
  useEffect,
  useMemo,
  useState,
...
function sortisDepuis(minute: number): number {
  return FOURNEES.reduce(
    (somme, f) => (minute >= f.sortie ? somme + f.quantite : somme),
    0,
  )
}
...
function Boule(): ReactElement {
  return (
    ...
    >
      ...
      />
      <path
        d="M44 66c22 12 90 12 112 0M44 134c22-12 90-12 112 0"
        stroke={accent(700)}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M66 44c12 22 12 90 0 112M134 44c-12 22-12 90 0 112"
        stroke={accent(700)}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M100 26c-14 22-14 126 0 148"
        stroke={accent(600)}
        strokeWidth="1.4"
        opacity="0.7"
      />
  ...
  return (
    ...
    >
      ...
      {[62, 100, 138, 176, 212].map((x) => (
        <path
          key={x}
          d={`M${String(x)} 30 ${String(x - 20)} 60`}
          stroke={accent(700)}
          strokeWidth="3"
          strokeLinecap="round"
        />
...
function Batard(): ReactElement {
  return (
    ...
    >
      ...
      />
      <path
        d="M46 52c34-12 94-12 128 0"
        stroke={accent(800)}
        strokeWidth="3.5"
        strokeLinecap="round"
      />
      <path
        d="M58 74c30 8 74 8 104 0"
        stroke={accent(700)}
        strokeWidth="1.4"
        opacity="0.6"
      />
...
function Rouleaux({
  ...
  return (
    <span
      className="o-inline-flex o-items-stretch o-gap-1.5"
      role="img"
      aria-label={`${String(valeur)} pains sortis du four`}
    >
        ...
        return (
          <span
            ...
            style={{
              ...
              boxShadow:
                'inset 0 8px 12px -8px rgba(0,0,0,0.9), inset 0 -8px 12px -8px rgba(0,0,0,0.9)',
            }}
          >
            <span
              className="o-block"
              style={{
                ...
                transition: reduced
                  ? undefined
                  : `transform 1600ms cubic-bezier(0.16, 1, 0.3, 1) ${String(retard)}ms`,
              }}
            >
...
function habitEtat(etat: Etat): CSSProperties {
  ...
  if (etat === 'sur la planche')
    return { backgroundColor: accentDoux(400, 58), color: 'var(--o-theme-fg)' }
  if (etat === 'parti')
    return { backgroundColor: 'var(--o-theme-surface)', color: 'var(--o-theme-muted)' }
...
function motEtat(f: Fournee, minute: number): string {
  ...
  if (etat === 'sur la planche')
    return `sur la planche, il en reste ${String(reste(f, minute))}`
...
const JOURNEE = [
  {
    date: '03 h 40',
    title: 'Le petrin tourne',
    body: 'Farine, eau de source a 13 degres, sel de Guerande, levain chef preleve la veille. Aucune levure.',
  },
  {
    date: '04 h 10',
    title: 'Pointage',
    body: 'La pate repose en bac, a 24 degres. Deux rabats a vingt minutes d intervalle, et plus rien.',
  },
  {
    date: '05 h 20',
    title: 'Faconnage',
    body: 'Division a la main a 350 grammes, mise en forme, mise en banneton. Le peseur n a jamais servi.',
  },
  {
    date: '06 h 15',
    title: 'Premiere fournee',
    body: 'Le four a sole est a 250 degres depuis 5 h. Cent vingt traditions, vingt-deux minutes, buee a l enfournement.',
  },
  {
    date: '11 h 00',
    title: 'Les pains longs',
    body: 'Seigle et noix, pousse de vingt heures, cuisson de cinquante minutes a four tombant.',
  },
  {
    date: '16 h 00',
    title: 'Le petit epeautre',
    body: 'Vingt-huit pieces, faconnees a 14 h pendant que la boutique respire.',
  },
  {
    date: '19 h 30',
    title: 'On eteint',
    body: 'Ce qui reste part chez Le Carillon. Le levain est rafraichi, et on recommence.',
  },
] as const
  ...
  return (
    <figure className="o-m-0 o-flex o-flex-col o-items-center o-gap-4">
      <svg
        ...
        style={{ maxWidth: 260 }}
        role="img"
        aria-label={`Il est ${lu} a la boutique`}
      >
        <circle
          cx="120"
          cy="120"
...
export default function Page(): ReactElement {
  ...
  const prochaine = useMemo(() => {
    const encoreLa = FOURNEES.find(
      (f) => etatDe(f, minute) === 'au four' || etatDe(f, minute) === 'sur la planche',
    )
  ...
  const fiche = suitHorloge
    ? prochaine
    : (FOURNEES.find((f) => f.cle === choisie) ?? prochaine)
  ...
  const aSortir = useMemo(() => {
    ...
    return uniques.length >= 2
      ? uniques
      : ['Tradition', 'Campagne au levain', 'Petit epeautre']
  }, [minute])

  /** Ce qui sera sur la planche au creneau choisi. */
  const planche = useMemo(
    () =>
      FOURNEES.filter((f) => etatDe(f, creneau) === 'sur la planche').map((f) => ({
        f,
        reste: reste(f, creneau),
      })),
    [creneau],
  )
      ...
      <div className="o-relative o-overflow-hidden" style={{ ...polices, ...kraft(9) }}>
        ...
        */}
        ...
        >
          <div
            aria-hidden="true"
            className="o-absolute o-inset-0 o-z-0 o-text-stone-700 dark:o-text-stone-200"
          >
          ...
          <div className="o-relative o-z-10 o-mx-auto o-grid o-w-full o-max-w-7xl o-grow o-gap-10 o-px-6 o-pb-16 o-pt-12 md:o-grid-cols-12 md:o-items-center md:o-px-10">
            <div className="md:o-col-span-7">
              <Surgit>
                <Etiquette sombre={false}>
                  Rue Brochant, Paris 17 — le petrin tourne a 3 h 40
                </Etiquette>
              </Surgit>
              <TitreVague
                delai={120}
              ...
              >
                Sept fournees par jour, et l heure de chacune est ecrite. Quand il n y en
                a plus, il n y en a plus : nous ne recuisons rien a seize heures pour
                faire joli en vitrine.
              </Surgit>
            ...
            <div className="o-relative o-min-w-0 md:o-col-span-5 md:o-pb-28">
              <Flotte
                ...
                duree={9}
                angle={-4}
                className="o-mx-auto o-w-2/3 md:o-w-full"
              >
                <Boule />
              </Flotte>
              <Flotte
              ...
              <Flotte
                ...
                delai={-4}
                angle={-3}
                className="o-mx-auto o-mt-4 o-w-4/5"
              >
                <Batard />
              </Flotte>
              ...
              <Surgit
                delai={820}
                className="o-relative o-z-20 o-mt-8 md:o-absolute md:o-bottom-0 md:o-left-0 md:o-mt-0 md:o-w-72"
              >
                <GlareHover
                ...
                >
                  <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
                    {etatDe(prochaine, minute) === 'sur la planche'
                      ? 'En vitrine maintenant'
                      : 'La prochaine fournee'}
                  </p>
                  ...
                  <p className="o-m-0 o-mt-2 o-text-sm o-text-stone-700 dark:o-text-stone-300">
                    {motEtat(prochaine, minute)}
                  </p>
                  <p
                    className="o-m-0 o-mt-4 o-border-t o-border-stone-200 o-pt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest dark:o-border-stone-800"
                    style={{ color: encre() }}
                  >
          ...
          <div className="o-mx-auto o-max-w-7xl">
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              ...
              <p className="o-m-0 o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300 md:o-col-span-5">
                Le ruban est la journee entiere. Le trait est votre heure. Chaque barre
                commence a l enfournement et finit quand la fournee est ecoulee, au debit
                reel du comptoir.
              </p>
            </div>
            ...
            <div className="o-mt-12 o-grid o-gap-10 md:o-grid-cols-12">
                ...
                <dl className="o-m-0 o-mt-8 o-border-t o-border-stone-300 dark:o-border-stone-700">
                  {(
                    [
                      ...
                      [
                        'Quantite',
                        `${String(fiche.quantite)} pieces, ecoulees en ${String(ecoulement(fiche))} minutes`,
                      ],
                      ['Prix', fiche.prix],
                    ] as const
                  ).map(([quoi, valeur]) => (
                    <div
                      key={quoi}
                      className="o-grid o-gap-x-6 o-gap-y-1 o-border-b o-border-stone-300 o-py-4 dark:o-border-stone-700 sm:o-grid-cols-12"
                    >
                      <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400 sm:o-col-span-3">
                        {quoi}
                      </dt>
                      <dd className="o-m-0 o-text-sm o-leading-relaxed o-text-stone-800 dark:o-text-stone-200 sm:o-col-span-9">
                        {valeur}
                      </dd>
                    </div>
                  ))}
              ...
              <div className="o-min-w-0 md:o-col-span-5">
                <div
                  className="o-rounded-2xl o-border-w-1 o-border-stone-300 o-p-6 dark:o-border-stone-700"
                  style={kraft(16)}
                >
                  ...
                  <p className="o-m-0 o-mt-6 o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300">
                    Les fournees a venir se relaient ici jusqu a la derniere tradition de
                    17 h 30. Apres elle, le four s eteint.
                  </p>
        ...
        */}
        <section
          id="levain"
          className="o-relative o-z-10 o-scroll-mt-24 o-flex o-items-center o-border-t o-border-b o-border-stone-300 o-px-6 o-py-24 dark:o-border-stone-700 md:o-px-10 md:o-py-36"
          style={{
            backgroundColor: 'var(--o-theme-bg)',
            minHeight: `calc(0.72 * ${ECRAN})`,
          }}
        >
          <div className="o-mx-auto o-w-full o-max-w-7xl">
            <Manifeste
              eteint="Un levain, c est une colonie qu on nourrit tous les jours et qu on ne possede pas."
              sombre={false}
            >
              Le notre a ete lance en 1997 par la mere de Salome, avec de la farine et de
              l eau. Il n a pas manque un rafraichi depuis.
            </Manifeste>
          </div>
        </section>
          ...
          <div className="o-mx-auto o-grid o-max-w-7xl o-gap-12 md:o-grid-cols-12">
            <div className="md:o-col-span-4">
              ...
              <p className="o-mt-5 o-max-w-sm o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300">
                Deux personnes au fournil, une au comptoir. Rien n est congele, rien n est
                livre : ce qui est en vitrine a ete petri dans la piece d a cote.
              </p>
              <p
        ...
        >
          ...
          <div className="o-relative o-mx-auto o-flex o-max-w-7xl o-flex-col o-items-center o-gap-8 o-text-center">
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-400">
              {nuitBlanche
                ? 'Pains sortis du four hier'
                : 'Pains sortis du four depuis 4 h 10'}
            </p>
          ...
          <div className="o-mx-auto o-max-w-7xl">
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              ...
              <p className="o-m-0 o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300 md:o-col-span-4 md:o-text-right">
                Un creneau de trente minutes, six pains au plus. Les creneaux barres sont
                deja pris.
              </p>
            </div>
                  ...
                  return (
                    <li key={c}>
                      ...
                      >
                        <span
                          aria-hidden="true"
                          className="o-h-4 o-w-px"
                          style={{
                            backgroundColor: 'currentColor',
                            opacity: pleine ? 0.8 : 0.3,
                          }}
                        />
                        {enHeure(c)}
                      </button>
              ...
              <div className="md:o-col-span-7">
                ...
                {planche.length === 0 ? (
                  <p className="o-m-0 o-mt-5 o-max-w-lg o-text-lg o-leading-relaxed o-text-stone-800 dark:o-text-stone-200">
                    Rien ne sera sorti a cette heure-la. C est le creux entre deux
                    fournees : prenez le creneau suivant, ou celui d avant.
                  </p>
                ) : (
                  <ul
                    aria-live="polite"
                    className="o-m-0 o-mt-5 o-list-none o-border-t o-border-stone-300 o-p-0 dark:o-border-stone-700"
                  >
                    {planche.map(({ f, reste: restant }) => (
                      <li
                        key={f.cle}
                        className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-4 o-border-b o-border-stone-300 o-py-4 dark:o-border-stone-700"
                      >
                        <span className="o-text-lg o-font-semibold o-tracking-tight o-text-stone-900 dark:o-text-stone-50">
                          {f.nom}
                        </span>
                        <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-600 dark:o-text-stone-300">
                          sorti a {enHeure(f.sortie)} —{' '}
                          {restant === 0 ? 'epuise' : `environ ${String(restant)} pieces`}
                        </span>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="o-min-w-0 md:o-col-span-5">
                ...
                >
                  <p className="o-m-0 o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300">
                    Le creneau se confirme par telephone ; nous ecrivons votre nom sur le
                    carnet et le pain vous attend sur la planche du haut.
                  </p>
                  <a
        ...
        */}
        <footer
          className="o-relative o-z-10 o-px-6 o-py-20 md:o-px-10 md:o-py-24"
          style={nuit('stone')}
        >
          <div className="o-mx-auto o-grid o-max-w-4xl o-items-center o-gap-12 md:o-grid-cols-2">
            ...
            <address className="o-not-italic">
              <p
                ...
                style={{ ...affiche('m', 800), fontSize: 'clamp(1.75rem, 3.6vw, 3rem)' }}
              >
                Levain
              </p>
