...
const FORMULES: readonly Formule[] = [
  {
    ...
    base: 42,
    resume:
      'Le minimum exigible par un bail commercial : les murs, un peu de contenu, la responsabilite.',
    garanties: {
  ...
  },
  {
    ...
    base: 78,
    resume:
      'La formule que nous proposons neuf fois sur dix : le contenu au bon niveau, et les pertes d exploitation entamees.',
    garanties: {
  ...
  },
  {
    ...
    base: 134,
    resume:
      'Pour une maison dont l arret coute plus cher que les murs : les pertes d exploitation en entier.',
    garanties: {
...
const SINISTRES: readonly Sinistre[] = [
  {
    ...
    lecon:
      'Le contenu, seul, depasse le plafond du Socle. C est le sinistre le plus courant, et celui ou la formule minimale se voit le plus.',
    postes: [
      {
        famille: 'batiment',
        detail: 'Plafond, cloisons, sol de la reserve',
        montant: 18400,
      },
      {
        famille: 'contenu',
        detail: 'Marchandises, mobilier, deux vitrines',
        montant: 31200,
      },
  ...
  },
  {
    ...
    lecon:
      'Ici ce n est pas le materiel qui coute le plus : c est l arret. Une formule sans pertes d exploitation laisse passer les deux tiers de la facture.',
    postes: [
      { famille: 'contenu', detail: 'Four de production, remplacement', montant: 46700 },
      {
        famille: 'exploitation',
        detail: 'Dix-neuf jours, dont neuf sous-traites',
        montant: 22300,
      },
      {
        famille: 'expertise',
        detail: 'Expertise technique du constructeur',
        montant: 2100,
      },
    ],
  },
  {
    ...
    lecon:
      'Le seul poste ou le plafond du Socle ne suffit pas d un facteur voisin de un : il s en faut de trente-sept mille euros, payables par la maison.',
    postes: [
      {
        famille: 'responsabilite',
        detail: 'Indemnisation transactionnelle',
        montant: 187000,
      },
      {
        famille: 'expertise',
        detail: 'Avocat, expertise medicale, frais',
        montant: 4600,
      },
    ],
  },
...
function compter(
  sinistre: Sinistre,
  formule: Formule,
): { total: number; couvert: number; reste: number } {
  const total = sinistre.postes.reduce((somme, poste) => somme + poste.montant, 0)
  const pris = sinistre.postes.reduce(
    (somme, poste) => somme + couvert(poste, formule),
    0,
  )
...
function CarteSinistre({
  sinistre,
  choisie,
}: {
  readonly sinistre: Sinistre
  readonly choisie: Formule
}): ReactElement {
  ...
  return (
    <div
      className="o-overflow-hidden o-rounded-2xl o-bg-white o-p-7 dark:o-bg-slate-900 md:o-p-10"
    ...
    >
      <div className="o-grid o-gap-10 lg:o-grid-cols-12">
        ...
        <div className="o-min-w-0 lg:o-col-span-4">
          ...
          <h3 className="o-m-0 o-mt-3 o-text-3xl o-font-medium o-tracking-tight o-text-slate-950 dark:o-text-slate-50">
            {sinistre.titre}
          </h3>
          <p className="o-mt-5 o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
            {sinistre.recit}
          </p>
          ...
          <p
            className="o-m-0 o-mt-2 o-tabular-nums o-text-slate-950 dark:o-text-slate-50"
          ...
          <p
            className={`o-m-0 o-mt-7 o-pt-4 ${NOTE}`}
            style={{
              borderTop: `2px solid ${semantique('--o-palette-rose-600')}`,
              color: semantique('--o-palette-rose-600'),
            }}
          >
          ...
          <p className={`o-m-0 o-mt-3 ${NOTE}`}>
            Franchise de {EURO.format(choisie.franchise)} € comprise
          </p>
        </div>
        ...
        <div className="o-min-w-0 lg:o-col-span-8">
          ...
          */}
          <div className="o-min-w-0 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
            ...
            >
              <caption className={`o-pb-4 o-text-left ${NOTE}`}>
                Ce que chaque formule prend en charge, poste par poste
              </caption>
              <thead>
                <tr>
                  <th
                    scope="col"
                    className={`o-px-2 o-py-3 o-text-left o-font-normal ${NOTE}`}
                  ...
                  {FORMULES.map((formule) => (
                    <th
                      ...
                      style={{
                        ...
                        backgroundColor:
                          formule.cle === choisie.cle ? accentDoux(400, 12) : undefined,
                      }}
                    >
                      {formule.nom}
                    </th>
              ...
              <tbody>
                {sinistre.postes.map((poste) => (
                  <tr key={poste.famille}>
                    <th
                      scope="row"
                      className="o-px-2 o-py-3 o-text-left o-font-normal"
                      style={{ borderBottom: `1px solid ${FILET}` }}
                    >
                      <span className="o-block o-text-slate-950 dark:o-text-slate-50">
                        {FAMILLES[poste.famille]}
                      </span>
                ...
                <tr>
                  <th
                    scope="row"
                    className={`o-px-2 o-py-4 o-text-left o-font-normal ${NOTE}`}
                    style={{ borderBottom: `1px solid ${FILET_FORT}` }}
                  >
...
function PlanCote(): ReactElement {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Plan cote du local d exemple"
      className="o-w-full"
      style={{ minWidth: 640 }}
    >
      ...
      <path
        d="M240 360h58M240 360a58 58 0 0 0 58-58"
        fill="none"
        stroke={encreAccent}
        strokeWidth="2"
      />
      ...
      />
      <path
        d="M128 387l-8 5 8 5M712 387l8 5-8 5"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M83 88l5-8 5 8M83 352l5 8 5-8"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      ...
      */}
      ...
      ).map(([x1, y1, x2, y2, valeur, quoi, ancre]) => (
        <g key={valeur}>
...
const CURSEURS: readonly {
  ...
  {
    cle: 'contenu',
    intitule: 'Contenu assure',
    unite: 'k€',
    min: 20,
    max: 400,
    pas: 5,
    depart: 96,
    aide: 'Materiel, marchandises, amenagements : leur valeur de remplacement',
  },
  {
    cle: 'franchise',
    intitule: 'Franchise choisie',
    unite: '€',
    min: 150,
    max: 2000,
    pas: 50,
    depart: 600,
    aide: 'Ce qui reste a votre charge a chaque sinistre, quel qu il soit',
  },
  {
    cle: 'chiffre',
    ...
    pas: 20,
    depart: 620,
    aide: 'Il sert a calculer les pertes d exploitation, pas a vous faire payer plus',
  },
]
...
function cotisation(
  ...
  return Math.round(
    (base + 0.42 * contenu + 0.11 * chiffre) * coefficientFranchise(franchise),
  )
}
...
export default function Page(): ReactElement {
  ...
  const [valeurs, setValeurs] = useState<
    Record<'contenu' | 'franchise' | 'chiffre', number>
  >({ contenu: 96, franchise: 600, chiffre: 620 })
  ...
  const total = useMemo(
    () =>
      choisie === undefined
        ? 0
        : cotisation(choisie.base, valeurs.contenu, valeurs.chiffre, valeurs.franchise),
    [choisie, valeurs],
  )
  ...
  return (
    <Porte forme="iris" marque="Franchise" sombre={false}>
      <div
        className="o-bg-white dark:o-bg-slate-950 o-text-slate-800 dark:o-text-slate-200"
        style={polices}
      >
        {/*
        ...
        */}
        <div id="haut" className="o-relative">
          <BarreFilet
            marque="Franchise"
            liens={NAVIGATION}
            action={['#devis', 'Chiffrer un contrat']}
            sombre={false}
          />
          ...
          */}
          ...
          >
            <div className="o-grid o-gap-10 md:o-grid-cols-12">
              <div className="o-min-w-0 md:o-col-span-8">
                <Surgit>
                  <Etiquette sombre={false}>
                    Courtier en assurance des professionnels — ORIAS 12 004 118
                  </Etiquette>
                </Surgit>
                <TitreVague
                  delai={130}
                  ...
                  style={{
                    ...affiche('l', 300),
                    fontSize: 'clamp(2.5rem, 6.2vw, 6.5rem)',
                  }}
                >
              ...
              <Surgit
                delai={440}
                className="o-flex o-flex-col o-justify-end o-gap-7 md:o-col-span-4"
              >
                <p className="o-m-0 o-text-base o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
                  Trois sinistres reels, leur facture poste par poste, et ce que chacune
                  de nos trois formules laisse a votre charge. Le tableau de garanties
                  vient apres, et il se lit tout seul.
                </p>
                <Actions
                  sombre={false}
                  pleine={[
            ...
            <Surgit delai={620}>
              <div
                className="o-grid o-gap-px md:o-grid-cols-3"
                style={{ backgroundColor: FILET, borderTop: `1px solid ${FILET_FORT}` }}
              >
                {SINISTRES.map((sinistre) => {
                  ...
                  return (
                    ...
                    >
                      <span className={NOTE}>
                        <span style={{ color: encre() }}>{sinistre.numero}</span> —{' '}
                        {sinistre.titre}
                      </span>
                      <span
        ...
        <main>
            ...
            <div className="o-grid o-gap-12 lg:o-grid-cols-12">
              <div className="lg:o-col-span-4">
                ...
                <p className="o-mt-5 o-text-sm o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
                  Une boutique avec atelier, quatre-vingt-quatre metres carres, six
                  personnes. Les trois sinistres de cette page sont les siens, et les
                  chiffres du devis en bas de page sont les siens aussi.
                </p>
                <dl className="o-m-0 o-mt-8 o-flex o-list-none o-flex-col o-gap-4 o-p-0">
                  {COTES.map((cote) => (
                    ...
                    >
                      <dt
                        className="o-font-mono o-text-base o-tabular-nums"
                        style={{ color: encre() }}
                      >
                        {cote.valeur}
                      </dt>
              ...
              <figure className="o-m-0 o-min-w-0 lg:o-col-span-8">
                ...
                <figcaption
                  className="o-mt-6 o-pt-4 o-font-mono o-text-xs o-leading-relaxed o-text-slate-500 dark:o-text-slate-400"
                  style={{ borderTop: `1px solid ${FILET}` }}
                >
                  Figure 01 — le local, a l echelle, avec ses deux cotes et les quatre
                  chiffres du contrat poses a l endroit qu ils mesurent. C est le plan que
                  l expert joint a son rapport.
                </figcaption>
              </figure>
            </div>
          ...
          */}
          <section
            id="sinistres"
            aria-labelledby="sinistres-titre"
            className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-8 md:o-py-32"
            style={{ borderTop: `1px solid ${FILET}` }}
          >
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              <div className="md:o-col-span-7">
                ...
                <h2
                  id="sinistres-titre"
                  className="o-m-0 o-mt-5 o-max-w-2xl o-text-slate-950 dark:o-text-slate-50"
              ...
              <div className="md:o-col-span-5 md:o-text-right">
                <p className={`o-m-0 o-mb-3 ${NOTE}`}>
                  La formule que vous avez aujourd hui
                </p>
                <div
                  role="group"
                  aria-label="Votre formule"
                ...
                <p className="o-m-0 o-mt-4 o-max-w-sm o-text-sm o-leading-relaxed o-text-slate-600 dark:o-text-slate-400 md:o-ml-auto">
                  {choisie.resume}
                </p>
              </div>
            </div>
          ...
          >
            <div className="o-grid o-gap-12 lg:o-grid-cols-12">
              <div className="lg:o-col-span-4">
                ...
                <p className="o-mt-5 o-text-sm o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
                  Un contrat ne vaut que par ce qui se passe la semaine du sinistre. Voici
                  ce que nous faisons a votre place, et ce que nous ne pouvons pas faire a
                  votre place.
                </p>
                <p className="o-m-0 o-mt-8 o-text-lg">
                  <a
                    href="tel:+33228440290"
              ...
              <div className="o-min-w-0 lg:o-col-span-8">
                <Stepper
                  ...
                  reach="all"
                >
                  <p className="o-m-0 o-max-w-2xl o-text-lg o-leading-relaxed o-text-slate-700 dark:o-text-slate-300">
                    {courante?.texte}
                  </p>
                </Stepper>
              </div>
          ...
          */}
          <section
            id="exclusions"
            aria-labelledby="exclusions-titre"
            className="o-scroll-mt-24 o-px-6 o-py-28 md:o-px-8 md:o-py-40"
            style={nuit('slate')}
          >
              ...
              <div className="o-min-w-0 md:o-col-span-9">
                ...
                <ol className="o-m-0 o-mt-12 o-list-none o-p-0">
                  {(
                    [
                      [
                        'Le defaut d entretien',
                        'Une toiture dont les ardoises manquaient depuis deux ans, une chaudiere sans revision : l assureur refuse, et il a raison de refuser.',
                      ],
                      [
                        'Le vol sans effraction',
                        'Une porte laissee ouverte, un code communique. Nous proposons une extension, elle coute treize euros par mois, et nous la conseillons pour les commerces.',
                      ],
                      [
                        'La faute intentionnelle',
                        'Elle n est jamais assurable, par aucun contrat et chez aucune compagnie. La loi l interdit, et c est la seule exclusion qui ne se negocie pas.',
                      ],
                      [
                        'Les marchandises hors du local',
                        'Un stock en depot, un materiel prete, une exposition : cela releve d un autre contrat, et nous le disons avant, pas apres.',
                      ],
                    ] as const
                    ...
                    <li
                      ...
                      style={{
                        borderTop: `1px solid color-mix(in oklab, #ffffff 16%, transparent)`,
                      }}
                    >
                      <p
                        className={`o-m-0 md:o-col-span-1 ${NOTE_SUR_NUIT}`}
                        style={{ color: encreSurSombre() }}
                      >
                        {String(rang + 1).padStart(2, '0')}
                      </p>
                      <p className="o-m-0 o-text-xl o-font-medium o-tracking-tight o-text-slate-50 md:o-col-span-4">
                        {titre}
                      </p>
                      <p className="o-m-0 o-leading-relaxed o-text-slate-300 md:o-col-span-7">
                        {texte}
                      </p>
                    </li>
                  ))}
          ...
          */}
          ...
          >
            ...
            <div className="o-mt-16 o-grid o-gap-12 lg:o-grid-cols-12 lg:o-items-start">
                    ...
                    return (
                      <div key={curseur.cle}>
                        <div className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-3">
                          <label
                            htmlFor={id}
                            className="o-text-base o-text-slate-950 dark:o-text-slate-50"
                          >
                            {curseur.intitule}
                          </label>
                          <p
              ...
              <div className="o-min-w-0 lg:o-col-span-6">
                <p className={`o-m-0 ${NOTE}`}>
                  Cotisation mensuelle, formule {choisie.nom}
                </p>
                <p
                  aria-live="polite"
                ...
                <p className="o-m-0 o-mt-5 o-text-lg o-text-slate-700 dark:o-text-slate-300">
                  soit{' '}
                  <span className="o-tabular-nums o-text-slate-950 dark:o-text-slate-50">
                    {EURO.format(total * 12)} €
                  </span>{' '}
                  par an, prelevables au mois ou au trimestre.
                </p>
                <p
                  className={`o-m-0 o-mt-8 o-pt-4 ${NOTE}`}
                  style={{ borderTop: `1px solid ${FILET}`, textTransform: 'none' }}
                >
                  {EURO.format(choisie.base)} € de base + 0,42 € par millier de contenu +
                  0,11 € par millier de chiffre d affaires, le tout multiplie par le
                  coefficient de franchise — 1,28 a 150 € et 0,82 a 2 000 €, en ligne
                  droite entre les deux. Ici :{' '}
                  {String(
                    Math.round(coefficientFranchise(valeurs.franchise) * 100) / 100,
                  ).replace('.', ',')}
                  .
                </p>
                <p className="o-mt-6 o-max-w-md o-text-sm o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
                  Ce montant est une estimation de courtier, pas une proposition d
                  assureur : la compagnie garde son mot a dire sur le sinistre passe et l
                  activite exacte. Nous vous rendons la vraie proposition sous
        ...
        */}
        <footer>
            ...
            <div className="o-grid o-gap-10 md:o-grid-cols-12 md:o-items-end">
              <div className="md:o-col-span-7">
                ...
                <p className="o-m-0 o-mt-4">
                  <a
                    href="tel:+33228440290"
                    className="o-no-underline o-text-slate-50 focus:o-ring"
                    style={{
                      ...affiche('l', 300),
                ...
                <p className="o-m-0 o-mt-4 o-max-w-lg o-leading-relaxed o-text-slate-300">
                  Une personne du cabinet repond, pas un serveur vocal. La declaration
                  part le jour meme, et vous recevez sa copie.
                </p>
              </div>
              <div className="md:o-col-span-5">
                ...
                <p className="o-m-0 o-mt-5">
                  <a
                    href="mailto:contact@franchise-courtage.fr"
          ...
          <div
            className="o-bg-white o-px-6 o-py-8 dark:o-bg-slate-950 md:o-px-8"
            style={{ borderTop: `1px solid ${FILET}` }}
          >
            <div className="o-flex o-flex-wrap o-items-baseline o-gap-x-8 o-gap-y-3">
              ...
              <span className={NOTE}>
                Courtier immatricule a l ORIAS sous le numero 12 004 118 — verifiable sur
                orias.fr
              </span>
            </div>
            <p className={`o-mt-5 o-flex o-flex-wrap o-gap-x-6 o-gap-y-2 ${NOTE}`}>
              <span>
                Responsabilite civile professionnelle et garantie financiere conformes au
                code des assurances
              </span>
            ...
            <p
              className={`o-mt-5 o-flex o-flex-wrap o-justify-between o-gap-4 o-pt-5 ${NOTE}`}
              style={{ borderTop: `1px solid ${FILET}` }}
            >
