...
const PISTES: readonly Piste[] = [
  { nom: 'Le Pre', couleur: 'verte', bas: 1200, haut: 1310, longueur: 900, etat: 'ouverte' },
  { nom: 'Les Melezes', couleur: 'verte', bas: 1200, haut: 1360, longueur: 1200, etat: 'ouverte' },
  { nom: 'Le Ruisseau', couleur: 'verte', bas: 1240, haut: 1390, longueur: 1050, etat: 'ouverte' },
  { nom: 'La Clairiere', couleur: 'verte', bas: 1300, haut: 1480, longueur: 1400, etat: 'damage', note: 'Damage jusqu a 10 h' },
  { nom: 'Le Chalet', couleur: 'bleue', bas: 1300, haut: 1650, longueur: 2100, etat: 'ouverte' },
  { nom: 'La Serre', couleur: 'bleue', bas: 1420, haut: 1820, longueur: 2400, etat: 'ouverte' },
  { nom: 'Les Crocus', couleur: 'bleue', bas: 1500, haut: 1900, longueur: 2200, etat: 'ouverte' },
  { nom: 'Le Pas du Loup', couleur: 'bleue', bas: 1650, haut: 2080, longueur: 2700, etat: 'ouverte' },
  { nom: 'La Traverse', couleur: 'bleue', bas: 1780, haut: 2120, longueur: 3100, etat: 'ouverte' },
  { nom: 'Le Grand Vallon', couleur: 'bleue', bas: 1820, haut: 2440, longueur: 4200, etat: 'ouverte' },
  { nom: 'La Combe Nord', couleur: 'rouge', bas: 1650, haut: 2380, longueur: 3400, etat: 'ouverte' },
  { nom: 'Le Rocher Blanc', couleur: 'rouge', bas: 1700, haut: 2410, longueur: 3050, etat: 'ouverte' },
  { nom: 'Les Barres', couleur: 'rouge', bas: 1880, haut: 2460, longueur: 2600, etat: 'ouverte' },
  { nom: 'La Vire', couleur: 'rouge', bas: 1920, haut: 2510, longueur: 2350, etat: 'damage', note: 'Ouverture a 11 h' },
  { nom: 'Le Tunnel', couleur: 'rouge', bas: 2020, haut: 2520, longueur: 1900, etat: 'ouverte' },
  { nom: 'Le Torrent', couleur: 'rouge', bas: 1480, haut: 1960, longueur: 2200, etat: 'fermee', note: 'Manque de neige sous 1 600 m' },
  { nom: 'Le Couloir Sud', couleur: 'noire', bas: 2100, haut: 2590, longueur: 1600, etat: 'ouverte' },
  { nom: 'La Face', couleur: 'noire', bas: 2140, haut: 2610, longueur: 1450, etat: 'ouverte' },
  { nom: 'Les Cheminees', couleur: 'noire', bas: 2180, haut: 2600, longueur: 1300, etat: 'fermee', note: 'Risque d avalanche 3 sur 5' },
  { nom: 'Le Dos d Ane', couleur: 'noire', bas: 2060, haut: 2480, longueur: 1500, etat: 'fermee', note: 'Risque d avalanche 3 sur 5' },
  { nom: 'La Goulotte', couleur: 'noire', bas: 2240, haut: 2620, longueur: 1150, etat: 'ouverte' },
  { nom: 'Le Vallon Perdu', couleur: 'rouge', bas: 1560, haut: 2140, longueur: 2900, etat: 'ouverte' },
]
...
const NIVEAUX = [
  ...
  { id: 'intermediaire', mot: 'Je descends tout en bleu', couleurs: ['verte', 'bleue', 'rouge'] as const },
  { id: 'confirme', mot: 'Je cherche du raide', couleurs: ['bleue', 'rouge', 'noire'] as const },
] as const
...
const COURS: readonly Cours[] = [
  { nom: 'Jardin des neiges', debut: 9, fin: 10.5, moniteur: 'Lea M.', rendezVous: 'Tapis du Pre', places: 4 },
  { nom: 'Collectif enfants — flocon', debut: 9.5, fin: 12, moniteur: 'Come V.', rendezVous: 'Depart telesiege Serre', places: 0 },
  { nom: 'Particulier adulte', debut: 11, fin: 12.5, moniteur: 'Nadia B.', rendezVous: 'Front de neige', places: 2 },
  { nom: 'Collectif ados — etoile', debut: 13.5, fin: 16, moniteur: 'Hugo T.', rendezVous: 'Gare intermediaire', places: 3 },
  { nom: 'Hors-piste accompagne', debut: 13, fin: 16.5, moniteur: 'Lea M.', rendezVous: 'Sommet Grand Vallon', places: 1 },
  { nom: 'Ski de nuit — initiation', debut: 18, fin: 20, moniteur: 'Come V.', rendezVous: 'Front de neige', places: 6 },
]
...
function Flocons({ nombre, germe }: { readonly nombre: number; readonly germe: number }): ReactElement {
...
function Echelle(): ReactElement {
  ...
  return (
    <svg viewBox="0 0 560 620" className="o-h-auto o-w-full" role="img" aria-label="Enneigement par altitude, de 1 200 a 2 600 metres, et limite pluie-neige a 1 480 metres">
      ...
      {Array.from({ length: 17 }, (_, rang) => {
        ...
        return (
          <g key={altitude}>
            <path d={`M${String(majeur ? 74 : 84)} ${String(y(altitude))}H92`} stroke={majeur ? 'var(--o-theme-fg)' : accentDoux(700, 40)} strokeWidth="1" />
            {majeur && (
              <text x="66" y={y(altitude) + 5} fontSize="15" textAnchor="end" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', color: 'var(--o-theme-muted)' }}>
                {String(altitude)}
              </text>
            )}
          </g>
      ...
      <path d={`M92 ${String(y(LIMITE))}H540`} stroke={accent(500)} strokeWidth="1.5" strokeDasharray="6 6" />
      <text x="540" y={y(LIMITE) + 22} fontSize="15" textAnchor="end" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.1em', color: encre() }}>
        ...
        return (
          <g key={mesure.altitude}>
            <rect
              ...
              style={{ transformOrigin: `92px ${String(y(mesure.altitude))}px`, '--o-sk-delai': `${String((rang * 0.12).toFixed(2))}s` } as CSSProperties}
            />
            <text x={110} y={y(mesure.altitude) + 7} fontSize="21" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', color: 'var(--o-theme-fg)' }}>
              {String(mesure.hauteur)} cm
            </text>
            <text x={110} y={y(mesure.altitude) + 34} fontSize="14" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', color: 'var(--o-theme-muted)' }}>
              {mesure.nature}
            </text>
          </g>
        )
...
function Ciel({ genre, couleur }: { readonly genre: Creneau['ciel']; readonly couleur: string }): ReactElement {
  return (
    <svg viewBox="0 0 40 30" width="34" height="26" aria-hidden="true" fill="none" stroke={couleur} strokeWidth="1.8" strokeLinecap="round">
      {genre === 'soleil' && (
        <>
          <circle cx="20" cy="15" r="6.5" />
          {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => {
            const r = (angle * Math.PI) / 180
            return <path key={angle} d={`M${String(20 + Math.cos(r) * 10)} ${String(15 + Math.sin(r) * 10)}L${String(20 + Math.cos(r) * 13)} ${String(15 + Math.sin(r) * 13)}`} />
          })}
        </>
      )}
      {genre === 'voile' && (
      ...
      {genre === 'couvert' && <path d="M9 19a6 6 0 0 1 5-8 8 8 0 0 1 15 2 5 5 0 0 1-1 10H13a5 5 0 0 1-4-4Z" />}
      {genre === 'neige' && (
        <>
...
function Bulletin(): ReactElement {
  ...
  const releve = useMemo(() => {
    ...
    const jour = METEO.filter((c) => Number.parseInt(c.heure, 10) >= 9 && Number.parseInt(c.heure, 10) <= 17)
    const meilleur = [...jour].sort((a, b) => b.visibilite - a.visibilite || a.vent - b.vent)[0]
  ...
  return (
    <div>
      ...
      <div className="o-flex o-flex-wrap o-items-center o-gap-3">
        <p className="o-m-0 o-mr-2 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Votre niveau</p>
        {NIVEAUX.map((cible) => {
          ...
          return (
            <button
              ...
              className={`o-rounded-full o-border-w-1 o-px-4 o-py-2 o-text-sm o-transition-colors focus:o-ring ${
                actif ? '' : 'o-border-black-20 dark:o-border-zinc-700 hover:o-bg-black-10 dark:hover:o-bg-zinc-900'
              }`}
              style={actif ? { backgroundColor: encre(), color: 'var(--o-theme-bg)', borderColor: encre() } : undefined}
            >
              {cible.mot}
            </button>
          )
      ...
      {/* ------- Ce que cela ouvre ------- */}
      <dl className="o-m-0 o-mt-10 o-grid o-gap-px sm:o-grid-cols-3" style={{ backgroundColor: accentDoux(700, 18) }}>
        {[
          [`Pistes ouvertes sur ${String(releve.miennes.length)} de votre niveau`, String(releve.ouvertes.length)],
          ['Denivele cumule', `${releve.denivele.toLocaleString('fr-FR')} m`],
          ['Longueur cumulee', `${(releve.longueur / 1000).toFixed(1).replace('.', ',')} km`],
        ].map(([quoi, valeur]) => (
          <div key={quoi} className="o-bg-zinc-50 dark:o-bg-zinc-950 o-px-6 o-py-6">
            ...
            <dd className="o-m-0 o-mt-3 o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 3.4vw, 2.75rem)', lineHeight: 1 }}>
              {valeur}
            </dd>
          </div>
        ))}
      ...
      <div className="o-mt-10 o-rounded-2xl o-p-8" style={nuit('slate')}>
        <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Le conseil du bureau, calcule a 8 h 15</p>
        <BlurReveal
          as="p"
          step={70}
          blur={9}
          ...
          style={{ ...affiche('m', 300), fontSize: 'clamp(1.25rem, 2.8vw, 2rem)', lineHeight: 1.12 }}
        >
          {conseil}
        </BlurReveal>
      </div>
      ...
      <div className="o-mt-14">
        ...
        <ul className="o-m-0 o-mt-6 o-list-none o-border-t o-border-black-10 dark:o-border-zinc-800 o-p-0">
          {releve.miennes.map((piste) => (
            <li key={piste.nom} className="o-border-b o-border-black-10 dark:o-border-zinc-800">
              <GlareHover duration={900} width={18} className="o-block">
                <div className="o-flex o-flex-wrap o-items-baseline o-gap-x-6 o-gap-y-2 o-py-4">
                  <span aria-hidden="true" className="o-size-3 o-shrink-0 o-rounded-full" style={{ backgroundColor: TEINTES[piste.couleur], outline: piste.couleur === 'noire' ? '1px solid var(--o-theme-line)' : undefined }} />
                  ...
                  <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-tabular-nums o-text-zinc-500 dark:o-text-zinc-400">
                    {String(piste.bas)} — {String(piste.haut)} m · {(piste.longueur / 1000).toFixed(1).replace('.', ',')} km
                  </span>
                  <span
                    className="o-font-mono o-text-xs o-uppercase o-tracking-widest"
                    style={{ color: piste.etat === 'ouverte' ? encre() : 'var(--o-theme-muted)' }}
                  >
      ...
      <div className="o-mt-14">
        <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">La meteo du col, a trois heures</p>
        <div className="o-mt-6 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
          <div className="o-flex o-gap-px" style={{ minWidth: 700, backgroundColor: accentDoux(700, 18) }}>
            {METEO.map((creneau) => {
              ...
              return (
                ...
                >
                  <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">{creneau.heure}</p>
                  <div className="o-mt-3" style={{ color: encre() }}>
                    <Ciel genre={creneau.ciel} couleur="currentColor" />
                  </div>
                  <p className="o-m-0 o-mt-3 o-text-lg o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50">{String(creneau.temperature)} °C</p>
    ...
    <Porte forme="compteur" marque="Combe" sombre={false}>
      <div className="o-bg-zinc-50 dark:o-bg-zinc-950 o-text-zinc-900 dark:o-text-zinc-50" style={polices}>
        ...
        >
          ...
          <Grain opacite={0.05} />
          <BarreGelule marque="Combe" liens={NAVIGATION} action={['#cours', 'Reserver']} />

          <div className="o-relative o-z-20 o-flex o-flex-col o-justify-between o-gap-12 o-px-6 o-pb-16 o-pt-32 md:o-px-10" style={{ minHeight: `calc(100vh - ${String(CHROME)}px)` }}>
            <div>
              <Surgit>
                <Etiquette>Ecole de ski — massif du Grand Vallon — 1 200 a 2 620 m</Etiquette>
              </Surgit>
              <TitreVague
                delai={140}
                className="o-m-0 o-mt-8 o-max-w-4xl o-text-zinc-50"
                style={{ ...affiche('l', 300), fontSize: 'clamp(3rem, 12vw, 11rem)', letterSpacing: '-0.05em' }}
              >
                Combe
              </TitreVague>
            </div>
            ...
            <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-8">
              <Surgit delai={520} as="p" className="o-m-0 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-200">
                Six moniteurs, vingt-deux pistes, et un bulletin qui ne vous dit pas que tout va bien : il vous dit ce qui est ouvert pour vous, et a quelle heure monter.
              </Surgit>
              <Surgit delai={640}>
                <a
                  href="#bulletin"
        ...
        {/* ================= Le bulletin : le mecanisme =================== */}
        <section id="bulletin" className="o-relative o-scroll-mt-24 o-overflow-hidden o-px-6 o-py-24 md:o-px-10 md:o-py-32">
          {!reduced && <Flocons nombre={22} germe={4441} />}
          <div className="o-relative o-mx-auto o-max-w-6xl">
            <Reveal>
              <Indice rang="01" sombre={false}>Le bulletin</Indice>
            </Reveal>
            <Reveal delay={80}>
              <h2 className="o-m-0 o-mt-6 o-max-w-3xl o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.85rem, 4.4vw, 3.75rem)', lineHeight: 0.94, letterSpacing: '-0.03em' }}>
        ...
        <section id="lumiere" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32" style={nuit('slate')}>
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
              <Indice rang="02">La combe</Indice>
            </Reveal>
            <Reveal delay={80}>
              <h2 className="o-m-0 o-mt-6 o-max-w-3xl o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.85rem, 4.2vw, 3.5rem)', lineHeight: 0.96, letterSpacing: '-0.03em' }}>
                La pente ne change pas. La lumiere, si.
              </h2>
            </Reveal>
            <p className="o-m-0 o-mt-6 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-300">
              Lire une neige, c est lire une lumiere. Promenez le pointeur sur la face : a gauche le petit matin bleu, a droite le couchant, en haut la lumiere dure de midi, en bas le jour blanc dans lequel on ne voit plus une bosse.
            </p>
            ...
            <p className="o-m-0 o-mt-4 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
              La face nord depuis la table d orientation — les trois couloirs noirs sont a droite du sommet
            </p>
          </div>
        </section>

        {/* ================= Les cours : la frise de la journee (A23) ===== */}
        <section id="cours" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
              <Indice rang="03" sombre={false}>Les cours</Indice>
            </Reveal>
            <Reveal delay={80}>
              <h2 className="o-m-0 o-mt-6 o-max-w-2xl o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.85rem, 4vw, 3.25rem)', lineHeight: 0.96, letterSpacing: '-0.03em' }}>
              ...
              <div style={{ minWidth: 720 }}>
                <div className="o-flex o-border-b o-border-black-10 dark:o-border-zinc-800 o-pb-2 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                  {[9, 11, 13, 15, 17, 19].map((h) => (
                    <span key={h} className="o-grow">{h} h</span>
                  ))}
                  <span>21 h</span>
                </div>
                <ul className="o-m-0 o-list-none o-p-0">
                  {COURS.map((seance) => {
                    ...
                    const gauche = ((seance.debut - debutFrise) / (finFrise - debutFrise)) * 100
                    const large = ((seance.fin - seance.debut) / (finFrise - debutFrise)) * 100
                    return (
                      <li key={seance.nom} className="o-relative o-border-b o-border-black-10 dark:o-border-zinc-800" style={{ height: 72 }}>
                        <button
                          type="button"
                          disabled={!libre}
                          aria-pressed={choisi}
                          ...
                          style={{
                            ...
                            backgroundColor: choisi ? encre() : libre ? accentDoux(300, 34) : 'var(--o-theme-surface)',
                            color: choisi ? 'var(--o-theme-bg)' : libre ? 'var(--o-theme-fg)' : 'var(--o-theme-muted)',
                          }}
                        >
                          ...
                          <span className="o-truncate o-font-mono o-text-xs o-uppercase o-tracking-widest">
                            {seance.moniteur} · {libre ? `${String(seance.places)} places` : 'complet'}
                          </span>
                        </button>
                      </li>
                    )
            ...
            <div className="o-mt-10 o-grid o-gap-8 md:o-grid-cols-12">
              <div className="md:o-col-span-7">
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Cours retenu</p>
                <p className="o-m-0 o-mt-3 o-text-zinc-950 dark:o-text-zinc-50" aria-live="polite" style={{ ...affiche('m', 300), fontSize: 'clamp(1.35rem, 3vw, 2.25rem)', lineHeight: 1.04 }}>
                ...
                <p className="o-m-0 o-mt-4 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                  Avec {retenu?.moniteur ?? ''}. Rendez-vous {retenu?.rendezVous ?? ''}, dix minutes avant, skis aux pieds et forfait en poche.
                </p>
              </div>
              <div className="md:o-col-span-5 md:o-flex md:o-items-end md:o-justify-end">
                ...
                >
                  Reserver ce cours <Icon icon={ArrowUpRight} size={15} aria-hidden="true" />
                </a>
              </div>
            </div>
          </div>
        ...
        <footer className="o-border-t o-border-black-10 dark:o-border-zinc-800 o-px-6 o-py-16 md:o-px-10">
          <div className="o-mx-auto o-max-w-6xl">
            ...
            <div className="o-mt-8 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
              <svg viewBox="0 0 760 520" className="o-h-auto" style={{ minWidth: 600, width: '100%', maxWidth: 860 }} role="img" aria-label="Carte du massif : front de neige, tapis du Pre, gare intermediaire et sommet du Grand Vallon">
                <defs>
                  <pattern id="o-sk-points" width="12" height="12" patternUnits="userSpaceOnUse">
                ...
                <rect width="760" height="520" fill="url(#o-sk-points)" clipPath="url(#o-sk-relief)" />
                ...
                {LIEUX.map((lieu) => {
                  ...
                  return (
                    <g key={lieu.nom}>
                      <circle cx={lieu.x} cy={lieu.y} r="7" fill="var(--o-theme-bg)" stroke={accent(500)} strokeWidth="3" />
                      <text
                        ...
                        fill="currentColor"
                        style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.1em', color: 'var(--o-theme-fg)' }}
                      >
                        {lieu.nom}
                      </text>
                      <text
                        ...
                        textAnchor={aGauche ? 'end' : 'start'}
                        fill="currentColor"
                        style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.08em', color: 'var(--o-theme-muted)' }}
                      >
                        {lieu.detail}
                      </text>
                    </g>
            ...
            <div className="o-mt-10 o-grid o-gap-8 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-8 sm:o-grid-cols-3">
              ...
              <nav aria-label="Liens utiles">
                <ul className="o-m-0 o-list-none o-space-y-2 o-p-0">
                  {['Tarifs des cours', 'Forfaits du domaine', 'Securite et avalanches', 'Nous ecrire'].map((lien) => (
                    <li key={lien}>
                      <a href="#bulletin" className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400 o-no-underline o-transition-colors hover:o-text-zinc-950 dark:hover:o-text-zinc-50 focus:o-ring">
                        {lien}
                      </a>
                    </li>
                  ))}
            ...
            <p className="o-m-0 o-mt-10 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
              Ecole de ski Combe — © 2026. Enneigement et meteo releves a 8 h 15 par le service des pistes ; le bulletin fait foi sur le domaine.
            </p>
          </div>
        </footer>
      </div>
