...
const PIECES: readonly Piece[] = [
  {
    ...
    cartel:
      'Monture ouverte sous la pierre : la lumiere passe, et la bague se nettoie a l eau.',
  },
  {
    cle: 'quai',
    nom: 'Quai',
    ...
    graine: 'auber-quai',
    cartel:
      'Trente-huit heures d atelier. Longueur ajustable sans casser le rythme des maillons.',
  },
  {
    cle: 'rive',
    nom: 'Rive',
    ...
    graine: 'auber-rive',
    cartel:
      'Quatre millimetres, section demi-jonc. Gravure interieure au burin, comprise.',
  },
  {
    cle: 'lumiere',
    nom: 'Lumiere',
...
const DIAPOSITIVES = [
  {
    ...
    texte:
      'Chaque pierre est choisie avant qu un dessin existe, et tracee au lot : Botswana, Ceylan, Colombie, Mozambique. Jamais l inverse.',
  },
  {
    mot: 'Le metal',
    titre: 'Un or qui a deja vecu.',
    texte:
      'Or 18 carats refondu a l atelier, platine 950. Aucun metal de mine n est entre rue du Louvre depuis 2019.',
  },
  {
    mot: 'Les heures',
    titre: 'Les heures sont comptees, et facturees comme telles.',
    texte:
      'De quatorze a trente-huit heures de sertissage par piece, au taux reel de l atelier, charges comprises. Le revient est ecrit sur le devis.',
  },
  {
    mot: 'Le prix',
    titre: 'Le prix, entier, sans mystere.',
    texte:
      'La pierre, le metal, les heures, la taxe. La marge est de deux fois quatre dixiemes le revient, et elle est ecrite aussi.',
  },
] as const
...
const COLOPHON = [
  [
    'Composition',
    'Cormorant Garamond pour les titres, Work Sans pour le corps, IBM Plex Mono pour les cartels',
  ],
  [
    'Papier',
    'Noir de zinc 950, grain de film a six pour cent, filets blancs a dix pour cent',
  ],
  [
    'Photographies',
    'Pieces photographiees a l atelier ; tirages sous licence libre, credits dans le depot',
  ],
  [
    'Cristal',
    'Scene en shader, une seule par page, remplacee par un aplat sous mouvement reduit',
  ],
  [
    'Poincon',
    'Poincon de maitre 4 AU 75 — Auber SAS au capital de 120 000 EUR, RCS Paris 642 018 774',
  ],
] as const
    ...
    <div
      ...
      style={{
        ...
        transition: reduced
          ...
          : `opacity 500ms cubic-bezier(0.16, 1, 0.3, 1) ${String(delai)}ms, transform 900ms cubic-bezier(0.16, 1, 0.3, 1) ${String(delai)}ms, filter 900ms cubic-bezier(0.16, 1, 0.3, 1) ${String(delai)}ms`,
      }}
    >
      {children}
    </div>
    ...
    <div className="o-grid o-gap-10 md:o-grid-cols-12">
      <div className="o-flex o-flex-col o-gap-8 md:o-col-span-7">
        ...
        <div style={{ '--o-eslider-accent': encreSurSombre() } as CSSProperties}>
          <p className="o-m-0 o-mb-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
            ...
            <span className="o-tabular-nums o-text-zinc-50">
              {carat.toLocaleString('fr-FR')} ct
            </span>
          </p>
          <ElasticSlider
            label="Poids de la pierre, en carats"
            min={0.5}
            max={2}
            step={0.25}
            value={carat}
        ...
        <p className="o-m-0 o-max-w-md o-text-xs o-leading-relaxed o-text-zinc-500">
          Facon comptee a 68 EUR de l heure d atelier, taux reel charges comprises. Devis
          ferme trente jours, confirme par devis nominatif.
        </p>
      </div>

      <dl
        aria-live="polite"
        className={`o-m-0 o-flex o-flex-col o-gap-3 o-p-6 md:o-col-span-5 ${verre(true)}`}
      >
        {(
          [
          ...
          <div
            key={quoi}
            className="o-flex o-items-baseline o-justify-between o-gap-4 o-border-b o-border-white-10 o-pb-3 o-text-sm"
          >
            <dt className="o-text-zinc-300">{quoi}</dt>
            <dd className="o-m-0 o-font-mono o-tabular-nums o-text-zinc-100">
              {euros(montant)}
            </dd>
          </div>
        ))}
        <div className="o-mt-4 o-flex o-items-baseline o-justify-between o-gap-4">
          <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-300">
    ...
    () => (
      <Volume
        ...
        construire={(contexte) => {
          ...
          const filDeLumiere = new three.LineBasicMaterial({
            color: 0xffffff,
            transparent: true,
            opacity: 0.62,
          })
        ...
        */}
        <div className="o-relative">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(to top, var(--o-palette-zinc-950) 0%, color-mix(in oklab, var(--o-palette-zinc-950) 55%, transparent) 40%, transparent 75%)',
              }}
            />
            <Grain opacite={0.06} />
          </div>
          ...
          <div className="o-relative o-z-10" style={{ marginTop: `calc(-1 * ${ECRAN})` }}>
            ...
            >
              ...
              <div className="o-flex o-grow o-flex-col o-justify-end o-px-6 o-pb-24 o-pt-16 md:o-px-14 md:o-pb-28">
                ...
                <TitreVague
                  delai={120}
                  className="o-m-0 o-mt-6 o-max-w-4xl"
                  style={{ ...serif('l'), fontSize: 'clamp(3rem, 8vw, 8.5rem)' }}
                >
                ...
                <div className="o-mt-10 o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
                  ...
                  >
                    La pierre, le metal, les heures de sertissage et la taxe sont ecrits.
                    Une maison qui se cache derriere un prix rond n a rien a montrer.
                  </Surgit>
                  <Surgit
                    delai={640}
                  ...
                  >
                    <Actions
                      ...
                      fantome={['#composer', 'Composer un devis']}
                    />
                  </Surgit>
                </div>
              </div>
              <Coin position="bd">
                Atelier ouvert le jeudi
                <br />
                31 rue du Louvre
              </Coin>
            </section>
                    ...
                    <div className="o-grid o-gap-8 md:o-grid-cols-12">
                      <div className="md:o-col-span-3">
                        <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
                          ...
                          {String(DIAPOSITIVES.length).padStart(2, '0')}
                        </p>
                      ...
                      <div className="o-min-w-0 md:o-col-span-9">
                        ...
                        <Entre key={`${d.mot}-texte`} delai={120}>
                          <p className="o-m-0 o-mt-8 o-max-w-lg o-text-base o-leading-relaxed o-text-zinc-300 md:o-ml-auto md:o-text-right">
                            {d.texte}
                          </p>
                        </Entre>
                      </div>
        ...
        >
          ...
          */}
          <section
            id="pieces"
            className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-14 md:o-py-32"
          >
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              <div className="md:o-col-span-8">
                ...
                <h2
                  ...
                  style={{ ...serif('m'), fontSize: 'clamp(2rem, 4.5vw, 4.25rem)' }}
                >
              ...
              <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400 md:o-col-span-4 md:o-text-right">
                Passez le pointeur sur la piece :<br />
                la loupe grossit deux fois et demie
              </p>
            </div>
            ...
            <ol className="o-m-0 o-mt-20 o-list-none o-p-0">
              {PIECES.map((piece, rang) => (
                <li
                  key={piece.cle}
                  id={piece.cle}
                  className="o-grid o-items-center o-gap-10 o-border-t o-border-white-10 o-py-16 md:o-grid-cols-12 md:o-gap-16"
                >
                  <div
                    className={`md:o-col-span-6 ${rang % 2 === 1 ? 'md:o-col-start-7 md:o-order-2' : ''}`}
                  >
                    <LensZoom
                      src={photo(piece.graine, 1200, 1500)}
                      alt={`${piece.nom} — ${piece.type}`}
                      ratio={0.85}
                      zoom={2.5}
                      size={220}
                  ...
                  <div
                    className={`md:o-col-span-5 ${rang % 2 === 1 ? 'md:o-order-1' : 'md:o-col-start-7'}`}
                  >
                    <p
                    ...
                    <h3
                      ...
                      style={{ ...serif('l'), fontSize: 'clamp(2.75rem, 6vw, 6rem)' }}
                    >
                      <ShineText
                    ...
                    <p className="o-m-0 o-mt-5 o-max-w-sm o-text-base o-leading-relaxed o-text-zinc-300">
                      {piece.cartel}
                    </p>
            ...
            <div className="o-grid o-gap-12 md:o-grid-cols-12">
              <div className="md:o-col-span-4">
                ...
                <h2
                  ...
                  style={{ ...serif('m'), fontSize: 'clamp(2rem, 4vw, 3.75rem)' }}
                >
                  Le reste se compose.
                </h2>
                <p className="o-mt-5 o-max-w-sm o-text-base o-leading-relaxed o-text-zinc-300">
                  Une pierre, un poids, une monture. Le devis decompose ce qu il contient,
                  ligne a ligne, et la taxe en dernier.
                </p>
              </div>
              <div className="md:o-col-span-8">
                <Devis />
          ...
          */}
          <section
            id="atelier"
            className="o-scroll-mt-24 o-flex o-flex-col o-items-center o-justify-center o-border-t o-border-white-10 o-px-6 o-text-center"
            style={{ minHeight: ECRAN }}
          >
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
        ...
        >
          <div className="o-grid o-gap-10 md:o-grid-cols-12">
            <div className="md:o-col-span-4">
              <p
                className="o-m-0"
                style={{ ...serif('m'), fontSize: 'clamp(2.5rem, 5vw, 4.5rem)' }}
              >
                Auber
              </p>
            ...
            <dl className="o-m-0 md:o-col-span-8">
              {COLOPHON.map(([terme, valeur]) => (
                ...
                >
                  ...
                  <dd className="o-m-0 o-text-sm o-leading-relaxed o-text-zinc-300 sm:o-col-span-9">
                    {valeur}
                  </dd>
                </div>
              ))}
