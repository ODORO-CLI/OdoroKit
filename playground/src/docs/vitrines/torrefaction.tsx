...
import { ArrowRight, Coffee, Flame, MapPin, Package, Repeat, Thermometer } from '@odoro-cli/icons/filaire'
import { useMemo, useState, type ReactElement } from 'react'

import { nuit } from './communs.jsx'
import { accent, accentDoux, aplat, encre } from './palettes.js'
import { Actions, affiche, Appel, BarreCoins, Chiffres, Croix, Grain, Horloge, Numerotee, Porte, Surgit, TitreVague, usePolices } from './marche.jsx'
 ...
 */
function cuisson(rang: number, aujourdhui: Date): { readonly date: Date; readonly jours: number } {
...
function Axe({ nom, valeur }: { readonly nom: string; readonly valeur: number }): ReactElement {
  return (
...
export default function Page(): ReactElement {
  ...
  return (
    ...
    <div id="haut" className="o-bg-stone-50 dark:o-bg-stone-950 o-text-stone-900 dark:o-text-stone-100" style={polices}>
      ...
      <header className="o-relative o-isolate o-min-h-screen o-overflow-hidden" style={nuit('stone')}>
        <img src={photo('brulerie-sechage', 1800, 1000)} alt="" aria-hidden="true" className="o-absolute o-inset-0 o-z-0 o-size-full o-object-cover" style={{ filter: 'saturate(1.3) contrast(1.05)' }} />
        <div aria-hidden="true" className="o-absolute o-inset-0 o-z-0" style={{ background: `linear-gradient(105deg, ${accentDoux(600, 55)} 0%, transparent 55%), linear-gradient(to bottom, color-mix(in oklab, var(--o-palette-stone-950) 50%, transparent) 0%, transparent 35%, var(--o-palette-stone-950) 92%)` }} />
        <Grain opacite={0.08} />
        <Croix />

        <BarreCoins marque="Brulerie Nord" liens={[['#cours-titre', 'Le cours'], ['#origines-titre', 'Les origines'], ['#breve-titre', 'L abonnement']]} droite={<Horloge ville="Dunkerque" />} />
        ...
        <div className="o-relative o-z-10 o-mx-auto o-flex o-min-h-screen o-max-w-7xl o-flex-col o-justify-between o-px-6 o-pb-8 o-pt-20 md:o-px-8">
          <div className="o-max-w-md">
            <Surgit as="p" className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-300">
              01 / Six origines<br />02 / Torrefie le mardi, expedie le mercredi<br />03 / Le cours au kilo, publie
            </Surgit>
            <Surgit delai={140} as="p" className="o-m-0 o-mt-8 o-max-w-sm o-text-lg o-leading-relaxed o-text-stone-100">
              Nous publions ce que nous payons le kilo vert, ce que nous vendons le kilo torrefie, et l ecart entre les deux. Le producteur est nomme, la parcelle aussi.
            </Surgit>
            <Surgit delai={280} className="o-mt-8">
              <Actions pleine={['#cours-titre', <>Lire le cours du jour <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]} fantome={['#breve-titre', 'Le sac du mois']} />
            </Surgit>
          </div>

          {/* Le mot-marque chrome, en bas du cadre — Fuel. */}
          <div className="o-mt-16 o-flex o-items-end o-justify-between o-gap-6">
            <TitreVague delai={360} cadence={120} className="o-m-0 o-uppercase" style={{ ...affiche('xxl', 800), fontSize: 'clamp(2.75rem, 12.5vw, 13rem)', background: 'linear-gradient(180deg, #ffffff 0%, #d6d3d1 45%, #78716c 100%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>
              Brulerie Nord
            </TitreVague>
            <Surgit delai={700} as="p" className="o-m-0 o-hidden o-shrink-0 o-pb-3 o-text-right o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-400 md:o-block">
              Numero 214<br />1 900 exemplaires
            </Surgit>
          </div>
        </div>
      </header>
      ...
      <header className="o-mx-auto o-max-w-5xl o-px-5 o-pt-10 md:o-px-8">
        <p className="o-flex o-flex-wrap o-items-center o-justify-between o-gap-x-6 o-gap-y-1 o-border-b o-border-stone-900 dark:o-border-stone-100 o-pb-2 o-text-xs o-uppercase o-tracking-widest">
          ...
          <span className="o-text-stone-600 dark:o-text-stone-400">{dateLisible(aujourdhui)}</span>
          <span className="o-text-stone-600 dark:o-text-stone-400">Tirage 1 900 exemplaires</span>
        ...
        <p className="o-mt-4 o-border-t o-border-b o-border-stone-900 dark:o-border-stone-100 o-py-1.5 o-text-center o-text-xs o-uppercase o-tracking-widest o-text-stone-600 dark:o-text-stone-400">
          Bulletin du cafe de specialite — six origines — 12 rue des Hollandais, Dunkerque
        </p>
      </header>
      ...
      <main>
        ...
        <section aria-labelledby="atelier-titre" className="o-mx-auto o-max-w-5xl o-scroll-mt-24 o-px-5 o-pb-14 o-pt-16 md:o-px-8 md:o-pb-20 md:o-pt-24">
          <h2 id="atelier-titre" className="o-m-0 o-max-w-3xl o-font-serif o-text-3xl o-font-normal o-leading-tight o-tracking-tight md:o-text-5xl">
        ...
        <section aria-labelledby="edito-titre" className="o-mx-auto o-max-w-5xl o-scroll-mt-24 o-px-5 o-pb-16 md:o-px-8">
          <h2
            id="edito-titre"
          ...
          >
            <p className="o-m-0">
              ...
              torrefaction. Avant, il degaze et le gout se ferme ; apres, il
              s eteint. C est pour cela que chaque sachet de ce bulletin porte sa
              date de cuisson et non une date de peremption : la seconde ne dit
              rien, la premiere dit tout.
            </p>
            <p className="o-m-0 o-mt-3">
              Nous torrefions le mardi, par lots de douze kilos, et nous expedions
              le mercredi. Un sachet commande le jeudi part donc le mercredi
              suivant : c est plus lent qu ailleurs, et c est le seul moyen de vous
              envoyer un cafe de six jours plutot que de six semaines.
            </p>
            <p className="o-m-0 o-mt-3">
              Les cours ci-dessous bougent avec la recolte et avec le change. Nous
              les republions a chaque numero, a la hausse comme a la baisse, et
              nous indiquons ce qui va manquer avant que cela manque.
            </p>
            <p className="o-m-0 o-mt-3">
              Chaque origine porte l altitude, le traitement, la variete et le nom
              de la station ou de la ferme. Quand nous ne savons pas, nous
              l ecrivons — cela arrive, et le cacher serait pire.
            </p>
          </div>
        </section>
        ...
        >
          <div className="o-mx-auto o-max-w-5xl o-px-5 o-py-10 md:o-px-8">
            ...
            >
              <Icon icon={Coffee} size={13} style={{ color: encre() }} aria-hidden="true" />
            ...
            <div className="o-mt-5 o-overflow-x-auto o-scrollbar dark:o-scrollbar-dark">
              <table className="o-w-full o-text-sm" style={{ minWidth: '44rem', borderCollapse: 'collapse' }}>
                <caption className="o-sr-only">Cours des six origines au bulletin du jour</caption>
                <thead>
                  <tr className="o-border-b o-border-stone-400 dark:o-border-stone-600">
                    {['Origine', 'Pays', 'Altitude', 'Traitement', 'Le kilo', 'Stock', 'Tendance'].map((entete) => (
                      <th
                        key={entete}
                        scope="col"
                ...
                <tbody>
                  {SACHETS.map((item) => {
                    ...
                    return (
                      <tr key={item.nom} className="o-border-b o-border-stone-200 dark:o-border-stone-800">
                        <th scope="row" className="o-py-2.5 o-pr-5 o-text-left o-font-medium">
                          {item.nom}
                        </th>
                        <td className="o-py-2.5 o-pr-5 o-text-stone-600 dark:o-text-stone-400">{item.pays}</td>
                        ...
                        <td className="o-py-2.5 o-whitespace-nowrap">
                          <span className="o-tabular-nums" style={{ color: encre() }} aria-hidden="true">
                            {t.signe}
                          </span>{' '}
                          <span className="o-text-xs o-text-stone-600 dark:o-text-stone-400">{t.mot}</span>
                        </td>
                      </tr>
                    )
                  })}
            ...
            <p className="o-mt-4 o-max-w-2xl o-text-xs o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
              Cours du jour de parution. Le stock est celui de l atelier a la lecture : quand il tombe sous douze sachets, la ligne passe en tendu, et le lot suivant n arrivera pas avant la prochaine recolte.
            </p>
          </div>
        </section>
        ...
        <section id="origines" aria-labelledby="origines-titre" className="o-mx-auto o-max-w-5xl o-scroll-mt-24 o-px-5 o-pb-24 o-pt-16 md:o-px-8 md:o-pt-24">
          <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-x-10 o-gap-y-3 o-border-b o-border-stone-900 dark:o-border-stone-100 o-pb-3">
            <h2 id="origines-titre" className="o-m-0 o-font-serif o-text-3xl o-font-normal o-leading-tight o-tracking-tight md:o-text-5xl">
            ...
            <p className="o-m-0 o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-600 dark:o-text-stone-400">
              Une fiche par lot<br />Elles s empilent en defilant
            </p>
          </div>

          <StickyStack className="o-mt-10 o-flex o-flex-col o-gap-6" offset={125} gap={18} shrink={0.04}>
                ...
                <div className="o-grid md:o-grid-cols-12">
                  ...
                  <div className="o-min-w-0 o-p-5 md:o-col-span-8 md:o-p-7">
                    <p className="o-m-0 o-flex o-flex-wrap o-items-baseline o-gap-x-3 o-gap-y-1">
                      <span className="o-font-serif o-text-2xl o-tracking-tight md:o-text-3xl">{item.nom}</span>
                    ...
                    <div className="o-mt-5 o-grid o-gap-x-8 o-gap-y-5 lg:o-grid-cols-2">
                      <dl className="o-m-0 o-grid o-grid-cols-2 o-gap-x-5 o-gap-y-3 o-text-sm">
                        {([
                          ...
                          [Flame, 'Derniere cuisson', dateLisible(cuisson(item.cuisson, aujourdhui).date)],
                    ...
                    <p className="o-m-0 o-mt-5 o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-x-6 o-gap-y-1 o-border-t o-border-stone-300 dark:o-border-stone-700 o-pt-3 o-text-sm o-tabular-nums">
                      <span>
                        <span className="o-font-semibold" style={{ color: encre() }}>{euros(item.prix250)}</span>
                        <span className="o-text-stone-600 dark:o-text-stone-400"> le 250 g — {euros(item.prix1000)} le kilo</span>
                      </span>
                      <span className="o-text-xs o-uppercase o-tracking-widest o-text-stone-600 dark:o-text-stone-400">
                        {item.stock250 === 0
        ...
        <section aria-label="Torrefie a Dunkerque, le mardi" className="o-relative o-isolate o-overflow-hidden o-border-t o-border-b o-border-stone-900 dark:o-border-stone-100">
          <Duotone
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to bottom, color-mix(in oklab, var(--o-palette-stone-950) 58%, transparent), color-mix(in oklab, var(--o-palette-stone-950) 28%, transparent))' }}
          >
            <CurvedLoop
              courbure={0.42}
              taille={52}
              ...
              style={{ fontFamily: 'var(--o-vitrine-affichage, var(--o-font-sans))', letterSpacing: '-0.02em' }}
            >
          ...
          <p className="o-absolute o-bottom-3 o-right-4 o-z-20 o-m-0 o-px-2.5 o-py-1 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-300" style={{ backgroundColor: 'var(--o-palette-stone-950)' }}>
            Les sacs de jute, a la reception du lot
          </p>
        </section>

        {/* ================= 8. Quatre nombres, sur filets ================= */}
        <section aria-label="Le bulletin en quatre nombres" className="o-mx-auto o-max-w-5xl o-px-5 o-py-16 md:o-px-8 md:o-py-20">
          <Chiffres sombre={false} nombres={NOMBRES} />
        </section>

        {/* ================= 9. La breve : l abonnement ==================== */}
        <section aria-labelledby="breve-titre" className="o-mx-auto o-max-w-5xl o-scroll-mt-24 o-px-5 o-pb-16 md:o-px-8">
          <div className="o-grid o-gap-8 md:o-grid-cols-12">
            <div className="md:o-col-span-7">
              ...
              <p className="o-mt-4 o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300">
                On choisit une quantite et un rythme ; le cafe part le mercredi qui
                suit la torrefaction, sans qu on ait rien a faire. La remise depend
                de ce qui est consomme par mois, et elle est calculee ci-contre —
                pas negociee.
              </p>
              <p className="o-mt-3 o-text-sm o-leading-relaxed o-text-stone-700 dark:o-text-stone-300">
                ...
                justification et sans delai de preavis. Une pause n annule pas
                l anciennete, donc pas la remise.
              </p>
              <p className="o-mt-3 o-text-xs o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
                Un abonne a deux kilos par mois remplit un lot entier : l atelier n a
                ni a stocker ni a prevoir, et c est cela qui est rendu. La remise
                n est pas un geste commercial, c est un cout qui disparait.
              </p>
            </div>
            ...
            <div className="o-border-w-1 o-border-stone-900 dark:o-border-stone-100 o-p-5 md:o-col-span-5">
              <p className="o-flex o-items-center o-gap-2 o-text-xs o-uppercase o-tracking-widest">
                <Icon icon={Repeat} size={12} style={{ color: encre() }} aria-hidden="true" />
                  ...
                  {QUANTITES.map((valeur) => {
                    ...
                    return (
                      <button
                        ...
                        style={
                          actif
                            ? { color: encre(), fontWeight: 700, textDecoration: 'underline', textUnderlineOffset: '4px' }
              ...
              >
                ...
                <div className="o-mt-2 o-flex o-items-baseline o-justify-between o-gap-4 o-border-t o-border-stone-300 dark:o-border-stone-700 o-pt-3">
                  <dt className="o-text-xs o-uppercase o-tracking-wider">Par mois, abonne</dt>
                  <dd className="o-m-0 o-font-serif o-text-xl o-tabular-nums" style={{ color: encre() }}>
        ...
        <div id="appel" className="o-scroll-mt-24 o-border-t o-border-stone-900 dark:o-border-stone-100">
          <Appel
            sombre={false}
            titre="Encore chaud."
            texte="Le tambour tourne mardi a onze heures. Ce qui en sort part mercredi, et il reste de la place dans le lot."
            action={['#breve-titre', <>S abonner au sac du mois <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]}
          />
        </div>
      </main>
      ...
      <footer className="o-relative o-overflow-hidden o-border-t o-border-stone-900 dark:o-border-stone-100">
        <div className="o-mx-auto o-max-w-6xl o-px-5 o-pt-14 md:o-px-8">
                ...
                <ul className="o-m-0 o-mt-4 o-flex o-list-none o-flex-col o-gap-2 o-p-0">
                  {colonne.liens.map(([cible, mot]) => (
                    <li key={`${colonne.titre}-${mot}`}>
                      <a href={cible} className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-no-underline o-text-stone-600 dark:o-text-stone-400 hover:o-text-stone-900 dark:hover:o-text-stone-100 o-transition-colors focus:o-ring">
                        {mot}
                      </a>
                    </li>
                  ))}
          ...
          <p
            ...
            style={{ ...affiche('xxl', 800), fontSize: 'clamp(2rem, 12.6vw, 13.5rem)', lineHeight: 0.84 }}
          >
            Brulerie Nord
          </p>
          ...
          >
            <p className="o-m-0">
              <span className="o-font-semibold o-text-stone-900 dark:o-text-stone-100">Brulerie Nord</span>
            ...
            <p className="o-m-0 o-mt-3">
              ...
              hausse comme a la baisse. Les stocks sont ceux de l atelier au moment
              de la lecture. Brulerie Nord SARL au capital de 35 000 EUR, RCS
              Dunkerque 811 226 470.
            </p>
          </div>
