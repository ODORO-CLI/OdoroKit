...
import { Actions, affiche, BarreFilet, Etiquette, Grain, Indice, Porte, Surgit, TitreVague, usePolices, verre } from './marche.jsx'
 ...
 * chiffre invente.
 */
function tablesLibres(dateISO: string, service: 'midi' | 'soir', creneau: string, couverts: number): number {
...
function LigneCarte({ plat }: { readonly plat: Plat }): ReactElement {
  return (
    <li className="o-py-2.5">
      ...
      <p className="o-m-0 o-mt-0.5 o-text-sm o-text-stone-600 dark:o-text-stone-400">{plat.detail}</p>
      <p className="o-m-0 o-mt-1 o-text-xs o-text-stone-500 dark:o-text-stone-400">
        {plat.origine}
        {plat.allergenes.length > 0 && <span> — allergenes : {plat.allergenes.join(', ')}</span>}
  ...
  return (
    ...
    <div className="o-bg-stone-50 dark:o-bg-stone-950 o-text-stone-900 dark:o-text-stone-100" style={polices}>
      ...
      <ZoomDefile
        ...
        fond={
          <>
            <img src={photo('perrin-salle', 1800, 1000)} alt="" aria-hidden="true" className="o-absolute o-inset-0 o-z-0 o-size-full o-object-cover" />
      ...
      >
        ...
        <BarreFilet marque="Maison Perrin" liens={[['#carte', 'La carte'], ['#ardoise', 'L ardoise'], ['#reserver', 'Reserver']]} action={['#reserver', 'Reserver une table']} />
        ...
        <div className="o-relative o-z-20 o-mx-auto o-flex o-min-h-screen o-max-w-6xl o-flex-col o-justify-end o-px-6 o-pb-16 o-pt-24">
          ...
          <TitreVague delai={100} className="o-m-0 o-mt-6 o-max-w-4xl o-text-stone-50" style={{ ...affiche('l', 300), fontSize: 'clamp(2.5rem, 6.5vw, 7rem)' }}>
          ...
          <div className="o-mt-10 o-grid o-items-end o-gap-8 lg:o-grid-cols-12">
            <div className="o-min-w-0 lg:o-col-span-7">
              <Surgit delai={420} as="p" aria-live="polite" className="o-m-0 o-flex o-w-fit o-max-w-full o-flex-wrap o-items-center o-gap-x-3 o-gap-y-1 o-overflow-hidden o-rounded-2xl o-border-w-1 o-border-white-20 o-bg-white-10 o-px-4 o-py-2 o-backdrop-blur-md">
                <Icon icon={Clock} size={15} style={{ color: encreSurSombre() }} aria-hidden="true" />
                <SplitFlap interval={70} step={45} className="o-font-mono o-text-xs o-uppercase o-tracking-widest" style={{ color: encreSurSombre() }}>
                  {etat.titre}
                </SplitFlap>
                <span className="o-text-sm o-text-stone-300">{etat.detail}</span>
              </Surgit>
              <Surgit delai={520} className="o-mt-6">
                <Actions pleine={['#reserver', <>Reserver une table <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]} fantome={['#carte', 'Lire la carte']} />
              </Surgit>
            </div>

            {/* La carte flottante, comme le soin le plus demande chez Salonix. */}
            <Surgit delai={640} className={`${verre(true)} o-flex o-min-w-0 o-items-center o-gap-4 o-p-4 lg:o-col-span-5`}>
              <img src={photo('perrin-cuisine', 300, 300)} alt="" aria-hidden="true" className="o-size-16 o-shrink-0 o-rounded-xl o-object-cover" />
              <div className="o-min-w-0">
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-400">Ce midi</p>
                <p className="o-m-0 o-mt-1 o-truncate o-text-base o-font-medium o-text-stone-50">{carte.formule}</p>
                <p className="o-m-0 o-mt-0.5 o-text-sm o-text-stone-300">{carte.horaire}</p>
              </div>
              <Icon icon={ArrowRight} size={16} className="o-ml-auto o-shrink-0 o-text-stone-300" aria-hidden="true" />
            </Surgit>
          </div>
          ...
          <div className="o-mt-10 o-flex o-justify-between o-gap-6 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-400">
            <Surgit delai={720} as="p" className="o-m-0">14 rue Cavendish<br />Metro Voltaire</Surgit>
            <Surgit delai={780} as="p" className="o-m-0 o-text-right">Du mardi au samedi<br />Jusqu a 23 h</Surgit>
          </div>
        </div>
      </ZoomDefile>

      {/* ================= 2. La maison : trois photos qui derivent, en decale ===== */}
      <section aria-labelledby="maison-titre" className="o-relative o-z-10 o-mx-auto o-max-w-6xl o-px-6 o-pt-20 md:o-pt-28">
        <div className="o-grid o-gap-10 md:o-grid-cols-12">
          <div className="o-min-w-0 md:o-col-span-5">
            <div className="md:o-sticky" style={{ top: 140 }}>
              ...
              <Reveal delay={80}>
                <h2 id="maison-titre" className="o-m-0 o-mt-6" style={affiche('m', 300)}>
              ...
              <Reveal delay={160}>
                <p className="o-mt-6 o-max-w-sm o-text-base o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
                  Vingt-deux couverts a l interieur, huit en terrasse d avril a octobre. Le comptoir sert jusqu a la fermeture, sans reservation — c est la seule facon d entrer sans avoir prevu.
                </p>
              </Reveal>
              <Reveal delay={240}>
                <p className="o-mt-8 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
                  Ouvert en 1998<br />Meme cuisine, meme comptoir
                </p>
              </Reveal>
            </div>
          </div>
          ...
          <div className="o-min-w-0 md:o-col-span-7">
            <div className="o-grid o-grid-cols-12 o-gap-4 md:o-gap-6">
              <Parallaxe vitesse={0.12} glisse={0.55} className="o-col-span-8">
                <Devoile src={photo('perrin-comptoir', 900, 1100)} alt="Le comptoir, en fin de service" ratio="4 / 5" depuis="bas" derive={30} legende="Le comptoir, en fin de service" />
              </Parallaxe>
              <Parallaxe vitesse={-0.1} glisse={0.7} className="o-col-span-4 o-self-end o-pb-16">
                <Devoile src={photo('perrin-cuisine', 700, 900)} alt="La cuisine, ouverte sur la salle" ratio="3 / 4" depuis="droite" derive={24} legende="La cuisine" />
              </Parallaxe>
              <Parallaxe vitesse={0.18} glisse={0.85} className="o-col-span-9 o-col-start-3 md:o-col-span-8 md:o-col-start-4" style={{ marginBottom: '-4rem' }}>
                <Devoile src={photo('perrin-rue', 1200, 800)} alt="La terrasse, huit couverts d avril a octobre" ratio="3 / 2" depuis="gauche" derive={36} legende="La terrasse — huit couverts, d avril a octobre" className="o-shadow-2xl" />
              </Parallaxe>
            </div>
          </div>
        </div>
      ...
      <main id="carte" className="o-mx-auto o-max-w-3xl o-scroll-mt-24 o-px-6 o-pb-14 o-pt-28 md:o-pt-40">
        ...
        <p className="o-mt-8 o-text-center o-text-xs o-leading-relaxed o-text-stone-500 dark:o-text-stone-400">
          Prix nets, service compris. Les allergenes sont ceux de la liste des
          quatorze. Tout est prepare sur place sauf mention contraire, et cette
          mention figure sous le plat.
        </p>
      </main>
      ...
      >
        <Crosshatch
          ...
          strength={0.16}
        />
        <div aria-hidden="true" className="o-relative o-z-10 o-border-b o-border-white-10 o-py-6 o-font-serif o-italic o-text-stone-100">
          <Bandeau mots={[...carte.entrees, ...carte.plats].map((plat) => plat.nom)} separateur="—" vitesse={70} taille="clamp(2rem, 5vw, 4.5rem)" />
        </div>
        <div className="o-relative o-z-10 o-mx-auto o-max-w-3xl o-px-6 o-py-12">
          ...
          >
            <Icon icon={ChefHat} size={14} aria-hidden="true" />
            L ardoise — {carte.libelle.toLowerCase()}
          </h2>
            ...
            {[...carte.entrees, ...carte.plats].slice(0, 6).map((plat) => (
              <li key={plat.nom} className="o-flex o-items-baseline o-gap-2">
                ...
                <span
                  ...
                  style={{
                    borderColor: 'color-mix(in oklab, var(--o-palette-stone-100) 30%, transparent)',
                    marginBottom: '0.35em',
                  }}
                />
                <span className="o-shrink-0 o-tabular-nums" style={{ color: encreSurSombre() }}>
                  {plat.prix} EUR
                </span>
              </li>
            ))}
          ...
          <p className="o-mt-6 o-text-sm o-leading-relaxed o-text-stone-300 dark:o-text-stone-300">
            Reecrite chaque lundi, selon le marche de la veille. Ce qui n y est
            plus est parti : nous ne gardons rien d une semaine sur l autre.
          </p>
        </div>
      </section>

      {/* ----- Les heures, en tableau ------------------------------------- */}
      <section id="horaires" aria-labelledby="horaires-titre" className="o-mx-auto o-max-w-3xl o-px-6 o-py-12">
        <h2
          id="horaires-titre"
        ...
        <table className="o-mt-5 o-w-full o-text-sm" style={{ borderCollapse: 'collapse' }}>
            ...
            {JOURS.map((jour, rang) => {
              ...
              return (
                <tr
                  ...
                  style={aujourdhui ? { backgroundColor: accentDoux(500, 14) } : undefined}
                >
                  <th scope="row" className="o-py-2.5 o-pr-5 o-text-left o-font-medium o-capitalize">
                    {jour}
                    {aujourdhui && (
                      <span className="o-ml-2 o-text-xs o-font-normal" style={{ color: encre() }}>
                        aujourd hui
                      </span>
                    )}
                  </th>
                  <td className="o-py-2.5 o-tabular-nums o-text-stone-600 dark:o-text-stone-400">
                    {plages.length === 0
                      ? 'Ferme'
                      : plages
                          .map((p) => `${heureLisible(p.ouverture)} — ${heureLisible(p.fermeture)}`)
                          .join('   ')}
                  </td>
                </tr>
              )
      ...
      >
        <div className="o-mx-auto o-max-w-3xl o-px-6 o-py-12">
          ...
          <p className="o-mt-3 o-text-sm o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
            Trente couverts, et pas un de plus. Au-dela de six personnes, appelez :
            nous rapprochons des tables, et cela se decide de vive voix.
          </p>
          ...
          {plageDemandee === undefined ? (
            <p aria-live="polite" className="o-mt-3 o-text-sm o-text-stone-600 dark:o-text-stone-400">
              Pas de service ce jour-la. Choisissez une autre date, ou l autre
              service.
            </p>
          ) : (
            <>
              <div role="group" aria-label="Choisir un creneau" className="o-mt-3 o-flex o-flex-wrap o-gap-2">
                {creneaux.map((item) => {
      ...
      <section aria-labelledby="appel-titre" className="o-mx-auto o-max-w-6xl o-px-6 o-py-24 o-text-center md:o-py-36">
        <h2 id="appel-titre" className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
        ...
        <Aimant force={0.2} className="o-mt-8 o-max-w-full">
          <a
            ...
            style={{ ...affiche('xl', 300), fontSize: 'clamp(2.25rem, 9.5vw, 10rem)', fontVariantNumeric: 'tabular-nums' }}
          >
            01 43 79 22 08
          </a>
        </Aimant>
        <p className="o-mx-auto o-mt-6 o-max-w-md o-text-sm o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
          On decroche entre les services, de 10 h a midi et de 16 h a 19 h. Le reste du temps, on est en salle.
        </p>
      </section>
      ...
      <footer className="o-border-t o-border-stone-900 dark:o-border-stone-100">
        <div className="o-mx-auto o-grid o-max-w-6xl o-gap-10 o-px-6 o-py-14 md:o-grid-cols-12 md:o-py-20">
          <div className="md:o-col-span-4">
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">Venir</p>
            <p className="o-m-0 o-mt-4 o-font-serif o-text-2xl o-leading-snug o-text-stone-950 dark:o-text-stone-50 md:o-text-3xl">
              14 rue Cavendish<br />Paris 11e
            </p>
            <p className="o-m-0 o-mt-3 o-text-sm o-text-stone-600 dark:o-text-stone-400">Metro Voltaire (9), Charonne (9)<br />Bus 46, 56 — arret Cavendish</p>
          </div>
          <div className="md:o-col-span-4">
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">Les heures</p>
            <p className="o-m-0 o-mt-4 o-font-serif o-text-2xl o-leading-snug o-text-stone-950 dark:o-text-stone-50 md:o-text-3xl">
              Mardi — samedi<br />12h — 14h30, 19h — 22h30
            </p>
            <p className="o-m-0 o-mt-3 o-text-sm o-text-stone-600 dark:o-text-stone-400">Dimanche midi seulement. Lundi, c est le marche : ferme.</p>
          </div>
          <div className="md:o-col-span-4">
            <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">Ecrire</p>
            <p className="o-m-0 o-mt-4 o-font-serif o-text-2xl o-leading-snug md:o-text-3xl">
              <a href="#reserver" className="o-inline-flex o-items-center o-gap-2 o-no-underline o-text-stone-950 dark:o-text-stone-50 hover:o-underline focus:o-ring">
                bonjour@maisonperrin.fr <Icon icon={ArrowUpRight} size={20} aria-hidden="true" />
              </a>
            </p>
            <p className="o-m-0 o-mt-3 o-text-sm o-text-stone-600 dark:o-text-stone-400">Groupes, privatisations le dimanche soir, questions sur la carte.</p>
          </div>
        </div>
