...
import { ArrowRight, Camera, MapPin, Package, RotateCcw, Ruler, Scissors } from '@odoro-cli/icons/filaire'
...
const GUIDE: readonly {
  ...
  { taille: '34', poitrine: '80 - 83', ceinture: '62 - 65', bassin: '88 - 91', dos: '38,5' },
  { taille: '36', poitrine: '84 - 87', ceinture: '66 - 69', bassin: '92 - 95', dos: '39,5' },
  { taille: '38', poitrine: '88 - 91', ceinture: '70 - 73', bassin: '96 - 99', dos: '40,5' },
  { taille: '40', poitrine: '92 - 95', ceinture: '74 - 77', bassin: '100 - 103', dos: '41,5' },
  { taille: '42', poitrine: '96 - 99', ceinture: '78 - 81', bassin: '104 - 107', dos: '42,5' },
  { taille: '44', poitrine: '100 - 104', ceinture: '82 - 86', bassin: '108 - 112', dos: '43,5' },
  { taille: '46', poitrine: '105 - 109', ceinture: '87 - 91', bassin: '113 - 117', dos: '44,5' },
]
...
const MATIERES: readonly {
...
}[] = [
  {
    ...
    entretien: 'Nettoyage a sec uniquement. Brosse douce dans le sens du poil apres chaque port. Ne pas repasser : la vapeur suffit.',
  },
  {
    matiere: 'Popeline de coton',
    ...
    entretien: 'Machine 30 degres, essorage 800 tours. Repassage moyen sur l envers du col. Le coton peigne perd 2 % a la premiere lessive : la coupe en tient compte.',
  },
  {
    matiere: 'Toile de lin',
    ...
    grammage: '245 g/m2',
    tisseur: 'Filature Rougier, Lodeve',
    entretien: 'Machine 30 degres, sechage a plat. Le lin se froisse, c est sa nature ; un repassage tres chaud sur l envers le remet a plat en deux minutes.',
  },
  {
    matiere: 'Laine des Pyrenees',
    ...
    grammage: '410 g/m2',
    tisseur: 'Filature Rougier, Lodeve',
    entretien: 'Lavage a la main a froid, lessive laine, sechage a plat sur serviette. Ne jamais suspendre mouillee : la maille s allonge de trois centimetres.',
  },
  {
    matiere: 'Velours cotele',
    ...
    grammage: '340 g/m2',
    tisseur: 'Tissage Berthaud, Charlieu',
    entretien: 'Machine 30 degres sur l envers, sans adoucissant. Repassage a la pattemouille, jamais directement sur la cote.',
  },
  {
    matiere: 'Coton cire',
    ...
    grammage: '380 g/m2',
    tisseur: 'Tissage Berthaud, Charlieu',
    entretien: 'Ni machine, ni sec : eponge humide et sechage a l air. Le recirage se fait chez nous, gratuitement, une fois par an.',
  },
]
...
const SILHOUETTES: readonly {
  ...
  { rang: '01', graine: 'lisiere-defile-1', alt: 'Long manteau a carreaux vert et bleu, presente sur mannequin', piece: 'Manteau Sablon', matiere: 'Laine bouillie' },
  { rang: '02', graine: 'lisiere-defile-2', alt: 'Un passage sur le podium exterieur, robe courte bleue, public assis de part et d autre', piece: 'Maille Cotiere', matiere: 'Laine des Pyrenees' },
  { rang: '03', graine: 'lisiere-defile-3', alt: 'Robe longue vert olive a manches gigot, presentee sur buste', piece: 'Robe Aout', matiere: 'Serge de viscose' },
  { rang: '04', graine: 'lisiere-defile-4', alt: 'Manteau bleu porte en exterieur, photographie de mode en couleurs', piece: 'Trench Orme', matiere: 'Coton cire' },
  { rang: '05', graine: 'lisiere-defile-5', alt: 'Veste a carreaux et noeud papillon, presentee sur mannequin coiffe d un chapeau melon', piece: 'Veste Talus', matiere: 'Velours cotele' },
]
  ...
  return (
    ...
    <div className="o-bg-zinc-50 dark:o-bg-zinc-950 o-text-zinc-900 dark:o-text-zinc-50" style={polices}>
      ...
      <header className="o-relative o-isolate o-overflow-hidden">
        <BarreCoins marque="Lisiere" liens={NAVIGATION} droite={<a href="#panier" className="o-no-underline focus:o-ring" style={{ color: ENCRE_ACCENT }}>Panier (2)</a>} sombre={false} />
        ...
        {/* La planche contact du passage : quatre des cinq silhouettes, petites
            ...
            repetition. */}
        <Stagger className="o-grid o-list-none o-m-0 o-grid-cols-2 o-gap-2 o-p-0 o-px-2 md:o-grid-cols-4" as="ul" step={80}>
          {SILHOUETTES.slice(0, 4).map((silhouette) => (
            <li key={silhouette.rang} className="o-min-w-0">
              <div className="o-relative o-overflow-hidden o-bg-zinc-100 dark:o-bg-zinc-900" style={{ aspectRatio: '3 / 4' }}>
                <img src={photo(silhouette.graine, 700, 900)} alt={silhouette.alt} className="o-absolute o-inset-0 o-size-full o-object-cover" />
              </div>
              <p className="o-m-0 o-mt-2 o-flex o-items-baseline o-gap-2 o-font-mono o-text-xs o-uppercase o-tracking-widest">
                <span className="o-tabular-nums" style={{ color: ENCRE_ACCENT }}>{silhouette.rang}</span>
                <span className="o-min-w-0 o-truncate o-text-zinc-900 dark:o-text-zinc-50">{silhouette.piece}</span>
              </p>
            </li>
          ))}
        </Stagger>
        ...
        <div className="o-relative o-px-2 o-pb-4 o-pt-10">
          <Surgit delai={300} as="p" className="o-m-0 o-select-none o-whitespace-nowrap o-text-center o-uppercase o-text-zinc-950 dark:o-text-zinc-50" style={{ ...corps('xxl', 800), fontSize: 'clamp(3.5rem, 17.5vw, 19rem)', lineHeight: 0.84 }}>
            Lisiere
          </Surgit>
          ...
          <div className="o-mt-6 o-flex o-flex-wrap o-items-center o-justify-between o-gap-x-8 o-gap-y-3 o-px-4 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
            <Surgit delai={520} as="p" className="o-m-0">Numero douze — automne hiver 26</Surgit>
            <Surgit delai={600} as="p" className="o-m-0 o-max-w-md o-text-center">Trente-deux pieces, photographiees en pied, vendues telles quelles</Surgit>
            ...
            <Surgit delai={680} as="p" className="o-m-0">
              <a href="#defile" className="o-inline-flex o-items-center o-gap-2 o-no-underline o-underline-offset-8 hover:o-underline focus:o-ring" style={{ color: ENCRE_ACCENT }}>
                Le passage du 4 septembre <Icon icon={ArrowRight} size={13} aria-hidden="true" />
              </a>
            </Surgit>
          </div>
        </div>
      ...
      <section className={`o-border-b ${FILET} o-px-6 o-py-16 md:o-py-20`}>
        <div className="o-mx-auto o-max-w-4xl o-text-center">
          ...
          <p className="o-mx-auto o-mt-8 o-max-w-2xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">
            Lisiere edite deux collections par an et rien entre les deux. Chaque
            piece est coupee en France, en series de quarante, dans des tissus
            dont nous nommons le tisseur. La grille ci-dessous est le catalogue
            entier : il n y a pas de seconde page.
          </p>
      ...
      <div id="defile" aria-labelledby="defile-titre" className={`o-scroll-mt-24 o-border-b ${FILET}`}>
        <Rail
          ecrans={2.6}
          entete={
            <div className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-x-8 o-gap-y-2 o-px-6 o-pb-6 o-pt-8">
              <div>
                ...
                <h2 id="defile-titre" className="o-mt-3 o-font-serif o-tracking-tight" style={{ fontSize: 'clamp(1.75rem, 3.4vw, 3rem)', lineHeight: 1 }}>
        ...
        >
          ...
          <div className="o-mr-10 o-flex o-shrink-0 o-flex-col o-justify-end o-self-stretch o-pb-10" style={{ width: 'clamp(200px, 26vw, 320px)' }}>
            ...
            <p className="o-m-0 o-mt-4 o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">
              Les cinq silhouettes ci-contre sont passees dans cet ordre. Elles
              sont toutes en vente ; aucune n a ete coupee pour la seule photographie.
            </p>
          </div>

          {SILHOUETTES.map((silhouette) => (
            <figure key={silhouette.rang} className="o-m-0 o-mr-10 o-shrink-0" style={{ width: LARGEUR_SILHOUETTE }}>
              <div className="o-relative o-overflow-hidden o-bg-zinc-100 dark:o-bg-zinc-900" style={{ aspectRatio: '3 / 4' }}>
                <img src={photo(silhouette.graine, 900, 1200)} alt={silhouette.alt} decoding="async" className="o-absolute o-inset-0 o-size-full o-object-cover" />
              </div>
              <figcaption className={`o-mt-3 o-flex o-items-baseline o-gap-3 o-border-t ${FILET} o-pt-3 o-text-xs o-uppercase o-tracking-widest`}>
                <span className="o-tabular-nums" style={{ color: ENCRE_ACCENT }}>{silhouette.rang}</span>
                <span className="o-text-zinc-900 dark:o-text-zinc-50">{silhouette.piece}</span>
                <span className="o-ml-auto o-text-zinc-500 dark:o-text-zinc-400">{silhouette.matiere}</span>
              </figcaption>
            </figure>
          ))}

          {/* Le generique ferme le rail, comme au bas d une planche contact. */}
          <div className="o-mr-6 o-flex o-shrink-0 o-flex-col o-justify-center o-self-stretch" style={{ width: 'clamp(180px, 22vw, 260px)' }}>
            ...
            <p className="o-m-0 o-mt-6 o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
              Stylisme<br />
              <span className="o-text-zinc-900 dark:o-text-zinc-50">Nadia Berthier</span>
            </p>
            <p className="o-m-0 o-mt-6 o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
              Trente-deux pieces au cahier<br />Huit montrees ci-dessous
            </p>
          </div>
          <div aria-hidden="true" className="o-w-6 o-shrink-0" />
        </Rail>
      ...
      <section id="collection" className={`o-border-b ${FILET} o-px-6 o-py-16 md:o-py-24`}>
        <div className="o-mx-auto o-max-w-7xl">
          <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-6">
            ...
            <p className="o-max-w-sm o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">
              Prix nets, taxes comprises, livraison offerte a partir de 200 € en
              France. Les tailles vont du 34 au 46.
            </p>
          </div>
          ...
          {/*
            ...
            compteur suit.
          */}
          <div className={`o-mt-10 o-flex o-flex-wrap o-items-center o-gap-x-3 o-gap-y-3 o-border-t ${FILET} o-pt-6`}>
          ...
          <p aria-live="polite" className="o-mt-4 o-text-sm o-text-zinc-600 dark:o-text-zinc-300">
          ...
          */}
          <Reveal className="o-mt-10 o-grid o-gap-x-6 o-gap-y-12 md:o-grid-cols-2 lg:o-grid-cols-3">
            {cahier.map((piece, index) => (
              ...
              >
                <a href="#piece" className="o-block o-no-underline o-text-current focus:o-ring dark:o-text-current">
                  <HoverZoom
                    ...
                    zoom={1.08}
                  />
                  <div className={`o-mt-4 o-flex o-items-baseline o-justify-between o-gap-4 o-border-t ${FILET} o-pt-3`}>
                    <div>
                      <h3 className="o-font-serif o-text-lg o-tracking-tight">{piece.nom}</h3>
      ...
      <section id="piece" className={`o-border-b ${FILET} o-px-6 o-py-16 md:o-py-24`}>
        <div className="o-mx-auto o-grid o-max-w-7xl o-items-start o-gap-12 lg:o-grid-cols-2">
          <Reveal>
            <ImageStackSwipe
              images={[
                media('lisiere-piece-1', 'Le manteau Sablon, presente sur mannequin', 900, 640),
                media('lisiere-piece-2', 'La maille Cotiere, sur cintre', 900, 640),
                media('lisiere-piece-3', 'Le tissage de la laine, sur metier a bras', 900, 640),
                media('lisiere-piece-4', 'La doublure en cupro ecru, en detail', 900, 640),
              ]}
          ...
          <div>
            ...
            <p className="o-mt-6 o-max-w-prose o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">
              Laine bouillie 780 g/m2, doublure cupro, deux poches passepoilees et
              une poche interieure. Coupe droite, epaule tombee, longueur 112 cm
              en taille 38. Il se porte ferme sur une maille epaisse sans tirer.
            </p>
              ...
              <div id="guide-tailles" className="o-mt-6 o-w-full o-overflow-x-auto">
                <table className="o-w-full o-text-left o-text-sm">
                  <caption className="o-pb-3 o-text-left o-text-xs o-text-zinc-500 dark:o-text-zinc-400">
                    Mesures du corps en centimetres. Le manteau Sablon ajoute
                    12 cm d aisance a la poitrine : entre deux tailles, prenez la
                    plus petite.
                  </caption>
                  <thead>
                    <tr className={`o-border-b ${FILET_FORT}`}>
                      {['Taille', 'Poitrine', 'Ceinture', 'Bassin', 'Dos'].map((entete) => (
                        <th
                          key={entete}
                          scope="col"
                  ...
                  <tbody>
                    {GUIDE.map((ligne) => (
                      <tr key={ligne.taille} className={`o-border-b ${FILET}`}>
                        <th scope="row" className="o-py-2 o-pr-4 o-tabular-nums o-font-medium">
                          {ligne.taille}
                        </th>
                        <td className="o-py-2 o-pr-4 o-tabular-nums o-text-zinc-600 dark:o-text-zinc-300">{ligne.poitrine}</td>
                        <td className="o-py-2 o-pr-4 o-tabular-nums o-text-zinc-600 dark:o-text-zinc-300">{ligne.ceinture}</td>
                        <td className="o-py-2 o-pr-4 o-tabular-nums o-text-zinc-600 dark:o-text-zinc-300">{ligne.bassin}</td>
                        <td className="o-py-2 o-tabular-nums o-text-zinc-600 dark:o-text-zinc-300">{ligne.dos}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <dl className={`o-mt-10 o-grid o-gap-x-6 o-gap-y-4 o-border-t ${FILET} o-pt-6 sm:o-grid-cols-2`}>
              <div>
                <dt className="o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Serie</dt>
                <dd className="o-mt-1 o-text-sm">40 pieces, numerotees</dd>
              </div>
              <div>
                <dt className="o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Fabrication</dt>
                <dd className="o-mt-1 o-text-sm">Atelier Vasseur, Roubaix</dd>
              </div>
              <div>
                <dt className="o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Entretien</dt>
                <dd className="o-mt-1 o-text-sm">Nettoyage a sec, brosse douce</dd>
              </div>
              <div>
                <dt className="o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Retour</dt>
      ...
      <section id="matieres" className={`o-border-b ${FILET} o-px-6 o-py-16 md:o-py-24`}>
        <div className="o-mx-auto o-max-w-7xl">
          ...
          <p className="o-mt-6 o-max-w-2xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">
            La meme fiche est cousue dans chaque piece. Rien n est traite
            deperlant, rien n est enduit : un vetement qui se nettoie mal se
            porte moins.
          </p>

          <div className="o-mt-12 o-w-full o-overflow-x-auto">
            <table className="o-w-full o-text-left o-text-sm" style={{ minWidth: '46rem' }}>
              <caption className="o-sr-only">
                Composition, grammage, tisseur et entretien des six matieres de
                la collection automne hiver 26.
              </caption>
              <thead>
                <tr className={`o-border-b ${FILET_FORT}`}>
                  {['Matiere', 'Composition', 'Grammage', 'Tisseur', 'Entretien'].map((entete) => (
                    <th
                      key={entete}
                      scope="col"
              ...
              <tbody>
                {MATIERES.map((m) => (
                  <tr key={m.matiere} className={`o-border-b ${FILET}`}>
                    <th scope="row" className="o-py-4 o-pr-5 o-align-top o-font-serif o-text-base o-whitespace-nowrap">
                      {m.matiere}
                    </th>
                    <td className="o-py-4 o-pr-5 o-align-top o-text-zinc-600 dark:o-text-zinc-300">{m.composition}</td>
                    <td className="o-py-4 o-pr-5 o-align-top o-tabular-nums o-whitespace-nowrap o-text-zinc-600 dark:o-text-zinc-300">{m.grammage}</td>
                    <td className="o-py-4 o-pr-5 o-align-top o-text-zinc-600 dark:o-text-zinc-300">{m.tisseur}</td>
                    <td className="o-py-4 o-align-top o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">{m.entretien}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <p className="o-mt-6 o-text-sm o-italic o-text-zinc-500 dark:o-text-zinc-400">
            Un bouton perdu, une couture ouverte, un ourlet a reprendre : la
            reparation est gratuite a vie, boutique ou par voie postale.
          </p>
        </div>
      </section>

      {/* ----- Provenance et fabrication -------------------------------------- */}
      <section id="fabrication" className={`o-border-b ${FILET} o-px-6 o-py-16 md:o-py-24`}>
        <div className="o-mx-auto o-max-w-7xl">
          ...
          <Stagger className="o-mt-12 o-grid o-gap-10 md:o-grid-cols-3" step={90}>
            {FABRICATION.map((atelier) => (
              <article key={atelier.titre}>
                <img
                  src={photo(`lisiere-atelier-${atelier.titre.toLowerCase().replace(/ /g, '-')}`, 700, 500)}
                ...
                <h3 className="o-mt-5 o-flex o-items-center o-gap-2 o-font-serif o-text-xl o-tracking-tight">
                  <Icon icon={Scissors} size={18} style={{ color: ENCRE_ACCENT }} aria-hidden="true" />
                  {atelier.titre}
                </h3>
                <p className="o-mt-1 o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                  {atelier.lieu}
                ...
                <dl className={`o-mt-5 o-flex o-flex-col o-gap-2 o-border-t ${FILET} o-pt-4 o-text-sm`}>
                  <div className="o-flex o-flex-wrap o-gap-x-3">
                    <dt className="o-text-zinc-500 dark:o-text-zinc-400">Depuis</dt>
                    <dd className="o-text-zinc-700 dark:o-text-zinc-200">{atelier.depuis}</dd>
                  </div>
                  <div className="o-flex o-flex-wrap o-gap-x-3">
                    <dt className="o-text-zinc-500 dark:o-text-zinc-400">Effectif</dt>
                    <dd className="o-text-zinc-700 dark:o-text-zinc-200">{atelier.effectif}</dd>
                  </div>
                  <div className="o-flex o-flex-wrap o-gap-x-3">
                    <dt className="o-text-zinc-500 dark:o-text-zinc-400">Distance</dt>
                    <dd className="o-text-zinc-700 dark:o-text-zinc-200">{atelier.distance}</dd>
                  </div>
                  <div className="o-flex o-flex-wrap o-gap-x-3">
                    <dt className="o-text-zinc-500 dark:o-text-zinc-400">Y est fait</dt>
                    <dd className="o-text-zinc-700 dark:o-text-zinc-200">{atelier.fait}</dd>
                  </div>
                </dl>
              </article>
            ))}
          ...
          <p
            ...
            style={{ borderColor: ENCRE_ACCENT }}
          >
            Le prix de revient d un manteau Sablon se repartit ainsi : 118 € de
            tissu et fournitures, 96 € de faconnage, 34 € de transport et de
            controle, 232 € de marge brute — dont le loyer des trois boutiques,
            les salaires et les series invendues. Nous n avons ni sous-traitance
            en cascade, ni intermediaire.
          </p>
        </div>
      </section>
          ...
          <div className="o-mt-12 o-grid o-items-start o-gap-12 lg:o-grid-cols-3">
                ...
                <tbody>
                  {LIVRAISON.map((ligne) => (
                    <tr key={ligne.zone} className={`o-border-b ${FILET}`}>
                      <th scope="row" className="o-py-4 o-pr-5 o-align-top o-font-medium">
                        {ligne.zone}
                      </th>
                      <td className="o-py-4 o-pr-5 o-align-top o-whitespace-nowrap o-text-zinc-600 dark:o-text-zinc-300">
                        {ligne.delai}
                      </td>
                      <td className="o-py-4 o-pr-5 o-align-top o-whitespace-nowrap o-font-medium" style={{ color: ENCRE_ACCENT }}>
                        {ligne.frais}
                      </td>
                      <td className="o-py-4 o-align-top o-text-zinc-600 dark:o-text-zinc-300">{ligne.note}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              <p className="o-mt-4 o-text-sm o-text-zinc-600 dark:o-text-zinc-300">
                Commande passee avant 13 heures un jour ouvre : le colis part le
                jour meme. Aucune expedition le samedi ni le dimanche.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="o-mt-4 o-flex o-flex-col o-gap-6 o-list-none o-p-0">
                {RETOURS.map((point) => (
                  <li key={point.titre}>
                    <h4 className="o-font-serif o-text-lg o-tracking-tight">{point.titre}</h4>
      ...
      {/* ----- Boutiques ------------------------------------------------------ */}
      <section id="boutiques" className={`o-border-b ${FILET} o-px-6 o-py-16 md:o-py-24`}>
        <div className="o-mx-auto o-max-w-7xl">
            ...
            {BOUTIQUES.map((boutique) => (
              <article key={boutique.ville}>
                ...
                <div className={`o-mt-4 o-border-t ${FILET} o-pt-4`}>
                  <h3 className="o-font-serif o-text-xl o-tracking-tight">{boutique.ville}</h3>
                  ...
                  <dl className="o-mt-3 o-flex o-flex-col o-gap-1 o-text-sm">
                    {boutique.horaires.map(([jours, heures]) => (
                      <div key={jours} className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-3">
                        <dt className="o-text-zinc-500 dark:o-text-zinc-400">{jours}</dt>
                        <dd className="o-tabular-nums o-text-zinc-700 dark:o-text-zinc-200">{heures}</dd>
                      </div>
                    ))}
                  </dl>
                </div>
          ...
          <p className="o-mt-8 o-max-w-2xl o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-300">
            Les trois boutiques tiennent le catalogue entier et les sept tailles.
            Une piece reservee en ligne y attend quarante-huit heures, sans
            paiement. Retouches faites sur place, comptez cinq jours.
          </p>
        </div>
      </section>
      ...
      <footer id="panier" className={`o-scroll-mt-24 o-border-t ${FILET_FORT} o-overflow-hidden o-px-6 o-pt-14`}>
        <div className="o-mx-auto o-max-w-7xl">
          {/* La lettre de saison, en une ligne : deux champs, pas un ecran. */}
          <div className={`o-grid o-items-end o-gap-x-10 o-gap-y-6 o-border-b ${FILET} o-pb-12 md:o-grid-cols-12`}>
            <p className="o-m-0 o-font-serif o-tracking-tight md:o-col-span-7" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.75rem)', lineHeight: 1.05 }}>
          ...
          <div className="o-mt-12 o-grid o-gap-x-8 o-gap-y-10 o-font-mono o-text-xs o-uppercase o-tracking-widest sm:o-grid-cols-2 lg:o-grid-cols-4">
            <div>
              ...
              <p className="o-m-0 o-mt-4 o-leading-relaxed o-text-zinc-900 dark:o-text-zinc-50">
                18 rue de Poitou<br />75003 Paris<br />01 44 61 08 12
              </p>
              <a href="#boutiques" className="o-mt-4 o-inline-flex o-items-center o-gap-2 o-no-underline o-underline-offset-4 hover:o-underline focus:o-ring" style={{ color: ENCRE_ACCENT }}>
                bonjour@lisiere.fr <Icon icon={ArrowRight} size={12} aria-hidden="true" />
              </a>
            </div>
            {([
              ['Collection', [['#collection', 'Automne hiver 26'], ['#defile', 'Le defile'], ['#piece', 'Manteaux'], ['#collection', 'Archives']]],
              ['Maison', [['#fabrication', 'Ateliers'], ['#boutiques', 'Boutiques'], ['#livraison', 'Retours et echanges'], ['#matieres', 'Entretien']]],
            ] as const).map(([titre, liens]) => (
              <nav key={titre} aria-label={titre}>
                ...
                <ul className="o-m-0 o-mt-4 o-flex o-list-none o-flex-col o-gap-2 o-p-0">
                  {liens.map(([href, mot]) => (
                    <li key={mot}>
                      <a href={href} className="o-no-underline o-text-zinc-900 dark:o-text-zinc-50 o-underline-offset-4 hover:o-underline focus:o-ring">{mot}</a>
                    </li>
                  ))}
                </ul>
              </nav>
            ...
            <div>
              ...
              <p className="o-m-0 o-mt-4 o-leading-relaxed o-text-zinc-500 dark:o-text-zinc-400">
                Deux collections par an<br />Rien entre les deux
              </p>
            </div>
          </div>
        </div>
        ...
        <p
          ...
          style={{ ...corps('xxl', 800), fontSize: 'clamp(3rem, 18.5vw, 20rem)', lineHeight: 0.76 }}
        >
          Lisiere
        </p>

        <div className={`o-mx-auto o-mt-6 o-flex o-max-w-7xl o-flex-wrap o-items-baseline o-justify-between o-gap-x-8 o-gap-y-2 o-border-t ${FILET} o-py-6 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400`}>
          <p className="o-m-0">Lisiere SAS — RCS Paris 892 401 337 — TVA FR 42 892 401 337</p>
