...
import { Actions, affiche, BarreFilet, Etiquette, Indice, Manifeste, Porte, Surgit, TitreVague, usePolices } from './marche.jsx'
...
const TAILLES: readonly Taille[] = [
  { cle: 'petit', nom: 'Petit', tiges: '20 a 25 tiges', base: 26, hauteur: '35 cm environ' },
  { cle: 'moyen', nom: 'Moyen', tiges: '30 a 40 tiges', base: 42, hauteur: '50 cm environ' },
  { cle: 'grand', nom: 'Grand', tiges: '50 a 60 tiges', base: 68, hauteur: '65 cm environ' },
  { cle: 'brassee', nom: 'Brassee', tiges: '75 a 90 tiges', base: 96, hauteur: '80 cm environ' },
]
...
const CALENDRIER: readonly MoisFloral[] = [
  {
    ...
    absentes: 'Ni pivoine, ni dahlia, ni rose de jardin : rien de tout cela ne pousse en janvier.',
  },
  {
    ...
    absentes: 'Toujours pas de pivoine. Les roses viennent de serre, nous n en prenons pas.',
  },
  {
  ...
  {
    fleurs: ['Lilas', 'Tulipe perroquet', 'Muguet', 'Ancolie', 'Pois de senteur', 'Viburnum'],
  ...
  {
    fleurs: ['Pivoine', 'Rose de jardin', 'Pois de senteur', 'Lilas', 'Ancolie', 'Marguerite'],
  ...
  {
    fleurs: ['Rose de jardin', 'Delphinium', 'Astrance', 'Achillee', 'Scabieuse', 'Pivoine'],
    note: 'La rose de jardin francaise est a son maximum, parfum compris.',
    absentes: 'La pivoine s arrete au 20 : apres, c est de l import, nous nous abstenons.',
  },
  {
  ...
  {
    fleurs: ['Chrysantheme', 'Dahlia', 'Sedum', 'Branches a baies', 'Anemone du Japon', 'Eucalyptus'],
  ...
  {
    fleurs: ['Chrysantheme', 'Renoncule', 'Anemone', 'Branches a baies', 'Pin', 'Eucalyptus'],
...
const PAPIER: CSSProperties = { backgroundColor: 'light-dark(#f6efe5, var(--o-palette-stone-950))' }
...
export default function Page(): ReactElement {
  ...
  const laPalette = PALETTES_FLORALES.find((p) => p.cle === palette) ?? PALETTES_FLORALES[0]
  ...
  const compte = useMemo(() => {
    if (laTaille === undefined || laPalette === undefined || laZone === undefined) return undefined
  ...
  return (
    ...
    <div className="o-text-stone-900 dark:o-text-stone-100" style={{ ...polices, ...PAPIER }}>
      {/* ================= 1. L ouverture : creme, le nom a la main ======== */}
      <header className="o-relative o-isolate">
        <BarreFilet sombre={false} marque="Tige & Co" liens={[['#saison', 'La saison'], ['#atelier', 'L atelier'], ['#carnet', 'Commander']]} action={['#adresse', 'Venir a l atelier']} />
        ...
        <div className="o-relative o-z-10 o-mx-auto o-grid o-max-w-6xl o-items-center o-gap-10 o-px-6 o-pb-16 o-pt-14 lg:o-grid-cols-12 lg:o-gap-8 lg:o-pt-20">
          <div className="o-min-w-0 lg:o-col-span-7">
            <Surgit>
              <Etiquette sombre={false}>Fleuriste — Paris 11e — ouvert jusqu a 19 h 30</Etiquette>
            </Surgit>
            <Surgit delai={140} className="o-mt-8">
              <HandWritten path={TRACE_NOM} viewBox="0 0 320 110" width={320} thickness={4} duration={2200} declenchement="montage" color={encre()} className="o-max-w-full">
                Tige & Co
              </HandWritten>
            </Surgit>
            <TitreVague delai={320} cadence={90} className="o-m-0 o-mt-2 o-max-w-3xl o-uppercase o-text-stone-950 dark:o-text-stone-50" style={{ ...affiche('l', 800), fontSize: 'clamp(2.75rem, 8vw, 8rem)' }}>
              Ce qui est sur l etal ce matin.
            </TitreVague>
            {moisFloral !== undefined && (
              <Surgit delai={720} as="p" className="o-m-0 o-mt-8 o-max-w-lg o-text-lg o-leading-relaxed o-text-stone-600 dark:o-text-stone-300">
            ...
            <Surgit delai={840} className="o-mt-9">
              <Actions sombre={false} pleine={['#carnet', <>Composer un bouquet <Icon icon={ArrowRight} size={16} aria-hidden="true" /></>]} fantome={['#saison', 'Ce qui pousse']} />
            </Surgit>
          </div>

          {/* La brassee derive, et mord sur la section suivante. */}
          <Surgit delai={500} className="o-relative o-min-w-0 lg:o-col-span-5" style={{ marginBottom: 'min(0px, calc(2rem - 8vw))' }}>
            <Parallaxe vitesse={0.18} echelle={0.03}>
              ...
              <Devoile src={photo('tige-brassee', 1000, 1250)} alt="Une brassee de fleurs de saison, papier kraft, posee sur la table de l atelier" ratio="4 / 5" depuis="bas" derive={48} className="o-overflow-hidden o-rounded-3xl o-shadow-2xl" />
            </Parallaxe>
            {/* Les petales : des autocollants colles de travers, qui flottent et se decollent au survol. */}
            <Flotte amplitude={6} duree={7} angle={-8} className="o-absolute o-z-20" style={{ top: '-1.25rem', left: '-1rem' }}>
              <StickerPeel corner="top-right" size={34} className="o-rounded-2xl">
                <span className="o-block o-px-4 o-py-2.5 o-text-sm o-font-semibold" style={aplat()}>Monte ce matin</span>
              </StickerPeel>
            </Flotte>
            <Flotte amplitude={8} duree={9} delai={-3} angle={7} className="o-absolute o-z-20" style={{ bottom: '3rem', right: '-1.25rem' }}>
              <StickerPeel corner="bottom-left" size={34} className="o-rounded-2xl">
                <span className="o-block o-px-4 o-py-2.5 o-text-sm o-font-semibold" style={aplat()}>Livre a velo en 2 h</span>
              </StickerPeel>
            </Flotte>
            <Flotte amplitude={5} duree={8} delai={-5} angle={4} className="o-absolute o-z-20 o-hidden md:o-block" style={{ top: '38%', right: '-2.5rem' }}>
              <StickerPeel corner="top-left" size={30} className="o-rounded-2xl">
                <span className="o-block o-px-4 o-py-2.5 o-text-sm o-font-semibold" style={aplat()}>Sept jours de tenue</span>
              </StickerPeel>
            </Flotte>
          </Surgit>
        </div>
        ...
        <p className="o-pointer-events-none o-absolute o-bottom-6 o-left-6 o-z-0 o-m-0 o-hidden o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-500 dark:o-text-stone-400 md:o-block">
          22 rue de la Folie-Mericourt<br />Paris 11e
        </p>
      </header>

      <main>
        {/* ================= 2. La saison : manifeste, photos en decale, douze mois ===== */}
        <section id="saison" aria-labelledby="saison-titre" className="o-scroll-mt-24 o-mx-auto o-max-w-6xl o-px-6 o-pb-24 o-pt-28 md:o-pt-40">
          <Indice rang="01" sombre={false}>La saison</Indice>
          <h2 id="saison-titre" className="o-sr-only">Ce qui pousse ce mois-ci</h2>
          {moisFloral !== undefined && (
            <div className="o-mt-8">
              <Manifeste sombre={false} eteint={`En ${MOIS[moisCourant]}, l etal ne connait que six fleurs :`}>
          ...
          <div className="o-relative o-mt-20 o-grid o-grid-cols-12 o-gap-4 md:o-gap-8">
            <Parallaxe vitesse={0.14} className="o-col-span-7 md:o-col-span-5">
              <Devoile src={photo('tige-fevrier', 900, 1100)} alt="Renoncules en fleur, avant montage" ratio="4 / 5" depuis="bas" derive={30} legende="Renoncules — de janvier a mars" />
            </Parallaxe>
            <Parallaxe vitesse={-0.1} className="o-self-end md:o-pb-24" style={{ gridColumn: 'span 5 / 13' }}>
              <Devoile src={photo('tige-tulipes', 700, 900)} alt="Tulipes perroquet roses et mimosa" ratio="3 / 4" depuis="droite" derive={24} legende="Tulipes perroquet — le mardi" />
            </Parallaxe>
            <Parallaxe vitesse={0.2} className="o-col-span-10 o-col-start-2 md:o-col-span-6 md:o-col-start-4" style={{ marginTop: '-2rem' }}>
              <Devoile src={photo('tige-rose', 1200, 800)} alt="Roses de jardin et pivoines roses, en brassee" ratio="3 / 2" depuis="gauche" derive={36} legende="Roses de jardin — six semaines de mai" className="o-shadow-2xl" />
            </Parallaxe>
            <p className="o-col-span-12 o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-500 dark:o-text-stone-400 md:o-absolute md:o-right-0 md:o-top-0 md:o-w-56 md:o-text-right">
              Quatre producteurs, Ile-de-France et Val de Loire. Coupe la veille, sur le seau le matin.
            </p>
          </div>
          ...
          <div className="o-mt-24 o-border-t o-border-stone-900 dark:o-border-stone-100 o-pt-6">
            ...
            <div role="group" aria-label="Choisir un mois du calendrier des fleurs" className="o-relative o-flex o-gap-1 o-overflow-x-auto o-pb-2 o-scrollbar dark:o-scrollbar-dark">
                  ...
                  <button
                    ...
                    style={
                      actif
                        ...
                        : { borderColor: courant ? encre() : 'var(--o-theme-line)', color: courant ? encre() : 'inherit' }
                    }
                  >
            ...
            {moisChoisi !== undefined && (
              <div aria-live="polite" className="o-mt-8 o-grid o-gap-6 md:o-grid-cols-12">
                <p className="o-m-0 o-text-2xl o-font-semibold o-leading-snug o-tracking-tight md:o-col-span-7 md:o-text-3xl">
                  <span className="o-capitalize">{MOIS[moisVu]}</span> : {moisChoisi.fleurs.join(', ').toLowerCase()}.
                </p>
                <div className="md:o-col-span-5">
                  <p className="o-m-0 o-text-sm o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">{moisChoisi.note}</p>
                  <p className="o-m-0 o-mt-3 o-text-sm o-leading-relaxed" style={{ color: encre() }}>{moisChoisi.absentes}</p>
                </div>
              </div>
            )}
          </div>
        ...
        <section id="atelier" aria-labelledby="atelier-titre" className="o-scroll-mt-24 o-border-t o-border-stone-200 dark:o-border-stone-800">
          <div className="o-mx-auto o-grid o-max-w-6xl o-gap-10 o-px-6 o-py-20 md:o-grid-cols-12 md:o-py-28">
            <div className="o-min-w-0 md:o-col-span-4">
              <div className="md:o-sticky" style={{ top: 133 }}>
                <Indice rang="02" sombre={false}>L atelier</Indice>
                <h2 id="atelier-titre" className="o-m-0 o-mt-6 o-text-stone-950 dark:o-text-stone-50" style={{ ...affiche('m', 800), fontSize: 'clamp(2rem, 4.5vw, 4rem)' }}>
                ...
                <p className="o-mt-6 o-max-w-xs o-text-base o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
                  Les couronnes partent dans l heure ; les bouquets du jour attendent sur le seau, pas dans une chambre froide.
                </p>
              </div>
            </div>
            ...
            <div className="o-grid o-grid-cols-12 o-gap-4 md:o-col-span-8 md:o-gap-6">
              <Reveal className="o-col-span-12 sm:o-col-span-8">
                <HoverZoom src={photo('tige-atelier-couronne', 1200, 900)} alt="Le tressage d une base de couronne" ratio={1.333} zoom={1.18} className="o-w-full o-rounded-2xl" />
                <p className="o-m-0 o-mt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">La couronne — huit par jour, pas une de plus</p>
              </Reveal>
              <Reveal delay={90} className="o-col-span-6 sm:o-col-span-4 sm:o-mt-16">
                <HoverZoom src={photo('tige-atelier-rond', 700, 700)} alt="Un bouquet rond, monte en spirale" ratio={1} zoom={1.18} className="o-w-full o-rounded-2xl" />
                <p className="o-m-0 o-mt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">Le rond, en spirale</p>
              </Reveal>
              <Reveal delay={180} className="o-col-span-6 sm:o-col-span-4 sm:o-col-start-3">
                <HoverZoom src={photo('tige-atelier-sechees', 700, 700)} alt="Une tete sechee, gardee pour l hiver" ratio={1} zoom={1.18} className="o-w-full o-rounded-2xl" />
                <p className="o-m-0 o-mt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">Les sechees, pour l hiver</p>
              </Reveal>
            </div>
          </div>
        </section>
        ...
        <section id="carnet" aria-labelledby="carnet-titre" className="o-scroll-mt-24 o-border-t o-border-stone-200 dark:o-border-stone-800">
          <div className="o-mx-auto o-max-w-6xl o-px-6 o-pt-20 md:o-pt-28">
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              <div className="md:o-col-span-8">
                <Indice rang="03" sombre={false}>Le carnet de commandes</Indice>
                <h2 id="carnet-titre" className="o-m-0 o-mt-6 o-max-w-2xl o-text-stone-950 dark:o-text-stone-50" style={{ ...affiche('m', 800), fontSize: 'clamp(2rem, 4.5vw, 4rem)' }}>
              ...
              <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-500 dark:o-text-stone-400 md:o-col-span-4 md:o-text-right">
                Le prix se recalcule a chaque choix<br />Port offert des 50 EUR a velo
              </p>
            </div>
          </div>
          ...
          <div className="o-mx-auto o-grid o-max-w-6xl o-gap-10 o-px-6 o-pb-24 o-pt-12 lg:o-grid-cols-12 lg:o-gap-10">
            ...
            <aside aria-label="Composer un bouquet" className="lg:o-col-span-3">
              <div className="lg:o-sticky" style={{ top: 133 }}>
                {([
                  ['Taille', TAILLES.map((t) => [t.cle, t.nom, t.tiges] as const), taille, setTaille],
                  [
                    'Palette',
                  ...
                  ['Livraison', ZONES.map((z) => [z.cle, z.nom, z.delai] as const), zone, setZone],
                ] as const).map(([titre, options, courant, poser], rang) => (
                  <fieldset key={titre} className={`o-m-0 o-p-0 ${rang > 0 ? 'o-mt-5' : ''}`}>
                        ...
                        return (
                          <li key={cle}>
                            <button
                              ...
                              style={actif ? { backgroundColor: accentDoux(500, 15) } : undefined}
                            >
                              <span
                                className="o-block o-text-sm"
                                style={actif ? { color: encre(), fontWeight: 600 } : undefined}
                              >
                                {nom}
                              </span>
                              ...
                              <span
                                ...
                                style={
                                  actif
                                    ? { color: 'color-mix(in oklab, var(--o-theme-fg) 72%, transparent)' }
                ...
                {compte !== undefined && laTaille !== undefined && laPalette !== undefined && laZone !== undefined && (
                  <dl
                    aria-live="polite"
                  ...
                  >
                    <div className="o-flex o-items-baseline o-justify-between o-gap-3">
                      <dt className="o-text-stone-600 dark:o-text-stone-400">Les fleurs</dt>
                      <dd className="o-m-0 o-tabular-nums">{euros(compte.fleurs)}</dd>
                    </div>
                    <div className="o-flex o-items-baseline o-justify-between o-gap-3">
                      <dt className="o-text-stone-600 dark:o-text-stone-400">Le port</dt>
                    ...
                    <div className="o-mt-1.5 o-flex o-items-baseline o-justify-between o-gap-3 o-border-t o-border-stone-200 dark:o-border-stone-800 o-pt-2">
                      <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest">Total</dt>
                      <dd className="o-m-0 o-text-2xl o-font-bold o-tabular-nums o-tracking-tight" style={{ color: encre() }}>
                        {euros(compte.total)}
                      </dd>
                    </div>
                    <p className="o-m-0 o-mt-2 o-text-xs o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
                      ...
                      {!deSaison && (
                        <span style={{ color: encre() }}>
                          {' '}
                          Cette palette n est pas de saison en {MOIS[moisCourant]} : nous la
                          montons avec ce qui existe, et le resultat differe de la photographie.
                        </span>
                      )}
                    </p>
                    <p className="o-m-0 o-mt-2 o-flex o-items-start o-gap-1.5 o-text-xs o-text-stone-600 dark:o-text-stone-400">
                      <Icon icon={laZone.cle === 'velo' ? Bike : Truck} size={12} className="o-mt-0.5 o-shrink-0" aria-hidden="true" />
                      {laZone.delai}
                      {laZone.franchise > 0 && <span> — port offert des {euros(laZone.franchise)} de fleurs</span>}
                    </p>
                    <button type="button" className="o-mt-3 o-inline-flex o-w-full o-items-center o-justify-center o-gap-2 o-rounded-full o-px-5 o-py-3 o-text-sm o-font-semibold o-transition-transform hover:o-scale-105 focus:o-ring" style={aplat()}>
                      Commander ce bouquet <Icon icon={ArrowRight} size={16} aria-hidden="true" />
                    </button>
                  </dl>
                )}
              </div>
                ...
                {BOUQUETS.map((bouquet, rang) => (
                  <li key={bouquet.nom} className={rang % 3 === 1 ? 'lg:o-mt-12' : ''}>
                    ...
                    <p className="o-m-0 o-mt-3 o-flex o-items-baseline o-justify-between o-gap-3">
                      <span className="o-text-lg o-font-semibold o-tracking-tight">{bouquet.nom}</span>
                      <span className="o-shrink-0 o-tabular-nums o-font-semibold" style={{ color: encre() }}>
                        {bouquet.prix} EUR
                      </span>
                    </p>
        ...
        <section id="adresse" aria-labelledby="adresse-titre" className="o-scroll-mt-24 o-border-t o-border-stone-900 dark:o-border-stone-100">
          <div className="o-mx-auto o-max-w-6xl o-px-6 o-py-24 md:o-py-36">
            <h2 id="adresse-titre" className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
              Venir chercher
            </h2>
            <p className="o-m-0 o-mt-8 o-uppercase o-text-stone-950 dark:o-text-stone-50" style={{ ...affiche('xl', 800), fontSize: 'clamp(2.5rem, 9.5vw, 10rem)', lineHeight: 0.88 }}>
              22 rue de la<br />Folie-Mericourt
            </p>
            <p className="o-m-0 o-mt-8 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-stone-500 dark:o-text-stone-400">
              Paris 11e — Parmentier, Oberkampf<br />Du mardi au samedi, 9 h — 19 h 30 — dimanche jusqu a midi
            </p>
          </div>
        </section>
      </main>
      ...
      <footer className="o-border-t o-border-stone-900 dark:o-border-stone-100">
        <div className="o-mx-auto o-max-w-5xl o-px-6 o-pb-12 o-pt-16 md:o-pb-16 md:o-pt-24">
          <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-x-10 o-gap-y-6">
            <div>
              <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-500 dark:o-text-stone-400">Colophon</p>
            ...
            <HandWritten path={TRACE_NOM} viewBox="0 0 320 110" width={190} thickness={3} duration={2000} declenchement="vue" color={encre()} className="o-max-w-full">
              Tige & Co
            </HandWritten>
          </div>
          ...
          <dl className="o-m-0 o-mt-12 o-text-sm o-leading-relaxed o-text-stone-600 dark:o-text-stone-400">
            {([
              ['Caracteres', <>Bricolage Grotesque pour les titres, Figtree pour le texte, JetBrains Mono pour les notes. Le nom est trace a la main, d un seul trait.</>],
              ['Papier', <>Creme chaude, encre pierre. Rien ne bouge derriere le texte : ce sont les fleurs qui derivent.</>],
              ['Photographies', <>Wikimedia Commons — Lizzie Amianyuhua (CC0), Didier Descouens et Boris Presseq, Acabashi, Wolfmann, Geoff Derrin, Pittigrilli (CC BY-SA 4.0), Jebulon, Nguyenthibeut (CC BY-SA 3.0), et une couronne sans nom (CC0).</>],
              ['Fleurs', <>Quatre producteurs nommes, Ile-de-France et Val de Loire. Rien qui ait pris l avion, jamais, meme en decembre.</>],
              ['Mentions', <>Tige &amp; Co SARL — RCS Paris 852 330 117. <a href="mailto:bonjour@tige.paris" className="o-no-underline o-text-stone-900 dark:o-text-stone-100 hover:o-underline focus:o-ring">bonjour@tige.paris ↗</a></>],
            ] as const).map(([terme, texte]) => (
              <div key={terme} className="o-grid o-gap-x-8 o-gap-y-1 o-border-t o-border-stone-300 dark:o-border-stone-700 o-py-4 md:o-grid-cols-12">
                <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-stone-900 dark:o-text-stone-100 md:o-col-span-3">{terme}</dt>
