...
const VOIES: readonly Voie[] = [
  {
    ...
    prises: [
      { x: 96, y: 840, forme: 'Bac', tenue: 700, mouvement: 'Depart les deux mains au bac' },
      { x: 148, y: 764, forme: 'Bac', tenue: 320, mouvement: 'Main droite, croise court' },
      ...
      { x: 122, y: 534, forme: 'Reglette', tenue: 420, mouvement: 'Reglette a deux doigts' },
      { x: 196, y: 462, forme: 'Bac', tenue: 280, mouvement: 'Jete court, il passe tout seul' },
      ...
      { x: 210, y: 86, forme: 'Relais', tenue: 620, mouvement: 'Relais — on mousquetonne' },
    ],
  },
  {
    id: '6a+',
    ...
    prises: [
      { x: 240, y: 848, forme: 'Bac', tenue: 620, mouvement: 'Depart assis, pieds hauts' },
      { x: 292, y: 762, forme: 'Reglette', tenue: 340, mouvement: 'Reglette plate, main droite' },
      { x: 238, y: 688, forme: 'Inverse', tenue: 420, mouvement: 'Inverse — le bassin rentre' },
      { x: 300, y: 604, forme: 'Pince', tenue: 300, mouvement: 'Pince, coude haut' },
      { x: 244, y: 520, forme: 'Reglette', tenue: 280, mouvement: 'Relance, on ne pose pas' },
      { x: 312, y: 440, forme: 'Bac', tenue: 260, mouvement: 'Le seul bac de la voie' },
      { x: 250, y: 352, forme: 'Plat', tenue: 540, mouvement: 'Plat glissant, pied a plat' },
      { x: 318, y: 272, forme: 'Reglette', tenue: 320, mouvement: 'Deux doigts, bras tendu' },
      { x: 262, y: 186, forme: 'Pince', tenue: 380, mouvement: 'Pince haute, on se redresse' },
      { x: 296, y: 92, forme: 'Relais', tenue: 640, mouvement: 'Relais — deux mousquetons' },
    ],
  },
  {
    id: '6c',
    ...
    prises: [
      { x: 62, y: 844, forme: 'Bac', tenue: 560, mouvement: 'Depart debout, main gauche' },
      ...
      { x: 136, y: 626, forme: 'Plat', tenue: 300, mouvement: 'Premier plat, on ralentit' },
      { x: 86, y: 552, forme: 'Reglette', tenue: 380, mouvement: 'Reglette, pied droit haut' },
      { x: 158, y: 486, forme: 'Bidoigt', tenue: 1600, mouvement: 'Le crux — bidoigt, on cherche' },
      { x: 104, y: 410, forme: 'Inverse', tenue: 1180, mouvement: 'Inverse sous la bavette' },
      { x: 182, y: 338, forme: 'Pince', tenue: 820, mouvement: 'Sortie de bavette, epaule bloquee' },
      { x: 128, y: 258, forme: 'Bac', tenue: 300, mouvement: 'Repos genou, on secoue' },
      { x: 196, y: 182, forme: 'Reglette', tenue: 340, mouvement: 'Dernier pas difficile' },
      { x: 154, y: 104, forme: 'Bac', tenue: 260, mouvement: 'Bac du haut' },
      { x: 188, y: 62, forme: 'Relais', tenue: 620, mouvement: 'Relais — fin de la voie' },
    ],
  },
  {
    id: '7a',
    ...
    prises: [
      { x: 300, y: 852, forme: 'Bac', tenue: 700, mouvement: 'Depart, talon droit engage' },
      { x: 352, y: 786, forme: 'Pince', tenue: 460, mouvement: 'Pince, le bassin sort' },
      { x: 296, y: 712, forme: 'Reglette', tenue: 900, mouvement: 'Reglette, corps en tension' },
      { x: 356, y: 630, forme: 'Inverse', tenue: 1340, mouvement: 'Inverse sous le toit' },
      { x: 292, y: 560, forme: 'Bidoigt', tenue: 1820, mouvement: 'Le crux — bidoigt plein toit' },
      { x: 348, y: 486, forme: 'Plat', tenue: 1440, mouvement: 'Plat, talon gauche a recaler' },
      { x: 284, y: 412, forme: 'Reglette', tenue: 1120, mouvement: 'Sortie de toit, tout part du pied' },
      { x: 344, y: 330, forme: 'Bac', tenue: 420, mouvement: 'Premier bac depuis le sol' },
      { x: 288, y: 248, forme: 'Pince', tenue: 520, mouvement: 'Pince, on respire enfin' },
...
const JOURNEE: readonly Creneau[] = [
  ...
  { debut: 14, fin: 16.5, nom: 'Scolaires — college Jean-Mace', genre: 'ferme', places: 0 },
...
function Panneaux({ couleur, pas = 96 }: { readonly couleur: string; readonly pas?: number }): ReactElement {
  return (
    <div
      aria-hidden="true"
...
function Poussiere({ nombre, germe }: { readonly nombre: number; readonly germe: number }): ReactElement {
...
function Degaine({ hauteur = 54, couleur }: { readonly hauteur?: number; readonly couleur: string }): ReactElement {
  return (
    <svg viewBox="0 0 20 60" width={hauteur / 3} height={hauteur} aria-hidden="true" fill="none">
 ...
 */
function Grimpeur({ largeur = 150, couleur, corde }: { readonly largeur?: number; readonly couleur: string; readonly corde: string }): ReactElement {
  return (
    <svg viewBox="0 0 120 190" width={largeur} height={largeur * 1.58} aria-hidden="true" fill="none">
      {/* Le bras gauche tendu vers la prise, le droit plie. */}
      <path d="M52 76 L30 34" stroke={couleur} strokeWidth="9" strokeLinecap="round" />
      <path d="M70 78 L92 52 L84 86" stroke={couleur} strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <path d="M55 106 L38 132 L46 162" stroke={couleur} strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M67 106 L84 128 L78 160" stroke={couleur} strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
...
function Coupe(): ReactElement {
  ...
  return (
    <svg viewBox="0 0 1100 210" className="o-h-auto o-w-full" role="img" aria-label="Coupe de la paroi : dalle a 82 degres, vertical, devers a 108 degres, toit a 152 degres, relais a 17,4 metres">
      {/* Le sol. */}
      <path d="M20 196H1080" stroke={accentDoux(700, 30)} strokeWidth="1" strokeDasharray="3 7" />
      ...
      {reperes.map((repere) => (
        <g key={repere.nom}>
          <path d={`M${String(repere.x)} 196V${String(repere.y)}`} stroke={accentDoux(700, 26)} strokeWidth="1" />
          <text x={repere.x} y={repere.y - 24} fontSize="17" textAnchor="middle" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.14em', color: 'var(--o-theme-fg)' }}>
            {repere.nom.toUpperCase()}
          </text>
          <text x={repere.x} y={repere.y - 6} fontSize="15" textAnchor="middle" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', color: 'var(--o-theme-muted)' }}>
            {repere.angle}
          </text>
        </g>
      ))}
      <text x="1086" y="28" fontSize="15" textAnchor="end" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.12em', color: 'var(--o-theme-muted)' }}>
        RELAIS 17,4 M
      </text>
    </svg>
  )
  ...
  return (
    <div className="o-grid o-gap-10 md:o-grid-cols-12 md:o-gap-14">
      ...
      <div className="md:o-col-span-6 lg:o-col-span-5">
        <ClickSparks color={accent(400)} count={12} distance={56} className="o-rounded-2xl">
          <div className="o-relative o-overflow-hidden o-rounded-2xl" style={{ backgroundColor: accentDoux(950, 88) }}>
            <Panneaux couleur="color-mix(in oklab, white 7%, transparent)" pas={70} />
            <Semis nombre={34} germe={911} couleur="color-mix(in oklab, white 13%, transparent)" taille={22} opacite={1} />
            <svg viewBox="0 0 420 900" className="o-relative o-h-auto o-w-full" role="img" aria-label={`Le trace de la voie ${voie?.cotation ?? ''} — ${voie?.nom ?? ''}`}>
              {/* Le sol, et la ligne des dix metres. */}
              <path d="M0 880H420" stroke="color-mix(in oklab, white 26%, transparent)" strokeWidth="2" />
              {[200, 440, 680].map((y, index) => (
                <g key={y}>
                  <path d={`M0 ${String(y)}H420`} stroke="color-mix(in oklab, white 10%, transparent)" strokeWidth="1" strokeDasharray="4 10" />
                  <text x="8" y={y - 8} fontSize="15" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.14em', color: 'var(--o-palette-stone-400)' }}>
                    {String((3 - index) * 4)} M
                  </text>
                </g>
              ))}
              ...
              <path d={`M${ligne}`} fill="none" stroke="color-mix(in oklab, white 14%, transparent)" strokeWidth="3" strokeLinejoin="round" strokeLinecap="round" />
              <path
                d={`M${ligne}`}
                fill="none"
                stroke={accent(400)}
                ...
                style={{
                  ...
                  transition: reduced ? undefined : `stroke-dashoffset ${String(duree)}ms cubic-bezier(0.4, 0, 0.3, 1)`,
                }}
              />
                ...
                return (
                  <g key={`${String(prise.x)}-${String(prise.y)}`}>
                    {relais && allumee && !reduced && (
                      <circle data-o-es-relais="" cx={prise.x} cy={prise.y} r="13" fill="none" stroke={accent(400)} strokeWidth="1.5" style={{ transformOrigin: `${String(prise.x)}px ${String(prise.y)}px` }} />
                    )}
                    <ellipse
                      cx={prise.x}
                      cy={prise.y}
                      rx={relais ? 13 : 12}
                      ry={relais ? 13 : 8}
                      transform={relais ? undefined : `rotate(${String((index % 5) * 26 - 50)} ${String(prise.x)} ${String(prise.y)})`}
                      fill={allumee ? accent(400) : 'color-mix(in oklab, white 16%, transparent)'}
                    ...
                    <text
                      ...
                      fontSize="14"
                      fill="currentColor"
                      style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.1em', color: allumee ? 'var(--o-palette-stone-50)' : 'var(--o-palette-stone-400)' }}
                    >
      ...
      <div className="md:o-col-span-6 lg:o-col-span-7">
        <div className="o-flex o-flex-wrap o-items-center o-gap-4">
          <PillTabs
            ...
            size="sm"
            style={{ '--o-pill-fill': accentDoux(300, 46), '--o-pill-ink': encre() } as CSSProperties}
        ...
        <h3 className="o-m-0 o-mt-8 o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 700), fontSize: 'clamp(1.75rem, 3.6vw, 3.25rem)', lineHeight: 0.94 }}>
          {voie?.nom ?? ''}
        </h3>
        <p className="o-m-0 o-mt-4 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">{voie?.note ?? ''}</p>

        <dl className="o-m-0 o-mt-8 o-grid o-gap-px sm:o-grid-cols-3" style={{ backgroundColor: accentDoux(700, 18) }}>
          {[
            ...
            <div key={quoi} className="o-bg-zinc-50 dark:o-bg-zinc-950 o-px-4 o-py-4">
              ...
              <dd className="o-m-0 o-mt-2 o-font-mono o-text-sm o-text-zinc-950 dark:o-text-zinc-50">{valeur}</dd>
            </div>
          ))}
        </dl>
        ...
        <div className="o-mt-8 o-rounded-2xl o-p-6" style={nuit('zinc')}>
          <p className="o-m-0 o-flex o-items-center o-gap-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">
            <span style={{ color: encreSurSombre() }}>{String(Math.min(rang, prises.length)).padStart(2, '0')}</span>
            <span aria-hidden="true" className="o-h-px o-w-6 o-bg-white-20" />
            {fini ? 'Voie enchainee' : `Mouvement sur ${String(prises.length)}`}
          </p>
          <p className="o-m-0 o-mt-4 o-text-zinc-50" aria-live="polite" style={{ ...affiche('m', 300), fontSize: 'clamp(1.25rem, 2.6vw, 2rem)', lineHeight: 1.06 }}>
            {courante?.mouvement ?? ''}
          </p>
          ...
          <div aria-hidden="true" className="o-mt-5 o-flex o-items-end o-gap-1" style={{ height: 46 }}>
            {prises.map((prise, index) => (
              <span
                ...
                style={{
                  ...
                  minHeight: 3,
                  backgroundColor: index < rang ? accent(400) : 'color-mix(in oklab, white 16%, transparent)',
          ...
          <p className="o-m-0 o-mt-3 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500">
            Chaque barre est le temps passe sur une prise. La ligne met ce temps-la a la rejoindre.
          </p>
        </div>
        ...
        <dl className="o-m-0 o-mt-8 o-flex o-flex-wrap o-gap-x-10 o-gap-y-4 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-6">
          {[
            ['Mouvement le plus long', `${String(Math.max(...prises.map((prise) => prise.tenue)))} ms`],
            ['Tour complet', `${(prises.reduce((somme, prise) => somme + prise.tenue, 0) / 1000).toFixed(1).replace('.', ',')} s`],
            ['Prises comptees', String(prises.length)],
          ].map(([quoi, valeur]) => (
            <div key={quoi}>
              <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">{quoi}</dt>
              <dd className="o-m-0 o-mt-1 o-font-mono o-text-sm o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50">{valeur}</dd>
            </div>
          ))}
        </dl>
      </div>
  ...
  return (
    <div className="o-flex o-h-full o-items-end o-p-6 md:o-p-10">
      <div className="o-max-w-md o-rounded-2xl o-border-w-1 o-border-white-10 o-bg-black-70 o-p-6 o-backdrop-blur-xl md:o-p-8">
        ...
        <h3 className="o-m-0 o-mt-4 o-text-zinc-50" style={{ ...affiche('m', 700), fontSize: 'clamp(1.5rem, 3.2vw, 2.75rem)', lineHeight: 0.94 }}>
          {etage.nom}
        </h3>
        <p className="o-m-0 o-mt-4 o-text-sm o-leading-relaxed o-text-zinc-300">{etage.texte}</p>
        <dl className="o-m-0 o-mt-5">
          {etage.detail.map(([quoi, valeur]) => (
            <div key={quoi} className="o-flex o-items-baseline o-justify-between o-gap-4 o-border-t o-border-white-10 o-py-2">
...
export default function Page(): ReactElement {
  ...
  const grimper = (p: number): void => {
    const haut = p * SOMMET
    if (metres.current !== null) metres.current.textContent = haut.toFixed(1).replace('.', ',')
    let rang = 0
    ...
    <Porte forme="trou" marque="Devers" sombre={false}>
      <div className="o-bg-zinc-50 dark:o-bg-zinc-950 o-text-zinc-900 dark:o-text-zinc-50" style={polices}>
        ...
        <header className="o-relative o-isolate o-flex o-flex-col o-overflow-hidden" style={{ minHeight: `calc(100vh - ${String(CHROME)}px)` }}>
          <div aria-hidden="true" className="o-absolute o-inset-0 o-z-0" style={{ backgroundColor: accentDoux(200, 22) }}>
            <Panneaux couleur={accentDoux(800, 16)} pas={110} />
            <Semis nombre={26} germe={4177} couleur={accentDoux(500, 62)} taille={30} opacite={0.5} />
            {!reduced && <Poussiere nombre={14} germe={521} />}
          </div>

          <BarreCoins marque="Devers" liens={NAVIGATION} droite="Salle ouverte — 6 h 30 / 23 h" sombre={false} />
          ...
          <div className="o-relative o-z-10 o-flex o-grow o-flex-col o-justify-between o-gap-12 o-px-6 o-pb-10 md:o-px-10">
            <div className="o-grid o-items-end o-gap-10 md:o-grid-cols-12">
              <div className="md:o-col-span-7">
                <Surgit>
                  <Etiquette sombre={false}>Salle d escalade — 1 400 metres carres — quartier nord</Etiquette>
                </Surgit>
                <TitreVague
                  delai={140}
                  className="o-m-0 o-mt-6 o-text-zinc-950 dark:o-text-zinc-50"
                  style={{ ...affiche('l', 700), fontSize: 'clamp(3.25rem, 13vw, 11rem)', lineHeight: 0.8, letterSpacing: '-0.05em' }}
                >
                  Devers
                </TitreVague>
                <Surgit delai={520} as="p" className="o-m-0 o-mt-6 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                  Quarante-deux voies, dix-sept metres de haut, et un topo qui vous montre la ligne avant que vous mettiez les chaussons.
                </Surgit>
              </div>
              ...
              <Surgit delai={340} className="md:o-col-span-5">
                <Spotlight size={420} color={accentDoux(400, 90)} border={false}>
                  <div className="o-rounded-2xl o-p-7" style={nuit('zinc')}>
                    <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Voie du jour — secteur nord</p>
                    <p className="o-m-0 o-mt-4 o-text-zinc-50" style={{ ...affiche('m', 700), fontSize: 'clamp(2.5rem, 5vw, 3.75rem)', lineHeight: 0.86, letterSpacing: '-0.04em' }}>
                      6c
                    </p>
                    ...
                    <p className="o-m-0 o-mt-5 o-border-t o-border-white-10 o-pt-4 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-400">
                      ...
                      <br />
                      <span style={{ color: encreSurSombre() }}>11 croix</span> sur 64 essais
                    </p>
                  </div>
                </Spotlight>
              </Surgit>
            ...
            <Surgit delai={700} className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-6">
              <div className="o-flex o-flex-wrap o-gap-3">
                ...
                >
                  Voir une voie se tracer <Icon icon={ArrowRight} size={15} aria-hidden="true" />
                </a>
                <a
                  href="#venir"
          ...
          >
            ...
            <Couche profondeur={0}>
              <div
                aria-hidden="true"
                className="o-absolute o-inset-0"
                style={{ background: `linear-gradient(to bottom, var(--o-palette-stone-950) 0%, ${accentDoux(950, 82)} 52%, var(--o-palette-stone-950) 100%)` }}
              />
            </Couche>
            ...
            */}
            <Couche profondeur={-0.34}>
              <div className="o-absolute o-inset-x-0" style={{ top: '-180%', height: '300%' }}>
                <Semis nombre={44} germe={2203} couleur="color-mix(in oklab, white 9%, transparent)" taille={26} opacite={1} />
                <Panneaux couleur="color-mix(in oklab, white 5%, transparent)" pas={130} />
              </div>
            </Couche>

            <Couche profondeur={-0.78} derive={18}>
              <div className="o-absolute" style={{ top: '-230%', left: '6%', right: '6%', height: '340%' }}>
                <div className="o-absolute o-inset-0 o-rounded-2xl" style={{ backgroundColor: accentDoux(900, 62) }} />
                <Panneaux couleur="color-mix(in oklab, white 10%, transparent)" pas={92} />
                <Semis nombre={72} germe={7717} couleur={accentDoux(400, 90)} taille={30} opacite={0.9} />
              </div>
            </Couche>

            {/* La corde, qui file vers le haut a la vitesse du premier plan. */}
            <Couche profondeur={-1} derive={26}>
              <svg aria-hidden="true" className="o-absolute o-h-full o-w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                <path
                  data-o-es-corde=""
            ...
            <Couche profondeur={-1.3} derive={44}>
              <div className="o-absolute" style={{ top: '-160%', left: '-4%' }}>
                <span className="o-block" style={{ width: 190, height: 130, backgroundColor: accentDoux(700, 70), clipPath: 'polygon(0 0, 100% 22%, 78% 100%, 0 74%)' }} />
              </div>
              <div className="o-absolute" style={{ top: '-40%', right: '-3%' }}>
                <span className="o-block" style={{ width: 230, height: 160, backgroundColor: accentDoux(800, 72), clipPath: 'polygon(22% 0, 100% 12%, 100% 88%, 0 100%)' }} />
              </div>
              <div className="o-absolute" style={{ top: '86%', left: '12%' }}>
                <span className="o-block" style={{ width: 150, height: 108, backgroundColor: accentDoux(600, 62), clipPath: 'polygon(0 16%, 86% 0, 100% 82%, 12% 100%)' }} />
              </div>
            </Couche>
            ...
            <Couche profondeur={-1.45}>
              <div className="o-absolute o-inset-x-0" style={{ top: '82%' }}>
                <div className="o-h-24" style={{ backgroundColor: 'var(--o-palette-stone-800)' }} />
                <div className="o-h-96" style={{ backgroundColor: 'var(--o-palette-stone-950)' }} />
              </div>
            </Couche>
            ...
            */}
              ...
              <div className="o-absolute o-inset-0 o-flex o-items-center o-justify-center">
                <div className="o-relative">
                  ...
                  <span
                    aria-hidden="true"
                    className="o-absolute o-block"
                    style={{ left: 77, bottom: '100%', width: 3, height: '70vh', backgroundColor: accentDoux(200, 92) }}
                  />
                  <Grimpeur largeur={160} couleur="var(--o-palette-stone-950)" corde={accentDoux(200, 92)} />
                </div>
              </div>
            </Couche>
            ...
            <div className="o-pointer-events-none o-absolute o-right-6 o-top-6 o-z-40 md:o-right-10 md:o-top-10">
              <div className="o-rounded-2xl o-border-w-1 o-border-white-10 o-bg-black-70 o-px-5 o-py-4 o-text-right o-backdrop-blur-xl">
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Altimetre</p>
                <p className="o-m-0 o-mt-1 o-tabular-nums o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 4vw, 3rem)' }}>
                  <span ref={metres} aria-hidden="true">0,0</span>
                  <span className="o-ml-1 o-text-base">m</span>
                  <span className="o-sr-only">Zone atteinte : {ETAGES[zone]?.nom ?? ''}</span>
                </p>
        ...
        <section id="topo" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32">
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
              <Indice rang="01" sombre={false}>Le topo</Indice>
            </Reveal>
            <ScrollFloat
              as="h2"
              lift={16}
              ...
              style={{ ...affiche('m', 700), fontSize: 'clamp(1.85rem, 4.4vw, 3.75rem)', lineHeight: 0.9, letterSpacing: '-0.04em' }}
            >
            ...
            <p className="o-m-0 o-mt-6 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
              Choisissez une cotation : la ligne s allume prise par prise, dans l ordre, et met sur chaque mouvement le temps que le grimpeur y a passe le jour de l ouverture.
            </p>
        ...
        <section aria-labelledby="ouvertures-titre" className="o-border-t o-border-black-10 dark:o-border-zinc-800 o-px-6 o-py-20 md:o-px-10 md:o-py-28">
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
              <Indice rang="02" sombre={false}>Les ouvertures</Indice>
            </Reveal>
            <Reveal delay={80}>
              <h2 id="ouvertures-titre" className="o-m-0 o-mt-6 o-max-w-2xl o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 700), fontSize: 'clamp(1.6rem, 3.4vw, 2.75rem)', lineHeight: 0.92, letterSpacing: '-0.04em' }}>
            ...
            <div className="o-mt-14 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
              <svg viewBox="0 0 720 260" className="o-h-auto" style={{ minWidth: 560, width: '100%', maxWidth: 860 }} role="img" aria-label="Voies ouvertes ce mois-ci par cotation, de 4 a 8a">
                  ...
                  return (
                    <g key={cotation}>
                      <path
                        ...
                        stroke={nombre === maxOuvertures ? accent(500) : accentDoux(700, 58)}
                        strokeWidth={nombre === maxOuvertures ? 5 : 3}
                        strokeLinecap="round"
                        pathLength={600}
                        style={{ strokeDasharray: 600, '--o-es-l': 600, '--o-es-delai': `${String((index * 0.07).toFixed(2))}s` } as CSSProperties}
                      />
                      <text x={x} y={220 - hauteur - 14} fontSize="17" textAnchor="middle" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', color: 'var(--o-theme-fg)' }}>
                        {String(nombre)}
                      </text>
                      <text x={x} y={246} fontSize="14" textAnchor="middle" fill="currentColor" style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.1em', color: 'var(--o-theme-muted)' }}>
                        {cotation}
                      </text>
                    </g>
                  )
            ...
            <p className="o-m-0 o-mt-8 o-max-w-lg o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
              Le pic est a 6a : c est la cotation ou la salle compte le plus de monde, donc celle qui s use le plus vite. Les deux ouvreurs remettent un secteur entier toutes les trois semaines.
            </p>
          </div>
        </section>

        {/* ================= Venir grimper (A23) ========================= */}
        <section id="venir" className="o-scroll-mt-24 o-px-6 o-py-24 md:o-px-10 md:o-py-32" style={nuit('stone')}>
          <div className="o-mx-auto o-max-w-6xl">
            <Reveal>
              <Indice rang="03">Venir grimper</Indice>
            </Reveal>
            <Reveal delay={80}>
              <h2 className="o-m-0 o-mt-6 o-max-w-2xl o-text-zinc-50" style={{ ...affiche('m', 700), fontSize: 'clamp(1.85rem, 4vw, 3.25rem)', lineHeight: 0.9, letterSpacing: '-0.04em' }}>
            ...
            <div className="o-mt-14">
              <div className="o-flex o-items-stretch o-gap-px o-overflow-hidden o-rounded-xl" style={{ backgroundColor: 'color-mix(in oklab, white 12%, transparent)' }}>
                {JOURNEE.map((bloc) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: 0,
                        backgroundColor: choisi ? accent(500) : libre ? 'var(--o-palette-stone-900)' : 'color-mix(in oklab, var(--o-palette-stone-100) 7%, var(--o-palette-stone-950))',
                        color: choisi ? 'var(--o-palette-stone-950)' : libre ? 'var(--o-palette-stone-100)' : 'var(--o-palette-stone-500)',
                      }}
                    >
                      <span className="o-absolute o-left-2 o-top-2 o-font-mono o-text-xs o-uppercase o-tracking-widest">{heure(bloc.debut)}</span>
                      <span className="o-absolute o-bottom-2 o-left-2 o-right-2 o-block o-truncate o-text-xs">{bloc.genre === 'ferme' ? 'Ferme' : `${String(bloc.places)} places`}</span>
                    </button>
                  )
                })}
              </div>
            ...
            <div className="o-mt-10 o-grid o-gap-8 md:o-grid-cols-12">
              <div className="md:o-col-span-7">
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Creneau retenu</p>
                <p className="o-m-0 o-mt-3 o-text-zinc-50" aria-live="polite" style={{ ...affiche('m', 300), fontSize: 'clamp(1.5rem, 3.2vw, 2.5rem)', lineHeight: 1 }}>
                  {retenu?.nom ?? ''} — {heure(retenu?.debut ?? 0)} a {heure(retenu?.fin ?? 0)}
                </p>
              ...
              <div className="md:o-col-span-5 md:o-flex md:o-items-end md:o-justify-end">
                <a
                  ...
                  style={{ backgroundColor: encreSurSombre(), color: 'var(--o-palette-stone-950)' }}
                >
                  Reserver ce creneau <Icon icon={ArrowUpRight} size={15} aria-hidden="true" />
                </a>
              </div>
            </div>
          </div>
        ...
        <footer className="o-px-6 o-py-16 md:o-px-10">
          <div className="o-mx-auto o-max-w-6xl">
            ...
            <div className="o-mt-6 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
              <svg viewBox="0 0 460 300" className="o-h-auto" style={{ minWidth: 460, width: '100%', maxWidth: 640 }} role="img" aria-label="Plan des trois lignes de metro ; la salle est a la station Devers, correspondance des lignes A, B et C">
                {LIGNES.map((ligne, index) => (
                  <path
                    ...
                    strokeLinejoin="round"
                    pathLength={600}
                    style={{ strokeDasharray: 600, '--o-es-l': 600, '--o-es-delai': `${String((index * 0.2).toFixed(2))}s` } as CSSProperties}
                  />
                ))}
                {STATIONS.map((station) => {
                  ...
                  const ancre = station.x < 160 ? 'start' : station.x > 300 ? 'end' : 'middle'
                  const dessous = station.y >= 150
                  return (
                    <g key={station.nom}>
                      {maison ? (
                        <rect x={station.x - 11} y={station.y - 11} width="22" height="22" fill="var(--o-theme-bg)" stroke={accent(500)} strokeWidth="3" />
                      ) : (
                        <circle cx={station.x} cy={station.y} r="5.5" fill="var(--o-theme-bg)" stroke="var(--o-theme-muted)" strokeWidth="2" />
                      )}
                      <text
                        x={station.x + (ancre === 'start' ? -2 : ancre === 'end' ? 2 : 0)}
                        y={maison ? station.y - 20 : dessous ? station.y + 22 : station.y - 14}
                        fontSize={maison ? 14 : 11}
                        textAnchor={ancre}
                        fill="currentColor"
                        style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.1em', color: maison ? 'var(--o-theme-fg)' : 'var(--o-theme-muted)' }}
                      >
            ...
            <div className="o-mt-10 o-grid o-gap-8 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-8 sm:o-grid-cols-3">
              ...
              <nav aria-label="Liens utiles">
                <ul className="o-m-0 o-list-none o-space-y-2 o-p-0">
                  {['Tarifs et abonnements', 'Cours et stages', 'Louer le mur', 'Nous ecrire'].map((lien) => (
                    <li key={lien}>
                      <a href="#venir" className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-600 dark:o-text-zinc-400 o-no-underline o-transition-colors hover:o-text-zinc-950 dark:hover:o-text-zinc-50 focus:o-ring">
                        {lien}
                      </a>
                    </li>
                  ))}
            ...
            <p className="o-m-0 o-mt-10 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
              Devers — societe cooperative — agrement FFME 2026 — © 2026. Les temps de tenue sont releves sur les videos d ouverture.
            </p>
          </div>
        </footer>
      </div>
