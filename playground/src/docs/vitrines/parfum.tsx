...
const PARFUMS: readonly Parfum[] = [
  {
    ...
    recharge: 96,
    texte:
      'Un bois sec, sans vanille pour l adoucir. Le vetiver vient d Haiti, distille par le meme atelier depuis 2019, et sa part n a pas bouge d un dixieme.',
    tete: [
  ...
  },
  {
    ...
    recharge: 82,
    texte:
      'Une rose qui ne sent pas la rose de parfumerie : l absolue est coupee de geranium et de terre humide, ce qui la ramene au jardin plutot qu au flacon.',
    tete: [
  ...
  },
  {
    ...
    recharge: 68,
    texte:
      'Un citron qui tient quatre heures, ce qui est long pour un hesperide. Le prix rend la tenue : nous ne pretendons pas qu il dure la journee.',
    tete: [
  ...
  },
  {
    ...
    recharge: 112,
    texte:
      'Le plus tenace du catalogue, et le plus difficile a porter. Trois gouttes suffisent ; le flacon est livre avec un compte-gouttes.',
...
const PREMIER: Parfum = PARFUMS[0] ?? {
  cle: 'cendre',
  nom: 'Cendre Claire',
  famille: '',
  parfumeur: '',
...
function poser(parfum: Parfum): readonly NotePosee[] {
  ...
  return toutes.map(([etage, note], rang) => ({
    ...note,
    etage,
    place: PLACES[rang] ?? ([50, 50] as const),
  }))
}
  ...
  switch (etage) {
    ...
    default:
      return {
        ...
        backgroundColor: active ? encre() : accentDoux(500, 42),
        color: active ? 'var(--o-theme-bg)' : undefined,
      }
  }
}
...
function Champ({ parfum }: { readonly parfum: Parfum }): ReactElement {
  ...
  return (
    <div>
      ...
      >
        ...
        {ETAGES.map(([cle, mot], rang) => (
          <span
            key={cle}
            aria-hidden="true"
            className="o-pointer-events-none o-absolute o-right-4 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-neutral-500 dark:o-text-neutral-400"
            style={{ top: `${String(6 + rang * 32)}%` }}
          >
            {mot}
          </span>
        ))}
        {notes.map((n, rang) => {
          ...
          return (
            <Flotte
              ...
              style={{
                left: `${String(n.place[0])}%`,
                top: `${String(n.place[1])}%`,
                width: `min(${String(diametre)}px, 30%)`,
              }}
            >
              <button
                type="button"
                ...
                onClick={() => {
                  setRevelee(estActive ? null : n.nom)
                }}
                ...
                style={{
                  ...robe(n.etage, estActive),
                  boxShadow: estActive
                    ? '0 12px 30px -12px color-mix(in oklab, currentColor 40%, transparent)'
                    : undefined,
                }}
              >
                {n.nom}
                <span className="o-sr-only">
                  , {n.part} % du concentre, {n.origine}, {etageDe(n.etage)}
                </span>
              </button>
            </Flotte>
          )
      ...
      <p
        aria-live="polite"
        className="o-m-0 o-mt-4 o-flex o-min-h-12 o-flex-wrap o-items-baseline o-gap-x-4 o-gap-y-1 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-4"
      >
        {active === null ? (
          ...
          <>
            <span
              className="o-text-lg o-font-medium o-text-neutral-950 dark:o-text-neutral-50"
              style={{ fontFamily: 'var(--o-vitrine-affichage)', fontWeight: 400 }}
            >
              {active.nom}
            </span>
            <span
              ...
              style={{ color: encre() }}
            >
              {active.part} % du concentre
            </span>
            <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-neutral-500 dark:o-text-neutral-400">
              {etageDe(active.etage)} — {active.origine}
            </span>
          </>
        )}
      </p>
  ...
  return (
    ...
    >
      <nav
        ...
        className="o-pointer-events-auto o-flex o-items-center o-gap-1 o-rounded-full o-border-w-1 o-border-white-10 o-p-1.5 o-pl-4 o-text-zinc-50"
        style={{ backgroundColor: 'var(--o-palette-neutral-950)' }}
      >
        <a
          href="#haut"
          className="o-mr-3 o-text-sm o-font-semibold o-tracking-tight o-text-zinc-50 o-no-underline focus:o-ring"
        >
          Maison Trace
        </a>
        {NAVIGATION.map(([href, mot]) => (
          <a
            key={href}
            href={href}
            className="o-hidden o-rounded-full o-px-3 o-py-1.5 o-text-sm o-text-zinc-300 o-no-underline o-transition-colors hover:o-text-zinc-50 sm:o-inline-block focus:o-ring"
          >
            {mot}
          </a>
        ))}
        <a
          ...
          style={{
            ...
            color: 'var(--o-palette-neutral-950)',
          }}
        >
          Liste d attente
        </a>
...
function Bulle({
  ...
  readonly place: readonly [droite: string, haut: string]
}): ReactElement {
  return (
    <Flotte
      amplitude={9}
      ...
      angle={angle}
      className="o-absolute"
      style={{ right: place[0], top: place[1] }}
    >
      <div className={`${verre(true)} o-px-4 o-py-3`}>
        <p className="o-m-0 o-text-sm o-font-medium o-text-white">{nom}</p>
        <p className="o-m-0 o-mt-0.5 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-300">
          {origine}
        </p>
      </div>
    </Flotte>
...
function FlaconDessine(): ReactElement {
  ...
  return (
    ...
    >
      ...
      <path
        d="M44 181h112v102c0 10-6 14-16 14H60c-10 0-16-4-16-14Z"
        fill={trait}
        opacity="0.26"
      />
...
export default function Page(): ReactElement {
  ...
  return (
    <Porte forme="iris" marque="Maison Trace">
      <div
        className="o-bg-white dark:o-bg-neutral-950 o-text-neutral-900 dark:o-text-neutral-100"
        style={polices}
      >
        <Gelule />
        ...
        */}
        <section
          id="haut"
          className="o-relative o-isolate o-flex o-flex-col o-justify-end o-overflow-hidden o-px-6 o-pb-20 o-pt-40 md:o-px-12"
          style={{ ...nuit('neutral'), minHeight: '100vh' }}
        >
          <LiquidChrome
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, var(--o-palette-neutral-950) 6%, color-mix(in oklab, var(--o-palette-neutral-950) 70%, transparent) 48%, transparent 84%)',
            }}
          />
          <Grain opacite={0.05} />
          ...
          */}
          <div
            data-trace-flacon=""
            className="o-absolute o-inset-0 o-z-0 max-md:o-hidden"
          >
            <style>
              {
          ...
          */}
          <div
            aria-hidden="true"
            className="o-pointer-events-none o-absolute o-inset-0 o-z-20 max-lg:o-hidden"
          >
            <Bulle
              nom="Vetiver"
              origine="Haiti — 34 %"
          ...
          <div className="o-relative o-z-10 o-max-w-4xl">
            ...
            <TitreVague
              delai={120}
              className="o-m-0 o-mt-6 o-text-neutral-50"
              style={{ ...affiche('l', 300), fontSize: 'clamp(3rem, 8.5vw, 8.5rem)' }}
            >
            ...
            <Surgit
              delai={520}
              as="p"
              className="o-m-0 o-mt-8 o-max-w-md o-text-base o-leading-relaxed o-text-neutral-300"
            >
              Les matieres, leur part dans le concentre, leur origine. La tenue est
              mesuree, pas promise.
            </Surgit>
            <Surgit delai={640} className="o-mt-10">
              <Actions
                pleine={[
                  '#notes',
                  <>
                    Lire les notes <Icon icon={ArrowRight} size={16} aria-hidden="true" />
                  </>,
                ]}
                fantome={['#coffret', 'Les quatre en 2 ml']}
              />
            </Surgit>
          </div>
          <Coin position="bd">
            7 rue Marcel Journet, Grasse
            <br />
            Compose, macere et mis en flacon sur place
          </Coin>
        </section>
        ...
        <main>
          ...
          */}
          <section
            id="notes"
            className="o-scroll-mt-32 o-px-6 o-py-24 md:o-px-12 md:o-py-32"
          >
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              ...
              <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-neutral-500 dark:o-text-neutral-400 md:o-col-span-4 md:o-text-right">
                La taille d une note est sa part
                <br />
                dans le concentre, non dans la solution
              </p>
            </div>
            ...
            */}
            ...
            <div className="o-mt-10 o-grid o-gap-12 md:o-grid-cols-12">
              <div className="md:o-col-span-5">
                ...
                <p className="o-mt-6 o-max-w-md o-text-base o-leading-relaxed o-text-neutral-600 dark:o-text-neutral-400">
                  {parfum.texte}
                </p>
                <dl className="o-m-0 o-mt-8 o-grid o-grid-cols-2 o-gap-x-6 o-gap-y-4 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-6 o-font-mono o-text-xs">
                  {(
                    ...
                    <div key={quoi}>
                      <dt className="o-uppercase o-tracking-widest o-text-neutral-500 dark:o-text-neutral-400">
                        {quoi}
                      </dt>
                      <dd className="o-m-0 o-mt-1 o-text-sm o-font-medium o-text-neutral-950 dark:o-text-neutral-50">
                        {valeur}
                      </dd>
                    </div>
                  ))}
                ...
                <ul className="o-m-0 o-mt-8 o-flex o-list-none o-flex-wrap o-gap-x-6 o-gap-y-2 o-p-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-neutral-500 dark:o-text-neutral-400">
                  {ETAGES.map(([etage, mot, quand]) => (
                    <li key={etage} className="o-flex o-items-center o-gap-2">
                      <span
                        aria-hidden="true"
                        className="o-inline-block o-size-3 o-rounded-full o-border-w-1"
                        style={robe(etage, false)}
                      />
                      {mot} · {quand}
                    </li>
                  ))}
          ...
          */}
          <section
            id="temps"
            className="o-scroll-mt-32 o-border-t o-border-black-10 dark:o-border-zinc-800 o-px-6 o-py-24 md:o-px-12 md:o-py-32"
          >
            <div className="o-grid o-gap-10 md:o-grid-cols-12 md:o-items-center">
              ...
              */}
              <p
                className="o-m-0 o-tabular-nums o-text-neutral-950 dark:o-text-neutral-50 md:o-col-span-7"
                style={{
                  ...affiche('xxl', 300),
              ...
              >
                ...
                <span className="o-italic" style={{ fontSize: '0.5em', color: encre() }}>
                  {' '}
                  h
                </span>
              </p>
              <div className="md:o-col-span-5">
                ...
                <p
                  className="o-m-0 o-mt-5 o-max-w-md o-text-neutral-950 dark:o-text-neutral-50"
                  style={{
                    ...affiche('m', 300),
                ...
                >
                  Soixante-douze heures : le temps qu un concentre repose avant la
                  premiere mouillette.
                </p>
                <p className="o-mt-5 o-max-w-md o-text-base o-leading-relaxed o-text-neutral-600 dark:o-text-neutral-400">
                  Rien n est senti avant. La tenue est ensuite mesuree sur mouillette a 21
                  degres, jusqu au seuil de detection d un panel de six nez.
                </p>
              </div>
            </div>
          </section>
          ...
          */}
          <section
            id="coffret"
            className="o-scroll-mt-32 o-relative o-isolate o-overflow-hidden o-px-6 o-py-24 md:o-px-12 md:o-py-36"
            style={{
              background: `linear-gradient(to bottom, var(--o-theme-bg), ${accentDoux(300, 18)})`,
            }}
          >
            <div
              aria-hidden="true"
              className="o-pointer-events-none o-absolute o-left-1/2 o-top-1/2 o-z-0 o-h-1/2 o-w-4/5 o-rounded-full o-blur-3xl"
              style={{
                transform: 'translate(-50%, -50%)',
                background: accentDoux(400, 30),
              }}
            />
            <div
              className={`o-relative o-z-10 o-mx-auto o-max-w-2xl o-p-8 md:o-p-12 ${verre(false)}`}
            >
              <p
                className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest"
                style={{ color: encre() }}
              >
                Le coffret d essai — liste d attente
              </p>
              <h2
                className="o-m-0 o-mt-4 o-text-neutral-950 dark:o-text-neutral-50"
                style={{
                  ...affiche('m', 300),
              ...
              <p className="o-mt-4 o-max-w-lg o-text-sm o-leading-relaxed o-text-neutral-600 dark:o-text-neutral-400">
                La prochaine serie part en octobre. Laissez une adresse : vous saurez la
                veille, et rien d autre ne vous sera envoye.
              </p>
              {inscrit ? (
                <p
                  className="o-mt-8 o-flex o-items-center o-gap-2 o-border-t o-border-black-10 dark:o-border-zinc-800 o-pt-6 o-text-sm o-text-neutral-950 dark:o-text-neutral-50"
                  aria-live="polite"
                >
                  <span
                    ...
                    aria-hidden="true"
                  />
                  Vous etes sur la liste, {courriel}. Un seul message, la veille du
                  depart.
                </p>
              ) : (
                <form
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="o-inline-flex o-items-center o-justify-center o-gap-2 o-rounded-full o-px-6 o-py-3 o-text-sm o-font-semibold o-transition-transform hover:o-scale-105 focus:o-ring"
                    style={aplat()}
                  >
                    Rejoindre la liste
              ...
              <p className="o-m-0 o-mt-4 o-font-mono o-text-xs o-text-neutral-500 dark:o-text-neutral-400">
                Sans inscription, sans relance, sans conditions.
              </p>
            </div>
          </section>
        </main>
        ...
        */}
        <CinematicFooter
          ...
          heading={
            <span
              className="o-block o-text-neutral-950 dark:o-text-neutral-50"
              style={{ ...affiche('l', 300), fontSize: 'clamp(2.5rem, 7vw, 6.5rem)' }}
            >
              Maison Trace
            </span>
          }
          actions={
            <a
              href="mailto:coffret@maisontrace.fr"
          ...
          links={ENGAGEMENTS.map(([titre, quoi]) => (
            <span
              key={titre}
              className="o-inline-flex o-items-baseline o-gap-2 o-rounded-full o-border-w-1 o-border-black-10 dark:o-border-zinc-800 o-px-4 o-py-2 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-neutral-600 dark:o-text-neutral-400"
            >
