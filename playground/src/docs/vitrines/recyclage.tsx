...
const POSTES: readonly Poste[] = [
  {
    cle: 'fosse',
    rang: '01',
    nom: 'Fosse et pre-tri',
    principe:
      'Deux agents retirent a la main ce qui n a rien a faire la : verre casse, textile, cables, bouteilles de gaz.',
    debit: '9 t/h',
  },
  {
    cle: 'trommel',
    ...
    nom: 'Trommel',
    principe:
      'Un cylindre perfore de 60 mm qui tourne a onze tours par minute. Ce qui est plus petit tombe et part aux fines.',
    debit: '9 t/h',
  },
  {
    cle: 'balistique',
    rang: '03',
    nom: 'Crible balistique',
    principe:
      'Des palettes inclinees qui montent. Ce qui roule redescend, ce qui est plat monte : les corps creux se separent des papiers.',
    debit: '7 t/h',
  },
  {
    cle: 'overband',
    rang: '04',
    nom: 'Overband magnetique',
    principe:
      'Un aimant permanent suspendu au-dessus du tapis. Il enleve l acier, et lui seul : rien d autre n y repond.',
    debit: '7 t/h',
  },
  {
    cle: 'foucault',
    rang: '05',
    nom: 'Courants de Foucault',
    principe:
      'Un rotor aimante a trois mille tours induit un champ dans les metaux conducteurs non magnetiques. L aluminium saute par-dessus la lame.',
    debit: '7 t/h',
  },
  {
    cle: 'optique',
    rang: '06',
    nom: 'Tri optique infrarouge',
    principe:
      'Une lampe, un spectrometre, une rampe de buses. Chaque plastique a une signature dans le proche infrarouge ; le noir de carbone n en a pas.',
    debit: '5 t/h',
  },
  {
    cle: 'cabine',
    rang: '07',
    nom: 'Cabine de controle',
    principe:
      'Le dernier regard humain. Ce qui passe encore ici part au refus, et le refus part en combustible de substitution.',
    debit: '5 t/h',
  },
]
...
const PASSAGES: Readonly<Record<string, Readonly<Record<string, string>>>> = {
  fosse: {
    ...
    bocal:
      'Retire a la main. Le verre casse dechire les tapis et raye les optiques ; il a sa propre collecte.',
  },
  trommel: {
    defaut: 'Trop gros pour les trous de 60 mm : il reste sur le cylindre et continue.',
    bouchon:
      'Tombe dans les fines : moins de 60 mm, il part avec le sable et les tessons.',
  },
  balistique: {
...
const OBJETS: readonly Objet[] = [
  {
    ...
    sortie: 'optique',
    capture:
      'Le spectrometre lit la bande du PET a 1 660 nanometres et la buse la souffle dans le bon couloir.',
    devient: 'Paillettes lavees, puis fibre polyester ou bouteille neuve.',
    rendement: '0,92 kg de paillette par kilo entre',
    dessin: (
      <g>
        <path
          d="M34 16h12v8l6 8v34a6 6 0 0 1-6 6H34a6 6 0 0 1-6-6V32l6-8Z"
          fill="none"
          strokeWidth="2.5"
        />
  ...
  },
  {
    ...
    sortie: 'optique',
    capture:
      'Meme poste, autre buse : le PEHD absorbe a 1 730 nanometres, et le couloir suivant lui est reserve.',
    devient: 'Granule, puis tubes d assainissement et bacs de collecte.',
    rendement: '0,89 kg de granule par kilo entre',
    dessin: (
      <g>
        <path
          d="M30 20h20v46a6 6 0 0 1-6 6H36a6 6 0 0 1-6-6Z"
          fill="none"
          strokeWidth="2.5"
        />
  ...
  },
  {
    ...
    sortie: 'foucault',
    capture:
      'Le rotor induit un courant dans la paroi ; le champ oppose la repousse et elle saute la lame de partage.',
    devient: 'Lingot, puis canette neuve en soixante jours.',
    rendement: '0,95 kg de metal par kilo entre',
    dessin: (
      <g>
        <path
          d="M30 18h20v46a4 4 0 0 1-4 4H34a4 4 0 0 1-4-4Z"
          fill="none"
          strokeWidth="2.5"
        />
  ...
  },
  {
    ...
    sortie: 'overband',
    capture:
      'Ferromagnetique : l aimant la decolle du tapis et la depose deux metres plus loin, sans rien toucher d autre.',
    devient: 'Ferraille, puis acier de construction au four electrique.',
    rendement: '0,97 kg d acier par kilo entre',
    dessin: (
      <g>
        <path
          d="M28 24h24v40a4 4 0 0 1-4 4H32a4 4 0 0 1-4-4Z"
          fill="none"
          strokeWidth="2.5"
        />
  ...
  },
  {
    ...
    sortie: 'optique',
    capture:
      'Sa signature est celle du carton double d un film : le tri optique la separe des papiers purs.',
  ...
  },
  {
    ...
    sortie: 'balistique',
    capture:
      'Corps plat : il monte le long des palettes et part au flux papier, avant meme les machines a metaux.',
  ...
  },
  {
    ...
    sortie: 'trommel',
    capture:
      'Moins de soixante millimetres : il tombe par les trous du cylindre et part aux fines, avec le sable.',
    devient: 'Rien, s il est seul. Laisse-le visse sur la bouteille et il suit le PET.',
    rendement: 'perdu a 100 % en vrac',
    dessin: (
      <g>
        <path
          d="M28 34h24v18a4 4 0 0 1-4 4H32a4 4 0 0 1-4-4Z"
          fill="none"
          strokeWidth="2.5"
        />
  ...
  },
  {
    ...
    sortie: 'fosse',
    capture:
      'Retire a la main des le pre-tri. Le verre n a rien a faire ici : il casse, il raye, et il a sa propre collecte.',
    devient:
      'Calcin, puis verre neuf — mais seulement s il passe par le conteneur a verre.',
    rendement: '0 kg par cette chaine',
    dessin: (
      <g>
        <path
          d="M30 24h20v40a6 6 0 0 1-6 6H36a6 6 0 0 1-6-6Z"
          fill="none"
          strokeWidth="2.5"
        />
  ...
  return POSTES.slice(0, sortie + 1).map((poste, rang) => {
    ...
    if (poste.cle === 'balistique') {
      return {
        poste,
        pris: false,
        mot: (ROULANTS.has(objet.cle) ? table['roulant'] : table['plat']) ?? '',
      }
    }
...
function Chaine(): ReactElement {
  ...
  const choisie =
    visibles.find((etape) => etape.poste.cle === ligne) ?? visibles[visibles.length - 1]
  ...
  return (
    <div>
      ...
      <ul
        className="o-m-0 o-mt-5 o-grid o-list-none o-gap-px o-p-0 sm:o-grid-cols-4 lg:o-grid-cols-8"
          ...
          return (
            <li key={candidat.cle} className="o-min-w-0">
              <button
                ...
                style={{
                  backgroundColor: actif ? accentDoux(400, 26) : 'var(--o-theme-bg)',
                }}
              >
                <svg
                  viewBox="0 0 80 80"
                  ...
                  aria-hidden="true"
                  fill="none"
                  stroke={actif ? encre() : 'currentColor'}
                  strokeLinejoin="round"
                >
                  {candidat.dessin}
                </svg>
                <span className="o-text-center o-text-xs o-leading-snug">
                  {candidat.nom}
                </span>
              </button>
            </li>
            ...
            {POSTES.map((poste, rang) => {
              ...
              return (
                <g key={poste.cle}>
                  <path
                    d={`M${String(x)} 108V52`}
                    stroke={accentDoux(900, traverse ? 44 : 18)}
                    strokeWidth="1.5"
                  />
                  <rect
                    x={x - 26}
                    ...
                    height={32}
                    fill={
                      pris ? accent(400) : traverse ? accentDoux(400, 34) : 'transparent'
                    }
        ...
        <div className="o-min-w-0 lg:o-col-span-5">
          ...
          {objet === null ? (
            <p className="o-m-0 o-max-w-sm o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
              Rien sur le tapis. Choisissez un objet ci-dessus : la chaine ne devine pas,
              elle mesure, et elle ne se trompe que quand on lui donne ce qu elle ne sait
              pas lire.
            </p>
          ) : (
            <AnimatedList
          ...
          {objet !== null && choisie !== undefined && (
            <div className="o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-pt-8">
              <p
                ...
                style={{ color: encre() }}
              >
                {choisie.poste.rang} — {choisie.poste.nom} —{' '}
                {choisie.pris ? 'objet capte' : 'objet non capte'}
              </p>
              <h3
              ...
              {fini && (
                <dl className="o-m-0 o-mt-10 o-grid o-gap-6 sm:o-grid-cols-3">
                  {(
                    ...
                    <div
                      key={quoi}
                      className="o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-pt-4"
                    >
                      <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                        {quoi}
                      </dt>
                      <dd className="o-m-0 o-mt-2 o-text-sm o-leading-relaxed">
                        {valeur}
                      </dd>
                    </div>
                  ))}
...
function Machine({ poste }: { readonly poste: Poste }): ReactElement {
  const formes: Readonly<Record<string, ReactNode>> = {
    ...
    trommel: (
      <g>
        <path
          d="M10 150h180v-60H10Z"
          fill={accentDoux(800, 30)}
          stroke={accentDoux(200, 54)}
          strokeWidth="2"
        />
        <ellipse
          cx="100"
    ...
    balistique: (
      <g>
        ...
        {Array.from({ length: 7 }, (_, rang) => (
          <path
            key={rang}
            d={`M${String(24 + rang * 22)} ${String(162 - rang * 12)}l14 -22`}
            stroke={accentDoux(200, 46)}
            strokeWidth="2"
          />
        ))}
        <path
          d="M170 84h24v86h-24Z"
          fill={accentDoux(800, 30)}
    ...
    overband: (
      <g>
        ...
        />
        <path
          d="M42 102v22M100 102v22M158 102v22"
          stroke={accent(400)}
          strokeWidth="2"
          strokeDasharray="4 5"
        />
      ...
      <g>
        ...
        {Array.from({ length: 12 }, (_, rang) => (
          <path
            key={rang}
            data-o-tr-souffle=""
            d={`M${String(30 + rang * 13)} 122v18`}
            stroke={accent(400)}
            strokeWidth="2"
            style={{ animationDelay: `${String(rang * 0.12)}s` } as CSSProperties}
          />
        ))}
    ...
    cabine: (
      <g>
        <path
          d="M20 60h160v110H20Z"
          fill={accentDoux(800, 30)}
          stroke={accentDoux(200, 56)}
          strokeWidth="2"
        />
        <path
          d="M36 76h128v54H36Z"
  ...
  return (
    ...
    <svg
      viewBox="0 0 210 250"
      className="o-h-auto o-shrink-0"
      style={{ width: '26vw', overflow: 'visible' }}
      aria-hidden="true"
    >
      {formes[poste.cle]}
      <text
    ...
    <div>
      ...
      <div className="o-relative o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
        <table
          ...
          style={{ borderCollapse: 'separate', borderSpacing: 3, minWidth: 640 }}
        >
          <caption className="o-sr-only">
            Tonnage sorti par flux et par mois, chaque ligne graduee sur son propre
            maximum
          </caption>
          <thead>
            <tr>
              <th
                scope="col"
                className="o-pr-4 o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400"
              >
                Flux
              </th>
              {MOIS.map((mot, rang) => (
                <th
                  key={rang}
                  scope="col"
                  className="o-w-12 o-text-center o-font-mono o-text-xs o-font-normal o-text-zinc-500 dark:o-text-zinc-400"
                >
                  {mot}
                </th>
              ))}
              <th
                scope="col"
                className="o-pl-4 o-text-right o-font-mono o-text-xs o-font-normal o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400"
              >
                Annee
              </th>
            </tr>
            ...
            {FLUX.map((flux) => {
              ...
              return (
                <tr key={flux.nom}>
                  <th
                    scope="row"
                    className="o-whitespace-nowrap o-pr-4 o-text-sm o-font-medium"
                  >
                    {flux.nom}
                  </th>
      ...
      <p
        aria-live="polite"
        className="o-m-0 o-mt-6 o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400"
      >
        {case_ === null
...
const ZONES = [
  {
    ...
    texte:
      'On entre par la. Le badge, les chaussures fermees, le gilet. Aucune visite ne commence sans les trois.',
  ...
  },
  {
    ...
    texte:
      'Quatre portes, une fosse de neuf cents metres cubes. Une benne de collecte s y vide en sept minutes.',
  ...
  },
  {
    ...
    texte:
      'Cent dix metres de convoyeurs, sept postes, soixante mille tonnes par an. C est la que passe tout ce que vous mettez dans le bac jaune.',
  ...
  },
  {
    ...
    texte:
      'Trente places, une passerelle vitree au-dessus de la cabine. Les classes de CM1 y viennent depuis 2011.',
  ...
  },
  {
    ...
    texte:
      'Les balles pressees attendent le camion : une balle de PET pese trois cents kilos et fait un metre cube.',
    ...
    <div className="o-grid o-gap-10 lg:o-grid-cols-12 lg:o-gap-14">
      <div className="o-min-w-0 lg:o-col-span-7">
        <svg
          ...
          role="img"
          aria-label="Plan du centre de tri : le quai, la halle, l accueil, la salle pedagogique et le stockage"
        >
          {/* Le terrain et la voirie. */}
          <path
            d="M8 8h984v492H8Z"
            fill="none"
            stroke={accentDoux(900, 18)}
            strokeWidth="1"
            strokeDasharray="6 8"
          />
...
const GESTES = [
  {
    mot: 'En vrac',
    legende:
      'Jamais de sac ferme : la chaine ne l ouvre pas, et le sac part au refus avec tout ce qu il contient.',
    dessin: (
      <g>
  ...
  },
  {
    mot: 'Non imbrique',
    legende:
      'Un pot dans une boite ne sera lu que comme une boite. Chaque chose seule, et chacune sera vue.',
    dessin: (
      <g>
  ...
  },
  {
    mot: 'Bouchon visse',
    legende:
      'Visse, il suit sa bouteille. Seul, il fait deux grammes et tombe dans les fines : c est du plastique perdu.',
    dessin: (
      <g>
  ...
  },
  {
    mot: 'Pas de verre',
    legende:
      'Le verre a son conteneur. Ici, il casse, raye les optiques et blesse en cabine de tri.',
    dessin: (
      <g>
  ...
  return (
    <Porte forme="compteur" marque="Seconde Vie" sombre={false}>
      ...
      >
        ...
        <header
          className="o-relative o-flex o-flex-col o-justify-center o-px-6 o-pb-16 o-pt-20 md:o-px-12"
          style={{ minHeight: ECRAN }}
        >
          <div className="o-mx-auto o-w-full o-max-w-7xl">
            <Surgit>
              <Etiquette sombre={false}>
                Centre de tri — 60 000 tonnes par an, 214 communes
              </Etiquette>
            </Surgit>
            <TitreVague
              delai={140}
              ...
              style={{
                ...affiche('l', 300),
                fontSize: 'clamp(2.6rem, 7.6vw, 7.5rem)',
                lineHeight: 0.9,
              }}
            >
            ...
            <div className="o-mt-14 o-grid o-gap-10 md:o-grid-cols-12">
              <Surgit
                delai={520}
                as="p"
                className="o-m-0 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400 md:o-col-span-5"
              >
                Un aimant, un rotor, un spectrometre et deux paires d yeux. Chaque machine
                ne sait faire qu une chose, et c est en les mettant bout a bout qu on
                separe huit matieres.
              </Surgit>

              <Surgit
                delai={640}
                className="md:o-col-span-4 md:o-col-start-7 md:o-ml-auto md:o-w-full"
              >
                <dl className="o-m-0">
                  {(
                    [
                    ...
                    <div
                      key={quoi}
                      className="o-flex o-items-baseline o-justify-between o-gap-4 o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-py-3"
                    >
                      <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                        {quoi}
                      </dt>
            ...
            <Surgit
              delai={760}
              className="o-mt-12 o-flex o-flex-wrap o-items-center o-gap-4"
            >
              <a
                href="#tri"
          ...
          >
            <Couche profondeur={0} className="o-bg-zinc-950">
              <div
                ...
                style={{
                  background: `radial-gradient(64% 58% at 40% 26%, ${accentDoux(800, 26)}, transparent 72%)`,
                }}
              />
            </Couche>
            ...
            <Couche profondeur={0.44} derive={16}>
              ...
              >
                {Array.from({ length: 14 }, (_, rang) => (
                  <g key={rang}>
                    <path
                      d={`M${String(60 + rang * 180)} 500V120`}
                      stroke={accentDoux(200, 20)}
                      strokeWidth="3"
                    />
                    <path
                      d={`M${String(60 + rang * 180)} 120 ${String(150 + rang * 180)} 74 ${String(240 + rang * 180)} 120`}
                      fill="none"
                      stroke={accentDoux(200, 22)}
                      strokeWidth="3"
                    />
                  </g>
                ))}
            ...
            <Couche profondeur={0.48} derive={26} className="o-flex o-items-end">
              <div
                className="o-flex o-shrink-0 o-items-end"
                style={{ gap: '4vw', marginBottom: '9%' }}
              >
                {POSTES.map((poste) => (
            ...
            <Couche profondeur={0.64} derive={34} className="o-flex o-items-end">
              <svg
                ...
                style={{ width: '240vw', height: 74, marginBottom: '7%' }}
                aria-hidden="true"
              >
                <path d="M0 44h2000" stroke={accentDoux(200, 26)} strokeWidth="14" />
                <path
                  data-o-tr-tapis={reduced ? undefined : ''}
                  d="M0 44h2000"
                  stroke={accent(400)}
                  strokeWidth="3"
        ...
        <section
          className="o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-px-6 o-py-24 md:o-px-12 md:o-py-32"
          ...
          <div className="o-mx-auto o-grid o-max-w-7xl o-gap-14 lg:o-grid-cols-12 lg:o-items-center">
            <div className="o-min-w-0 lg:o-col-span-5">
              ...
              <BeamConnect
                ...
                thickness={2}
                color={accent(500)}
                className="o-mt-10 o-flex o-items-center o-justify-between o-gap-6"
              >
                <span
                  data-beam="from"
                  className="o-inline-flex o-items-center o-gap-2 o-border-w-1 o-border-zinc-300 dark:o-border-zinc-700 o-px-4 o-py-2 o-font-mono o-text-xs o-uppercase o-tracking-widest"
                >
                  Bac jaune
                </span>
                <span
                  data-beam="to"
                  className="o-inline-flex o-items-center o-gap-2 o-px-4 o-py-2 o-font-mono o-text-xs o-uppercase o-tracking-widest"
                  style={aplat()}
                >
                  Bouteille neuve
                </span>
              ...
              <p className="o-m-0 o-mt-8 o-max-w-md o-text-base o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                Huit semaines, trois cent vingt kilometres, et une perte de matiere de
                huit pour cent a chaque tour. Un plastique n est pas eternel : il descend
                d un usage a l autre.
              </p>
            </div>
                  ...
                  {(
                    [
                      [
                        'PET clair',
                        'Paillette lavee',
                        'Fibre polyester pour doublure et rembourrage, ou bouteille neuve si la qualite tient.',
                      ],
                      [
                        'Acier etame',
                        'Ferraille',
                        'Refondu au four electrique. Un acier peut repasser indefiniment sans perdre ses proprietes.',
                      ],
                      [
                        'Carton et brique',
                        'Fibre longue',
                        'Desencree, puis papier d essuyage. La fibre raccourcit a chaque tour : sept passages au plus.',
                      ],
                    ] as const
                    ...
                    >
                      ...
                      <p className="o-m-0 o-mt-6 o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                        {texte}
                      </p>
                    </div>
                  ))}
        ...
        <section
          id="annee"
          className="o-scroll-mt-24 o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-px-6 o-py-24 md:o-px-12 md:o-py-32"
        >
          <div className="o-mx-auto o-max-w-7xl">
            <div className="o-grid o-gap-8 md:o-grid-cols-12 md:o-items-end">
              <div className="o-min-w-0 md:o-col-span-7">
                ...
                <Reveal delay={80}>
                  <h2
                    className="o-m-0 o-mt-5 o-max-w-2xl o-text-balance"
                    style={{
                      ...affiche('m', 300),
                      fontSize: 'clamp(1.8rem, 4vw, 3.5rem)',
                      lineHeight: 0.96,
          ...
          <div className="o-mx-auto o-max-w-7xl">
            ...
            <ul className="o-m-0 o-mt-10 o-grid o-list-none o-gap-10 o-p-0 sm:o-grid-cols-2 lg:o-grid-cols-4">
              {GESTES.map((geste) => (
                <li key={geste.mot} className="o-min-w-0">
                  ...
                  <p className="o-m-0 o-mt-5 o-text-lg o-font-medium o-tracking-tight">
                    {geste.mot}
                  </p>
                  <p className="o-m-0 o-mt-2 o-max-w-xs o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                    {geste.legende}
                  </p>
                </li>
              ))}
            ...
            <div className="o-mt-16 o-flex o-flex-wrap o-items-center o-justify-between o-gap-6 o-border-t o-border-zinc-200 dark:o-border-zinc-800 o-pt-6">
              <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">
                Seconde Vie — route departementale 14, 27400 Heudebouville — syndicat
                mixte de 214 communes
              </p>
              <nav
              ...
              >
                {(
                  ...
                  <a
                    key={mot}
                    href={cible}
                    className="o-inline-flex o-items-center o-gap-1 o-text-sm o-no-underline o-text-zinc-600 dark:o-text-zinc-400 o-transition-colors hover:o-text-zinc-950 dark:hover:o-text-zinc-50 focus:o-ring"
                  >
                    {mot}
