...
const MODULES: readonly Module[] = [
  {
    ...
    heures: 7,
    prix: 520,
    texte: 'Loyer, machines, assurances, temps non facturable. On ouvre vos propres chiffres, pas un cas d ecole.',
  ...
  },
  {
    ...
    heures: 14,
    prix: 980,
    texte: 'Metre, debours, marge, alea. Trois devis reels sont refaits en salle, et compares a ce qui a ete facture.',
  ...
  },
  {
    ...
    prix: 1450,
    prerequis: 'devis',
    texte: 'Le dossier de consultation, le memoire technique, la dematerialisation. On depose une offre blanche en fin de session.',
    sortie: 'Un memoire technique de huit pages, reutilisable, ecrit pendant la formation.',
  },
  {
    cle: 'plan',
    ...
    heures: 21,
    prix: 1290,
    texte: 'Echelles, cotes, niveaux, reserves. Le trace se fait au sol, en grandeur reelle, dans la halle.',
  ...
  },
  {
    ...
    prix: 940,
    prerequis: 'plan',
    texte: 'Quantifier sans sur-commander. Les chutes sont pesees en fin de session, et comparees d un stagiaire a l autre.',
  ...
  },
  {
    ...
    prix: 2380,
    prerequis: 'plan',
    texte: 'Etaiement, verinage, maconnerie de reprise. Cinq jours en halle sur un mur monte pour etre repris.',
  ...
  },
  {
    ...
    heures: 14,
    prix: 980,
    texte: 'Planning, approvisionnement, co-activite. Ecrit pour les entreprises de un a cinq, pas pour les majors.',
  ...
  },
  {
    ...
    heures: 7,
    prix: 460,
    texte: 'L obligation, sa forme reelle, et comment la tenir a jour en une heure par trimestre.',
  ...
  },
  {
    ...
    heures: 14,
    prix: 890,
    texte: 'Le contrat, le tuteur, les six premieres semaines. Deux maitres d apprentissage interviennent en salle.',
  ...
  },
  {
    ...
    heures: 28,
    prix: 1950,
    texte: 'Evaluation, financement, clientele, hommes. Le cas travaille est une reprise reelle, anonymisee.',
  ...
  },
  {
    ...
    heures: 7,
    prix: 490,
    texte: 'Dire un metier en trois phrases, devant un client, une mairie ou une camera. Filme, revu, refait.',
  ...
  },
  {
    ...
    heures: 7,
    prix: 520,
    texte: 'Avant, pendant, apres. Lumiere, cadrage, classement. Avec le telephone que vous avez deja.',
...
function compter(choisis: readonly string[]): Compte {
  ...
  const blocs = BLOCS.map((b) => b.cle).filter((cle) => modules.some((m) => m.bloc === cle))
  return {
    heures,
...
const SESSIONS = [
  ...
  { id: 'nov-17', quand: '17 novembre', module: 'sousoeuvre', places: 'complet — liste d attente' },
...
const ESSAI = [
  {
    titre: 'Les charges',
    question: 'Un atelier depense 4 200 EUR par mois — loyer, machines, assurances, comptable, vehicule. Vous travaillez seul. Combien cela fait-il par an ?',
    reponse: '50 400 EUR. On ne divise rien encore : on pose le total, charges sociales du gerant comprises quand il s en verse.',
  },
  {
    titre: 'Les heures',
    question: 'Vous ouvrez 45 semaines. Sur 39 heures hebdomadaires, combien sont reellement facturables ?',
    reponse: 'Environ 1 100, pas 1 755. Devis, achats, deplacements et relances mangent un tiers du temps, et ce tiers est paye par les deux autres.',
  },
  {
    titre: 'Le taux',
    question: 'Charges annuelles sur heures facturables, plus le salaire que vous voulez vous verser. Ou tombe votre taux horaire ?',
    reponse: '46 EUR de couverture des charges, plus 28 EUR de remuneration : 74 EUR de l heure avant marge. Le tarif affiche a 45 EUR de l heure vous fait travailler a perte, et c est la le sujet du module.',
  },
] as const
...
function Essai(): ReactElement {
  ...
  if (reste === null) {
    return (
      <div className="o-border-w-1 o-p-8 md:o-p-12" style={{ borderColor: 'var(--o-theme-line)', backgroundColor: 'var(--o-theme-bg)' }}>
        ...
        <p className="o-m-0 o-mt-4 o-max-w-lg o-text-base o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300">
          C est le premier quart d heure du module « Le prix de revient horaire », en entier. Rien n est enregistre, rien ne vous est demande, et personne ne vous rappellera.
        </p>
        <button
          type="button"
          onClick={() => {
  ...
  return (
    <div className="o-border-w-1 o-p-8 md:o-p-12" style={{ borderColor: encre(), backgroundColor: 'var(--o-theme-bg)' }}>
      <div className="o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-4">
        ...
        <p className="o-m-0 o-font-mono o-text-2xl o-tabular-nums" style={{ color: reste === 0 ? 'var(--o-theme-muted)' : encre() }} aria-live="off">
          {minutes(reste)}
        </p>
      </div>
      ...
      <div className="o-mt-8">
        ...
        >
          <div>
            <p className="o-m-0 o-max-w-2xl o-text-lg o-leading-relaxed o-text-zinc-900 dark:o-text-zinc-100">{courant.question}</p>
            {vu ? (
              <p className="o-m-0 o-mt-6 o-max-w-2xl o-pl-5 o-text-base o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300" style={{ borderLeft: `4px solid ${encre()}` }}>
                {courant.reponse}
              </p>
            ) : (
              <button
            ...
            {vu && etape === ESSAI.length - 1 && (
              <p className="o-m-0 o-mt-8 o-max-w-2xl o-text-base o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300">
                Le module dure sept heures et se termine sur <strong className="o-font-semibold">vos</strong> chiffres. Il coute 520 EUR, dont 312 pris en charge dans le cas le plus courant.
              </p>
            )}
          </div>
        </Stepper>
...
const JALONS = [
  { heures: 0, nom: 'La premiere heure', texte: 'On vient pour un module, souvent le moins cher, souvent en urgence.' },
  { heures: 70, nom: 'Soixante-dix heures', texte: 'L attestation de competences est delivree, et la remise passe a huit pour cent.' },
  { heures: 210, nom: 'Deux cent dix heures', texte: 'Un bloc entier est valide. Il se garde cinq ans, et il se complete quand vous voulez.' },
  { heures: 420, nom: 'Quatre cent vingt heures', texte: 'Le titre d artisan responsable d atelier, inscrit au repertoire national. Personne ne le fait en un an, et c est tres bien ainsi.' },
] as const
...
export default function Page(): ReactElement {
  ...
  const basculer = useCallback((cle: string) => {
    setChoisis((precedents) => {
      if (precedents.includes(cle)) {
        ...
        setAvis(orphelins.some((o) => precedents.includes(o)) ? `« ${moduleDe(orphelins[0] ?? '')?.nom ?? ''} » est retire avec son prerequis.` : null)
  ...
  return (
    <Porte forme="compteur" marque="Atelier Continu" sombre={false}>
      ...
      */}
      <div className="o-relative" style={{ ...polices, backgroundColor: accentDoux(100, 8) }}>
        ...
        <div className="o-relative o-z-10">
          ...
          */}
          ...
          <section id="haut" className="o-relative o-flex o-flex-col" style={{ minHeight: ECRAN }}>
            <div className="o-mx-auto o-grid o-w-full o-max-w-7xl o-grow o-items-center o-gap-12 o-px-6 o-pb-20 o-pt-36 md:o-grid-cols-12 md:o-px-10">
              <div className="md:o-col-span-7">
                <Surgit>
                  <Etiquette sombre={false}>Organisme certifie Qualiopi — Saint-Etienne, halle de la Chapelle</Etiquette>
                </Surgit>
                <TitreVague
                  delai={140}
                  cadence={80}
                  className="o-m-0 o-mt-7 o-max-w-3xl o-text-zinc-950 dark:o-text-zinc-50"
                  style={{ ...affiche('l', 300), fontSize: 'clamp(2.4rem, 6.6vw, 6.5rem)', letterSpacing: '-0.045em', lineHeight: 0.96 }}
                >
                  On apprend un metier en heures, pas en journees.
                </TitreVague>
                <Surgit delai={600} as="p" className="o-m-0 o-mt-8 o-max-w-lg o-text-lg o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300">
                  Douze modules, quatre blocs, et un parcours que vous composez. La duree, le cout et le reste a charge se calculent devant vous.
                </Surgit>
                <Surgit delai={740} className="o-mt-9">
                  <Actions
                    pleine={['#parcours', <>Composer un parcours <Icon icon={ArrowDown} size={16} aria-hidden="true" /></>]}
              ...
              <Surgit delai={860} className="md:o-col-span-5">
                <div
                  ...
                  style={{ borderColor: 'var(--o-theme-line)', backgroundColor: 'var(--o-theme-bg)', transform: 'rotate(-1.6deg)', boxShadow: '0 24px 60px -40px rgba(0,0,0,0.45)' }}
                >
                  <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Le plus suivi cette annee</p>
                  <p className="o-m-0 o-mt-4 o-text-2xl o-font-semibold o-tracking-tight o-text-zinc-950 dark:o-text-zinc-50">Le prix de revient horaire</p>
                  <p className="o-m-0 o-mt-3 o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                    Sept heures. On ouvre vos chiffres, et la moitie des stagiaires decouvre qu ils travaillent a perte.
                  </p>
                  <dl className="o-m-0 o-mt-6 o-grid o-grid-cols-3 o-gap-4 o-border-t o-pt-5" style={{ borderColor: 'var(--o-theme-line)' }}>
                    {(
                      [
                        ['Duree', '7 h'],
                        ['Tarif', '520 EUR'],
                      ...
                      <div key={quoi}>
                        ...
                        <dd className="o-m-0 o-mt-1 o-text-base o-font-semibold o-tabular-nums" style={{ color: encre() }}>
                          {valeur}
                        </dd>
                      </div>
                    ))}
          ...
          <div className="o-px-6 md:o-px-10">
            ...
            */}
            <div className="o-mx-auto o-max-w-7xl o-overflow-hidden o-border-t" style={{ borderColor: 'var(--o-theme-line)' }}>
              <Logos
                sombre={false}
                titre="Ils nous envoient leurs equipes"
                marques={['Charpente Vialle', 'Maconnerie du Furan', 'Atelier Brasseur', 'Couverture Lheritier', 'Menuiserie Sauge', 'Terre & Chaux']}
              />
            </div>
          </div>
          ...
          */}
          <section id="parcours" className="o-scroll-mt-24">
            <Rail
              ecrans={4}
              entete={
                <div className="o-border-b o-px-6 o-pb-6 o-pt-24 md:o-px-10" style={{ borderColor: 'var(--o-theme-line)', backgroundColor: accentDoux(100, 14) }}>
                  <div className="o-mx-auto o-flex o-max-w-7xl o-flex-wrap o-items-end o-justify-between o-gap-6">
                    <div>
                      ...
                      <h2
                        ...
                        style={{ ...affiche('m', 300), fontSize: 'clamp(1.5rem, 3vw, 2.5rem)', letterSpacing: '-0.04em' }}
                      >
                    ...
                    <dl className="o-m-0 o-flex o-flex-wrap o-gap-x-8 o-gap-y-3">
                      {(
                        ...
                        <div key={quoi}>
                          <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">{quoi}</dt>
                          <dd className="o-m-0 o-mt-1 o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.25rem, 2.2vw, 1.9rem)' }}>
                            {valeur}
                          </dd>
                        </div>
                      ))}
                  ...
                  <p aria-live="polite" className="o-m-0 o-mx-auto o-mt-4 o-max-w-7xl o-text-sm o-text-zinc-600 dark:o-text-zinc-300" style={{ minHeight: '1.25rem' }}>
                    {avis}
                  </p>
                </div>
              }
              ...
              {MODULES.map((module) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="o-m-0 o-mt-4 o-grow o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">{module.texte}</p>
                    <p className="o-m-0 o-mt-5 o-border-t o-pt-4 o-text-sm o-leading-relaxed o-text-zinc-800 dark:o-text-zinc-200" style={{ borderColor: 'var(--o-theme-line)' }}>
                      {module.sortie}
                    </p>
          ...
          */}
          <section id="titre" className="o-scroll-mt-24 o-border-t o-px-6 o-py-20 md:o-px-10 md:o-py-28" style={{ borderColor: 'var(--o-theme-line)' }}>
            <div className="o-mx-auto o-grid o-max-w-7xl o-gap-12 lg:o-grid-cols-12">
              <div className="lg:o-col-span-7">
                ...
                <h2
                  ...
                  style={{ ...affiche('m', 300), fontSize: 'clamp(1.75rem, 3.4vw, 3rem)', letterSpacing: '-0.04em' }}
                >
                  {compte.heures === 0 ? 'Votre parcours est vide.' : `${String(compte.heures)} heures, ${String(compte.jours)} journees a poser.`}
                </h2>

                <dl aria-live="polite" className="o-m-0 o-mt-10">
                  {(
                    [
                      ['Tarif catalogue', euros(compte.brut), `${String(choisis.length)} module${choisis.length > 1 ? 's' : ''}`],
                      ['Degressivite', compte.remise === 0 ? '—' : `- ${euros(compte.remise)}`, compte.heures > 70 ? 'quinze pour cent au-dela de 70 h' : compte.heures > 35 ? 'huit pour cent au-dela de 35 h' : 'a partir de 35 heures'],
                      ['Tarif net', euros(compte.net), 'ce qui est facture a l entreprise'],
                      ['Prise en charge', `- ${euros(compte.priseEnCharge)}`, compte.priseEnCharge >= PLAFOND ? 'plafond annuel atteint' : 'soixante pour cent du net'],
                    ] as const
                  ).map(([quoi, valeur, note]) => (
                    <div key={quoi} className="o-grid o-gap-x-6 o-gap-y-1 o-border-t o-py-4 md:o-grid-cols-12" style={{ borderColor: 'var(--o-theme-line)' }}>
                      <dt className="md:o-col-span-7">
                        <span className="o-block o-text-base o-font-medium o-text-zinc-950 dark:o-text-zinc-50">{quoi}</span>
                        <span className="o-mt-1 o-block o-text-sm o-text-zinc-600 dark:o-text-zinc-400">{note}</span>
                      </dt>
                      <dd className="o-m-0 o-font-mono o-tabular-nums o-text-zinc-900 dark:o-text-zinc-100 md:o-col-span-5 md:o-text-right">{valeur}</dd>
                    </div>
                  ))}
                </dl>
                ...
                >
                  <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-700 dark:o-text-zinc-300">Reste a charge de l entreprise</p>
                  <p className="o-m-0 o-tabular-nums o-text-zinc-950 dark:o-text-zinc-50" style={{ ...affiche('m', 300), fontSize: 'clamp(1.9rem, 3.6vw, 3rem)' }}>
                    {euros(compte.reste)}
                  </p>
                </div>
              ...
              <div className="lg:o-col-span-5">
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500 dark:o-text-zinc-400">Les prochaines sessions</p>
                <AnimatedList
                ...
                <p className="o-m-0 o-mt-5 o-text-sm o-leading-relaxed o-text-zinc-600 dark:o-text-zinc-400">
                  Une session se tient a six stagiaires au minimum. En dessous, elle est reportee et personne n avance d argent.
                </p>
              </div>
            </div>
          </section>
          ...
          {/*
            ----- La coupe sombre ------------------------------------------------
          */}
          <section className="o-flex o-items-center o-px-6 o-py-24 md:o-px-10 md:o-py-36" style={nuit('zinc')}>
            <div className="o-mx-auto o-w-full o-max-w-7xl">
              <Manifeste eteint="Nous ne vendons pas des journees de salle.">
                Nous vendons des gens qui rentrent lundi en sachant faire quelque chose qu ils ne savaient pas faire vendredi.
              </Manifeste>
              <p className="o-m-0 o-mt-10 o-max-w-xl o-text-base o-leading-relaxed o-text-zinc-400">
                C est pour cela que chaque module se termine sur un livrable qui vous appartient : un devis, un document unique, un plan de reprise. Pas une attestation.
              </p>
            </div>
          </section>
          ...
          */}
          <Epingle ecrans={3} actes={JALONS.length}>
            {(acte) => {
              ...
              return (
                <div className="o-flex o-h-full o-flex-col o-justify-center o-px-6 md:o-px-10" style={{ backgroundColor: accentDoux(100, 10) }}>
                  <div className="o-mx-auto o-w-full o-max-w-5xl">
                    ...
                    <p
                      ...
                      style={{ ...affiche('l', 300), fontSize: 'clamp(2.5rem, 8vw, 7rem)', lineHeight: 0.9 }}
                    >
                      {jalon.nom}
                    </p>
                    ...
                    <div
                      ...
                      style={{ borderColor: 'var(--o-theme-line)', backgroundColor: 'var(--o-theme-bg)' }}
                    >
                      <div
                        className="o-h-full"
                        style={{ width: reduced ? '100%' : 'calc(var(--p, 0) * 100%)', backgroundColor: accent(500) }}
                      />
                      {[70, 210, 420].map((h) => (
                        <span
                          key={h}
                          ...
                          style={{ left: `${String((h / 420) * 100)}%`, backgroundColor: 'var(--o-palette-zinc-950)', opacity: 0.45 }}
                        />
                      ))}
                    </div>
                    <div aria-hidden="true" className="o-mt-2 o-flex o-justify-between o-font-mono o-text-xs o-tabular-nums o-text-zinc-500 dark:o-text-zinc-400">
                      <span>0 h</span>
                      <span>70 h</span>
                      <span>210 h</span>
                      <span>420 h</span>
                    ...
                    <p className="o-m-0 o-mt-10 o-max-w-xl o-text-lg o-leading-relaxed o-text-zinc-700 dark:o-text-zinc-300">{jalon.texte}</p>
                  </div>
                </div>
              )
            }}
          ...
          */}
          <section id="essai" className="o-scroll-mt-24 o-border-t o-px-6 o-py-20 md:o-px-10 md:o-py-28" style={{ borderColor: 'var(--o-theme-line)' }}>
          ...
          <footer className="o-px-6 o-py-16 md:o-px-10" style={nuit('zinc')}>
            <div className="o-mx-auto o-max-w-7xl">
              <div className="o-flex o-flex-wrap o-items-end o-justify-between o-gap-4">
                ...
                <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-400">Mise a jour a 06 h 00</p>
              </div>

              <div className="o-mt-6 o-overflow-x-auto" style={{ overflowY: 'hidden' }}>
                <table className="o-w-full o-text-left o-font-mono o-text-sm" style={{ minWidth: 620, borderCollapse: 'collapse' }}>
                  <thead>
                    <tr className="o-border-b o-border-white-20">
                      {(['Heure', 'Module', 'Salle', 'Duree', 'Etat'] as const).map((entete) => (
                        <th key={entete} scope="col" className="o-py-3 o-pr-6 o-text-xs o-uppercase o-tracking-widest o-font-normal o-text-zinc-400">
                          {entete}
                        </th>
                      ))}
                    </tr>
                  ...
                  <tbody>
                    {DEPARTS.map(([heure, module, salle, duree, etat]) => (
                      <tr key={`${heure}-${module}`} className="o-border-b o-border-white-10">
                        <td className="o-py-4 o-pr-6 o-tabular-nums o-text-zinc-100">{heure}</td>
                        <td className="o-py-4 o-pr-6 o-text-zinc-100">{module}</td>
                        <td className="o-py-4 o-pr-6 o-text-zinc-400">{salle}</td>
                        <td className="o-py-4 o-pr-6 o-tabular-nums o-text-zinc-400">{duree}</td>
                        <td className="o-py-4 o-pr-6" style={{ color: etat === 'Complet' ? 'var(--o-palette-zinc-500)' : encreSurSombre() }}>
                          {etat}
                        </td>
                      </tr>
                    ))}
              ...
              <div className="o-mt-12 o-grid o-gap-8 o-border-t o-border-white-10 o-pt-8 md:o-grid-cols-4">
                {(
                  [
                    ...
                    ['Mentions', ['Declaration 84 42 05 199 42', 'Certification Qualiopi — actions de formation']],
                  ] as const
                ).map(([titre, lignes]) => (
                  <div key={titre}>
                    <p className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-zinc-500">{titre}</p>
                    {lignes.map((ligne) => (
