...
const FONDS: readonly Papier[] = [
  {
    ...
    teinte: '#f4efe4',
    grain: 'Grain fin',
    usage: 'Aquarelle, lavis, fusain',
    prix: '2,40 EUR la feuille',
    note: 'Cent pour cent coton, sans acide. Il boit sans gondoler et se tend a l eau claire.',
  },
  {
    id: 'verge',
    nom: 'Verge d Arches',
    ...
    teinte: '#f7f2e6',
    grain: 'Verge',
    usage: 'Correspondance, faire-part',
    prix: '1,10 EUR la feuille',
    note: 'Les vergeures se voient a contre-jour : ce sont les fils de la forme, restes dans la feuille.',
  },
  {
    id: 'bristol',
    nom: 'Bristol lisse',
    ...
    teinte: '#fdfdfb',
    grain: 'Lisse',
    usage: 'Plume, encre de Chine, calligraphie',
    prix: '1,60 EUR la feuille',
    note: 'Surface fermee : la plume glisse et l encre reste dessus, elle ne part pas en barbes.',
  },
  {
    id: 'bouffant',
    nom: 'Offset bouffant',
    ...
    teinte: '#f6f1e3',
    grain: 'Bouffant',
    usage: 'Roman, livre de poche',
    prix: '0,22 EUR la feuille',
    note: 'Le papier des livres : leger dans la main, epais dans la tranche. C est toute la main.',
  },
  {
    id: 'couche',
    nom: 'Couche mat',
    ...
    teinte: '#fbfcfd',
    grain: 'Couche',
    usage: 'Photographie, catalogue',
    prix: '0,45 EUR la feuille',
    note: 'Une charge de kaolin ferme la surface. Lourd, mince, et fidele sur les gris.',
  },
  {
    id: 'kraft',
    nom: 'Kraft naturel',
    ...
    teinte: '#d9c3a1',
    grain: 'Kraft',
    usage: 'Emballage, carnet, patron',
    prix: '0,20 EUR la feuille',
    note: 'Fibres longues non blanchies : il se dechire droit dans le sens de la machine.',
  },
  {
    id: 'japon',
    nom: 'Japon fin',
    ...
    teinte: '#f2ead8',
    grain: 'Fibre longue',
    usage: 'Reliure, reparation, estampe',
    prix: '3,20 EUR la feuille',
    note: 'On le dechire mouille pour obtenir un bord en frange, qui se fond dans la page reparee.',
  },
  {
    id: 'calque',
    nom: 'Calque',
    ...
    teinte: '#eef1f2',
    grain: 'Calque',
    usage: 'Report, architecture, patron',
    prix: '0,60 EUR la feuille',
    note: 'Rendu translucide au raffinage, pas par un enduit : il reste dessinable des deux cotes.',
  },
  {
    id: 'buvard',
    nom: 'Buvard',
    ...
    teinte: '#f3dfe4',
    grain: 'Buvard',
    usage: 'Ecriture a la plume, sechage',
    prix: '0,95 EUR la feuille',
    note: 'Ni colle ni charge : la fibre est laissee ouverte, et c est ce qui boit l encre.',
  },
  {
    id: 'gratter',
    nom: 'Carte a gratter',
    ...
    teinte: '#ffffff',
    grain: 'Enduit',
    usage: 'Illustration au grattoir',
    prix: '3,80 EUR la feuille',
    note: 'Un enduit de craie sur carte noire. On ne dessine pas : on enleve.',
  },
]
          ...
          <pattern id="o-pa-fibres" width="80" height="80" patternUnits="userSpaceOnUse">
            <g stroke={accentDoux(900, 14)} strokeWidth="0.7" strokeLinecap="round">
              {fibres.map((f, rang) => (
                <path
                  key={rang}
                  d={`M${f.x.toFixed(1)} ${f.y.toFixed(1)}l${f.dx.toFixed(1)} ${f.dy.toFixed(1)}`}
                />
              ))}
            </g>
          </pattern>
  ...
  return (
    ...
    >
      <div
        ...
        style={{ aspectRatio: '1 / 1.414', backgroundColor: papier.teinte }}
      >
        {/* La moitie basse, qui reste. */}
        <div
          className="o-absolute o-inset-x-0 o-bottom-0 o-top-1/2"
          style={{
        ...
        <svg
          viewBox="0 0 120 120"
          className="o-pointer-events-none o-absolute o-left-1/2 o-top-1/2 o-w-20"
        ...
        >
          <circle
            ...
            r="40"
            fill="none"
            stroke={accentDoux(900, 16)}
            strokeWidth="1.5"
          />
          <path
            d="M60 26v68M34 44h52M34 76h52"
            stroke={accentDoux(900, 14)}
            strokeWidth="1.2"
          />
        </svg>
      </div>
  ...
  return (
    <div className="o-relative o-flex o-gap-6" style={{ height: 420 }}>
      ...
      <div className="o-relative o-w-24 o-shrink-0">
        <span
          aria-hidden="true"
          className="o-absolute o-bottom-0 o-top-0 o-w-px"
          style={{ left: 0, backgroundColor: 'var(--o-palette-slate-700)' }}
        />
        {graduations.map((valeur) => {
          ...
          return (
            <span
              key={valeur}
              aria-hidden="true"
              className="o-absolute o-flex o-items-center o-gap-2"
              style={{ bottom: `${String(y)}%`, left: 0 }}
            >
              <span
                className="o-block o-h-px"
                style={{
                  width: longue ? 22 : 11,
                  backgroundColor: 'var(--o-palette-slate-600)',
                }}
              />
              {longue && (
                <span className="o-font-mono o-text-xs o-tabular-nums o-text-slate-400">
                  {valeur}
                </span>
              )}
            </span>
  ...
  return (
    <div className="o-grid o-gap-10 lg:o-grid-cols-12">
              ...
              <li key={ligne.id}>
                ...
                >
                  <span
                    ...
                    style={{
                      backgroundColor: ligne.teinte,
                      boxShadow: choisi
                        ? `0 0 0 2px ${encre()}`
                        : `inset 0 0 0 1px ${accentDoux(900, 20)}`,
                    }}
                  />
                  <span className="o-min-w-0 o-grow">
                    <span
                      className={`o-block o-text-sm ${choisi ? 'o-font-semibold o-text-slate-950 dark:o-text-slate-50' : 'o-text-slate-700 dark:o-text-slate-300'}`}
                    >
                      {ligne.nom}
                    </span>
      ...
      <div className="lg:o-col-span-5">
        ...
        <p className="o-m-0 o-mt-5 o-max-w-md o-text-base o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
          {papier.note}
        </p>

        <dl
          className="o-m-0 o-mt-8 o-grid o-gap-px sm:o-grid-cols-2"
          style={{ backgroundColor: accentDoux(900, 16) }}
        >
          {(
            [
              [
                'Epaisseur',
                `${(releve.epaisseur / 1000).toFixed(3).replace('.', ',')} mm`,
                'grammage x main',
              ],
              [
                'Une feuille A4',
                `${releve.feuilleA4.toFixed(1).replace('.', ',')} g`,
                `${String(releve.parLettre)} dans une lettre de 20 g`,
              ],
              [
                'Opacite',
                `${String(papier.opacite)} %`,
                papier.opacite < 50 ? 'on lit au travers' : 'le verso ne traverse pas',
              ],
              [
                'Cinq centimetres',
                `${String(releve.parPile)} feuilles`,
                'de pile, a plat',
              ],
            ] as const
          ).map(([quoi, valeur, note]) => (
            <div key={quoi} className="o-bg-slate-50 dark:o-bg-slate-950 o-px-5 o-py-4">
              <dt className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-slate-500 dark:o-text-slate-400">
                {quoi}
              </dt>
              <dd className="o-m-0 o-mt-2 o-font-mono o-text-xl o-tabular-nums o-text-slate-950 dark:o-text-slate-50">
                {valeur}
              </dd>
              <dd className="o-m-0 o-mt-1 o-text-xs o-leading-relaxed o-text-slate-500 dark:o-text-slate-400">
                {note}
              </dd>
            </div>
          ))}
        ...
        <p className="o-m-0 o-mt-6 o-flex o-flex-wrap o-items-baseline o-justify-between o-gap-4 o-border-t o-border-black-10 dark:o-border-slate-800 o-pt-5">
          <span className="o-font-mono o-text-xs o-uppercase o-tracking-widest o-text-slate-500 dark:o-text-slate-400">
            Au detail
          </span>
          <span className="o-font-mono o-text-sm o-tabular-nums o-text-slate-950 dark:o-text-slate-50">
            {papier.prix}
          </span>
        </p>
      </div>
...
export default function Page(): ReactElement {
  ...
  return (
    <Porte forme="trou" marque="Filigrane" sombre={false}>
      <div
        className="o-bg-slate-50 dark:o-bg-slate-950 o-text-slate-900 dark:o-text-slate-50"
        style={polices}
      >
        ...
        >
          ...
          <div className="o-relative o-flex o-grow o-items-center o-px-6 o-py-16 md:o-px-10">
            <div className="o-mx-auto o-grid o-w-full o-max-w-6xl o-items-center o-gap-12 lg:o-grid-cols-12">
              <div className="lg:o-col-span-7">
                <Surgit>
                  <Etiquette sombre={false}>
                    Papetier — fonds de dix-sept mille feuilles
                  </Etiquette>
                </Surgit>
                <TitreVague
                  delai={140}
                ...
                <Surgit
                  delai={520}
                  as="p"
                  className="o-m-0 o-mt-8 o-max-w-lg o-text-lg o-leading-relaxed o-text-slate-600 dark:o-text-slate-400"
                >
                  Un papier tient dans deux nombres : le grammage et la main. Tout le
                  reste — l epaisseur, le poids d une lettre, ce qu on voit au travers —
                  se calcule, et nous le calculons ici.
                </Surgit>
              ...
              <div
                className="o-relative o-hidden lg:o-col-span-5 lg:o-block"
                style={{ height: 440 }}
              >
                {(
                  [
                ...
                ).map(([feuille, decalageX, decalageY, glisse, angle], rang) =>
        ...
        <section
          id="nuancier"
          className="o-relative o-scroll-mt-24 o-border-t o-border-black-10 dark:o-border-slate-800 o-px-6 o-py-24 md:o-px-10 md:o-py-32"
        >
          <div className="o-mx-auto o-max-w-6xl">
            ...
            <Reveal delay={140}>
              <p className="o-m-0 o-mt-6 o-max-w-xl o-text-base o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
                La main est le volume qu occupe un gramme. C est elle, et pas le grammage,
                qui dit l epaisseur : un bouffant de 90 grammes est plus epais qu un
                couche de 135.
              </p>
            </Reveal>
          ...
          <div className="o-mx-auto o-grid o-max-w-6xl o-items-center o-gap-16 lg:o-grid-cols-12">
            <div className="lg:o-col-span-5">
              ...
              <p className="o-m-0 o-mt-6 o-max-w-md o-text-base o-leading-relaxed o-text-slate-300">
                Les vergeures, le filigrane, la charge, l endroit ou la pate est plus
                mince : rien de tout cela ne se voit a plat. C est le premier geste du
                metier, et c est celui qu on vous apprend au comptoir.
              </p>

              {/* Le sceau de la maison, dans la pate. */}
              <div
                className="o-relative o-mt-12 o-flex o-items-center o-justify-center"
                style={{ width: 220, height: 220 }}
              >
                <CircularText
                  size={210}
                  speed={26}
                  className="o-absolute o-text-slate-400"
                >
                ...
                <svg viewBox="0 0 120 120" className="o-w-24" aria-hidden="true">
                  <circle
                    ...
                    stroke="currentColor"
                    strokeWidth="1.5"
                    className="o-text-slate-500"
                  />
                  <path
                    d="M60 22v76M30 44h60M30 76h60"
                    stroke="currentColor"
                    strokeWidth="1.2"
                    className="o-text-slate-600"
                  />
                  <circle
                    cx="60"
                    cy="60"
            ...
            <div className="lg:o-col-span-7">
              ...
              <p className="o-m-0 o-mt-8 o-max-w-md o-font-mono o-text-xs o-uppercase o-leading-relaxed o-tracking-widest o-text-slate-400">
                Echelle des grammages du fonds — de 40 a 320 g au metre carre. Le repere
                suit le papier choisi dans le nuancier.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="o-mx-auto o-grid o-max-w-6xl o-items-center o-gap-16 lg:o-grid-cols-12">
            ...
            <div className="lg:o-col-span-7">
              <div
                ...
                style={{ boxShadow: `inset 0 0 0 1px ${accentDoux(900, 18)}` }}
              >
                <p
                  className="o-m-0 o-font-mono o-text-xs o-uppercase o-tracking-widest"
                  style={{ color: encre() }}
                ...
                <p
                  className="o-m-0 o-mt-5 o-max-w-lg o-text-base o-leading-relaxed o-text-slate-600 dark:o-text-slate-400"
                  aria-live="polite"
                >
                  {ouverte?.texte}
                </p>
                    ...
                    return (
                      <li key={id}>
                        ...
                        >
                          <span
                            aria-hidden="true"
                            className="o-block o-size-4 o-rounded-full"
                            style={{
                              backgroundColor: ligne.teinte,
                              boxShadow: `inset 0 0 0 1px ${accentDoux(900, 20)}`,
                            }}
                          />
                          {ligne.nom}
                        </button>
        ...
        <section
          ...
          className="o-border-t o-border-black-10 dark:o-border-slate-800 o-px-6 o-py-20 md:o-px-10 md:o-py-28"
        >
          <div className="o-mx-auto o-max-w-3xl o-text-center">
            ...
            <p className="o-m-0 o-mt-5 o-text-base o-leading-relaxed o-text-slate-600 dark:o-text-slate-400">
              Dix-sept echantillons de format carte postale, affranchis a nos frais. Un
              papier se choisit entre deux doigts, pas sur un ecran.
            </p>
            ...
            */}
            ...
            <p
              className="o-m-0 o-mt-4 o-text-xs o-leading-relaxed o-text-slate-500 dark:o-text-slate-400"
              aria-live="polite"
            >
              {envoye
                ? 'C est parti a la levee de 18 h. Comptez trois jours.'
                : 'Une adresse, rien d autre. Nous n envoyons pas de lettre d information.'}
            </p>
          </div>
        </section>
        ...
        <footer className="o-px-6 o-pb-16 md:o-px-10">
          <div className="o-mx-auto o-max-w-4xl">
            <div
              className="o-relative o-p-8 md:o-p-10"
              style={{
                boxShadow: `inset 0 0 0 2px ${accentDoux(900, 40)}`,
            ...
            >
              <div className="o-flex o-flex-wrap o-items-start o-justify-between o-gap-6 o-border-b o-border-black-20 dark:o-border-slate-700 o-pb-5">
                <p className="o-m-0">
                  ...
                  <span className="o-mt-2 o-block o-text-2xl o-font-semibold o-tracking-tight o-text-slate-950 dark:o-text-slate-50">
                    Filigrane
                  </span>
                </p>
                ...
                <svg viewBox="0 0 180 48" className="o-w-40" aria-hidden="true">
                  ...
                  <text
                    ...
                    fontSize="9"
                    fill="currentColor"
                    className="o-text-slate-500 dark:o-text-slate-400"
                    style={{ fontFamily: 'var(--o-font-mono)', letterSpacing: '0.2em' }}
                  >
                    3 760 214 000 417
                  </text>
                </svg>
              ...
              <dl className="o-m-0 o-mt-6 o-grid o-gap-6 sm:o-grid-cols-2 lg:o-grid-cols-4">
                {(
                  ...
                  <div key={quoi}>
                    ...
                    <dd className="o-m-0 o-mt-2 o-text-sm o-leading-relaxed o-text-slate-700 dark:o-text-slate-300">
                      {valeur}
                    </dd>
                  </div>
                ))}
